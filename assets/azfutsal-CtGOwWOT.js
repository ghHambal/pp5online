import{s as Kn}from"./supabase-BV-W2lsh.js";import{b as ln}from"./browser-JP79f-a9.js";import{g as Ze}from"./ui-MMtcTwtt.js";import{p as Zn}from"./promptpay-CIuxvxIA.js";import{compressImage as Pt,uploadAzfutsalPlayerPhoto as ei}from"./storage-CuUjCgvI.js";import{l as ti,f as ni}from"./confetti-loader-BAN5Lv-C.js";import{o as et}from"./print-overlay-BVfxEd6n.js";import{g as ii,w as oi}from"./workload-scheduler-C9WpzjbH.js";const Ee=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]);function ai({name:e,award:t,templateUrl:n}){const i=Ee(e),o=Ee(t);return`<!DOCTYPE html><html lang="th"><head><meta charset="UTF-8"><title>เกียรติบัตร ${i}</title>
    <link href="https://fonts.googleapis.com/css2?family=Charmonman:wght@400;700&display=swap" rel="stylesheet">
    <style>
      * { box-sizing: border-box; }
      body { font-family: 'Sarabun', sans-serif; margin: 0; background: #fff; }
      .cert { position: relative; width: 100%; max-width: 1000px; margin: 0 auto; aspect-ratio: 2000 / 1414; background: url('${Ee(n)}') center/contain no-repeat; }
    ...
    </body></html>`}function ri({name:e,award:t,templateUrl:n}){const i=Ee(e),o=Ee(t);return`<div style="container-type:inline-size;position:relative;width:100%;aspect-ratio:2000/1414;border-radius:10px;overflow:hidden;background:#fff url('${Ee(n)}') center/contain no-repeat">
  ...
  </div>`}function di({name:e,award:t,templateUrl:n},i){if(!n){i==null||i("ยังไม่ได้อัปโหลดพื้นหลังเกียรติบัตร กรุณาแจ้งแอดมิน");return}et(ai({name:e,award:t,templateUrl:n}))}let ve=!1,Ge=null;const De=new Set;function ue(e){e&&(clearInterval(e),De.delete(e))}function si(e){return e&&De.add(e),e}function li(){ve=!1,De.forEach(e=>clearInterval(e)),De.clear(),We(),jt(),["az-live-display-overlay","az-evbig-overlay","az-evpend-overlay","az-schedbig-overlay","az-matchbig-overlay","az-standbig-overlay"].forEach(e=>{var t;return(t=document.getElementById(e))==null?void 0:t.remove()})}function Ce(e,t,n){if(!ve)return null;const i=setInterval(async()=>{if(!ve||n&&!document.body.contains(n)){ue(i),ve||n==null||n.remove();return}await e()},t);return De.add(i),i}const Xe={champion:"ได้รับรางวัลชนะเลิศ การแข่งขัน{event}",runner_up:"ได้รับรางวัลรองชนะเลิศอันดับที่ 1 การแข่งขัน{event}",third:"ได้รับรางวัลรองชนะเลิศอันดับที่ 2 การแข่งขัน{event}",mvp:"ได้รับรางวัลผู้เล่นยอดเยี่ยม (MVP) การแข่งขัน{event}",top_scorer:"ได้รับรางวัลดาวซัลโว การแข่งขัน{event}",best_gk:"ได้รับรางวัลผู้รักษาประตูยอดเยี่ยม การแข่งขัน{event}",participant:"เข้าร่วมการแข่งขัน{event}"},ci={champion:"แชมป์",runner_up:"รองแชมป์",third:"อันดับ 3",mvp:"MVP",top_scorer:"ดาวซัลโว",best_gk:"ผู้รักษาประตูยอดเยี่ยม",participant:"ผู้เข้าร่วม (ค่าเริ่มต้น)"},S={MS:{label:"ม.ต้น",accent:"#db2777",base:"#ec4899",soft:"#fdf2f8",border:"#f9d4e6"},HS:{label:"ม.ปลาย",accent:"#16a34a",base:"#22c55e",soft:"#f0fdf4",border:"#bbf0cf"}};function re(e,t,n){const i=e.replace("#",""),o=parseInt(i.length===3?i.split("").map(d=>d+d).join(""):i,16);return"#"+[o>>16&255,o>>8&255,o&255].map(d=>Math.round(d+(t-d)*n)).map(d=>Math.max(0,Math.min(255,d)).toString(16).padStart(2,"0")).join("")}function cn(){const e=/^#[0-9a-fA-F]{6}$/.test(y("COLOR_MS",""))?y("COLOR_MS"):"#ec4899",t=/^#[0-9a-fA-F]{6}$/.test(y("COLOR_HS",""))?y("COLOR_HS"):"#22c55e";if(r.theme==="dark"){S.MS.base=e,S.MS.accent=re(e,255,.18),S.MS.soft=re(e,15,.82),S.MS.border=re(e,100,.58),S.HS.base=t,S.HS.accent=re(t,255,.18),S.HS.soft=re(t,15,.82),S.HS.border=re(t,100,.58);return}S.MS.base=e,S.MS.accent=re(e,0,.15),S.MS.soft=re(e,255,.94),S.MS.border=re(e,255,.78),S.HS.base=t,S.HS.accent=re(t,0,.15),S.HS.soft=re(t,255,.94),S.HS.border=re(t,255,.78)}const pn="azfutsal.standalone.admin@pp5online.internal",pi="8112d7c9-ab32-4e63-9026-ab2367401d4c",fi=[{code:"M1",round:"รอบแรก"},{code:"M2",round:"รอบแรก"},{code:"M3",round:"รอบแรก"},{code:"M4",round:"รอบแรก"},{code:"M5",round:"รอบแรก"},{code:"M6",round:"รอบแรก"},{code:"M7",round:"รอบแก้ตัว",refA:"L_M1",refB:"L_M2"},{code:"M8",round:"รอบแก้ตัว",refA:"L_M3",refB:"L_M4"},{code:"M9",round:"รอบแก้ตัว",refA:"L_M5",refB:"L_M6"},{code:"M10",round:"ก่อนรองฯ",refA:"W_M1",refB:"W_M2"},{code:"M11",round:"ก่อนรองฯ",refA:"W_M3",refB:"W_M4"},{code:"M12",round:"ก่อนรองฯ",refA:"W_M5",refB:"REC_1"},{code:"M13",round:"ก่อนรองฯ",refA:"W_M6",refB:"REC_2"},{code:"M14",round:"รองฯ",refA:"W_M10",refB:"W_M11"},{code:"M15",round:"รองฯ",refA:"W_M12",refB:"W_M13"},{code:"M16",round:"ชิงที่ 3",refA:"L_M14",refB:"L_M15"},{code:"M17",round:"ชิงที่ 1",refA:"W_M14",refB:"W_M15"}],ui=[{code:"M1",round:"รอบแรก"},{code:"M2",round:"รอบแรก"},{code:"M3",round:"รอบแรก"},{code:"M4",round:"รอบแรก"},{code:"M5",round:"รอบแรก"},{code:"M6",round:"รอบแรก"},{code:"M7",round:"รอบแก้ตัว",refA:"L_M1",refB:"L_M2"},{code:"M8",round:"รอบแก้ตัว",refA:"L_M3",refB:"L_M4"},{code:"M9",round:"รอบแก้ตัว",refA:"L_M5",refB:"L_M6"},{code:"M10",round:"รอบ 10 ทีม",refA:"FIRST_ROUND_BYE",refB:"W_M1"},{code:"M11",round:"รอบ 10 ทีม",refA:"W_M2",refB:"W_M3"},{code:"M12",round:"รอบ 10 ทีม",refA:"W_M4",refB:"W_M5"},{code:"M13",round:"รอบ 10 ทีม",refA:"W_M6",refB:"W_M7"},{code:"M14",round:"รอบ 10 ทีม",refA:"W_M8",refB:"W_M9"},{code:"M15",round:"รอบ 6 ทีม",refA:"W_M10",refB:"W_M11"},{code:"M16",round:"รอบ 6 ทีม",refA:"W_M12",refB:"W_M13"},{code:"M17",round:"รอบ 6 ทีม",refA:"W_M14",refB:"LOTTERY_1"},{code:"M18",round:"รองฯ",refA:"W_M15",refB:"W_M16"},{code:"M19",round:"รองฯ",refA:"W_M17",refB:"LOTTERY_2"},{code:"M20",round:"ชิงที่ 1",refA:"W_M18",refB:"W_M19"}],fn=[{code:"M1",round:"รอบแรก"},{code:"M2",round:"รอบแรก"},{code:"M3",round:"รอบแรก"},{code:"M4",round:"รอบแรก"},{code:"M5",round:"รอบแรก"},{code:"M6",round:"รอบแรก"},{code:"M7",round:"รอบแรก"},{code:"M8",round:"รอบแรก"},{code:"M9",round:"รอบแก้ตัว",refA:"L_M1",refB:"L_M2"},{code:"M10",round:"รอบแก้ตัว",refA:"L_M3",refB:"L_M4"},{code:"M11",round:"รอบแก้ตัว",refA:"L_M5",refB:"L_M6"},{code:"M12",round:"รอบแก้ตัว",refA:"L_M7",refB:"L_M8"},{code:"M13",round:"รอบ 12 ทีม",pool:"R3"},{code:"M14",round:"รอบ 12 ทีม",pool:"R3"},{code:"M15",round:"รอบ 12 ทีม",pool:"R3"},{code:"M16",round:"รอบ 12 ทีม",pool:"R3"},{code:"M17",round:"รอบ 12 ทีม",pool:"R3"},{code:"M18",round:"รอบ 12 ทีม",pool:"R3"},{code:"M19",round:"รอบ 6 ทีม",pool:"R4"},{code:"M20",round:"รอบ 6 ทีม",pool:"R4"},{code:"M21",round:"รอบ 6 ทีม",pool:"R4"},{code:"M22",round:"รองฯ",refA:"W_M19",refB:"LOTTERY_1"},{code:"M23",round:"รองฯ",refA:"W_M20",refB:"W_M21"},{code:"M24",round:"ชิงที่ 3",refA:"L_M22",refB:"L_M23"},{code:"M25",round:"ชิงที่ 1",refA:"W_M22",refB:"W_M23"}],xi=fn,gi=fn,de=()=>y("MS_TEAM_FORMAT","12")==="16"?"16":"12",F={get MS(){return de()==="16"?xi:oe()?ui:fi},HS:gi},mi={get MS(){return de()==="16"?"M25":oe()?"M20":"M17"},HS:"M25"},bi={get MS(){return de()==="16"?"M24":oe()?null:"M16"},HS:"M24"},Dt={MS:["M7","M8","M9"]},Ot={},Ht={R3:["M1","M2","M3","M4","M5","M6","M7","M8","M9","M10","M11","M12"],R4:["M13","M14","M15","M16","M17","M18"]},tt={HS:Ht,MS:Ht},Ut=["M19","M20","M21"],yi={HS:Ut,MS:Ut},Ae=["M19","M20","M21"];function gt(e,t){if(e==="MS"&&oe()){if(t==="LOTTERY_1")return["M10","M11","M12","M13","M14"];if(t==="LOTTERY_2")return["M15","M16","M17"]}return t==="LOTTERY_1"?yi[e]||[]:[]}const p=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),W=e=>Number(e||0).toLocaleString("th-TH"),Ne=e=>e?new Date(e).toLocaleString("th-TH",{day:"numeric",month:"short",hour:"2-digit",minute:"2-digit"}):"";let h=null,ie=null,r={theme:typeof localStorage<"u"&&localStorage.getItem("az_theme")==="light"?"light":"dark",tab:"schedule",scheduleMode:"timeline",scheduleDay:1,bracketLevel:"MS",filterLevel:"ALL",filterTeam:"",filterTime:"",statsLevel:"MS",teamStatusLevel:"MS",teamStatusExpanded:null,adminSection:"general",newTeamName:"",newTeamLevel:"MS",rosterLookupCode:"",rosterLookupResult:null,rosterJersey:"",editingJerseyId:null,editJerseyValue:"",editingTeamName:!1,editTeamNameValue:"",myTeamMatchesOpen:!1,expandedPlayerId:null,teamCodeInput:typeof localStorage<"u"&&localStorage.getItem("az_team_code")||"",teamCodeLookupResult:null,myTeamTab:"roster",adminManageTeamId:null,adminCreatingTeam:!1,refundConfirmSign:null,refundConfirmDone:null,refundPayerSettingsOpen:!1,capLookupCode:"",capLookupResult:null,adminLoginOpen:!1,adminLoginUsername:"",adminLoginError:"",confirmRegOpen:!1,confirmRegTeamId:null,confirmRegQR:null,paymentUploading:!1,teamCreating:!1,rejectPaymentId:null,rejectReasonText:"",pendingConfirm:null,viewProofOpen:!1,viewProofUrl:null,liveDraw:null,certModalOpen:!1,certInput:"",certResults:null,certFullscreenIndex:null,knownStudentCode:null,editMatch:null,eventPicker:null,eventPickerFilter:"",adminTeamLevel:"MS",adminAthleteLevel:"MS",adminAthleteSearch:"",adminPaymentsLevel:"MS",adminRefundLevel:"MS",staffList:null,identity:{session:null,profile:null,isAdmin:!1,scopes:[],student:null,teacher:null},staffScopeEdit:null,manualPoolAssign:null,config:{},teams:[],players:[],matches:{MS:[],HS:[]},matchEvents:[],checkins:[],eventCheckins:[],eventCheckinDay:null,eventCheckinIncompleteLevel:"ALL",staffNames:{},awards:[],payments:[],refunds:[],loading:!0};function y(e,t=""){return r.config[e]??t}function un(e){return y(`CERT_TEXT_${e}`,Xe[e]||Xe.participant).replaceAll("{event}",y("EVENT_NAME","AZFUTSALCUP2026"))}function Ft(e){const t=[...r.players.map(s=>s.students)].find(s=>(s==null?void 0:s.student_code)===e);if(!t)return null;const n=r.players.find(s=>s.student_id===t.id),i=r.teams.find(s=>s.id===n.team_id),o=i.level,a=vn(o),d=[];return a.champion===i.name&&d.push({awardType:"champion",award:"ทีมชนะเลิศ"}),a.runnerUp===i.name&&d.push({awardType:"runner_up",award:"ทีมรองชนะเลิศ"}),(a.third===i.name||a.third2===i.name)&&d.push({awardType:"third",award:a.thirdLabel==="อันดับ 3 ร่วม"?"ทีมอันดับที่ 3 ร่วม":"ทีมอันดับที่ 3"}),a.mvp===t.full_name&&d.push({awardType:"mvp",award:"รางวัล MVP"}),a.topScorer===t.full_name&&d.push({awardType:"top_scorer",award:"รางวัลดาวซัลโว"}),a.bestGK===t.full_name&&d.push({awardType:"best_gk",award:"รางวัลผู้รักษาประตูยอดเยี่ยม"}),d.length||d.push({awardType:"participant",award:"ผู้เข้าร่วมการแข่งขัน"}),d.map(s=>({name:t.full_name,team:i.name,level:o,...s}))}function oe(){return de()==="12"&&r.teams.filter(e=>e.level==="MS").length===13}function xn(e,t=null){return!t&&e==="MS"&&oe()}const pt="20_MATCHES_2026_V1",qt="MS_M11_HS_M14_DAY2_ALTERNATE_0830_V1";async function vi(){if(!r.identity.isAdmin||!oe()||y("MS_BRACKET_REVISION")===pt||r.matches.MS.filter(c=>Number(String(c.match_code).replace(/^M/,""))>=10).some(c=>c.clock_status!=="not_started"||c.score_a!==null||c.score_b!==null||c.winner_team_id||c.loser_team_id))return!1;const i=[["M10","รอบ 10 ทีม","FIRST_ROUND_BYE","W_M1","16:40","16:45"],["M11","รอบ 10 ทีม","W_M2","W_M3","16:55","17:00"],["M12","รอบ 10 ทีม","W_M4","W_M5","17:10","17:15"],["M13","รอบ 10 ทีม","W_M6","W_M7","17:25","17:30"],["M14","รอบ 10 ทีม","W_M8","W_M9","17:40","17:45"],["M15","รอบ 6 ทีม","W_M10","W_M11","08:25","08:30"],["M16","รอบ 6 ทีม","W_M12","W_M13","08:55","09:00"],["M17","รอบ 6 ทีม","W_M14","LOTTERY_1","09:25","09:30"],["M18","รองฯ","W_M15","W_M16","09:55","10:00"],["M19","รองฯ","W_M17","LOTTERY_2","10:25","10:30"],["M20","ชิงที่ 1","W_M18","W_M19","12:25","12:30"]].map(([c,l,f,x,b,m])=>({level:"MS",match_code:c,round:l,order_no:Number(c.slice(1)),team_a_id:null,team_b_id:null,ref_a:f,ref_b:x,ready_time:b,kickoff_time:m,duration_min:14,break_min:1,score_a:null,score_b:null,yellow_a:0,red_a:0,yellow_b:0,red_b:0,winner_team_id:null,loser_team_id:null,is_locked:!1,clock_status:"not_started",clock_half:null,clock_started_at:null,clock_elapsed_before:0,clock_half_started_elapsed:0,is_penalty_shootout:!1,penalty_score_a:null,penalty_score_b:null})),{error:o}=await h.from("azfutsal_matches").upsert(i,{onConflict:"level,match_code"});if(o)return!1;for(const[c,l,f]of[["M13","16:25","16:30"],["M24","12:10","12:15"],["M25","12:40","12:45"]]){const{error:x}=await h.from("azfutsal_matches").update({ready_time:l,kickoff_time:f}).eq("level","HS").eq("match_code",c).eq("clock_status","not_started");if(x)return!1}const{error:a}=await h.from("azfutsal_config").upsert({key:"MS_BRACKET_REVISION",value:pt});if(a)return!1;const[{data:d},{data:s}]=await Promise.all([h.from("azfutsal_matches").select("*").eq("level","MS"),h.from("azfutsal_matches").select("*").eq("level","HS")]);return r.matches={MS:d||r.matches.MS,HS:s||r.matches.HS},r.config.MS_BRACKET_REVISION=pt,!0}function hi(e,t){const n=String(e||"").slice(0,10);return n?`${n}T${t}`:""}async function wi(){if(!r.identity.isAdmin||y("TWO_DAY_SCHEDULE_REVISION")===qt)return!1;const e=$n(y("START_TIME","")),t=hi(y("SECOND_DAY_START_TIME",e),"08:30");if(!t)return!1;const n=14,i=1;let o=new Date(t);const a=Me(2).map(([l,f])=>{const x=o.toTimeString().slice(0,5),b=new Date(o.getTime()-10*6e4).toTimeString().slice(0,5);return o=new Date(o.getTime()+(n+i)*6e4),{level:l,match_code:f,kickoff_time:x,ready_time:b,duration_min:n,break_min:i}}),{error:d}=await h.from("azfutsal_matches").upsert(a,{onConflict:"level,match_code"});if(d)return!1;const s=[{key:"SECOND_DAY_START_TIME",value:t},{key:"MATCH_MIN",value:String(n)},{key:"BREAK_MIN",value:String(i)},{key:"TWO_DAY_SCHEDULE_REVISION",value:qt}],{error:c}=await h.from("azfutsal_config").upsert(s);return c?!1:(a.forEach(l=>{const f=ee(l.level,l.match_code);f?Object.assign(f,l):r.matches[l.level].push(l)}),s.forEach(l=>{r.config[l.key]=l.value}),!0)}async function gn(){var z,N,I;const{data:{session:e}}=await h.auth.getSession();let t=null,n=!1,i=[],o=null,a=null;if(e){const{data:j}=await h.from("profiles").select("id, role, user_code, is_also_admin").eq("id",e.user.id).maybeSingle();if(t=j||null,t){const{data:O}=await h.from("azfutsal_admins").select("id, scopes").eq("profile_id",t.id).maybeSingle();i=(O==null?void 0:O.scopes)||[],n=i.includes("full");const{data:D}=await h.from("students").select("id, student_code, full_name, class_name, main_room").eq("profile_id",t.id).maybeSingle();o=D||null;const{data:Q}=await h.from("teachers").select("id, full_name, teacher_code").eq("profile_id",t.id).maybeSingle();a=Q||(((z=e.user.user_metadata)==null?void 0:z.account_type)==="azgames_competition_responsible"?{full_name:((N=e.user.user_metadata)==null?void 0:N.full_name)||"ครูผู้รับผิดชอบ",teacher_code:((I=e.user.user_metadata)==null?void 0:I.teacher_code)||t.user_code}:null)}}r.identity={session:e,profile:t,isAdmin:n,scopes:i,student:o,teacher:a};const[{data:d},{data:s},{data:c},{data:l},{data:f},{data:x},{data:b},{data:m},{data:w}]=await Promise.all([h.from("azfutsal_config").select("key, value"),h.from("azfutsal_teams").select("id, level, name, captain_student_id, vice_captain_student_id, payment_method, team_code, is_reserve, is_organizer, created_at, captain:students!azfutsal_teams_captain_student_id_fkey(full_name), vice_captain:students!azfutsal_teams_vice_captain_student_id_fkey(full_name)"),h.from("azfutsal_players").select("id, team_id, student_id, jersey_number, photo_url, registered_at, students(id, full_name, student_code, class_name, image_url, photo_url)"),h.from("azfutsal_matches").select("*").eq("level","MS"),h.from("azfutsal_matches").select("*").eq("level","HS"),h.from("azfutsal_awards").select("id, level, award_type, student_id, students(id, full_name)"),h.from("azfutsal_match_events").select("id, level, match_code, team_id, player_id, event_type, minute, is_penalty, created_at").order("created_at"),h.from("azfutsal_checkins").select("id, level, match_code, team_id, player_id, checked_in_by, checked_in_at"),h.from("azfutsal_event_checkins").select("id, day, team_id, player_id, checked_in_by, method, checked_in_at, parent_permission_confirmed, attire_confirmed, confirmed")]);r.config=Object.fromEntries((d||[]).map(j=>[j.key,j.value])),cn(),r.teams=s||[],r.players=c||[],r.matches={MS:l||[],HS:f||[]},await vi(),await wi(),r.awards=x||[],r.matchEvents=b||[],r.checkins=m||[],r.eventCheckins=w||[];const _=[...new Set([...r.checkins.map(j=>j.checked_in_by),...r.eventCheckins.map(j=>j.checked_in_by)].filter(Boolean))];if(_.length){const[{data:j},{data:O}]=await Promise.all([h.from("teachers").select("profile_id, full_name").in("profile_id",_),h.from("students").select("profile_id, full_name").in("profile_id",_)]);r.staffNames={},(j||[]).forEach(D=>{r.staffNames[D.profile_id]=D.full_name}),(O||[]).forEach(D=>{r.staffNames[D.profile_id]||(r.staffNames[D.profile_id]=D.full_name)})}else r.staffNames={};const[{data:T,error:E},{data:M,error:v}]=await Promise.all([h.from("azfutsal_payments").select("*").order("created_at",{ascending:!1}),h.from("azfutsal_refunds").select("id, team_id, receipt_no, deposit_amount, operation_fee, yellow_count, yellow_rate, yellow_deduction, red_count, red_rate, red_deduction, refund_amount, deduction_snapshot, logo_url, recipient_signature_url, payment_method, proof_url, confirmed_at, created_at").order("confirmed_at",{ascending:!1})]);E&&g("โหลดข้อมูลชำระเงินไม่สำเร็จ: "+E.message),v&&g("โหลดข้อมูลคืนเงินไม่สำเร็จ: "+v.message),r.payments=T||[],r.refunds=M||[],r.loading=!1}function U(e){var t;return((t=r.teams.find(n=>n.id===e))==null?void 0:t.name)||""}function ee(e,t){return r.matches[e].find(n=>n.match_code===t)}function G(e,t,n=new Set){const i=ee(e,t);if(!i)return{teamA:"",teamB:"",teamAId:null,teamBId:null,winnerId:null,loserId:null};if(n.has(t))return{teamA:"",teamB:"",teamAId:null,teamBId:null,winnerId:null,loserId:null};n.add(t);const o=F[e].find(f=>f.code===t)||{};let a=i.team_a_id,d=i.team_b_id;const s=y(`PAIRING_HIDDEN_${e}_${t}`,"0")==="1";!s&&!a&&o.refA&&(a=Vt(e,o.refA,n)),!s&&!d&&o.refB&&(d=Vt(e,o.refB,n));let c=i.winner_team_id,l=i.loser_team_id;return!c&&a&&d&&(mn(i)&&i.penalty_score_a!==i.penalty_score_b?(c=i.penalty_score_a>i.penalty_score_b?a:d,l=i.penalty_score_a>i.penalty_score_b?d:a):i.score_a!==null&&i.score_b!==null&&i.score_a!==i.score_b&&(c=i.score_a>i.score_b?a:d,l=i.score_a>i.score_b?d:a)),{teamA:U(a),teamB:U(d),teamAId:a,teamBId:d,winnerId:c,loserId:l,match:i}}function Vt(e,t,n){return t?t.startsWith("W_M")?G(e,t.slice(2),n).winnerId:t.startsWith("L_M")?G(e,t.slice(2),n).loserId:t==="FIRST_ROUND_BYE"&&y(`FIRST_ROUND_BYE_${e}`,"")||null:null}function Re(e,t){return t.map(n=>G(e,n).winnerId).filter(Boolean)}function Le(e,t){return t.map(n=>G(e,n).loserId).filter(Boolean)}function $t(e){return[...new Set([...Re(e,Ae),...Le(e,Ae)])]}function _i(e){return Qe(e)&&Ae.every(t=>G(e,t).winnerId&&G(e,t).loserId)}function nt(e){return _i(e)&&["M22","M23"].every(t=>{const n=ee(e,t);return n&&n.clock_status==="not_started"&&n.score_a===null&&n.score_b===null&&!n.winner_team_id&&!n.loser_team_id&&!r.matchEvents.some(i=>i.level===e&&i.match_code===t)&&!r.checkins.some(i=>i.level===e&&i.match_code===t)})}function mt(e,t){return["M22","M23"].includes(t)&&y(`PAIRING_HIDDEN_${e}_${t}`,"0")==="1"}function Wt(e,t,n){const i=[];for(const o of["M22","M23"]){const a=ee(e,o);a&&(a.team_a_id&&!(o===t&&n==="a")&&i.push(a.team_a_id),a.team_b_id&&!(o===t&&n==="b")&&i.push(a.team_b_id))}return i}function Gt(e,t,n,i){const o=[];return F[e].filter(a=>a.pool===t).forEach(a=>{const d=ee(e,a.code);d&&(d.team_a_id&&!(a.code===n&&i==="a")&&o.push(d.team_a_id),d.team_b_id&&!(a.code===n&&i==="b")&&o.push(d.team_b_id))}),o}function Ke(e,t,n){const i=r.matchEvents.filter(o=>o.level===e&&o.match_code===t&&o.team_id===n);return{goal:i.filter(o=>o.event_type==="goal").length,yellow:i.filter(o=>o.event_type==="yellow").length,red:i.filter(o=>o.event_type==="red").length}}function mn(e){return!!(e!=null&&e.is_penalty_shootout)&&e.penalty_score_a!==null&&e.penalty_score_a!==void 0&&e.penalty_score_b!==null&&e.penalty_score_b!==void 0}function zt(e,t,n){if(!e)return{aWins:!1,bWins:!1};if(e.winner_team_id)return{aWins:!!t&&String(e.winner_team_id)===String(t),bWins:!!n&&String(e.winner_team_id)===String(n)};const i=e.score_a!==null&&e.score_a!==void 0&&e.score_b!==null&&e.score_b!==void 0;return{aWins:i&&Number(e.score_a)>Number(e.score_b),bWins:i&&Number(e.score_b)>Number(e.score_a)}}function kt(e){return mn(e)?`<div style="margin-top:3px;font-size:9.5px;font-weight:800;color:#7c3aed;white-space:nowrap">จุดโทษ ${p(e.penalty_score_a)}-${p(e.penalty_score_b)}</div>`:""}function bt(e){if(!e||!e.clock_status||e.clock_status==="not_started")return null;let t=e.clock_elapsed_before||0;return e.clock_status==="running"&&e.clock_started_at&&(t+=Math.max(0,Math.floor((Date.now()-new Date(e.clock_started_at).getTime())/1e3))),t}function $i(e){const t=bt(e);return t===null?null:Math.floor(t/60)+1}function zi(e,t){const n=e>=t,i=n?e-t:e,o=String(Math.floor(i/60)).padStart(2,"0"),a=String(i%60).padStart(2,"0");return`${n?"+":""}${o}:${a}`}function St(e,t={}){const n=(e==null?void 0:e.clock_status)||"not_started";if(n==="not_started")return"";const i=Number(y("HALF_DURATION_MINUTES",7)),o=e.clock_half||1,a=n==="running",d=!!t.onDark,s=t.countdown?"countdown":"elapsed",c=o===2?"ครึ่งหลัง":"ครึ่งแรก",l=n==="paused"?`หยุดเวลา · ${c}`:n==="half_break"?"พักครึ่ง":n==="ended"?"หมดเวลา":`กำลังแข่ง · ${c}`,f=t.compact?d?"26px":"13px":"clamp(44px,12vw,64px)";return`<span style="display:inline-flex;align-items:center;justify-content:center;gap:${t.compact?"6px":"2px"};${t.compact?"":"width:100%;box-sizing:border-box;flex-direction:column;padding:10px 14px;background:#111827;border-radius:14px;"}">
  ...
  </span>`}function bn(){document.querySelectorAll(".az-clock-live").forEach(e=>{const t=e.dataset.clockStatus,n=e.dataset.clockStartedAt,i=Number(e.dataset.clockElapsedBefore||0),o=Number(e.dataset.clockHalfStartedElapsed||0),a=Number(e.dataset.clockHalfMinutes||7),d=Number(e.dataset.clockHalf||1),s=e.dataset.clockMode||"elapsed";let c=i;t==="running"&&n&&(c+=Math.max(0,Math.floor((Date.now()-new Date(n).getTime())/1e3)));const l=a*60,f=Math.max(0,c-o);if(s==="countdown"){const m=Math.max(0,l-f),w=String(Math.floor(m/60)).padStart(2,"0"),_=String(m%60).padStart(2,"0");e.textContent=`${w}:${_}`;return}const x=(d===2?l:0)+f,b=d===2?l*2:l;e.textContent=zi(x,b)})}if(typeof window<"u"&&!window._azClockTickerStarted){window._azClockTickerStarted=!0,setInterval(bn,1e3);const e=document.createElement("style");e.textContent="@keyframes azLivePulse{0%,100%{opacity:1}50%{opacity:.25}}",document.head.appendChild(e)}function ki(e,t,n){const i=(n==null?void 0:n.clock_status)||"not_started",o=(n==null?void 0:n.clock_half)||1,a="width:100%;padding:14px;border:none;border-radius:11px;color:#fff;font-weight:900;font-size:15px;cursor:pointer;box-shadow:0 4px 12px rgba(0,0,0,.18)",d="width:100%;padding:8px;border:1px solid #64748b;border-radius:9px;background:transparent;color:#cbd5e1;font-weight:700;font-size:11.5px;cursor:pointer";return i==="not_started"?`<button data-act="startMatchClock" data-level="${e}" data-code="${t}" style="${a};background:#16a34a">▶️ เริ่มการแข่งขัน</button>`:i==="running"||i==="paused"?`<div style="width:100%;display:flex;flex-direction:column;gap:7px"><button data-act="${i==="running"?"pauseMatchClock":"resumeMatchClock"}" data-level="${e}" data-code="${t}" style="${a};background:${i==="running"?"#f59e0b":"#16a34a"}">${i==="running"?"⏸ หยุดเวลา":"▶️ เล่นต่อ"}</button><button data-act="${o===1?"endHalfClock":"endMatchClock"}" data-level="${e}" data-code="${t}" style="${d}">⏹ ${o===1?"จบครึ่งแรก":"จบการแข่งขัน"}</button></div>`:i==="half_break"?`<button data-act="startSecondHalfClock" data-level="${e}" data-code="${t}" style="${a};background:#16a34a">▶️ เริ่มครึ่งหลัง</button>`:'<div style="width:100%;text-align:center;font-size:12px;font-weight:700;color:#94a3b8;padding:9px">หมดเวลาการแข่งขันแล้ว</div>'}const yn="az_offline_queue";function xe(){try{return JSON.parse(localStorage.getItem(yn)||"[]")}catch{return[]}}function he(e){localStorage.setItem(yn,JSON.stringify(e))}function Ie(){return"local_"+Date.now()+"_"+Math.random().toString(36).slice(2,9)}function je(e,t,n){const i=ee(e,t);i&&Object.assign(i,n);const o={level:e,match_code:t,clock_status:(i==null?void 0:i.clock_status)||n.clock_status||"not_started",clock_half:(i==null?void 0:i.clock_half)??n.clock_half??null,clock_started_at:(i==null?void 0:i.clock_started_at)??n.clock_started_at??null,clock_elapsed_before:(i==null?void 0:i.clock_elapsed_before)??n.clock_elapsed_before??0,clock_half_started_elapsed:(i==null?void 0:i.clock_half_started_elapsed)??n.clock_half_started_elapsed??0};let a=xe().filter(d=>!(d.type==="clockUpdate"&&d.payload.level===e&&d.payload.match_code===t));a.push({localId:Ie(),type:"clockUpdate",payload:o}),he(a),ge()}async function Si(e){if(e.type==="insertEvent"){const{data:t,error:n}=await h.from("azfutsal_match_events").insert(e.payload).select().single();if(n)throw n;const i=r.matchEvents.findIndex(o=>o.id===e.localEventId);i!==-1&&(r.matchEvents[i]=t)}else if(e.type==="deleteEvent"){const{error:t}=await h.from("azfutsal_match_events").delete().eq("id",e.payload.id);if(t)throw t}else if(e.type==="togglePenalty"){const{error:t}=await h.from("azfutsal_match_events").update({is_penalty:e.payload.is_penalty}).eq("id",e.payload.id);if(t)throw t}else if(e.type==="saveMatch"||e.type==="clockUpdate"){const{error:t}=await h.from("azfutsal_matches").upsert(e.payload,{onConflict:"level,match_code"});if(t)throw t}}async function ge(){if(r._azSyncing)return;let e=xe();if(!e.length)return;r._azSyncing=!0,$();let t=0;for(const n of e)try{await Si(n),t++}catch{break}if(r._azSyncing=!1,t>0&&(e=e.slice(t),he(e),e.length===0)){g("✅ ซิงก์ข้อมูลออฟไลน์ครบแล้ว"),await L();return}$()}typeof window<"u"&&!window._azSyncStarted&&(window._azSyncStarted=!0,setInterval(ge,6e3),window.addEventListener("online",ge));function Yt(){const e=xe().length;return r._azSyncing?'<span style="display:inline-flex;align-items:center;gap:5px;font-size:10px;font-weight:700;color:#d97706">🔄 กำลังซิงก์...</span>':e>0?`<span style="display:inline-flex;align-items:center;gap:5px;font-size:10px;font-weight:700;color:#d97706">📡 ค้างซิงก์ ${e} รายการ (ออฟไลน์)</span>`:""}function Ue(e){const t=new Map,n=i=>{i&&(t.has(i)||t.set(i,{id:i,team:U(i),gp:0,w:0,d:0,l:0,gf:0,ga:0,y:0,r:0}))};return r.matches[e].forEach(i=>{const o=G(e,i.match_code);if(!o.teamAId||!o.teamBId||i.score_a===null||i.score_b===null)return;n(o.teamAId),n(o.teamBId);const a=t.get(o.teamAId),d=t.get(o.teamBId);a.gp++,d.gp++,a.gf+=i.score_a,a.ga+=i.score_b,d.gf+=i.score_b,d.ga+=i.score_a,i.score_a>i.score_b?(a.w++,d.l++):i.score_a<i.score_b?(d.w++,a.l++):(a.d++,d.d++)}),r.matchEvents.filter(i=>i.level===e&&i.event_type!=="goal").forEach(i=>{const o=t.get(i.team_id);o&&(i.event_type==="yellow"?o.y++:i.event_type==="red"&&o.r++)}),Array.from(t.values()).map(i=>({...i,gd:i.gf-i.ga})).sort((i,o)=>o.w-i.w||o.gd-i.gd||o.gf-i.gf||i.r-o.r||i.y-o.y||i.team.localeCompare(o.team,"th"))}function Ei(e){return r.matchEvents.filter(t=>t.event_type==="goal"&&t.player_id===e).length}function Et(e,t=20){const n=new Map;r.matchEvents.filter(o=>o.event_type==="goal"&&o.level===e).forEach(o=>{n.set(o.player_id,(n.get(o.player_id)||0)+1)});const i=Array.from(n.entries()).map(([o,a])=>{var s;const d=r.players.find(c=>c.id===o);return d?{name:((s=d.students)==null?void 0:s.full_name)||"",team:U(d.team_id),goals:a,studentId:d.student_id,photoUrl:Z(d)}:null}).filter(Boolean).sort((o,a)=>a.goals-o.goals||o.name.localeCompare(a.name,"th"));return Number.isFinite(t)?i.slice(0,t):i}function Mi(e){const t=new Map;return r.matchEvents.filter(n=>(n.event_type==="yellow"||n.event_type==="red")&&n.level===e).forEach(n=>{t.has(n.player_id)||t.set(n.player_id,{yellow:0,red:0}),t.get(n.player_id)[n.event_type]++}),Array.from(t.entries()).map(([n,i])=>{var a;const o=r.players.find(d=>d.id===n);return o?{name:((a=o.students)==null?void 0:a.full_name)||"",team:U(o.team_id),yellow:i.yellow,red:i.red,photoUrl:Z(o)}:null}).filter(Boolean).sort((n,i)=>i.red-n.red||i.yellow-n.yellow||n.name.localeCompare(i.name,"th")).slice(0,20)}function Qt(e,t){const n=new Map;return r.matchEvents.filter(i=>i.event_type===t&&i.level===e).forEach(i=>{n.set(i.player_id,(n.get(i.player_id)||0)+1)}),Array.from(n.entries()).map(([i,o])=>{var d;const a=r.players.find(s=>s.id===i);return a?{name:((d=a.students)==null?void 0:d.full_name)||"",team:U(a.team_id),[t]:o,photoUrl:Z(a)}:null}).filter(Boolean).sort((i,o)=>o[t]-i[t]||i.name.localeCompare(o.name,"th"))}function Ti(e){return e==="MS"?oe():e==="HS"?y("JOINT_THIRD_HS","0")==="1":!1}function Ai(e){return e==="MS"&&oe()?["M18","M19"]:["M22","M23"]}function vn(e){const t=G(e,mi[e]),n=Ti(e),[i,o]=Ai(e),a=n?G(e,i):G(e,bi[e]),d=n?G(e,o):null,s=x=>{var w,_;const b=r.awards.find(T=>T.level===e&&T.award_type===x),m=b?r.players.find(T=>String(T.student_id)===String(b.student_id)):null;return{name:((w=b==null?void 0:b.students)==null?void 0:w.full_name)||((_=m==null?void 0:m.students)==null?void 0:_.full_name)||"",photoUrl:m?Z(m):"",team:m?U(m.team_id):""}},c=s("mvp"),l=s("top_scorer"),f=s("best_gk");return{champion:t.winnerId?U(t.winnerId):"",runnerUp:t.loserId?U(t.loserId):"",third:n?a.loserId?U(a.loserId):"":a.winnerId?U(a.winnerId):"",third2:d!=null&&d.loserId?U(d.loserId):"",thirdLabel:n?"อันดับ 3 ร่วม":"อันดับ 3",consolation:n?"":a.loserId?U(a.loserId):"",mvp:c.name,topScorer:l.name,bestGK:f.name,mvpAward:c,topScorerAward:l,bestGKAward:f}}function ft(e,t,n){if(!(t!=null&&t.name))return`<div style="display:flex;align-items:center;justify-content:space-between;padding:7px 0;font-size:12.5px"><span style="color:#6b7280">${p(e)}</span><span style="font-weight:700">-</span></div>`;const i=p(t.name.replace(/^(นาย|นางสาว|ด\.ช\.|ด\.ญ\.)\s*/,"").trim().charAt(0)||"?");return`<div style="display:flex;align-items:center;gap:10px;padding:8px;border-radius:11px;background:rgba(255,255,255,.72)">
  ...
  </div>`}function g(e){let t=document.getElementById("az-toast");t||(t=document.createElement("div"),t.id="az-toast",t.style.cssText="position:fixed;top:14px;left:50%;transform:translateX(-50%);z-index:9999;background:#111827;color:#fff;font-size:12.5px;padding:9px 16px;border-radius:10px;box-shadow:0 6px 18px rgba(0,0,0,.2);animation:azToastIn .15s ease",document.body.appendChild(t)),t.textContent=e,t.style.display="block",clearTimeout(t._t),t._t=setTimeout(()=>{t.style.display="none"},1800)}function Jt(e="student-login.html"){const t=new URL(`${e}?next=azfutsal.html`,window.location.href).href;try{if(window.self!==window.top){window.top.location.href=t;return}}catch{}window.location.href=t}function be(e){const t=S[e];return`<span style="font-size:10px;font-weight:700;padding:2px 8px;border-radius:999px;background:${t.base};color:#fff">${t.label}</span>`}function Fe(){return'<span style="font-size:10px;font-weight:700;padding:2px 8px;border-radius:999px;background:#fef3c7;color:#b45309">ทีมสำรอง</span>'}function qe(){return'<span style="font-size:10px;font-weight:700;padding:2px 8px;border-radius:999px;background:#e0e7ff;color:#4338ca">ทีมผู้จัด</span>'}function hn(){if(!ie)return;ie.dataset.theme=r.theme,document.documentElement.style.colorScheme=r.theme;const e=document.querySelector('meta[name="theme-color"]');e&&(e.content=r.theme==="dark"?"#0f172a":"#ec4899")}async function Ri(e,t){ie=e,h=t,ve=(await ii("azfutsal")).active,Ge==null||Ge.stop(),Ge=oi("azfutsal",{start:()=>{ve=!0},stop:li}),r.knownStudentCode=(typeof window<"u"?new URLSearchParams(window.location.search).get("studentCode"):null)||null,hn(),e.innerHTML='<div style="position:fixed;inset:0;background:#111827;display:flex;align-items:center;justify-content:center;color:#9ca3af;font-size:13px">กำลังโหลด...</div>',await gn(),$(),Ia()}async function L(){await gn(),$()}function $(){const e=r;hn(),cn(),ie.innerHTML=`
  <div class="az-futsal-stage" style="position:fixed;inset:0;background:#111827;display:flex;align-items:center;justify-content:center;overflow:hidden">
    <div class="az-futsal-app" style="width:100%;max-width:440px;height:100%;max-height:1000px;background:#fff;position:relative;box-shadow:0 24px 64px rgba(0,0,0,.5);border-radius:20px;overflow:hidden;display:flex;flex-direction:column;color:#111827">
      ...
      <main class="az-futsal-main" style="flex:1;min-height:0;overflow-y:auto;padding:16px 20px 24px;display:flex;flex-direction:column">
        ...
        ${e.tab==="summary"?Ao():""}
        ${e.tab==="myteam"?Co():""}
        ${e.tab==="admin"&&e.identity.isAdmin?Wo():""}
        ${e.tab==="staff"&&!e.identity.isAdmin&&(e.identity.scopes||[]).length?So():""}
      </main>
      ${Ii()}
      ${e.certModalOpen?Lo():""}
      ${e.editMatch?la():""}
      ${e.editMatch&&e.eventPicker?sa():""}
      ${e.adminLoginOpen?Fo():""}
      ${e.confirmRegOpen?qo():""}
      ${e.viewProofOpen?Uo():""}
      ${e.rejectPaymentId?Bo():""}
      ${e.liveDraw?Zo():""}
      ${e.manualPoolAssign?ca():""}
      ${e.pendingConfirm?Do():""}
      ${e.staffScopeEdit?Po():""}
      ${e.refundConfirmSign?Oo():""}
      ${e.refundConfirmDone?Ho():""}
      ${e.refundPayerSettingsOpen?Da():""}
    </div>
  </div>`,r.identity.isAdmin&&r.adminSection==="staff"&&_t(),r.refundConfirmSign&&fa(),r.refundPayerSettingsOpen&&pa()}function Li(){const e=r,t=y("EVENT_NAME","AZFUTSALCUP2025"),n=y("INFO_DATE","-"),i=y("INFO_VENUE","-");return`
  <header class="az-theme-header" style="flex-shrink:0;background:rgba(255,255,255,.94);backdrop-filter:blur(8px);border-bottom:1px solid #ececec;padding:16px 20px 14px">
  ...
  </header>`}function Ii(){const e=r,t=(n,i,o)=>`
    ...
    </button>`;if(e.tab==="admin"&&e.identity.isAdmin){const n=Un(e.adminSection).id;return`
  ...
  </nav>`}function it(e){return F[e.level].map(t=>{const n=G(e.level,t.code);return{level:e.level,code:t.code,round:t.round,teamA:n.teamA,teamB:n.teamB,teamAId:n.teamAId,teamBId:n.teamBId,m:n.match}}).filter(t=>t.teamAId===e.id||t.teamBId===e.id)}function le(e){return r.refunds.find(t=>t.team_id===e)||null}function Mt(){return y("REFUND_RECEIPT_LOGO_URL","")||new URL("./pp5-form-logo.png",window.location.href).href}function Oe(e){const t=Number(y("DEPOSIT_AMOUNT",500)),n=Number(y("OPERATION_FEE",100)),i=Number(y("RATE_YELLOW",30)),o=Number(y("RATE_RED",50)),a=new Map(it(e).map((b,m)=>[b.code,{...b,index:m}])),d=new Map;r.matchEvents.filter(b=>b.level===e.level&&b.team_id===e.id&&(b.event_type==="yellow"||b.event_type==="red")).forEach(b=>{d.has(b.match_code)||d.set(b.match_code,{yellow_count:0,red_count:0}),d.get(b.match_code)[b.event_type==="yellow"?"yellow_count":"red_count"]+=1});const s=Array.from(d.entries()).map(([b,m])=>{var E;const w=a.get(b),_=G(e.level,b),T=w?w.teamAId===e.id?w.teamB:w.teamA:_.teamAId===e.id?_.teamB:_.teamA;return{match_code:b,round:(w==null?void 0:w.round)||((E=F[e.level].find(M=>M.code===b))==null?void 0:E.round)||"",opponent:T||"ไม่พบข้อมูลคู่แข่งขัน",yellow_count:m.yellow_count,red_count:m.red_count,yellow_deduction:m.yellow_count*i,red_deduction:m.red_count*o,order:(w==null?void 0:w.index)??(Number(String(b).replace(/^M/,""))||999)}}).sort((b,m)=>b.order-m.order).map(({order:b,...m})=>m),c=s.reduce((b,m)=>b+m.yellow_count,0),l=s.reduce((b,m)=>b+m.red_count,0),f=c*i,x=l*o;return{deposit_amount:t,operation_fee:n,yellow_count:c,yellow_rate:i,yellow_deduction:f,red_count:l,red_rate:o,red_deduction:x,refund_amount:Math.max(t-n-f-x,0),deduction_snapshot:s,logo_url:Mt()}}function wn(e,t,n){var w,_;const i=Array.isArray(t.deduction_snapshot)?t.deduction_snapshot:[],o=i.length?i.map(T=>`
    <tr>
  ...
  <style>
    ...
    <header class="head"><img class="logo" src="${p(t.logo_url||Mt())}" alt="โลโก้โรงเรียน"><div><h1>${p(d)}</h1><div>${p(y("EVENT_NAME","AZFUTSALCUP"))}</div><div class="muted">${p(y("INFO_VENUE",""))}</div></div></header>
    <section class="meta">${a}<div><b>ทีม</b> ${p(e.name)}</div><div><b>ระดับ</b> ${p(((_=S[e.level])==null?void 0:_.label)||e.level)}</div>${m?`<div><b>วิธีคืนเงิน</b> ${p(m)}</div>`:""}</section>
  ...
  </main></body></html>`}function Xt(e){const t=r.teams.find(i=>i.id===e),n=le(e);if(!t||!n){g("ยังไม่มีใบเสร็จรับเงินคืนของทีมนี้");return}et(wn(t,n,!1))}function Ci(e){const t=r.teams.find(i=>i.id===e);if(!t)return;const n=Oe(t);et(wn(t,n,!0))}function Ni(e){const t=new Map,n=new Map;r.matchEvents.filter(d=>d.level===e.level&&d.team_id===e.id).forEach(d=>{d.event_type==="goal"?t.set(d.player_id,(t.get(d.player_id)||0)+1):(d.event_type==="yellow"||d.event_type==="red")&&(n.has(d.player_id)||n.set(d.player_id,{yellow:[],red:[]}),n.get(d.player_id)[d.event_type].push(d.match_code))});const i=d=>{var s,c;return((c=(s=r.players.find(l=>l.id===d))==null?void 0:s.students)==null?void 0:c.full_name)||""},o=Array.from(t.entries()).map(([d,s])=>({name:i(d),goals:s})).sort((d,s)=>s.goals-d.goals||d.name.localeCompare(s.name,"th")),a=Array.from(n.entries()).map(([d,s])=>({name:i(d),yellow:s.yellow,red:s.red})).sort((d,s)=>s.yellow.length+s.red.length-(d.yellow.length+d.red.length)||d.name.localeCompare(s.name,"th"));return{goalList:o,cardList:a}}function ji(e){const t=it(e),n=new Map(t.map((o,a)=>[o.code,{...o,order:a}])),i=new Map;return r.matchEvents.filter(o=>o.level===e.level&&o.team_id===e.id).forEach(o=>{i.has(o.player_id)||i.set(o.player_id,{goals:0,yellow:0,red:0,events:[]});const a=i.get(o.player_id);o.event_type==="goal"?a.goals++:o.event_type==="yellow"?a.yellow++:o.event_type==="red"&&a.red++;const d=n.get(o.match_code),s=d?d.teamAId===e.id?d.teamB:d.teamA:"";a.events.push({type:o.event_type,round:(d==null?void 0:d.round)||"",opponent:s,code:o.match_code,order:(d==null?void 0:d.order)??999,minute:o.minute,isPenalty:!!o.is_penalty})}),i.forEach(o=>o.events.sort((a,d)=>a.order-d.order||(a.minute??0)-(d.minute??0))),i}function Bi(e){const t=e.checked_in_by?r.staffNames[e.checked_in_by]||"เจ้าหน้าที่":"",n=e.checked_in_at?new Date(e.checked_in_at).toLocaleTimeString("th-TH",{hour:"2-digit",minute:"2-digit"}):"";return`<span style="display:inline-flex;align-items:center;gap:4px;font-size:10px;font-weight:800;color:#16a34a;border:1.5px dashed #16a34a;border-radius:6px;padding:2px 7px;transform:rotate(-2deg);white-space:nowrap">✅ รายงานตัวแล้ว${t?` · รับโดย ${p(t)}`:""}${n?` · ${n}`:""}</span>`}function Pi(e,t,n){const i=r.players.filter(c=>c.team_id===e.id);if(!i.length)return"";const o=r.checkins.filter(c=>c.level===t&&c.match_code===n&&c.team_id===e.id);if(!o.length)return'<div style="margin-top:6px;font-size:11px;color:#9ca3af">ยังไม่มีใครในทีมรายงานตัวสำหรับนัดนี้</div>';const a=new Set(o.map(c=>c.player_id)),d=i.filter(c=>a.has(c.id)).map(c=>{var l;return((l=c.students)==null?void 0:l.full_name)||""}).filter(Boolean),s=[...o].sort((c,l)=>new Date(l.checked_in_at)-new Date(c.checked_in_at))[0];return`<div style="margin-top:6px">${Bi(s)}<div style="margin-top:4px;font-size:11px;color:#6b7280">รายงานตัวแล้ว: ${p(d.join(", "))} (${d.length}/${i.length} คน)</div></div>`}function Di(e,t){const n=G(e,t),i=n.teamAId?r.teams.find(d=>d.id===n.teamAId):null,o=n.teamBId?r.teams.find(d=>d.id===n.teamBId):null,a=(d,s)=>{if(!d)return'<div style="flex:1;text-align:center;color:#9ca3af;padding:60px 0;font-size:15px">รอผลรอบก่อน</div>';const c=r.players.filter(x=>x.team_id===s),l=new Set(r.checkins.filter(x=>x.level===e&&x.match_code===t&&x.team_id===s).map(x=>x.player_id)),f=c.filter(x=>l.has(x.id)).length;return`
    <div style="flex:1;min-width:0">
  ...
  <div style="display:flex;gap:32px;max-width:1100px;margin:0 auto">
    ...
    ${a(o,n.teamBId)}
  </div>`}function Oi(e,t){var a;(a=document.getElementById("az-live-display-overlay"))==null||a.remove();const n=document.createElement("div");n.id="az-live-display-overlay",n.style.cssText="position:fixed;inset:0;z-index:9999;background:#fff;overflow-y:auto;padding:24px;font-family:Sarabun,Arial,sans-serif",n.innerHTML=`
    ...
    <div id="az-live-display-body" style="padding-top:8px"></div>`,document.body.appendChild(n);const i=()=>{const d=document.getElementById("az-live-display-body");d&&(d.innerHTML=Di(e,t))};i();const o=Ce(async()=>{await L(),i()},4e3,n);n.querySelector("#az-live-display-close").onclick=()=>{ue(o),n.remove()}}const Hi=`
...
`;function _n(e,t={}){var o;(o=document.getElementById("az-print-area"))==null||o.remove();const n=document.createElement("div");n.id="az-print-area";const i=t.landscape?"@media print{@page{size:A4 landscape}body{width:297mm}}":"";n.innerHTML=`<style>${Hi}${i}</style>
    <div class="print-actions"><button id="az-print-confirm">🖨️ สั่งพิมพ์ / บันทึก PDF</button><button id="az-print-close">ปิด</button></div>
    ${e}`,document.body.appendChild(n),n.querySelector("#az-print-confirm").onclick=()=>window.print(),n.querySelector("#az-print-close").onclick=()=>n.remove()}function Ui(e,t){const n=S[e],i=G(e,t),o=F[e].find(d=>d.code===t)||{},a=d=>{const s=r.players.filter(c=>c.team_id===d);return s.length?`<table class="print-table" style="table-layout:fixed">
    ...
    </tbody></table>`:'<div style="font-size:12px;color:#6b7280">ยังไม่มีรายชื่อนักกีฬา</div>'};_n(`
    ...
    <table class="print-table print-table-checkin" style="table-layout:fixed">
      ...
      <tbody>
        ${n.length?n.map((d,s)=>{var l;const c=Z(d);return`<tr>
            ...
            ${a.map(f=>{const x=f&&r.checkins.find(b=>b.level===e.level&&b.match_code===f.code&&b.player_id===d.id);return`<td class="print-stamp-cell">${x?qi(x):"&nbsp;"}</td>`}).join("")}
            <td>&nbsp;</td>
  ...
  `,{landscape:!0})}async function Tt(){return window.Html5Qrcode?window.Html5Qrcode:new Promise((e,t)=>{const n=document.createElement("script");n.src="https://unpkg.com/html5-qrcode@2.3.8/html5-qrcode.min.js",n.onload=()=>e(window.Html5Qrcode),n.onerror=()=>t(new Error("โหลดตัวอ่าน QR Code ไม่สำเร็จ")),document.head.appendChild(n)})}async function Wi(){if(window.L)return window.L;if(!document.getElementById("az-leaflet-css")){const e=document.createElement("link");e.id="az-leaflet-css",e.rel="stylesheet",e.href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css",document.head.appendChild(e)}return new Promise((e,t)=>{const n=document.createElement("script");n.src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js",n.onload=()=>e(window.L),n.onerror=()=>t(new Error("โหลดแผนที่ไม่สำเร็จ")),document.head.appendChild(n)})}function K(e="success"){try{const t=new(window.AudioContext||window.webkitAudioContext),n=(i,o,a,d,s)=>{const c=t.createOscillator(),l=t.createGain();c.connect(l),l.connect(t.destination),c.type=a;const f=t.currentTime+d;c.frequency.setValueAtTime(i,f),l.gain.setValueAtTime(s,f),l.gain.exponentialRampToValueAtTime(.01,f+o),c.start(f),c.stop(f+o)};e==="success"?n(880,.12,"sine",0,.08):e==="duplicate"?(n(600,.09,"square",0,.09),n(600,.09,"square",.14,.09)):n(150,.3,"sawtooth",0,.12)}catch{}}function Gi(e,t){var T;(T=document.getElementById("az-checkin-overlay"))==null||T.remove();const n=G(e,t);if(!n.teamAId||!n.teamBId){g("ต้องระบุทีมทั้งสองฝั่งก่อนสแกนรายงานตัว");return}const i=r.players.filter(E=>E.team_id===n.teamAId).map(E=>({...E,teamId:n.teamAId})),o=r.players.filter(E=>E.team_id===n.teamBId).map(E=>({...E,teamId:n.teamBId})),a=[...i,...o],d=document.createElement("div");d.id="az-checkin-overlay",d.style.cssText="position:fixed;inset:0;z-index:9999;background:#0b0f1a;display:flex;flex-direction:column",d.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:16px;display:flex;flex-direction:column;gap:14px;max-width:420px;margin:0 auto;width:100%">
    ...
    </div>`,document.body.appendChild(d);const s=new Set(r.checkins.filter(E=>E.level===e&&E.match_code===t).map(E=>E.player_id));let c=null,l=null,f=0;const x=()=>{const E=d.querySelector("#az-ci-list");d.querySelector("#az-ci-count").textContent=`${s.size} / ${a.length} คน`;const M=a.filter(v=>s.has(v.id));E.innerHTML=M.length?M.map(v=>{var z;return`<div style="display:flex;align-items:center;justify-content:space-between;gap:8px;font-size:12px;padding:5px 0;border-bottom:1px solid rgba(255,255,255,.06)"><span style="color:#e2e8f0;flex:1;min-width:0;overflow-wrap:break-word">${p(((z=v.students)==null?void 0:z.full_name)||"")}</span><span style="color:#38bdf8;font-weight:700;flex-shrink:0">${p(v.teamId===n.teamAId?n.teamA:n.teamB)}</span><button data-ci-undo="${p(v.id)}" style="flex-shrink:0;padding:2px 7px;border-radius:7px;border:1px solid rgba(239,68,68,.35);background:rgba(239,68,68,.1);color:#f87171;font-size:10px;font-weight:700;cursor:pointer">✕</button></div>`}).join(""):'<div style="color:#64748b;text-align:center;font-size:12px;padding:6px 0">ยังไม่มีใครรายงานตัว</div>'};x();async function b(E){var N;const M=a.find(I=>String(I.id)===String(E));if(!M)return;const v=d.querySelector("#az-ci-feedback"),{error:z}=await h.from("azfutsal_checkins").delete().match({level:e,match_code:t,player_id:M.id});if(z){g("ยกเลิกไม่สำเร็จ: "+z.message);return}s.delete(M.id),x(),v.innerHTML=`<span style="color:#94a3b8">ยกเลิกรายงานตัวของ ${p(((N=M.students)==null?void 0:N.full_name)||"")} แล้ว</span>`}d.addEventListener("click",E=>{const M=E.target.closest("[data-ci-undo]");M&&b(M.dataset.ciUndo)});async function m(E){var q,J,u,k;const M=d.querySelector("#az-ci-camwrap"),v=d.querySelector("#az-ci-feedback"),z=A=>{M.classList.add(A?"az-ci-flash-ok":"az-ci-flash-err"),setTimeout(()=>M.classList.remove(A?"az-ci-flash-ok":"az-ci-flash-err"),500)};let N=E;if(E.startsWith("SQ:")){const[,A,C]=E.split(":"),B=Math.floor(Date.now()/1e3)-parseInt(C,10);if(B>60||B<-60){K("error"),z(!1),v.innerHTML='<span style="color:#f87171">QR Code หมดอายุแล้ว ให้นักกีฬาเปิดหน้าใหม่</span>';return}N=A}const I=a.find(A=>{var C;return((C=A.students)==null?void 0:C.student_code)===N});if(!I){K("error"),z(!1),v.innerHTML='<span style="color:#f87171">ไม่พบนักกีฬาคนนี้ในสองทีมที่แข่งนัดนี้</span>';return}if(s.has(I.id)){K("duplicate"),z(!1),v.innerHTML=`<span style="color:#fbbf24">${p(((q=I.students)==null?void 0:q.full_name)||"")} รายงานตัวไปแล้ว</span>`;return}const{error:j}=await h.from("azfutsal_checkins").upsert({level:e,match_code:t,team_id:I.teamId,player_id:I.id,checked_in_by:((J=r.identity.profile)==null?void 0:J.id)||null,checked_in_at:new Date().toISOString()},{onConflict:"level,match_code,player_id"});if(j){K("error"),z(!1),v.innerHTML=`<span style="color:#f87171">บันทึกไม่สำเร็จ: ${p(j.message)}</span>`;return}K("success"),z(!0);const O=I.teamId===n.teamAId?n.teamA:n.teamB,D=Z(I),Q=D?`<img src="${p(D)}" style="width:40px;height:52px;object-fit:cover;border-radius:8px;border:1px solid rgba(255,255,255,.15);flex-shrink:0"/>`:`<div style="width:40px;height:52px;border-radius:8px;background:#1e293b;display:flex;align-items:center;justify-content:center;font-weight:800;color:#64748b;flex-shrink:0">${p((((u=I.students)==null?void 0:u.full_name)||"?").charAt(0))}</div>`;v.innerHTML=`
      <div style="display:flex;align-items:center;gap:10px;text-align:left">
        ...
        <div style="flex:1;min-width:0">
          ...
          <div style="color:#94a3b8;font-size:11px">${p(O)}</div>
        </div>
      ...
      </div>`,s.add(I.id),x()}const w=d.querySelector("#az-ci-manual-code"),_=()=>{const E=w.value.trim();E&&(m(E),w.value="",w.focus())};d.querySelector("#az-ci-manual-submit").addEventListener("click",_),w.addEventListener("keydown",E=>{E.key==="Enter"&&_()}),(async()=>{const E=d.querySelector("#az-ci-feedback");try{const M=r.teams.find(C=>C.id===n.teamAId),v=r.teams.find(C=>C.id===n.teamBId),z=[M==null?void 0:M.id,v==null?void 0:v.id].filter(Boolean),N=we(e,t),[{data:I,error:j},{data:O,error:D}]=await Promise.all([h.from("azfutsal_checkins").select("match_code, team_id, player_id").eq("level",e).in("team_id",z),h.from("azfutsal_event_checkins").select("team_id, player_id, confirmed").eq("day",N).in("team_id",z)]);if(j)throw j;if(D)throw D;const Q=C=>{const B=Number(String(t).replace(/^M/,"")),H=[...new Set((I||[]).filter(P=>P.team_id===C&&P.match_code!==t&&we(e,P.match_code)===N&&Number(String(P.match_code).replace(/^M/,""))<B).map(P=>P.match_code))];return H.length?(H.sort((P,V)=>Number(String(P).replace(/^M/,""))-Number(String(V).replace(/^M/,""))),H[0]):null},q=C=>{const B=new Set,H=Q(C);return H?(I||[]).filter(P=>P.match_code===H&&P.team_id===C).forEach(P=>B.add(P.player_id)):(O||[]).filter(P=>P.team_id===C&&P.confirmed).forEach(P=>B.add(P.player_id)),B};async function J(C,B){if(!C)return{copied:0};const H=q(C.id),P=B.filter(Y=>H.has(Y.id)&&!s.has(Y.id));if(!P.length)return{copied:0};const V=P.map(Y=>{var te;return{level:e,match_code:t,team_id:C.id,player_id:Y.id,checked_in_by:((te=r.identity.profile)==null?void 0:te.id)||null,checked_in_at:new Date().toISOString()}}),{error:X}=await h.from("azfutsal_checkins").upsert(V,{onConflict:"level,match_code,player_id"});if(X)throw X;return P.forEach(Y=>s.add(Y.id)),{copied:P.length}}const u=await J(M,i),k=await J(v,o);x();const A=[];u.copied&&A.push(`${p(n.teamA)} ${u.copied} คน`),k.copied&&A.push(`${p(n.teamB)} ${k.copied} คน`),A.length&&(E.innerHTML=`<span style="color:#4ade80">✓ นำรายชื่อที่เคยรายงานตัว/เช็คอินเข้างานตอนเช้ามาใช้แล้ว: ${A.join(" · ")} — ใครไม่มาจริงกด ✕ ในลิสต์ด้านล่างได้</span>`)}catch(M){E.innerHTML=`<span style="color:#f87171">นำรายชื่ออัตโนมัติไม่สำเร็จ: ${p(M.message)}</span>`}})(),d.querySelector("#az-ci-close").addEventListener("click",async()=>{if(c)try{await c.stop()}catch{}d.remove(),L()}),(async()=>{try{const E=await Tt();c=new E("az-ci-reader"),await c.start({facingMode:"environment"},{fps:25,aspectRatio:1},M=>{M===l&&Date.now()-f<2e3||(l=M,f=Date.now(),m(M))},()=>{})}catch(E){g("ไม่สามารถเปิดกล้องได้: "+Ze(E)),d.remove()}})()}function Yi(e){var v;(v=document.getElementById("az-evci-overlay"))==null||v.remove();const t=r.players,n=document.createElement("div");n.id="az-evci-overlay",n.style.cssText="position:fixed;inset:0;z-index:9999;background:#0b0f1a;display:flex;flex-direction:column",n.innerHTML=`
    <style>
    ...
    <div style="display:flex;align-items:center;gap:10px;padding:12px 16px;border-bottom:1px solid rgba(255,255,255,.08);flex-shrink:0">
      <div style="flex:1;min-width:0">
        ...
        <div style="color:#94a3b8;font-size:11.5px">วันที่ ${e} · ${p(Ve(e))}</div>
      </div>
    ...
    <div style="flex:1;overflow-y:auto;padding:16px;display:flex;flex-direction:column;gap:14px;max-width:420px;margin:0 auto;width:100%">
    ...
    </div>`,document.body.appendChild(n);const i=n.querySelector("#az-evci-feedback");no(i,z=>t.find(N=>String(N.id)===String(z))),oo(i);const o=new Set(r.eventCheckins.filter(z=>z.day===e).map(z=>z.player_id));let a=[],d=null,s=null,c=0,l=null,f=!1,x=!1;const b=()=>{const z=n.querySelector("#az-evci-list");n.querySelector("#az-evci-count").textContent=`${o.size} คน`;const N=a.map(I=>t.find(j=>j.id===I)).filter(Boolean);z.innerHTML=N.length?N.map(I=>{var j;return`<div style="display:flex;align-items:center;justify-content:space-between;gap:8px;font-size:12px;padding:5px 0;border-bottom:1px solid rgba(255,255,255,.06)"><span style="color:#e2e8f0;flex:1;min-width:0;overflow-wrap:break-word">${p(((j=I.students)==null?void 0:j.full_name)||"")}</span><span style="color:#38bdf8;font-weight:700;flex-shrink:0">${p(U(I.team_id))}</span></div>`}).join(""):'<div style="color:#64748b;text-align:center;font-size:12px;padding:6px 0">ยังไม่มีใครเช็คอิน</div>'};b();function m(z,N){var O,D;const I=Z(z),j=I?`<img src="${p(I)}" style="width:40px;height:52px;object-fit:cover;border-radius:8px;border:1px solid rgba(255,255,255,.15);flex-shrink:0"/>`:`<div style="width:40px;height:52px;border-radius:8px;background:#1e293b;display:flex;align-items:center;justify-content:center;font-weight:800;color:#64748b;flex-shrink:0">${p((((O=z.students)==null?void 0:O.full_name)||"?").charAt(0))}</div>`;i.innerHTML=`
      <div style="display:flex;align-items:center;gap:10px;text-align:left">
        ${j}
        <div style="flex:1;min-width:0">
          <div style="color:#4ade80;font-weight:800;font-size:12.5px">✓ เช็คอินเข้างานแล้ว</div>
          <div style="color:#e2e8f0;font-size:12.5px;font-weight:700;margin-top:1px;overflow-wrap:break-word">${p(((D=z.students)==null?void 0:D.full_name)||"")}</div>
          <div style="color:#94a3b8;font-size:11px">${p(U(z.team_id))}</div>
        </div>
      </div>
      ${zn(z)}
      ${En(e,z.id,N)}`}async function w(z,N,I){var D,Q;const{error:j}=await h.from("azfutsal_event_checkins").insert({day:e,team_id:z.team_id,player_id:z.id,checked_in_by:((D=r.identity.profile)==null?void 0:D.id)||null,method:"staff",checked_in_at:new Date().toISOString(),confirmed:!0,parent_permission_confirmed:N,attire_confirmed:I});if(j){K("error"),i.innerHTML=`<span style="color:#f87171">บันทึกไม่สำเร็จ: ${p(j.message)}</span>`;return}const O={id:null,day:e,team_id:z.team_id,player_id:z.id,checked_in_by:((Q=r.identity.profile)==null?void 0:Q.id)||null,method:"staff",checked_in_at:new Date().toISOString(),parent_permission_confirmed:N,attire_confirmed:I,confirmed:!0};r.eventCheckins.push(O),K("success"),m(z,O),o.add(z.id),a.unshift(z.id),a=a.slice(0,30),b()}function _(){var q,J;const z=l;if(!z)return;const N=Z(z),I=N?`<img src="${p(N)}" style="width:40px;height:52px;object-fit:cover;border-radius:8px;border:1px solid rgba(255,255,255,.15);flex-shrink:0"/>`:`<div style="width:40px;height:52px;border-radius:8px;background:#1e293b;display:flex;align-items:center;justify-content:center;font-weight:800;color:#64748b;flex-shrink:0">${p((((q=z.students)==null?void 0:q.full_name)||"?").charAt(0))}</div>`,j=pe(),O=fe(),D=(!j||f)&&(!O||x),Q=u=>`flex:1;min-width:130px;padding:8px;border-radius:9px;border:1px solid ${u?"#16a34a":"#334155"};background:${u?"rgba(22,163,74,.18)":"transparent"};color:${u?"#4ade80":"#94a3b8"};font-size:11px;font-weight:700;cursor:pointer`;i.innerHTML=`
      <div style="display:flex;align-items:center;gap:10px;text-align:left">
        ${I}
        <div style="flex:1;min-width:0">
          <div style="color:#38bdf8;font-weight:800;font-size:12.5px">ตรวจสอบก่อนบันทึกเช็คอิน</div>
          <div style="color:#e2e8f0;font-size:12.5px;font-weight:700;margin-top:1px;overflow-wrap:break-word">${p(((J=z.students)==null?void 0:J.full_name)||"")}</div>
          <div style="color:#94a3b8;font-size:11px">${p(U(z.team_id))}${z.jersey_number!=null?` · เบอร์ ${p(String(z.jersey_number))}`:""}</div>
        </div>
      </div>
      <div style="margin-top:8px;padding-top:8px;border-top:1px solid rgba(255,255,255,.08);display:flex;gap:6px;flex-wrap:wrap">
        ...
        ${O?`<button class="az-staging-toggle" data-field="attire" style="${Q(x)}">${x?"✅":"⬜"} แต่งกายเรียบร้อย</button>`:""}
      </div>
      <button id="az-evci-staging-confirm" ${D?"":"disabled"} style="width:100%;margin-top:8px;padding:10px;border-radius:10px;border:none;background:${D?"#16a34a":"#334155"};color:#fff;font-weight:800;font-size:12.5px;cursor:${D?"pointer":"not-allowed"}">${D?"✅ ยืนยันและบันทึกเช็คอิน":"ติ๊กให้ครบก่อนถึงจะบันทึกได้"}</button>`}i.addEventListener("click",async z=>{const N=z.target.closest(".az-staging-toggle");if(N){N.dataset.field==="permission"?f=!f:x=!x,_();return}const I=z.target.closest("#az-evci-staging-confirm");if(I&&!I.disabled){const j=l;l=null,await w(j,f,x)}});async function T(z){var Q;const N=n.querySelector("#az-evci-camwrap"),I=i,j=q=>{N.classList.add(q?"az-evci-flash-ok":"az-evci-flash-err"),setTimeout(()=>N.classList.remove(q?"az-evci-flash-ok":"az-evci-flash-err"),500)};let O=z;if(z.startsWith("SQ:")){const[,q,J]=z.split(":"),u=Math.floor(Date.now()/1e3)-parseInt(J,10);if(u>60||u<-60){K("error"),j(!1),I.innerHTML='<span style="color:#f87171">QR Code หมดอายุแล้ว ให้นักกีฬาเปิดหน้าใหม่</span>';return}O=q}const D=t.find(q=>{var J;return((J=q.students)==null?void 0:J.student_code)===O});if(!D){K("error"),j(!1),I.innerHTML='<span style="color:#f87171">ไม่พบนักกีฬาคนนี้ในระบบ</span>';return}if(o.has(D.id)){K("duplicate"),j(!1),I.innerHTML=`<span style="color:#fbbf24">${p(((Q=D.students)==null?void 0:Q.full_name)||"")} เช็คอินไปแล้ว</span>`;return}if(At()){l=D,f=!1,x=!1,K("success"),j(!0),_();return}await w(D,!1,!1)}const E=n.querySelector("#az-evci-manual-code"),M=()=>{const z=E.value.trim();z&&(T(z),E.value="",E.focus())};n.querySelector("#az-evci-manual-submit").addEventListener("click",M),E.addEventListener("keydown",z=>{z.key==="Enter"&&M()}),n.querySelector("#az-evci-close").addEventListener("click",async()=>{if(d)try{await d.stop()}catch{}n.remove(),L()}),(async()=>{try{const z=await Tt();d=new z("az-evci-reader"),await d.start({facingMode:"environment"},{fps:25,aspectRatio:1},N=>{N===s&&Date.now()-c<2e3||(s=N,c=Date.now(),T(N))},()=>{})}catch(z){g("ไม่สามารถเปิดกล้องได้: "+Ze(z)),n.remove()}})()}function Qi(){var c;const e=Mn();if(!e){g("ไม่พบข้อมูลนักกีฬาของคุณในระบบ");return}(c=document.getElementById("az-evsc-overlay"))==null||c.remove();const t=document.createElement("div");t.id="az-evsc-overlay",t.style.cssText="position:fixed;inset:0;z-index:9999;background:#0b0f1a;display:flex;flex-direction:column",t.innerHTML=`
    <style>
    ...
    <div id="az-evsc-success" style="display:none;flex:1;overflow-y:auto;padding:24px;flex-direction:column;align-items:center;justify-content:center;gap:16px;max-width:420px;margin:0 auto;width:100%;box-sizing:border-box;text-align:center"></div>`,document.body.appendChild(t);let n=null,i=null,o=0,a=!1;async function d(l){var M,v;if(n)try{await n.stop()}catch{}t.querySelector("#az-evsc-scanwrap").style.display="none";const f=t.querySelector("#az-evsc-success");f.style.display="flex";const x=Z(e),b=x?`<img src="${p(x)}" style="width:104px;height:132px;object-fit:cover;border-radius:14px;border:1px solid rgba(255,255,255,.15)"/>`:`<div style="width:104px;height:132px;border-radius:14px;background:#1e293b;display:flex;align-items:center;justify-content:center;font-weight:800;color:#64748b;font-size:34px">${p((((M=e.students)==null?void 0:M.full_name)||"?").charAt(0))}</div>`,m=_e(e.id,l),w=!!m&&!m.confirmed;f.innerHTML=`
      ...
      <div>
        ...
        <div style="color:#94a3b8;font-size:13px;margin-top:2px">${p(U(e.team_id))} · วันที่ ${l}</div>
      ...
      <button id="az-evsc-done" style="width:100%;padding:14px;border-radius:12px;border:none;background:#16a34a;color:#fff;font-weight:800;font-size:15px;cursor:pointer">✓ เสร็จสิ้น</button>`;const _=f.querySelector("#az-evsc-jersey-wrap"),T=f.querySelector("#az-evsc-done"),E=e.jersey_number!==null&&e.jersey_number!==void 0;_.innerHTML=E?kn(e):Sn(e),io(_,e,T),T.addEventListener("click",()=>{T.disabled||(t.remove(),$())}),await L()}async function s(l){var E,M;if(a)return;const f=t.querySelector("#az-evsc-camwrap"),x=t.querySelector("#az-evsc-feedback"),b=v=>{f.classList.add(v?"az-evsc-flash-ok":"az-evsc-flash-err"),setTimeout(()=>f.classList.remove(v?"az-evsc-flash-ok":"az-evsc-flash-err"),500)};if(!l.startsWith(yt)){K("error"),b(!1),x.innerHTML='<span style="color:#f87171">ไม่ใช่ QR จุดลงทะเบียนเข้างาน</span>';return}const m=Number(l.slice(yt.length));if(m!==1&&m!==2){K("error"),b(!1),x.innerHTML='<span style="color:#f87171">QR ไม่ถูกต้อง</span>';return}if(_e(e.id,m)){K("duplicate"),b(!1),a=!0,await d(m);return}const w=po();if(w){x.innerHTML='<span style="color:#94a3b8">📍 กำลังตรวจสอบพิกัด...</span>';const v=await Ln();if(v.error){K("error"),b(!1),x.innerHTML=`<span style="color:#f87171">${p(v.error)}</span>`;return}const z=co(v.lat,v.lng,w.lat,w.lng);if(z>w.radius){K("error"),b(!1),x.innerHTML=`<span style="color:#f87171">คุณอยู่นอกระยะจุดลงทะเบียน (ห่างประมาณ ${Math.round(z)} เมตร) กรุณาเข้าใกล้จุดลงทะเบียนแล้วลองสแกนใหม่</span>`;return}}const _=At(),{error:T}=await h.from("azfutsal_event_checkins").insert({day:m,team_id:e.team_id,player_id:e.id,checked_in_by:((E=r.identity.profile)==null?void 0:E.id)||null,method:"self",checked_in_at:new Date().toISOString(),confirmed:!_});if(T){if(T.code==="23505"){K("duplicate"),b(!1),a=!0,await d(m);return}K("error"),b(!1),x.innerHTML=`<span style="color:#f87171">บันทึกไม่สำเร็จ: ${p(T.message)}</span>`;return}a=!0,r.eventCheckins.push({id:null,day:m,team_id:e.team_id,player_id:e.id,checked_in_by:((M=r.identity.profile)==null?void 0:M.id)||null,method:"self",checked_in_at:new Date().toISOString(),parent_permission_confirmed:!1,attire_confirmed:!1,confirmed:!_}),K("success"),b(!0),await d(m)}t.querySelector("#az-evsc-close").addEventListener("click",async()=>{if(n)try{await n.stop()}catch{}t.remove(),a&&$()}),(async()=>{try{const l=await Tt();n=new l("az-evsc-reader"),await n.start({facingMode:"environment"},{fps:25,aspectRatio:1},f=>{f===i&&Date.now()-o<2e3||(i=f,o=Date.now(),s(f))},()=>{})}catch(l){g("ไม่สามารถเปิดกล้องได้: "+Ze(l)),t.remove()}})()}async function Ji(e){var s;(s=document.getElementById("az-evbig-overlay"))==null||s.remove();const t=await ln.toDataURL(eo(e),{width:320,margin:2,color:{dark:"#111827",light:"#ffffff"}}),n=Rn(e),i=document.createElement("div");i.id="az-evbig-overlay",i.style.cssText="position:fixed;inset:0;z-index:9999;background:linear-gradient(160deg,#fdf2f8 0%,#eff6ff 100%);overflow:hidden;font-family:Sarabun,Arial,sans-serif;display:flex;flex-direction:column",i.innerHTML=`
    <style>
    ...
    <div style="flex-shrink:0;padding:18px 28px;background:linear-gradient(120deg,#db2777,#6366f1 65%,#0ea5e9);color:#fff;display:flex;align-items:center;justify-content:space-between;gap:12px;box-shadow:0 6px 18px rgba(0,0,0,.15)">
      <div style="min-width:0">
        ...
        <div style="font-size:13px;opacity:.92;font-weight:700;margin-top:2px">จุดลงทะเบียนเข้างาน · วันที่ ${e} · ${p(Ve(e))}</div>
      </div>
      <div style="display:flex;align-items:center;gap:14px;flex-shrink:0">
        ${!n&&ht()?`<div style="font-size:12.5px;font-weight:800;background:rgba(255,255,255,.18);padding:6px 12px;border-radius:999px;white-space:nowrap">🕐 ${p(ht())}</div>`:""}
    ...
    <div style="flex:1;min-height:0;display:flex">
    ...
    </div>`,document.body.appendChild(i);const o=()=>{const c=r.eventCheckins.filter(b=>b.day===e).sort((b,m)=>new Date(m.checked_in_at)-new Date(b.checked_in_at)),l=document.getElementById("az-evbig-count");l&&(l.textContent=String(c.length));const f=document.getElementById("az-evbig-levelcounts");f&&(f.innerHTML=["MS","HS"].map(b=>{const m=vt(b,e);return`<div style="font-size:11px;font-weight:800;padding:4px 10px;border-radius:999px;background:${S[b].soft};color:${S[b].accent}">${S[b].label} ${m.done}/${m.total}</div>`}).join(""));const x=document.getElementById("az-evbig-feed");x&&(x.innerHTML=c.slice(0,40).map(b=>{var T;const m=r.players.find(E=>E.id===b.player_id),w=m?Z(m):null,_=new Date(b.checked_in_at).toLocaleTimeString("th-TH",{hour:"2-digit",minute:"2-digit"});return`
      <div style="display:flex;align-items:center;gap:14px;padding:10px 14px;border-radius:14px;background:#f0fdf4;border:2px solid #bbf7d0">
        ...
        <div style="flex:1;min-width:0">
          ...
          <div style="font-size:13.5px;font-weight:700;color:#16a34a;margin-top:1px">${p(m?U(m.team_id):"")}${(m==null?void 0:m.jersey_number)!=null?` · เบอร์ ${p(String(m.jersey_number))}`:""}</div>
        </div>
        <div style="flex-shrink:0;display:flex;flex-direction:column;align-items:flex-end;gap:5px">
          <div style="font-size:12px;color:#6b7280;font-weight:700">${_}</div>
      ...
      </div>`}).join("")||'<div style="text-align:center;padding:60px 0;color:#9ca3af"><div style="font-size:40px;margin-bottom:8px">🙋</div><div style="font-size:13px;font-weight:700">ยังไม่มีใครเช็คอิน</div><div style="font-size:12px;margin-top:2px">รอนักกีฬาคนแรกมาสแกน QR</div></div>')};o();const a=Ce(async()=>{await L(),o()},4e3,i);let d=null;if(n){const c=()=>{const l=document.getElementById("az-evbig-countdown-box"),f=document.getElementById("az-evbig-countdown-label"),x=document.getElementById("az-evbig-countdown");if(!l||!f||!x)return;const b=n.getTime()-Date.now();x.textContent=lo(b),b<=0?(f.textContent="ปิดรับเช็คอินแล้ว",f.style.color="#fecaca",l.style.background="#dc2626",l.classList.add("az-evbig-urgent")):b<=6e4?(f.textContent="ปิดรับเช็คอินใน",f.style.color="#fecaca",l.style.background="#dc2626",l.classList.add("az-evbig-urgent")):b<=3e5?(f.textContent="ปิดรับเช็คอินใน",f.style.color="#78350f",l.style.background="#f59e0b",l.classList.remove("az-evbig-urgent")):(f.textContent="ปิดรับเช็คอินใน",f.style.color="#cbd5e1",l.style.background="#1e293b",l.classList.remove("az-evbig-urgent"))};c(),d=ve?si(setInterval(c,1e3)):null}i.querySelector("#az-evbig-close").addEventListener("click",()=>{ue(a),d&&ue(d),i.remove()}),i.querySelector("#az-evbig-feed").addEventListener("click",async c=>{const l=c.target.closest("[data-evbig-undo]");if(!l)return;const{error:f}=await h.from("azfutsal_event_checkins").delete().eq("id",l.dataset.evbigUndo);if(f){g("ยกเลิกไม่สำเร็จ: "+f.message);return}await L(),o()})}function Xi(e){var a;(a=document.getElementById("az-evpend-overlay"))==null||a.remove();const t=document.createElement("div");t.id="az-evpend-overlay",t.style.cssText="position:fixed;inset:0;z-index:9999;background:#0b0f1a;display:flex;flex-direction:column",t.innerHTML=`
    <div style="display:flex;align-items:center;gap:10px;padding:12px 16px;border-bottom:1px solid rgba(255,255,255,.08);flex-shrink:0">
      <div style="flex:1;min-width:0">
        <div style="color:#f1f5f9;font-weight:800;font-size:14px">🕐 รอสตาฟยืนยันการเช็คอิน</div>
        <div style="color:#94a3b8;font-size:11.5px">วันที่ ${e} · ${p(Ve(e))} · จากการสแกนเองของนักกีฬา</div>
      </div>
      ...
      <div class="az-pend-row" data-player-id="${p(b.id)}" style="border:1px solid #fde68a;background:#fffbeb;border-radius:14px;padding:12px">
        <div style="display:flex;align-items:center;gap:10px">
          ...
          <div style="flex:1;min-width:0">
            ...
            <div style="font-size:12px;color:#6b7280">${p(U(b.team_id))}${b.jersey_number!=null?` · เบอร์ ${p(String(b.jersey_number))}`:" · ยังไม่ระบุเบอร์เสื้อ"}</div>
          </div>
    ...
    <div style="background:#fff;border-radius:20px;padding:24px;max-width:320px;width:100%;text-align:center">
      ...
      <div style="font-size:12.5px;color:#6b7280;margin-top:2px">${p(U(e.team_id))}${e.jersey_number!=null?` · เบอร์ ${p(String(e.jersey_number))}`:""}</div>
    ...
    <div id="az-venuemap-canvas" style="flex:1;min-height:0"></div>`,document.body.appendChild(i),i.querySelector("#az-venuemap-close").addEventListener("click",()=>i.remove());try{const a=await Wi();if(!document.getElementById("az-venuemap-overlay"))return;const d=a.map("az-venuemap-canvas").setView([e,t],17);a.tileLayer("https://mt1.google.com/vt/lyrs=y&x={x}&y={y}&z={z}",{attribution:"© Google Maps",maxZoom:21}).addTo(d),a.marker([e,t]).addTo(d),a.circle([e,t],{radius:n,color:"#16a34a",fillColor:"#16a34a",fillOpacity:.15,weight:2}).addTo(d)}catch(a){const d=document.getElementById("az-venuemap-canvas");d&&(d.innerHTML=`<div style="color:#f87171;text-align:center;padding:40px;font-size:13px">${p(a.message||"โหลดแผนที่ไม่สำเร็จ")}</div>`)}}function $n(e){if(!e)return"";const t=new Date(e);if(Number.isNaN(t.getTime()))return"";t.setDate(t.getDate()+1);const n=i=>String(i).padStart(2,"0");return`${t.getFullYear()}-${n(t.getMonth()+1)}-${n(t.getDate())}T${n(t.getHours())}:${n(t.getMinutes())}`}function ot(e){const t=y("START_TIME","");return e===1?t:y("SECOND_DAY_START_TIME",$n(t))}function we(e,t){return Number(String(t).replace(/^M/,""))<=(e==="HS"?13:10)?1:2}function Me(e){const t=(o,a)=>{const d=[];for(let s=0;s<Math.max(o.length,a.length);s+=1)o[s]&&d.push(o[s]),a[s]&&d.push(a[s]);return d},[n,i]=["MS","HS"].map(o=>F[o].filter(a=>we(o,a.code)===e).map(a=>[o,a.code]));return t(n,i)}function Ve(e){const t=ot(e).slice(0,10);return t?new Date(`${t}T00:00:00`).toLocaleDateString("th-TH",{weekday:"long",day:"numeric",month:"long",year:"numeric"}):"ยังไม่ได้กำหนดวันที่"}const yt="AZEVENTCHECKIN:";function ce(){return y("EVENT_CHECKIN_REQUIRE_BOTH_DAYS","1")==="1"}function pe(){return y("EVENT_CHECKIN_REQUIRE_PARENT_PERMISSION","0")==="1"}function fe(){return y("EVENT_CHECKIN_REQUIRE_ATTIRE","0")==="1"}function At(){return pe()||fe()}function ut(e,t){const n=_e(e,t);return n?n.confirmed?"✅":"⏳":"❌"}function Rt(){const e=ot(2).slice(0,10),t=new Date().toISOString().slice(0,10);return e&&t>=e?2:1}function eo(e){return`${yt}${e}`}function zn(e){return`<div class="az-jersey-row" data-jersey-id="${p(e.id)}" style="margin-top:8px;padding-top:8px;border-top:1px solid rgba(255,255,255,.08);display:flex;align-items:center;justify-content:space-between;gap:8px">
  ...
  </div>`}function to(e){return`<div class="az-jersey-row" data-jersey-id="${p(e.id)}" style="margin-top:8px;padding-top:8px;border-top:1px solid rgba(255,255,255,.08);display:flex;align-items:center;gap:6px">
  ...
  </div>`}function no(e,t){e.addEventListener("click",async n=>{const i=n.target.closest(".az-jersey-edit-btn");if(i){const a=t(i.dataset.jerseyId);if(!a)return;i.closest(".az-jersey-row").outerHTML=to(a);return}const o=n.target.closest(".az-jersey-save-btn");if(o){const a=o.closest(".az-jersey-row"),d=t(o.dataset.jerseyId);if(!d||!a)return;const c=a.querySelector(".az-jersey-input").value.trim(),l=c===""?null:Number(c);if(c!==""&&(Number.isNaN(l)||l<0)){g("เบอร์เสื้อไม่ถูกต้อง");return}const{error:f}=await h.from("azfutsal_players").update({jersey_number:l}).eq("id",d.id);if(f){g("บันทึกเบอร์เสื้อไม่สำเร็จ: "+f.message);return}d.jersey_number=l,a.outerHTML=zn(d),g("บันทึกเบอร์เสื้อแล้ว"),L()}}),e.addEventListener("keydown",n=>{var i,o,a;n.key==="Enter"&&((i=n.target.classList)!=null&&i.contains("az-jersey-input"))&&((a=(o=n.target.closest(".az-jersey-row"))==null?void 0:o.querySelector(".az-jersey-save-btn"))==null||a.click())})}function kn(e){return`<div class="az-jersey-self" style="width:100%;background:#151a26;border:1px solid #232838;border-radius:14px;padding:16px;text-align:left;box-sizing:border-box">
  ...
  </div>`}function Sn(e){const t=e.jersey_number!==null&&e.jersey_number!==void 0;return`<div class="az-jersey-self" style="width:100%;background:${t?"#151a26":"rgba(217,119,6,.14)"};border:1px solid ${t?"#232838":"#d97706"};border-radius:14px;padding:16px;text-align:left;box-sizing:border-box">
  ...
  </div>`}function io(e,t,n){const i=()=>{const a=t.jersey_number!==null&&t.jersey_number!==void 0;n&&(n.disabled=!a,n.style.opacity=a?"1":".45",n.style.cursor=a?"pointer":"not-allowed",n.textContent=a?"✓ เสร็จสิ้น":"กรุณาระบุเบอร์เสื้อก่อน")},o=()=>{e.innerHTML=kn(t),i()};e.addEventListener("click",async a=>{if(a.target.closest(".az-jersey-self-edit-btn")){e.innerHTML=Sn(t);return}if(a.target.closest(".az-jersey-self-save-btn")){const c=e.querySelector(".az-jersey-self-input").value.trim();if(c===""){g("กรุณากรอกเบอร์เสื้อ");return}const l=Number(c);if(Number.isNaN(l)||l<0){g("เบอร์เสื้อไม่ถูกต้อง");return}const{error:f}=await h.from("azfutsal_players").update({jersey_number:l}).eq("id",t.id);if(f){g("บันทึกเบอร์เสื้อไม่สำเร็จ: "+f.message);return}t.jersey_number=l,o(),g("บันทึกเบอร์เสื้อแล้ว"),L()}}),e.addEventListener("keydown",a=>{var d,s;a.key==="Enter"&&((d=a.target.classList)!=null&&d.contains("az-jersey-self-input"))&&((s=e.querySelector(".az-jersey-self-save-btn"))==null||s.click())}),i()}function En(e,t,n){const i=pe(),o=fe();if(!i&&!o)return"";const a=!!(n!=null&&n.parent_permission_confirmed),d=!!(n!=null&&n.attire_confirmed),s=c=>`flex:1;min-width:130px;padding:8px;border-radius:9px;border:1px solid ${c?"#16a34a":"#334155"};background:${c?"rgba(22,163,74,.18)":"transparent"};color:${c?"#4ade80":"#94a3b8"};font-size:11px;font-weight:700;cursor:pointer`;return`<div class="az-checkin-extra" data-day="${e}" data-player-id="${p(t)}" style="margin-top:8px;padding-top:8px;border-top:1px solid rgba(255,255,255,.08);display:flex;gap:6px;flex-wrap:wrap">
  ...
  </div>`}function oo(e){e.addEventListener("click",async t=>{const n=t.target.closest(".az-extra-toggle");if(!n)return;const i=n.closest(".az-checkin-extra");if(!i)return;const o=Number(i.dataset.day),a=i.dataset.playerId,d=_e(a,o);if(!d)return;const s=n.dataset.field,c=!d[s],{error:l}=await h.from("azfutsal_event_checkins").update({[s]:c}).eq("day",o).eq("player_id",a);if(l){g("บันทึกไม่สำเร็จ: "+l.message);return}d[s]=c,i.outerHTML=En(o,a,d),L()})}function Mn(){return r.identity.student&&r.players.find(e=>e.student_id===r.identity.student.id)||null}function _e(e,t){return r.eventCheckins.find(n=>n.day===t&&n.player_id===e)||null}function vt(e,t){const n=r.players.filter(a=>{var d;return((d=r.teams.find(s=>s.id===a.team_id))==null?void 0:d.level)===e}),i=new Set(r.eventCheckins.filter(a=>a.day===t&&a.confirmed).map(a=>a.player_id)),o=new Set(r.eventCheckins.filter(a=>a.day===t&&!a.confirmed).map(a=>a.player_id));return{done:n.filter(a=>i.has(a.id)).length,pending:n.filter(a=>o.has(a.id)).length,total:n.length}}function Lt(){const e=new Map([[1,new Set],[2,new Set]]);r.eventCheckins.filter(a=>a.confirmed&&(a.day===1||a.day===2)).forEach(a=>e.get(a.day).add(a.player_id)),r.checkins.forEach(a=>{const d=we(a.level,a.match_code);e.has(d)&&e.get(d).add(a.player_id)});const t=new Set([...e.get(1),...e.get(2)]),n=new Map(r.teams.map(a=>[a.id,a])),i=new Intl.Collator("th",{numeric:!0,sensitivity:"base"}),o=new Map([...r.teams].sort((a,d)=>{if(a.level!==d.level)return a.level==="MS"?-1:1;const s=a.team_code||a.name||"",c=d.team_code||d.name||"";return i.compare(s,c)||i.compare(String(a.id),String(d.id))}).map((a,d)=>[a.id,d]));return r.players.filter(a=>t.has(a.id)).map(a=>{var d,s,c;return{level:((d=n.get(a.team_id))==null?void 0:d.level)||"",teamOrder:o.get(a.team_id)??Number.MAX_SAFE_INTEGER,jerseyNumber:a.jersey_number!=null&&String(a.jersey_number).trim()!==""&&Number.isFinite(Number(a.jersey_number))?Number(a.jersey_number):Number.MAX_SAFE_INTEGER,studentCode:((s=a.students)==null?void 0:s.student_code)||"",fullName:((c=a.students)==null?void 0:c.full_name)||"",day1:e.get(1).has(a.id),day2:e.get(2).has(a.id)}}).filter(a=>a.level==="MS"||a.level==="HS").sort((a,d)=>a.level!==d.level?a.level==="MS"?-1:1:a.teamOrder-d.teamOrder||a.jerseyNumber-d.jerseyNumber||i.compare(a.fullName,d.fullName)||i.compare(a.studentCode,d.studentCode))}function ao(e,t){const n=`${e}:${t}`;let i=2166136261;for(let x=0;x<n.length;x+=1)i^=n.charCodeAt(x),i=Math.imul(i,16777619);const o=i>>>0,a=(o%51-25)/10,d=(o>>>6)%9-4,s=(o>>>10)%5-2,c=(78+(o>>>14)%21)/100,l=8.6+(o>>>18)%13/10,f=["Mali","Itim","Sriracha"];return`font-family:'${f[(o>>>22)%f.length]}',cursive;font-size:${l.toFixed(1)}pt;color:#123a72;opacity:${c.toFixed(2)};transform:translate(${d}px,${s}px) rotate(${a.toFixed(1)}deg)`}function ro(e,t,n){const i=String(e||"").trim().replace(/^(?:ด\.ช\.|ด\.ญ\.|เด็กชาย|เด็กหญิง|นาย|นางสาว|นาง)\s*/u,"").trim(),o=i.split(/\s+/u).filter(Boolean);if(o.length<2)return i;let a=2166136261;for(const d of`${t}:${n}:surname`)a^=d.charCodeAt(0),a=Math.imul(a,16777619);return(a>>>0)%2===0?o.join(" "):o[0]}function Tn(e={}){const t=!!e.systemNames,n=Lt(),i=new URL("./pp5-form-logo.png",window.location.href).href;let o=0;const a=n.some(c=>c.level==="MS"),d=`<colgroup><col class="col-no"><col class="col-code"><col><col class="col-date"><col class="col-date"><col class="col-note"></colgroup><thead><tr><th colspan="6" class="doc-head"><div class="head-wrap"><div class="logo-ring"><img class="logo" src="${i}" alt="โลโก้โรงเรียน"></div><div class="title">ฟุตซอลภายในโรงเรียนมูลนิธิอาซิซสถานครั้งที่ 10</div><div class="subtitle">ประจำปีงบประมาณ 2569</div>${t?'<div class="system-notice">รายชื่อในช่องวันที่สร้างอัตโนมัติเพื่อจัดทำเอกสาร ไม่ใช่ลายเซ็นของนักเรียน</div>':""}</div></th></tr><tr><th>ลำดับที่</th><th>รหัสนักเรียน</th><th>ชื่อสกุล</th><th>12 สิงหาคม</th><th>15 สิงหาคม</th><th>หมายเหตุ</th></tr></thead>`,s=["MS","HS"].map(c=>{const l=n.filter(m=>m.level===c);if(!l.length)return"";const x=`<tr class="level-row"><td colspan="6">${c==="MS"?"ระดับมัธยมศึกษาตอนต้น":"ระดับมัธยมศึกษาตอนปลาย"} (${l.length} คน)</td></tr>${l.map(m=>{o+=1;const w=_=>t?`<td class="system-name-cell"><span class="system-name" style="${ao(m.studentCode,_)}">${p(ro(m.fullName,m.studentCode,_))}</span></td>`:"<td></td>";return`<tr><td class="center">${o}</td><td class="center code">${p(m.studentCode)}</td><td>${p(m.fullName)}</td>${w(1)}${w(2)}<td></td></tr>`}).join("")}`;return`<table class="level-document ${c==="HS"&&a?"hs-document":"ms-document"}">${d}<tbody>${x}</tbody></table>`}).join("");return`<!doctype html><html lang="th"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${t?"รายชื่อยืนยันจากระบบ":"ใบรายชื่อเปล่า"} · นักกีฬาฟุตซอล ปีงบประมาณ 2569</title>${t?'<link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Itim&family=Mali:wght@400;500&family=Sriracha&display=swap" rel="stylesheet">':""}<style>
  ...
  </style></head><body>${s}</body></html>`}function Kt(e=!1){if(!Lt().length){g("ยังไม่มีรายชื่อนักเรียนที่เช็กอินหรือรายงานตัว");return}et(Tn({systemNames:e}))}function Zt(e=!1){const t=Lt();if(!t.length){g("ยังไม่มีรายชื่อนักเรียนที่เช็กอินหรือรายงานตัว");return}const n=new Blob(["\uFEFF",Tn({systemNames:e})],{type:"text/html;charset=utf-8"}),i=URL.createObjectURL(n),o=document.createElement("a");o.href=i,o.download=e?"รายชื่อยืนยันจากระบบ_ไม่ใช่ลายเซ็น_ปีงบประมาณ2569.html":"ใบรายชื่อเปล่า_นักกีฬาฟุตซอล_ปีงบประมาณ2569.html",document.body.appendChild(o),o.click(),o.remove(),URL.revokeObjectURL(i),g(`ดาวน์โหลด${e?"รายชื่อยืนยันจากระบบ":"ใบรายชื่อเปล่า"} ${t.length} คนแล้ว`)}function An(){return y("EVENT_CHECKIN_OPEN_TIME","")}function ke(){return y("EVENT_CHECKIN_CLOSE_TIME","")}function ht(e){const t=An(),n=ke();return!t&&!n?"":`เปิดเช็คอิน ${t||"-"} - ${n||"-"} น.`}function Rn(e){const t=ke(),n=ot(e).slice(0,10);if(!t||!n)return null;const i=new Date(`${n}T${t}:00`);return Number.isNaN(i.getTime())?null:i}function so(e){const t=Rn(e);return!!t&&new Date>=t}function lo(e){const t=Math.max(0,Math.floor(e/1e3)),n=Math.floor(t/3600),i=Math.floor(t%3600/60),o=t%60,a=d=>String(d).padStart(2,"0");return n>0?`${n}:${a(i)}:${a(o)}`:`${a(i)}:${a(o)}`}function co(e,t,n,i){const a=e*Math.PI/180,d=n*Math.PI/180,s=(n-e)*Math.PI/180,c=(i-t)*Math.PI/180,l=Math.sin(s/2)**2+Math.cos(a)*Math.cos(d)*Math.sin(c/2)**2;return 6371e3*2*Math.atan2(Math.sqrt(l),Math.sqrt(1-l))}function po(){const e=parseFloat(y("EVENT_VENUE_LAT","")),t=parseFloat(y("EVENT_VENUE_LNG","")),n=parseFloat(y("EVENT_VENUE_RADIUS","150"))||150;return Number.isNaN(e)||Number.isNaN(t)?null:{lat:e,lng:t,radius:n}}function fo(e){return e&&e.code===1?"กรุณาอนุญาตให้เว็บนี้เข้าถึงตำแหน่ง GPS เพื่อเช็คอิน (เปิดสิทธิ์ตำแหน่งในตั้งค่าเบราว์เซอร์แล้วลองใหม่)":e&&e.code===2?"โทรศัพท์ค้นหาพิกัดไม่พบ กรุณาเปิด GPS/บริการตำแหน่งแล้วลองใหม่":e&&e.code===3?"ค้นหาพิกัดใช้เวลานานเกินไป กรุณาลองใหม่อีกครั้ง":"อุปกรณ์นี้ไม่สามารถอ่านพิกัด GPS ได้"}function Ln(){return new Promise(e=>{if(!window.isSecureContext){e({error:"การใช้ GPS ต้องเปิดผ่านลิงก์ https:// เท่านั้น"});return}if(!navigator.geolocation){e({error:"อุปกรณ์นี้ไม่รองรับ GPS"});return}navigator.geolocation.getCurrentPosition(t=>e({lat:t.coords.latitude,lng:t.coords.longitude}),t=>e({error:fo(t)}),{enableHighAccuracy:!0,timeout:15e3,maximumAge:0})})}function uo(e,t="ALL"){return r.teams.filter(n=>t==="ALL"||n.level===t).map(n=>{const i=r.players.filter(d=>d.team_id===n.id);if(!i.length)return null;const o=new Set(r.eventCheckins.filter(d=>d.day===e&&d.confirmed).map(d=>d.player_id)),a=i.filter(d=>o.has(d.id)).length;return a>=i.length?null:{team:n,done:a,total:i.length}}).filter(Boolean)}function xo(e){if(!e.length)return"";const t=ce()?[1,2]:[1],n=o=>{const a=new Set(r.eventCheckins.filter(s=>s.day===o&&s.confirmed).map(s=>s.player_id)),d=e.filter(s=>a.has(s.id)).length;return{done:d,total:e.length,complete:d>=e.length}},i=t.every(o=>n(o).complete);return`
  <div style="border:1px solid ${i?"#bbf7d0":"#fde68a"};background:${i?"#f0fdf4":"#fffbeb"};border-radius:14px;padding:12px 14px">
  ...
  </div>`}function In(e){const t=r.eventCheckinDay||Rt(),n=vt("MS",t),i=vt("HS",t),o=ht(),a=r.eventCheckinIncompleteLevel||"ALL",d=uo(t,a),s=so(t);return ne(`
    ...
    ${At()?`<button data-act="openEventCheckinPendingReview" data-day="${t}" style="width:100%;margin-top:8px;padding:9px;border-radius:10px;border:1px solid #fde68a;background:#fffbeb;color:#b45309;font-weight:800;font-size:12.5px;cursor:pointer">🕐 รอสตาฟยืนยัน (${(n.pending||0)+(i.pending||0)} คน)</button>`:""}
    ${e?`
    ...
    <div style="margin-top:8px;padding:12px;border-radius:12px;background:${s?"#fef2f2":"#f9fafb"};border:1px solid ${s?"#fecaca":"#e5e7eb"}">
      <div style="font-size:12.5px;font-weight:800;color:${s?"#dc2626":"#6b7280"};margin-bottom:6px">${s?`⚠️ เลยเวลาปิดรับเช็คอิน (${p(ke())} น.) แล้ว — ทีมต่อไปนี้มาไม่ครบ พิจารณาสกอร์ตามนโยบายที่ตั้งไว้`:`🕐 ยังมาไม่ครบ ${d.length} ทีม (จะเตือนชัดเจนเมื่อถึงเวลาปิดรับ${ke()?` ${p(ke())} น.`:""})`}</div>
      <div style="display:flex;flex-direction:column;gap:4px">
        ${d.map(({team:c,done:l,total:f})=>`<div style="font-size:12px;color:#374151;display:flex;justify-content:space-between;gap:8px"><span>${be(c.level)} ${p(c.name)}</span><b style="color:${s?"#dc2626":"#6b7280"}">${l}/${f}</b></div>`).join("")}
      </div>
    ...
    <div style="margin-top:14px;padding-top:12px;border-top:1px solid #f3f4f6">
      ...
      <div style="display:flex;gap:8px;align-items:center">
        <input id="evci-open" type="time" value="${p(An())}" style="flex:1;border:1px solid #e5e7eb;border-radius:9px;padding:7px 8px;font-size:13px"/>
        <span style="font-size:12px;color:#9ca3af">ถึง</span>
        <input id="evci-close" type="time" value="${p(ke())}" style="flex:1;border:1px solid #e5e7eb;border-radius:9px;padding:7px 8px;font-size:13px"/>
      </div>
  ...
  `)}function It(){const e=[];return(r.filterLevel==="ALL"?["MS","HS"]:[r.filterLevel]).forEach(t=>{F[t].forEach(n=>{const i=G(t,n.code),o=i.match;e.push({level:t,code:n.code,round:n.round,day:we(t,n.code),teamA:i.teamA,teamB:i.teamB,teamAId:i.teamAId,teamBId:i.teamBId,m:o})})}),e.filter(t=>{var n;return!(r.filterTeam&&!`${t.teamA} ${t.teamB}`.toLowerCase().includes(r.filterTeam.toLowerCase())||r.filterTime&&!(((n=t.m)==null?void 0:n.kickoff_time)||"").includes(r.filterTime))}).sort((t,n)=>{var a,d;if(t.day!==n.day)return t.day-n.day;const i=((a=t.m)==null?void 0:a.kickoff_time)||"99:99",o=((d=n.m)==null?void 0:d.kickoff_time)||"99:99";return i.localeCompare(o)})}function Cn(){const e=[];return["MS","HS"].forEach(t=>{F[t].forEach(n=>{const i=G(t,n.code);e.push({level:t,code:n.code,round:n.round,day:we(t,n.code),teamA:i.teamA,teamB:i.teamB,teamAId:i.teamAId,teamBId:i.teamBId,m:i.match})})}),e.sort((t,n)=>{var a,d;if(t.day!==n.day)return t.day-n.day;const i=((a=t.m)==null?void 0:a.kickoff_time)||"99:99",o=((d=n.m)==null?void 0:d.kickoff_time)||"99:99";return i.localeCompare(o)})}function bo(){var f;(f=document.getElementById("az-schedbig-overlay"))==null||f.remove();let e=Rt(),t="ALL";const n=document.createElement("div");n.id="az-schedbig-overlay",n.style.cssText="position:fixed;inset:0;z-index:9999;background:#f8fafc;overflow:hidden;font-family:Sarabun,Arial,sans-serif;display:flex;flex-direction:column",n.innerHTML=`
    ...
    <div id="az-schedbig-body" style="flex:1;min-height:0;overflow-y:auto;padding:24px"></div>`,document.body.appendChild(n);const i=n.querySelector("#az-schedbig-daytabs"),o=n.querySelector("#az-schedbig-leveltabs"),a=n.querySelector("#az-schedbig-body"),d=x=>`padding:8px 14px;border-radius:9px;border:1px solid ${x?"#fff":"rgba(255,255,255,.4)"};background:${x?"#fff":"rgba(255,255,255,.12)"};color:${x?"#db2777":"#fff"};font-weight:800;font-size:12.5px;cursor:pointer;white-space:nowrap`;function s(){i.innerHTML=[1,2].map(x=>`<button class="az-schedbig-day" data-v="${x}" style="${d(e===x)}">วันที่ ${x}</button>`).join(""),o.innerHTML=["ALL","MS","HS"].map(x=>`<button class="az-schedbig-level" data-v="${x}" style="${d(t===x)}">${x==="ALL"?"ทั้งหมด":S[x].label}</button>`).join("")}function c(){const x=Cn().filter(b=>b.day===e&&(t==="ALL"||b.level===t));a.innerHTML=x.length?`<div style="zoom:1.25;display:grid;grid-template-columns:repeat(auto-fill,minmax(360px,1fr));gap:16px;max-width:1600px;margin:0 auto">${x.map(b=>at(b,{hideAdminActions:!0})).join("")}</div>`:`<div style="text-align:center;padding:80px 0;color:#9ca3af;font-size:15px">ไม่พบนัดของวันที่ ${e}</div>`}s(),c(),n.addEventListener("click",x=>{const b=x.target.closest(".az-schedbig-day");if(b){e=Number(b.dataset.v),s(),c();return}const m=x.target.closest(".az-schedbig-level");if(m){t=m.dataset.v,s(),c();return}const w=x.target.closest('[data-act="openMatchBigScreen"]');if(w){Nn(w.dataset.level,w.dataset.code);return}});const l=Ce(async()=>{await L(),c()},4e3,n);n.querySelector("#az-schedbig-close").addEventListener("click",()=>{ue(l),n.remove()}),n.querySelector("#az-schedbig-standings").addEventListener("click",()=>{jn()})}function Ye(e,t,n){const i=[...Me(1),...Me(2)],o=i.findIndex(([d,s])=>d===e&&s===t);return o===-1?null:i[o+n]||null}function Ct(){return Cn().find(e=>e.m&&["running","paused","half_break"].includes(e.m.clock_status))||null}function yo(){const e=Ct();return e?[e.level,e.code]:null}function Nn(e,t){var s;(s=document.getElementById("az-matchbig-overlay"))==null||s.remove();let n=e,i=t;const o=document.createElement("div");o.id="az-matchbig-overlay",o.style.cssText="position:fixed;inset:0;z-index:9999;background:#0b0f1a;display:flex;flex-direction:column;font-family:Sarabun,Arial,sans-serif",o.innerHTML=`
    ...
    <div id="az-matchbig-body" style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:40px"></div>`,document.body.appendChild(o);function a(){const c=n,l=i,f=G(c,l),b={round:(F[c].find(V=>V.code===l)||{}).round,teamA:f.teamA,teamB:f.teamB,teamAId:f.teamAId,teamBId:f.teamBId,m:f.match},m=b.m,w=o.querySelector("#az-matchbig-prev"),_=o.querySelector("#az-matchbig-next"),T=Ye(c,l,-1),E=Ye(c,l,1);w&&(w.disabled=!T,w.style.opacity=T?"1":".4",w.style.cursor=T?"pointer":"not-allowed"),_&&(_.disabled=!E,_.style.opacity=E?"1":".4",_.style.cursor=E?"pointer":"not-allowed");const M=m&&m.score_a!==null&&m.score_b!==null,v=m&&["running","paused","half_break"].includes(m.clock_status),z=(m==null?void 0:m.clock_status)==="paused"?"หยุดเวลา":(m==null?void 0:m.clock_status)==="half_break"?"พักครึ่ง":"กำลังแข่งขัน",N=(V,X)=>r.matchEvents.filter(Y=>Y.level===c&&Y.match_code===l&&Y.team_id===V&&Y.event_type===X),I=se(N(b.teamAId,"goal")),j=se(N(b.teamBId,"goal")),O=se(N(b.teamAId,"yellow")),D=se(N(b.teamBId,"yellow")),Q=se(N(b.teamAId,"red")),q=se(N(b.teamBId,"red")),J=!M&&(I.length>0||j.length>0),u=M?m.score_a:J?I.length:null,k=M?m.score_b:J?j.length:null,{aWins:A,bWins:C}=zt(m,b.teamAId,b.teamBId),B=(V,X,Y,te)=>{const ae=[];return V.length&&ae.push(`<div style="font-size:18px;color:#e2e8f0;margin-top:6px">⚽ ${p(V.join(", "))}</div>`),X.length&&ae.push(`<div style="font-size:18px;color:#fbbf24;margin-top:4px">🟨 ${p(X.join(", "))}</div>`),Y.length&&ae.push(`<div style="font-size:18px;color:#f87171;margin-top:4px">🟥 ${p(Y.join(", "))}</div>`),ae.length?`<div style="text-align:${te}">${ae.join("")}</div>`:""},H=kt(m),P=document.getElementById("az-matchbig-body");P&&(P.innerHTML=`
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:8px">${be(c)}<span style="color:#94a3b8;font-size:16px;font-weight:700">${p(b.round||"")} · ${p(l)}</span></div>
      ${v?`<div style="display:flex;align-items:center;gap:12px;margin-bottom:20px"><span style="width:12px;height:12px;border-radius:50%;background:#22c55e;${m.clock_status==="running"?"animation:azLivePulse 1.2s ease-in-out infinite":""}"></span><span style="color:#4ade80;font-weight:800;font-size:18px">${z}</span>${St(m,{compact:!0,onDark:!0})}</div>`:M?'<div style="color:#94a3b8;font-weight:700;font-size:16px;margin-bottom:20px">จบการแข่งขัน</div>':`<div style="color:#94a3b8;font-weight:700;font-size:16px;margin-bottom:20px">${p((m==null?void 0:m.kickoff_time)||"รอแข่ง")}</div>`}
      <div style="display:flex;align-items:center;justify-content:center;gap:5vw;width:100%;max-width:1400px">
        ...
        <div style="flex-shrink:0;text-align:center">
          ...
          ${H?`<div style="margin-top:6px">${H}</div>`:""}
        </div>
        <div style="flex:1;text-align:left;min-width:0">
          <div style="font-size:min(6vw,64px);font-weight:900;color:${C?"#4ade80":"#fff"};line-height:1.15;overflow-wrap:break-word">${p(b.teamB)||"รอผลรอบก่อน"}</div>
        </div>
      </div>
      <div style="display:flex;justify-content:center;gap:5vw;width:100%;max-width:1400px;margin-top:30px">
        <div style="flex:1;min-width:0">${B(I,O,Q,"right")}</div>
        <div style="flex-shrink:0;width:150px"></div>
        <div style="flex:1;min-width:0">${B(j,D,q,"left")}</div>
      </div>`,bn())}a();const d=Ce(async()=>{await L(),a()},3e3,o);o.querySelector("#az-matchbig-close").addEventListener("click",()=>{ue(d),o.remove()}),o.querySelector("#az-matchbig-prev").addEventListener("click",()=>{const c=Ye(n,i,-1);c&&([n,i]=c,a())}),o.querySelector("#az-matchbig-next").addEventListener("click",()=>{const c=Ye(n,i,1);c&&([n,i]=c,a())}),o.querySelector("#az-matchbig-live").addEventListener("click",()=>{const c=yo();if(!c){g("ไม่มีคู่ที่กำลังแข่งขันอยู่ตอนนี้");return}[n,i]=c,a()}),o.querySelector("#az-matchbig-standings").addEventListener("click",()=>{jn()})}function jn(){var c;(c=document.getElementById("az-standbig-overlay"))==null||c.remove();let e="MS";const t=document.createElement("div");t.id="az-standbig-overlay",t.style.cssText="position:fixed;inset:0;z-index:10000;background:#f8fafc;overflow:hidden;font-family:Sarabun,Arial,sans-serif;display:flex;flex-direction:column",t.innerHTML=`
    <div style="flex-shrink:0;padding:16px 24px;background:linear-gradient(120deg,#db2777,#6366f1 65%,#0ea5e9);color:#fff;display:flex;align-items:center;justify-content:space-between;gap:14px;flex-wrap:wrap;box-shadow:0 4px 16px rgba(0,0,0,.12)">
    ...
    <div id="az-standbig-body" style="flex:1;min-height:0;overflow-y:auto;padding:24px"></div>`,document.body.appendChild(t);const n=t.querySelector("#az-standbig-leveltabs"),i=t.querySelector("#az-standbig-body"),o=l=>`padding:8px 14px;border-radius:9px;border:1px solid ${l?"#fff":"rgba(255,255,255,.4)"};background:${l?"#fff":"rgba(255,255,255,.12)"};color:${l?"#db2777":"#fff"};font-weight:800;font-size:12.5px;cursor:pointer`;function a(){n.innerHTML=["MS","HS"].map(l=>`<button class="az-standbig-level" data-v="${l}" style="${o(e===l)}">${S[l].label}</button>`).join("")}function d(){const l=S[e],f=Ue(e),x=Et(e,1/0),b=Qt(e,"yellow"),m=Qt(e,"red"),w=(_,T)=>_.length?_.map((E,M)=>{const v=T==="goal"?E.goals:E[T],z=T==="goal"?"⚽":T==="yellow"?"🟨":"🟥";return`<div style="display:flex;align-items:center;gap:12px">
        ...
        <div style="font-size:20px;font-weight:900;color:${T==="red"?"#dc2626":T==="yellow"?"#d97706":l.accent}">${z} ${v}</div>
      ...
      <div style="max-width:1400px;margin:0 auto;display:flex;flex-direction:column;gap:20px">
        <div style="background:#fff;border:1px solid ${l.border};border-radius:16px;padding:18px;overflow-x:auto">
          ...
          <table style="width:100%;border-collapse:collapse;font-size:15px;white-space:nowrap">
            <thead><tr>
              ${["#","ทีม","GP","ชนะ","แพ้","GF","GA","GD","Y","R"].map(_=>`<th style="text-align:${_==="ทีม"?"left":"center"};padding:9px 10px;font-weight:800;color:#6b7280;border-bottom:2px solid #f3f4f6">${_}</th>`).join("")}
            </tr></thead>
            <tbody>
              ${f.length?f.map((_,T)=>`
                <tr style="background:${T%2===0?"#fff":l.soft}">
                  <td style="padding:10px;font-weight:700;color:#9ca3af">${T+1}</td>
                  <td style="padding:10px;font-weight:800">${p(_.team)}</td>
                  <td style="text-align:center;padding:10px">${_.gp}</td>
                  <td style="text-align:center;padding:10px;color:#16a34a;font-weight:800">${_.w}</td>
                  <td style="text-align:center;padding:10px;color:#dc2626;font-weight:800">${_.l}</td>
                  <td style="text-align:center;padding:10px">${_.gf}</td>
                  <td style="text-align:center;padding:10px">${_.ga}</td>
                  <td style="text-align:center;padding:10px;font-weight:800">${_.gd}</td>
                  <td style="text-align:center;padding:10px">${_.y}</td>
                  <td style="text-align:center;padding:10px">${_.r}</td>
      ...
      </div>`}a(),d(),t.addEventListener("click",l=>{const f=l.target.closest(".az-standbig-level");if(f){e=f.dataset.v,a(),d();return}});const s=Ce(async()=>{await L(),d()},5e3,t);t.querySelector("#az-standbig-close").addEventListener("click",()=>{ue(s),t.remove()})}function Bn(e,t=null){const n=r.scheduleDay===2?2:1,i=e.filter(o=>o.day===n&&!(t&&o.level===t.level&&o.code===t.code));return i.length?i.map(at).join(""):`<div style="text-align:center;padding:32px 0;color:#9ca3af;font-size:13px">ไม่พบนัดของวันที่ ${n} ที่ตรงกับตัวกรอง</div>`}function vo(){return`
  <div style="display:flex;gap:6px;margin-bottom:10px">
    ${[1,2].map(e=>{const t=r.scheduleDay===e,n=e===1?"#0284c7":"#7c3aed";return`<button data-act="setScheduleDay" data-v="${e}" style="flex:1;min-width:0;padding:9px 8px;border-radius:11px;border:1px solid ${t?n:"#e5e7eb"};background:${t?n:"#fff"};color:${t?"#fff":"#374151"};cursor:pointer;text-align:center"><span style="display:block;font-size:12px;font-weight:900">วันที่ ${e}</span><span style="display:block;margin-top:2px;font-size:9.5px;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${p(Ve(e))}</span></button>`}).join("")}
  </div>`}function ho(e){return e==="ชิงที่ 3"||e==="ชิงที่ 1"?"รอบชิง":e}function wo(e,t){const n=t==="a"?e.refA:e.refB;return e.pool?"รอจับสลากรอบนี้":n?n.startsWith("W_M")?`ผู้ชนะ ${n.slice(2)}`:n.startsWith("L_M")?`ผู้แพ้ ${n.slice(2)}`:n==="FIRST_ROUND_BYE"?"ทีมที่ได้สิทธิ์บาย":n.startsWith("REC_")?"ทีมจากรอบแก้ตัว":n==="LOTTERY_1"||n==="LOTTERY_2"?"ทีมจับฉลากจากผู้แพ้รอบนี้":"รอผลรอบก่อน":"รอจับสลาก"}function _o(e,t){const n=S[e],i=G(e,t.code),o=i.match||{},a=o.score_a!==null&&o.score_a!==void 0&&o.score_b!==null&&o.score_b!==void 0,{aWins:d,bWins:s}=zt(o,i.teamAId,i.teamBId),c=(f,x)=>{const b=(f==="a"?t.refA:t.refB)==="FIRST_ROUND_BYE";return`${p(x||wo(t,f))}${b&&x?' <span style="color:#d97706">⭐</span>':""}`},l=(f,x,b,m)=>`
  ...
  </div>`}function $o(){const e=r.bracketLevel||"MS",t=[];F[e].forEach(a=>{const d=ho(a.round);let s=t.find(c=>c.label===d);s||(s={label:d,matches:[]},t.push(s)),s.matches.push(a)});const n=e==="MS"?y("FIRST_ROUND_BYE_MS",""):"",i=r.theme==="dark"?["#172033","#2d1f13","#15243b","#231c3d","#0f2928","#2e2812"]:["#f8fafc","#fff7ed","#eff6ff","#f5f3ff","#f0fdfa","#fffbeb"],o=r.theme==="dark"?["#475569","#9a5b27","#3b6a9f","#6650a4","#247b75","#92762d"]:["#cbd5e1","#fed7aa","#bfdbfe","#ddd6fe","#99f6e4","#fde68a"];return`
  <div>
    <div style="display:flex;gap:6px;margin-bottom:10px">
      ${["MS","HS"].map(a=>`<button data-act="setBracketLevel" data-v="${a}" style="flex:1;padding:9px;border-radius:10px;border:1px solid ${e===a?S[a].base:"#e5e7eb"};background:${e===a?S[a].base:"#fff"};color:${e===a?"#fff":"#374151"};font-size:12.5px;font-weight:800;cursor:pointer">${S[a].label} · ${F[a].length} นัด</button>`).join("")}
    </div>
    <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:8px">
      <div style="font-size:11.5px;color:#6b7280">เลื่อนซ้าย–ขวาเพื่อดูเส้นทางถึงรอบชิง</div>
      ${e==="MS"&&oe()?`<div style="font-size:10.5px;color:#b45309;font-weight:700">⭐ ทีมบาย: ${p(U(n)||"รอจับสลาก")}</div>`:""}
    </div>
  ...
  </div>`}function zo(){const e=It(),t=r.scheduleMode==="bracket",n=Ct(),i=e.filter(o=>o.day===(r.scheduleDay===2?2:1)).length;return`
  <section>
  ...
  </section>`}const Pn=[{key:"full",label:"สิทธิ์เต็มรูปแบบ (แอดมิน)",desc:"เข้าถึงทุกส่วน: ทีม การเงิน ตั้งค่า ผลการแข่งขัน รายงานตัว"},{key:"checkin",label:"รับรายงานตัว",desc:"เปิดกล้องสแกน QR รายงานตัวนักกีฬาก่อนแข่งเท่านั้น"},{key:"result",label:"บันทึกผลการแข่งขัน",desc:"แก้ไขสกอร์ ผู้ทำประตู ใบเหลือง-แดงเท่านั้น"}];function ko(e,t,n){const i=S[e.level],o=t&&e.teamAId&&e.teamBId;if(!o&&!n)return"";const a=e.teamAId?r.teams.find(s=>s.id===e.teamAId):null,d=e.teamBId?r.teams.find(s=>s.id===e.teamBId):null;return`
  <div style="border:1px solid ${i.border};background:${i.soft};border-radius:12px;padding:10px 12px">
    <div style="display:flex;align-items:center;gap:6px;margin-bottom:4px">${be(e.level)}<span style="font-size:11px;color:#9ca3af;font-weight:600">${p(e.round)} · ${e.code}</span></div>
  ...
  </div>`}function So(){const e=r.identity.scopes||[],t=e.includes("checkin"),n=e.includes("result"),i=It();return`
  <section>
    ...
    ${t?`<div style="margin-bottom:14px">${In(!1)}</div>`:""}
    <div style="display:flex;gap:6px;margin-bottom:14px">
      ${["ALL","MS","HS"].map(o=>`<button data-act="setLevel" data-v="${o}" style="font-size:12.5px;padding:7px 14px;border-radius:9px;border:1px solid ${r.filterLevel===o?"#db2777":"#e5e7eb"};background:${r.filterLevel===o?"#db2777":"#fff"};color:${r.filterLevel===o?"#fff":"#374151"};font-weight:700;cursor:pointer">${o==="ALL"?"ทั้งหมด":S[o].label}</button>`).join("")}
    </div>
    <div style="display:flex;flex-direction:column;gap:10px">
      ${i.map(o=>ko(o,t,n)).join("")||'<div style="text-align:center;padding:32px 0;color:#9ca3af;font-size:13px">ยังไม่มีตารางแข่ง</div>'}
    </div>
  </section>`}function Dn(e){var n;const t=r.players.find(i=>i.id===e);return((n=t==null?void 0:t.students)==null?void 0:n.full_name)||""}function se(e){const t=[],n=new Map;return e.forEach(i=>{n.has(i.player_id)||(n.set(i.player_id,[]),t.push(i.player_id)),i.minute!=null&&n.get(i.player_id).push({minute:i.minute,isPenalty:!!i.is_penalty})}),t.map(i=>{const o=Dn(i),a=n.get(i).sort((d,s)=>d.minute-s.minute);return o?o+(a.length?` (${a.map(d=>d.minute+"'"+(d.isPenalty?"P":"")).join(", ")})`:""):""}).filter(Boolean)}function at(e,t){const n=S[e.level],i=e.m,o=i&&i.score_a!==null&&i.score_b!==null,a=i&&["running","paused","half_break"].includes(i.clock_status),d=(i==null?void 0:i.clock_status)==="paused"?"หยุดเวลา":(i==null?void 0:i.clock_status)==="half_break"?"พักครึ่ง":"กำลังแข่งขัน",s=(i==null?void 0:i.clock_status)==="paused"?"#d97706":(i==null?void 0:i.clock_status)==="half_break"?"#64748b":"#15803d",c=(i==null?void 0:i.clock_status)==="paused"?"#fef3c7":(i==null?void 0:i.clock_status)==="half_break"?"#e2e8f0":"#dcfce7",l=(z,N)=>r.matchEvents.filter(I=>I.level===e.level&&I.match_code===e.code&&I.team_id===z&&I.event_type===N),f=i?se(l(e.teamAId,"goal")):[],x=i?se(l(e.teamBId,"goal")):[],b=i?se(l(e.teamAId,"yellow")):[],m=i?se(l(e.teamBId,"yellow")):[],w=i?se(l(e.teamAId,"red")):[],_=i?se(l(e.teamBId,"red")):[],{aWins:T,bWins:E}=zt(i,e.teamAId,e.teamBId),M=(z,N,I,j)=>{const O=[];return z.length&&O.push(`<div style="font-size:10.5px;color:#6b7280;margin-top:3px;overflow-wrap:break-word;text-align:${j}">⚽ ${p(z.join(", "))}</div>`),N.length&&O.push(`<div style="font-size:10.5px;color:#6b7280;margin-top:2px;overflow-wrap:break-word;text-align:${j}">🟨 ${p(N.join(", "))}</div>`),I.length&&O.push(`<div style="font-size:10.5px;color:#6b7280;margin-top:2px;overflow-wrap:break-word;text-align:${j}">🟥 ${p(I.join(", "))}</div>`),O.join("")},v=(z,N,I)=>`
    <div style="flex:1;min-width:0;${N?"background:#dcfce7;border-radius:10px;":""}padding:6px 8px;text-align:${I}">
      <div style="font-size:13.5px;font-weight:${N?800:600};color:${N?"#15803d":"#111827"};line-height:1.3;overflow-wrap:break-word">${p(z)||'<span style="color:#c1c5cc">รอผลรอบก่อน</span>'}</div>
    </div>`;return`
  <div style="border:1px solid ${n.border};background:${n.soft};border-radius:14px;padding:12px 14px;overflow:hidden">
    <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px">
      ...
      <span style="flex:1"></span>
      ${a?`<span style="display:inline-flex;align-items:center;gap:5px;font-size:10.5px;font-weight:800;color:${s};background:${c};padding:3px 9px;border-radius:999px"><span style="width:7px;height:7px;border-radius:50%;background:${s};${i.clock_status==="running"?"animation:azLivePulse 1.2s ease-in-out infinite":""}"></span>${d}</span>${St(i,{compact:!0})}`:`<span style="font-size:${o?"10.5px":"13px"};font-weight:${o?700:800};color:${o?"#6b7280":n.base}">${o?"จบการแข่งขัน":p((i==null?void 0:i.kickoff_time)||"รอแข่ง")}</span>`}
    ...
    <div style="display:flex;align-items:flex-start;gap:8px;margin-top:2px">
      ...
      <div style="flex:1;min-width:0">${M(x,m,_,"right")}</div>
    </div>`:""}
  ...
  </div>`}function Eo(e){var f;const t=S[e.level],n=r.players.filter(x=>x.team_id===e.id),i=r.payments.find(x=>x.team_id===e.id),o=Number(y("MAX_ROSTER",12)),a=i?i.status:"unpaid",d={verified:["ยืนยันแล้ว","#16a34a","#dcfce7"],pending:["รอตรวจสอบ","#f59e0b","#fef3c7"],rejected:["ถูกปฏิเสธ","#dc2626","#fee2e2"],unpaid:["ยังไม่ชำระ","#6b7280","#f3f4f6"]},[s,c,l]=d[a];return`
  <div style="border:1px solid ${t.border};background:${t.soft};border-radius:12px;padding:12px">
    <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:4px">
      <div style="display:flex;align-items:center;gap:6px;min-width:0">
        ...
        ${e.is_reserve?Fe():""}${e.is_organizer?qe():""}
      </div>
    ...
    <div style="display:grid;grid-template-columns:repeat(3, 1fr);gap:10px;margin-top:10px">
      ${[...n].sort((x,b)=>(x.jersey_number??999)-(b.jersey_number??999)).map(x=>Io(x)).join("")}
    </div>`:""}
  ...
  <section>
    ...
    <div style="display:flex;flex-direction:column;gap:10px">
      ${d.length?d.map(Eo).join(""):'<div style="text-align:center;padding:32px 0;color:#9ca3af;font-size:13px">ยังไม่มีทีมลงทะเบียนในระดับนี้</div>'}
    </div>
  </section>`}function To(){const e=r.statsLevel,t=S[e],n=Ue(e),i=Et(e),o=Mi(e);return`
  <section>
  ...
  <section>
    ...
    <div style="display:flex;flex-direction:column;gap:14px">
      ${["MS","HS"].map(e=>{const t=S[e],n=vn(e);return`
        <div style="border:1px solid ${t.border};background:${t.soft};border-radius:14px;padding:16px">
          ...
          <div style="border-top:1px solid rgba(0,0,0,.06);padding-top:10px;display:flex;flex-direction:column;gap:7px">
            ${ft("MVP",n.mvpAward,t)}
            ${ft("ดาวซัลโว",n.topScorerAward,t)}
            ${ft("ผู้รักษาประตูยอดเยี่ยม",n.bestGKAward,t)}
          </div>
        </div>`}).join("")}
    </div>
  </section>`}function On(e,t){const n=S[e.level];return t?ri({name:e.name,award:un(e.awardType),templateUrl:t}):`
  ...
  </div>`}function Ro(e,t,n){const i=S[e.level];return`
  <div data-act="certFull" data-idx="${t}" style="cursor:pointer;margin-bottom:18px">
    <div style="max-width:320px;margin:0 auto;border-radius:10px;box-shadow:0 3px 14px rgba(0,0,0,.12)">${On(e,n)}</div>
  ...
  </div>`}function Lo(){const e=y("CERT_ENABLED","1")==="1",t=r.certResults,n=y("CERT_TEMPLATE_URL",""),i=r.certFullscreenIndex;if(i!==null&&t&&t[i]){const o=t[i],a=S[o.level];return`
    <div style="position:fixed;inset:0;z-index:65;background:#fff;display:flex;flex-direction:column">
      <div style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px;gap:20px;overflow-y:auto">
        <div style="width:100%;max-width:420px">${On(o,n)}</div>
  ...
  <div style="position:fixed;inset:0;z-index:65;background:#fff;display:flex;flex-direction:column">
    ...
    <div style="padding:20px;overflow-y:auto;flex:1">
      ...
      ${t&&t.length?t.map((o,a)=>Ro(o,a,n)).join(""):r.knownStudentCode?'<div style="text-align:center;padding:24px 0;color:#9ca3af;font-size:13px">ไม่พบข้อมูลเกียรติบัตรของคุณ อาจยังไม่ได้ลงทะเบียนแข่งขันฟุตซอล</div>':r.certInput&&t===null?'<div style="text-align:center;padding:24px 0;color:#9ca3af;font-size:13px">ไม่พบข้อมูล กรุณาตรวจสอบรหัสนักเรียน</div>':""}
      `:'<div style="text-align:center;padding:24px 0;color:#9ca3af;font-size:13px">ยังไม่เปิดใช้งานเกียรติบัตรสำหรับรุ่นนี้</div>'}
      </div>
    </div>
  </div>`}function en(e){return`<section><div style="text-align:center;padding:60px 20px;color:#6b7280;font-size:13.5px">${p(e)}</div></section>`}function Z(e){var t,n;return e.photo_url||((t=e.students)==null?void 0:t.image_url)||((n=e.students)==null?void 0:n.photo_url)}function me(e){return e?`<img src="${p(e)}" style="width:30px;height:38px;border-radius:8px;border:1px solid #d1d5db;object-fit:cover;flex-shrink:0;box-shadow:0 1px 3px rgba(0,0,0,.2)"/>`:'<div style="width:30px;height:38px;border-radius:8px;border:1px solid #d1d5db;background:#e5e7eb;flex-shrink:0"></div>'}function Io(e){var a,d;const t=Z(e),n=p((((a=e.students)==null?void 0:a.full_name)||"?").replace(/^[ดญ]\.[ชญ]\./,"").trim().charAt(0)),i="width:100%;height:100%;background:#e5e7eb;display:flex;align-items:center;justify-content:center;color:#9ca3af;font-size:22px;font-weight:800";return`
  ...
  </div>`}function Co(){const e=r;if(!e.identity.session)return en("กรุณาเข้าสู่ระบบ pp5 ก่อน");if(e.identity.isAdmin){if(e.adminManageTeamId){const n=e.teams.find(i=>i.id===e.adminManageTeamId);if(n)return xt(n,!0);e.adminManageTeamId=null}return e.adminCreatingTeam?tn(!0):No()}if(!e.identity.student)return en("หน้านี้สำหรับนักเรียน (หัวหน้าทีม/ตัวแทนทีม) เท่านั้น");const t=e.teams.find(n=>n.captain_student_id===e.identity.student.id);return t?xt(t,!1):e.teamCodeLookupResult&&typeof e.teamCodeLookupResult=="object"?xt(e.teamCodeLookupResult,!1,!0):tn(!1)}function No(){return`
  <section>
    ...
    ${["MS","HS"].map(e=>{const t=r.teams.filter(o=>o.level===e),n=Number(y(e==="MS"?"MAX_TEAMS_MS":"MAX_TEAMS_HS","")||0),i=r.payments.filter(o=>{var a;return o.status==="verified"&&((a=r.teams.find(d=>d.id===o.team_id))==null?void 0:a.level)===e}).length;return`<div style="margin-bottom:14px">
        ...
        ${t.length?t.map(o=>`
          <button data-act="adminOpenTeam" data-id="${o.id}" style="display:block;width:100%;text-align:left;border:1px solid #e5e7eb;border-radius:10px;padding:10px 12px;margin-bottom:6px;background:#fff;cursor:pointer">
            <div style="display:flex;align-items:center;gap:6px"><span style="font-size:13px;font-weight:700">${p(o.name)}</span>${o.is_reserve?Fe():""}${o.is_organizer?qe():""}</div>
  ...
  </section>`}function tn(e){const t=r.capLookupResult,n=!e&&y("REGISTRATION_OPEN_MS","0")!=="1"&&y("REGISTRATION_OPEN_HS","0")!=="1";return`
  <section>
  ...
  </section>`}function xt(e,t,n){const i=S[e.level],o=r.players.filter(v=>v.team_id===e.id),a=r.payments.find(v=>v.team_id===e.id),d=le(e.id),s=Number(y("MAX_ROSTER",12)),c=y("REGISTER_EDIT_DEADLINE",""),l=!n&&(t||!c||new Date<new Date(c)),f=r.rosterLookupResult,x=it(e),{goalList:b,cardList:m}=Ni(e),w=ji(e),_=Ue(e.level).find(v=>v.id===e.id)||{y:0,r:0},T=Math.max(Number(y("DEPOSIT_AMOUNT",500))-Number(y("OPERATION_FEE",100))-_.y*Number(y("RATE_YELLOW",30))-_.r*Number(y("RATE_RED",50)),0),E=v=>e.captain_student_id===v.student_id?` <span style="color:${i.accent};font-weight:700">(หัวหน้าทีม)</span>`:e.vice_captain_student_id===v.student_id?' <span style="color:#6b7280;font-weight:700">(รองหัวหน้าทีม)</span>':"",M=v=>{if(!l)return"";const z=[];return e.captain_student_id!==v.student_id&&z.push(`<button data-act="setCaptain" data-team="${e.id}" data-student="${v.student_id}" style="border:none;background:none;color:${i.accent};font-size:10.5px;cursor:pointer;font-weight:600">ตั้งหัวหน้า</button>`),e.vice_captain_student_id!==v.student_id&&z.push(`<button data-act="setViceCaptain" data-team="${e.id}" data-student="${v.student_id}" style="border:none;background:none;color:#6b7280;font-size:10.5px;cursor:pointer;font-weight:600">ตั้งรองหัวหน้า</button>`),z.join(" · ")};return`
  <section style="display:flex;flex-direction:column;gap:14px">
    ...
    <div style="border:1px solid ${i.border};background:${i.soft};border-radius:14px;padding:14px">
      ...
      <div style="display:flex;flex-direction:column;gap:8px;margin-bottom:${l&&o.length<s?"12px":"0"}">
        ${o.length?o.map(v=>{var D,Q;const z=w.get(v.id),N=z&&z.events.length>0,I=r.expandedPlayerId===v.id,j=[];z!=null&&z.goals&&j.push(`⚽${z.goals}`),z!=null&&z.yellow&&j.push(`🟨${z.yellow}`),z!=null&&z.red&&j.push(`🟥${z.red}`);const O=q=>q.type==="goal"?"⚽":q.type==="yellow"?"🟨":"🟥";return`
          <div style="background:#fff;border-radius:10px;padding:8px">
            <div style="display:flex;align-items:center;gap:10px;${N?"cursor:pointer":""}" ${N?`data-act="togglePlayerEventDetail" data-id="${v.id}"`:""}>
              ...
              <div style="flex:1;min-width:0">
                <div style="font-size:13px;font-weight:700">${p(((D=v.students)==null?void 0:D.full_name)||"")}${E(v)}</div>
                ...
                <div style="margin-top:3px;font-size:10.5px;color:#9ca3af">📷 ${ce()?`วันที่1 ${ut(v.id,1)} · วันที่2 ${ut(v.id,2)}`:`เช็คอินเข้างาน ${ut(v.id,1)}`}</div>
              ...
              ${N?`<span style="flex-shrink:0;color:#9ca3af;font-size:10px">${I?"▲":"▼"}</span>`:""}
            </div>
            ${I&&N?`
            <div style="margin-top:8px;padding-top:8px;border-top:1px solid #f3f4f6;display:flex;flex-direction:column;gap:2px">
              ${z.events.map(q=>`<div style="font-size:11px;color:#4b5563;padding:3px 0">${O(q)} ${p(q.round||"")} vs ${p(q.opponent||"-")}${q.minute!=null?` · นาทีที่ ${q.minute}${q.isPenalty?" (จุดโทษ)":""}`:""}</div>`).join("")}
            </div>`:""}
    ...
    <div style="border:1px solid ${i.border};background:${i.soft};border-radius:14px;padding:14px">
      ...
      ${x.length?`<div style="display:flex;flex-direction:column;gap:8px">${x.map(v=>at(v)+(v.teamAId&&v.teamBId?Pi(e,v.level,v.code):"")).join("")}</div>`:'<div style="font-size:12.5px;color:#9ca3af">ยังไม่มีตารางแข่งของทีมนี้ (รอจับสลากประกบคู่)</div>'}
    </div>`:""}
      ...
      ${a?`
        ...
        ${a.status!=="rejected"?`
          <div style="margin-top:10px;padding-top:10px;border-top:1px solid #f3f4f6;font-size:12px;color:#6b7280">
            <div>หักค่าดำเนินการ ${W((d==null?void 0:d.operation_fee)??y("OPERATION_FEE",100))} บาท${(d==null?void 0:d.yellow_count)??_.y?` · ใบเหลือง ${(d==null?void 0:d.yellow_count)??_.y} ใบ (−${W((d==null?void 0:d.yellow_deduction)??_.y*Number(y("RATE_YELLOW",30)))})`:""}${(d==null?void 0:d.red_count)??_.r?` · ใบแดง ${(d==null?void 0:d.red_count)??_.r} ใบ (−${W((d==null?void 0:d.red_deduction)??_.r*Number(y("RATE_RED",50)))})`:""}</div>
  ...
  </section>`}function Hn(e){const t={pending:["รอตรวจสอบ","#f59e0b","#fef3c7"],verified:["ยืนยันแล้ว","#16a34a","#dcfce7"],rejected:["ถูกปฏิเสธ","#dc2626","#fee2e2"]},[n,i,o]=t[e]||["-","#6b7280","#f3f4f6"];return`<span style="display:inline-block;font-size:11px;font-weight:700;padding:4px 10px;border-radius:999px;background:${o};color:${i};margin-bottom:8px">${n}</span>`}function rt(e,t,n={}){return`
  <div style="position:fixed;inset:0;z-index:55;background:rgba(0,0,0,.4);display:flex;align-items:center;justify-content:center;padding:20px">
  ...
  </div>`}const jo=["หลักฐานไม่ชัดเจน อ่านยอดเงิน/เวลาโอนไม่ออก กรุณาถ่ายใหม่ให้ชัด","ยอดเงินที่โอนไม่ตรงกับค่าประกันทีม","ไฟล์ที่แนบไม่ใช่สลิปการโอนเงิน","แนบหลักฐานผิดทีม กรุณาตรวจสอบและอัปโหลดใหม่","ชื่อบัญชีผู้โอนไม่ตรงกับที่แจ้งไว้ กรุณาแนบหลักฐานเพิ่มเติม"];function Bo(){const e=r.payments.find(n=>n.id===r.rejectPaymentId),t=e?r.teams.find(n=>n.id===e.team_id):null;return rt(`ปฏิเสธการชำระเงิน${t?" · "+t.name:""}`,`
    ...
    <div style="display:flex;flex-wrap:wrap;gap:6px;margin-bottom:10px">
      ${jo.map(n=>`<button data-act="pickRejectTemplate" data-text="${p(n)}" style="font-size:11px;padding:6px 10px;border-radius:999px;border:1px solid #e5e7eb;background:#f9fafb;color:#374151;cursor:pointer;text-align:left">${p(n)}</button>`).join("")}
    </div>
  ...
  `)}function Po(){const e=r.staffScopeEdit;if(!e)return"";const t=e.scopes||[];return rt(e.mode==="add"?`มอบสิทธิ์ให้ ${e.name}`:`แก้ไขสิทธิ์ของ ${e.name}`,`
  ...
  `)}function Do(){const e=r.pendingConfirm;return e?`
  ...
  </div>`:""}function Oo(){var i;const{teamId:e}=r.refundConfirmSign,t=r.teams.find(o=>o.id===e);if(!t)return"";const n=Oe(t);return`
  ...
  </div>`}function Ho(){const{teamId:e}=r.refundConfirmDone,t=r.teams.find(i=>i.id===e),n=le(e);return!t||!n?"":`
  <div style="position:fixed;inset:0;z-index:70;background:rgba(0,0,0,.5);display:flex;align-items:center;justify-content:center;padding:20px">
  ...
  <div style="position:fixed;inset:0;z-index:55;background:rgba(0,0,0,.4);display:flex;align-items:center;justify-content:center;padding:20px">
    <div style="background:#fff;width:100%;max-width:340px;border-radius:16px;padding:18px">
      ...
      <div style="display:flex;flex-direction:column;gap:8px">
        <input id="admin-login-username" value="${p(r.adminLoginUsername)}" placeholder="Username เลขครู 4 หลัก" autocomplete="username" inputmode="numeric" style="border:1px solid #e5e7eb;border-radius:10px;padding:10px 12px;font-size:13.5px"/>
  ...
  </div>`}function qo(){const e=r.teams.find(a=>a.id===r.confirmRegTeamId);if(!e)return"";const t=S[e.level],n=r.players.filter(a=>a.team_id===e.id),i=W(y("DEPOSIT_AMOUNT",500)),o=y("PROMPTPAY_NUMBER","0825424340");return`
  ...
  </div>`}const He=[{id:"settings",icon:"⚙️",label:"ตั้งค่า",sections:[["general","ทั่วไป"],["staff","สิทธิ์"]]},{id:"roster",icon:"👥",label:"ทีม/นักกีฬา",sections:[["teams","ทีม"],["athletes","นักกีฬา"]]},{id:"finance",icon:"💰",label:"การเงิน",sections:[["payments","ชำระเงิน"],["refunds","คืนเงิน"]]},{id:"tourney",icon:"🏆",label:"แข่งขัน",sections:[["ops","เวลา/รางวัล"],["certificates","เกียรติบัตร"],["eventcheckin","เช็คอินเข้างาน"]]}];function Un(e){return He.find(t=>t.sections.some(n=>n[0]===e))||He[0]}function Vo(e){for(const t of He){const n=t.sections.find(i=>i[0]===e);if(n)return n[1]}return""}function Wo(){const e=Un(r.adminSection);return`
  <section style="display:flex;flex-direction:column;gap:12px;flex:1;min-height:0">
    <div style="display:flex;align-items:center;justify-content:space-between">
      <h2 style="margin:0;font-size:17px;font-weight:800">แอดมิน · ${Vo(r.adminSection)}</h2>
    ...
    ${r.adminSection==="general"?Go():""}
    ${r.adminSection==="staff"?Yo():""}
    ${r.adminSection==="teams"?Qo():""}
    ${r.adminSection==="athletes"?Ba():""}
    ${r.adminSection==="payments"?Pa():""}
    ${r.adminSection==="refunds"?Oa():""}
    ${r.adminSection==="certificates"?Ha():""}
    ${r.adminSection==="ops"?Ua():""}
    ${r.adminSection==="eventcheckin"?In(!0):""}
  </section>`}function ne(e){return`<div style="border:1px solid #e5e7eb;border-radius:14px;padding:14px">${e}</div>`}function dt(e){return`<div style="border:1px solid #e5e7eb;border-radius:14px;padding:14px;flex:1;min-height:0;display:flex;flex-direction:column">${e}</div>`}function Go(){var t,n,i;const e=((n=(t=r.identity.session)==null?void 0:t.user)==null?void 0:n.email)===pn;return ne(`
    ...
    <div style="margin-bottom:10px">
      ...
      <div style="display:flex;align-items:center;gap:8px">
        <img src="${p(Mt())}" alt="โลโก้โรงเรียน" style="width:56px;height:56px;object-fit:contain;border:1px solid #e5e7eb;border-radius:9px;background:#fff;padding:4px"/>
  ...
  <div style="flex-shrink:0;margin-bottom:6px">
  ...
  </div>`}function Qo(){const e=r.adminTeamLevel||"MS",t=r.teams.filter(d=>d.level===e),n=e==="MS"&&oe(),i=r.matches[e].length>=F[e].length,o=Number(y(e==="MS"?"MAX_TEAMS_MS":"MAX_TEAMS_HS","")||0),a=r.payments.filter(d=>{var s;return d.status==="verified"&&((s=r.teams.find(c=>c.id===d.team_id))==null?void 0:s.level)===e}).length;return dt(`
    ...
    ${e==="MS"&&i?`<div style="flex-shrink:0;font-size:10.5px;color:#9ca3af;margin-bottom:8px">รูปแบบสายการแข่ง: ${n?"13 ทีม (จับบาย 1 ทีมก่อน)":`${de()} ทีม`} (${F.MS.length} นัด) — ล็อกไว้แล้วเพราะสร้างตารางแข่งแล้ว</div>`:""}
    ${i?`<button data-act="randomDraw" data-level="${e}" style="flex-shrink:0;width:100%;margin-bottom:6px;padding:9px;border-radius:9px;border:1px solid #e5e7eb;background:#fff;color:#374151;font-weight:700;font-size:12.5px;cursor:pointer">สุ่มจับคู่รอบแรกใหม่ (ทันที ไม่มีแอนิเมชัน)</button>`:`<button data-act="seedMatches" data-level="${e}" style="flex-shrink:0;width:100%;margin-bottom:10px;padding:9px;border-radius:9px;border:1px dashed ${S[e].base};background:${S[e].soft};color:${S[e].accent};font-weight:700;font-size:12.5px;cursor:pointer">สร้างตารางแข่งเริ่มต้น (${F[e].length} นัด)</button>`}
    ${i?`<button data-act="openLiveDraw" data-level="${e}" style="flex-shrink:0;width:100%;margin-bottom:${Qe(e)?"6px":"10px"};padding:10px;border-radius:9px;border:none;background:linear-gradient(135deg,#4338ca,#6366f1);color:#fff;font-weight:800;font-size:12.5px;cursor:pointer">🎬 จับสลากสด รอบแรก (สำหรับไลฟ์)</button>`:""}
    ${i&&Qe(e)&&wt(e,"R3")?nn(e,"R3","รอบ 12 ทีม"):""}
    ${i&&Qe(e)&&wt(e,"R4")?nn(e,"R4","รอบ 6 ทีม"):""}
    ${i&&nt(e)?`
    ...
    <div style="flex:1;min-height:0;display:flex;flex-direction:column;gap:8px;margin-bottom:12px;overflow-y:auto">
      ${t.length?t.map(d=>Na(d)).join(""):'<div style="font-size:12.5px;color:#9ca3af">ยังไม่มีทีมในระดับนี้</div>'}
    </div>
  ...
  `)}function Fn(e,t){var d;const n=F[e].find(s=>s.code===t),i=ee(e,t),o={a:null,b:null},a=s=>Re(e,s);if(mt(e,t)&&nt(e)){const s=$t(e),c=Wt(e,t,"a"),l=Wt(e,t,"b");return o.a={pool:s.filter(f=>!c.includes(f)),value:(i==null?void 0:i.team_a_id)||""},o.b={pool:s.filter(f=>!l.includes(f)),value:(i==null?void 0:i.team_b_id)||""},o}if(mt(e,t))return o;if(n.pool){const s=Re(e,((d=tt[e])==null?void 0:d[n.pool])||[]),c=Gt(e,n.pool,t,"a"),l=Gt(e,n.pool,t,"b");return o.a={pool:s.filter(f=>!c.includes(f)),value:(i==null?void 0:i.team_a_id)||""},o.b={pool:s.filter(f=>!l.includes(f)),value:(i==null?void 0:i.team_b_id)||""},o}return n.refA?n.refA==="FIRST_ROUND_BYE"?o.a={pool:r.teams.filter(s=>s.level===e).map(s=>s.id),value:(i==null?void 0:i.team_a_id)||y(`FIRST_ROUND_BYE_${e}`,"")}:n.refA==="REC_1"||n.refA==="REC_2"?o.a={pool:a(Dt[e]||[]),value:(i==null?void 0:i.team_a_id)||""}:n.refA==="WC_1"||n.refA==="WC_2"?o.a={pool:a(Ot[e]||[]),value:(i==null?void 0:i.team_a_id)||""}:(n.refA==="LOTTERY_1"||n.refA==="LOTTERY_2")&&(o.a={pool:Le(e,gt(e,n.refA)),value:(i==null?void 0:i.team_a_id)||"",lotteryRef:n.refA}):o.a={pool:r.teams.filter(s=>s.level===e).map(s=>s.id),value:(i==null?void 0:i.team_a_id)||""},n.refB?n.refB==="FIRST_ROUND_BYE"?o.b={pool:r.teams.filter(s=>s.level===e).map(s=>s.id),value:(i==null?void 0:i.team_b_id)||y(`FIRST_ROUND_BYE_${e}`,"")}:n.refB==="REC_1"||n.refB==="REC_2"?o.b={pool:a(Dt[e]||[]),value:(i==null?void 0:i.team_b_id)||""}:n.refB==="WC_1"||n.refB==="WC_2"?o.b={pool:a(Ot[e]||[]),value:(i==null?void 0:i.team_b_id)||""}:(n.refB==="LOTTERY_1"||n.refB==="LOTTERY_2")&&(o.b={pool:Le(e,gt(e,n.refB)),value:(i==null?void 0:i.team_b_id)||"",lotteryRef:n.refB}):o.b={pool:r.teams.filter(s=>s.level===e).map(s=>s.id),value:(i==null?void 0:i.team_b_id)||""},o}function Nt(e){const t=[...e];for(let n=t.length-1;n>0;n--){const i=new Uint32Array(1);crypto.getRandomValues(i);const o=i[0]%(n+1);[t[n],t[o]]=[t[o],t[n]]}return t}function qn(e,t,n){const i=n?F[e].filter(a=>a.pool===n).map(a=>a.code):F[e].filter(a=>!a.refA&&!a.pool).map(a=>a.code),o=xn(e,n)?[{code:"BYE",side:"bye",isBye:!0}]:[];return t==="byside"?[...o,...i.map(a=>({code:a,side:"a"})),...i.map(a=>({code:a,side:"b"}))]:[...o,...i.flatMap(a=>[{code:a,side:"a"},{code:a,side:"b"}])]}function Vn(e,t){var n;return t?Re(e,((n=tt[e])==null?void 0:n[t])||[]):r.teams.filter(i=>i.level===e).map(i=>i.id)}function wt(e,t){var i;const n=((i=tt[e])==null?void 0:i[t])||[];return n.length>0&&n.every(o=>G(e,o).winnerId)}function Qe(e){return e==="HS"||e==="MS"&&de()==="16"}function Jo(e){let t=0;for(let n=0;n<e.length;n++)t=t*31+e.charCodeAt(n)>>>0;return t}function Wn(e){var i;const t=Jo(e),n=S[((i=r.liveDraw)==null?void 0:i.level)||"MS"].base;return{top:16+t%54,left:12+(t>>>8)%68,color:n}}function Xo(e){const t=Wn(e),n=p((U(e)||"?").slice(0,2));return`
  <div id="ball-${e}" style="position:absolute;top:${t.top}%;left:${t.left}%;width:52px;height:52px;border-radius:50%;background:radial-gradient(circle at 35% 30%, #fff2, ${t.color});box-shadow:0 4px 10px rgba(0,0,0,.4), inset 0 -4px 8px rgba(0,0,0,.25), inset 0 3px 6px rgba(255,255,255,.35);display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:800;color:#fff;text-shadow:0 1px 2px rgba(0,0,0,.4);flex-shrink:0">${n}</div>`}function Ko(e){return`
  <div id="live-draw-pool" style="position:relative;height:220px;margin:0 34px 12px;border-radius:50% 50% 36px 36px / 100px 100px 30px 30px;background:linear-gradient(180deg, rgba(255,255,255,.14) 0%, rgba(255,255,255,.04) 35%, rgba(255,255,255,.10) 100%), radial-gradient(ellipse at 50% 12%, rgba(255,255,255,.28), transparent 55%), rgba(99,102,241,.08);border:2px solid rgba(255,255,255,.3);box-shadow:inset 0 -26px 46px rgba(0,0,0,.4), inset 0 14px 26px rgba(255,255,255,.16), 0 14px 34px rgba(0,0,0,.45);overflow:hidden;flex-shrink:0">
    ...
    ${e.map(t=>Xo(t)).join("")}
  </div>`}function Zo(){var b;const e=r.liveDraw,t=e.level,n=S[t],i='<div style="height:4px;flex-shrink:0;background:linear-gradient(90deg,#f59e0b,#ec4899,#6366f1,#22c55e,#f59e0b);background-size:200% 100%;animation:stageBarSweep 4s linear infinite"></div>',o="radial-gradient(ellipse 900px 500px at 50% -8%, rgba(99,102,241,.28), transparent 60%), radial-gradient(ellipse 700px 420px at 50% 112%, rgba(219,39,119,.18), transparent 60%), #0b0f1a",a=e.pool?((b=F[t].find(m=>m.pool===e.pool))==null?void 0:b.round)||"":"รอบแรก";if(!e.started){const m=Vn(t,e.pool),w=e.orderStrategy||"bypair",_=qn(t,w,e.pool),T=m.length>_.length,E=_.some(z=>z.isBye),M=_.filter(z=>!z.isBye).length/2,v=e.testMode!==!1;return`
    <div style="position:fixed;inset:0;z-index:80;background:${o};color:#fff;display:flex;flex-direction:column">
      ...
      <div style="flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px;text-align:center">
        ...
        <div style="font-size:13px;color:#9ca3af;margin-bottom:${E?"6px":"16px"}">ทีมในโหล ${m.length} ทีม · ${E?"1 สิทธิ์บาย + ":""}${M} คู่ (${_.length} ฉลาก)</div>
  ...
  <div style="position:fixed;inset:0;z-index:80;background:${o};color:#fff;display:flex;flex-direction:column;overflow-y:auto">
    ...
    <div style="flex:1;padding:0 18px 18px;display:grid;grid-template-columns:repeat(auto-fill, minmax(150px,1fr));gap:10px;align-content:start">
      ...
      <div style="border:1px solid rgba(251,191,36,.55);border-radius:12px;padding:10px;background:rgba(245,158,11,.12)">
        ...
        <div style="font-size:12.5px;font-weight:700;min-height:18px;overflow-wrap:break-word">${x?p(U(x)):'<span style="color:#6b7280">จับเป็นฉลากแรก</span>'}</div>
      </div>`:""}
      ${s.map(m=>{const w=e.filled[`${m}_a`],_=e.filled[`${m}_b`],T=E=>{if(!E)return'<span style="color:#4b5563">?</span>';const M=r.teams.find(v=>v.id===E);return p((M==null?void 0:M.name)||"")+(M!=null&&M.is_organizer?' <span style="color:#a5b4fc;font-size:10px">(ผู้จัด)</span>':"")};return`
        <div style="border:1px solid rgba(255,255,255,.12);border-radius:12px;padding:10px;background:rgba(255,255,255,.04)">
          ...
          <div style="font-size:12.5px;font-weight:700;min-height:18px;overflow-wrap:break-word">${T(w)}</div>
  ...
  </div>`}async function ea(){const e=r.liveDraw;if(!e)return;const t=Vn(e.level,e.pool),n=e.orderStrategy||"bypair",i=qn(e.level,n,e.pool),o=e.testMode!==!1;r.liveDraw={level:e.level,pool:e.pool,started:!0,testMode:o,orderStrategy:n,order:Nt(t),slotSeq:i,pickIndex:0,filled:{},phase:"idle",shaken:!1},await ti(),$()}let Be=null;function ta(){if(!Be)try{Be=new(window.AudioContext||window.webkitAudioContext)}catch{return null}return Be.state==="suspended"&&Be.resume().catch(()=>{}),Be}let Se=null;function na(){if(!Se){const e="/pp5online/";Se=new Audio(`${e}sounds/azfutsal-rolling-balls.mp3`),Se.loop=!0}return Se}let Te=null;function ia(){const e=na();clearInterval(Te),e.currentTime=0,e.volume=0,e.play().catch(()=>{});let t=0;Te=setInterval(()=>{t=Math.min(1,t+.15),e.volume=t,t>=1&&clearInterval(Te)},30)}function jt(){if(!Se)return;const e=Se;clearInterval(Te);let t=e.volume;Te=setInterval(()=>{t=Math.max(0,t-.2),e.volume=t,t<=0&&(clearInterval(Te),e.pause())},25)}function oa(){const e=ta();if(!e)return;const t=e.currentTime,n=e.createOscillator();n.type="triangle",n.frequency.setValueAtTime(520,t),n.frequency.exponentialRampToValueAtTime(110,t+.13);const i=e.createGain();i.gain.setValueAtTime(.3,t),i.gain.exponentialRampToValueAtTime(.001,t+.16),n.connect(i).connect(e.destination),n.start(t),n.stop(t+.17);const o=.09,a=e.createBuffer(1,Math.ceil(e.sampleRate*o),e.sampleRate),d=a.getChannelData(0);for(let f=0;f<d.length;f++)d[f]=(Math.random()*2-1)*Math.pow(1-f/d.length,2);const s=e.createBufferSource();s.buffer=a;const c=e.createBiquadFilter();c.type="highpass",c.frequency.value=2200;const l=e.createGain();l.gain.setValueAtTime(.22,t),l.gain.exponentialRampToValueAtTime(.001,t+o),s.connect(c).connect(l).connect(e.destination),s.start(t),s.stop(t+o+.01)}let Je=null;function We(){Je&&(clearInterval(Je),Je=null)}function on(){const e=document.getElementById("live-draw-pool");if(!e){We();return}Array.from(e.querySelectorAll('div[id^="ball-"]')).forEach(t=>{t.style.top=14+Math.random()*58+"%",t.style.left=10+Math.random()*72+"%"})}function aa(){const e=r.liveDraw;if(!e||!e.started||e.shaken)return;e.shaken=!0,$();const t=document.getElementById("live-draw-pool");t&&Array.from(t.querySelectorAll('div[id^="ball-"]')).forEach(n=>{n.style.transition="top .22s cubic-bezier(.4,0,.2,1), left .22s cubic-bezier(.4,0,.2,1)"}),We(),ia(),on(),Je=setInterval(on,250)}async function ra(){const e=r.liveDraw;if(!e||!e.started||e.phase==="spinning"||!e.shaken||e.pickIndex>=e.slotSeq.length)return;if(e.pickIndex>=e.order.length){g("ทีมในโหลหมดแล้ว ช่องที่เหลือเป็นบาย");return}const t=e.order[e.pickIndex],n=e.slotSeq[e.pickIndex];e.phase="spinning",We(),jt(),$();const i=T=>new Promise(E=>setTimeout(E,T)),o=document.getElementById("live-draw-pool");o&&(o.style.filter="brightness(1.15)");const a=document.getElementById(`ball-${t}`);if(a){a.style.transition="transform .1s ease, box-shadow .2s",a.style.boxShadow="0 0 0 6px rgba(255,255,255,.85), 0 0 26px 8px rgba(255,255,255,.55), 0 6px 16px rgba(0,0,0,.5)";for(const[T,E]of[[4,-3],[-5,3],[4,4],[-4,-4],[3,-2],[0,0]])a.style.transform=`translate(${T}px, ${E}px)`,await i(65)}const d=a?a.getBoundingClientRect():null,s=Wn(t),c=n.isBye?"⭐ สิทธิ์เข้ารอบบาย":`${n.code} · ทีม ${n.side.toUpperCase()}`,l=document.getElementById("live-draw-center");if(l){if(l.innerHTML=`
      ...
      </div>`,d){const T=d.left+d.width/2-window.innerWidth/2,E=d.top+d.height/2-window.innerHeight/2;l.style.transition="none",l.style.transform=`translate(calc(-50% + ${T}px), calc(-50% + ${E}px)) scale(.15)`,l.style.opacity="1",l.offsetWidth}l.style.transition="transform .6s cubic-bezier(.34,1.56,.64,1), opacity .3s",l.style.transform="translate(-50%,-50%) scale(1)",l.style.opacity="1"}await i(600);const f=document.getElementById("live-draw-reveal-name");f&&(f.textContent=U(t));const x=document.getElementById("capsule-half-l"),b=document.getElementById("capsule-half-r"),m=document.getElementById("capsule-paper");if(x&&(x.style.transform="translateX(-115px)"),b&&(b.style.transform="translateX(115px)"),m&&(m.style.opacity="1",m.style.transform="scale(1)"),oa(),ni("high"),e.filled[`${n.code}_${n.side}`]=t,e.pickIndex++,await i(2200),a&&(a.style.boxShadow="",a.style.transform=""),l&&(l.style.transform="translate(-50%,-50%) scale(0)",l.style.opacity="0"),o&&(o.style.filter=""),await i(350),e.phase="idle",e.shaken=!1,n.isBye){if(!e.testMode){const T=`FIRST_ROUND_BYE_${e.level}`,[{error:E},{error:M}]=await Promise.all([h.from("azfutsal_config").upsert({key:T,value:t}),h.from("azfutsal_matches").update({team_b_id:null}).eq("level",e.level).in("match_code",oe()?["M17","M19"]:["M12","M13"])]);if(E||M){g("บันทึกทีมบายไม่สำเร็จ: "+((E==null?void 0:E.message)||(M==null?void 0:M.message))),$();return}r.config[T]=t,r.matches[e.level].forEach(v=>{(oe()?["M17","M19"]:["M12","M13"]).includes(v.match_code)&&(v.team_b_id=null)}),g(`ทีม ${U(t)} ได้สิทธิ์เข้ารอบบาย`)}$();return}const w=e.filled[`${n.code}_a`],_=e.filled[`${n.code}_b`];if(w&&_&&!e.testMode){const T=(F[e.level].find(E=>E.code===n.code)||{}).round||"";await h.from("azfutsal_matches").upsert({level:e.level,match_code:n.code,round:T,team_a_id:w,team_b_id:_},{onConflict:"level,match_code"}),await L()}else $()}function ze(e,t,n,i,o,a,d,s){const c=r.matchEvents.filter(l=>l.level===e&&l.match_code===t&&l.team_id===n&&l.event_type===o);return`
  <div>
    ...
    </button>`}).join(""):'<div style="font-size:11.5px;color:#9ca3af;padding:6px 0">ไม่พบผู้เล่น</div>')}function sa(){if(!r.eventPicker)return"";const{team:e,type:t}=r.eventPicker,{level:n,code:i}=r.editMatch,o=G(n,i);if(!(e==="a"?o.teamAId:o.teamBId))return"";const d={goal:"ผู้ทำประตู",yellow:"ใบเหลือง",red:"ใบแดง"}[t];return`
  <div data-event-picker-backdrop style="position:fixed;inset:0;z-index:70;background:rgba(15,23,42,.68);display:flex;align-items:center;justify-content:center;padding:20px;backdrop-filter:blur(3px)">
    ...
    <div style="display:flex;flex-direction:column;gap:10px">
      ...
      <div style="display:flex;flex-direction:column;align-items:center;gap:10px;background:#111827;border-radius:12px;padding:12px">
        ${n.clock_status&&n.clock_status!=="not_started"?St(n,{countdown:!0}):'<span style="font-size:11.5px;color:#9ca3af;font-weight:700">ยังไม่เริ่มจับเวลา</span>'}
        ${ki(e,t,n)}
      </div>`:""}
      ...
      <div style="display:flex;flex-direction:column;gap:10px;border-top:1px solid #f3f4f6;padding-top:10px">
        <div style="display:flex;gap:10px">
          <div style="flex:1">${ze(e,t,o.teamAId,"a","goal",`⚽ ประตู (${p(o.teamA)})`,"#16a34a","#dcfce7")}</div>
          <div style="flex:1">${ze(e,t,o.teamBId,"b","goal",`⚽ ประตู (${p(o.teamB)})`,"#16a34a","#dcfce7")}</div>
        </div>
        <div style="display:flex;gap:10px">
          <div style="flex:1">${ze(e,t,o.teamAId,"a","yellow","เหลือง A","#b45309","#FEF9C3")}</div>
          <div style="flex:1">${ze(e,t,o.teamBId,"b","yellow","เหลือง B","#b45309","#FEF9C3")}</div>
        </div>
        <div style="display:flex;gap:10px">
          <div style="flex:1">${ze(e,t,o.teamAId,"a","red","แดง A","#dc2626","#FEE2E2")}</div>
          <div style="flex:1">${ze(e,t,o.teamBId,"b","red","แดง B","#dc2626","#FEE2E2")}</div>
        </div>
      </div>`}
      <div style="display:flex;gap:10px">
      ...
      ${o.teamAId&&o.teamBId&&(r.identity.isAdmin||(r.identity.scopes||[]).includes("checkin"))?(()=>{const m=r.checkins.filter(_=>_.level===e&&_.match_code===t).length,w=r.players.filter(_=>_.team_id===o.teamAId||_.team_id===o.teamBId).length;return`<button data-act="openCheckinScanner" data-level="${e}" data-code="${t}" style="padding:9px;border:none;border-radius:10px;background:linear-gradient(135deg,#0ea5e9,#6366f1);color:#fff;font-weight:700;font-size:12.5px;cursor:pointer">📷 สแกน QR รายงานตัว (${m}/${w})</button>
    ...
    </div>`,{bodyAttr:"data-match-editor-body"})}function ca(){const{level:e,pool:t}=r.manualPoolAssign,n=t==="SF",i=n?["M22","M23"]:F[e].filter(d=>d.pool===t).map(d=>d.code),o=n?"รองฯ":(F[e].find(d=>d.pool===t)||{}).round||"",a=n?$t(e):[];return rt(`กรอกเอง (Manual) · ${p(o)} · ${S[e].label}`,`
    <div style="display:flex;flex-direction:column;gap:10px">
      ...
      ${i.map(d=>{const s=ee(e,d),c=n?{a:{pool:a,value:(s==null?void 0:s.team_a_id)||""},b:{pool:a,value:(s==null?void 0:s.team_b_id)||""}}:Fn(e,d),l=f=>`<option value="">- เลือกทีม -</option>${f.pool.map(x=>`<option value="${x}" ${String(f.value)===String(x)?"selected":""}>${p(U(x))}</option>`).join("")}`;return`
    ...
    </div>`}).join(""):'<div style="font-size:12px;color:#9ca3af">ยังไม่มีผู้ดูแลระบบ</div>'}async function ua(e){if(!e||e.trim().length<2)return[];const t=`%${e.trim()}%`,[{data:n},{data:i}]=await Promise.all([h.from("teachers").select("profile_id, full_name, teacher_code").or(`full_name.ilike.${t},teacher_code.ilike.${t}`).not("profile_id","is",null).limit(8),h.from("students").select("profile_id, full_name, student_code").or(`full_name.ilike.${t},student_code.ilike.${t}`).not("profile_id","is",null).limit(8)]);return[...(n||[]).map(o=>({profile_id:o.profile_id,name:o.full_name,sub:`ครู · ${o.teacher_code||""}`})),...(i||[]).map(o=>({profile_id:o.profile_id,name:o.full_name,sub:`นักเรียน · ${o.student_code||""}`}))]}const Pe=e=>e===""||e===null||e===void 0||isNaN(Number(e))?null:Number(e),R=e=>document.getElementById(e);function xa(e,t){var _,T,E;const n=G(e,t),i=R("mx-teamA"),o=R("mx-teamB"),a=i?i.value||null:n.teamAId,d=o?o.value||null:n.teamBId,s=Pe(R("mx-scoreA").value),c=Pe(R("mx-scoreB").value),l=!!((_=r.editMatch)!=null&&_.penaltyMode),f=l?Pe((T=R("mx-penaltyScoreA"))==null?void 0:T.value):null,x=l?Pe((E=R("mx-penaltyScoreB"))==null?void 0:E.value):null;if(mt(e,t)&&(i||o)){if(!nt(e)){g("เปลี่ยนคู่ไม่ได้ เพราะ M22 หรือ M23 เริ่มแข่งขันหรือมีข้อมูลรายงานตัวแล้ว");return}const M=$t(e);if(a&&!M.includes(a)||d&&!M.includes(d)){g("เลือกได้เฉพาะทีมจาก M19–M21 เท่านั้น");return}const v=[];for(const N of["M22","M23"]){const I=ee(e,N),j=N===t?a:I==null?void 0:I.team_a_id,O=N===t?d:I==null?void 0:I.team_b_id;j&&v.push(j),O&&v.push(O)}if(new Set(v).size!==v.length){g("ทีมเดิมถูกเลือกซ้ำใน M22–M23");return}const z=Le(e,Ae);if(v.filter(N=>z.includes(N)).length>1){g("เลือกผู้แพ้คืนสิทธิ์ได้เพียง 1 ทีม");return}}if(s!==null&&s<0||c!==null&&c<0){g("สกอร์ต้องไม่ติดลบ");return}if(s===null!=(c===null)){g("กรุณากรอกสกอร์เวลาปกติให้ครบทั้งสองทีม");return}if(l){if(!a||!d){g("กรุณาระบุทีมทั้งสองฝั่งก่อนบันทึกผลจุดโทษ");return}if(s===null||c===null){g("กรุณากรอกสกอร์เวลาปกติก่อนบันทึกผลจุดโทษ");return}if(s!==c){g("โหมดจุดโทษใช้ได้เมื่อสกอร์เวลาปกติเสมอกันเท่านั้น");return}if(f===null||x===null){g("กรุณากรอกผลการดวลจุดโทษให้ครบทั้งสองทีม");return}if(f<0||x<0){g("ผลการดวลจุดโทษต้องไม่ติดลบ");return}if(f===x){g("ผลการดวลจุดโทษต้องมีผู้ชนะ ห้ามเสมอ");return}}else if(s!==null&&c!==null&&s===c){g("สกอร์เสมอ กรุณาเปิดโหมดตัดสินด้วยการยิงจุดโทษ");return}if(s!==null&&c!==null&&a&&d&&y("REQUIRE_EVENTS_BEFORE_SCORE","0")==="1"){const M=Ke(e,t,a).goal,v=Ke(e,t,d).goal;if(M!==s||v!==c){g(`ผู้ทำประตูที่บันทึกไว้ (${M}-${v}) ไม่ตรงกับสกอร์ (${s}-${c}) กรุณาระบุผู้ทำประตูให้ครบก่อนบันทึก`);return}}const b={level:e,match_code:t,round:(F[e].find(M=>M.code===t)||{}).round||"",score_a:s,score_b:c,is_penalty_shootout:l,penalty_score_a:f,penalty_score_b:x,winner_team_id:null,loser_team_id:null,ready_time:R("mx-ready").value||null,kickoff_time:R("mx-kickoff").value||null,updated_at:new Date().toISOString()};if(i&&(b.team_a_id=i.value||null),o&&(b.team_b_id=o.value||null),s!==null&&c!==null&&a&&d){const M=l?f>x:s>c;b.winner_team_id=M?a:d,b.loser_team_id=M?d:a}const m=ee(e,t);m?Object.assign(m,b):r.matches[e].push(b);let w=xe().filter(M=>!(M.type==="saveMatch"&&M.payload.level===e&&M.payload.match_code===t));w.push({localId:Ie(),type:"saveMatch",payload:b}),he(w),r.editMatch=null,$(),ge(),g("บันทึกผลการแข่งขันแล้ว")}function ga(e){var b;if(!r.editMatch||!r.eventPicker)return;const{level:t,code:n}=r.editMatch,{team:i,type:o}=r.eventPicker,a=G(t,n),d=i==="a"?a.teamAId:a.teamBId;if(!d)return;const s=Pe((b=R("event-picker-minute"))==null?void 0:b.value);if(s!==null&&s<1){g("นาทีต้องเริ่มตั้งแต่ 1");return}const c=s??$i(ee(t,n)),l=Ie(),f={level:t,match_code:n,team_id:d,player_id:e,event_type:o,minute:c,is_penalty:!1};r.matchEvents.push({id:l,...f,created_at:new Date().toISOString()});const x=xe();x.push({localId:l,type:"insertEvent",localEventId:l,payload:f}),he(x),r.eventPicker=null,r.eventPickerFilter="",$(),requestAnimationFrame(()=>{var w;const m=ie==null?void 0:ie.querySelector("[data-match-editor-body]");m&&Number.isFinite((w=r.editMatch)==null?void 0:w.scrollTop)&&(m.scrollTop=r.editMatch.scrollTop)}),ge(),g("บันทึกเหตุการณ์แล้ว")}function ma(e){const t=r.matchEvents.findIndex(i=>i.id===e);t!==-1&&r.matchEvents.splice(t,1);let n=xe();String(e).startsWith("local_")?n=n.filter(i=>i.localEventId!==e):n.push({localId:Ie(),type:"deleteEvent",payload:{id:e}}),he(n),$(),ge()}async function ba(e,t){const n=r.players.find(i=>i.id===e);if(n){g("กำลังอัปโหลดรูป...");try{const i=await ei(n.team_id,e,t),{error:o}=await h.from("azfutsal_players").update({photo_url:i}).eq("id",e);if(o){g("บันทึกรูปไม่สำเร็จ: "+o.message);return}await L(),g("อัปโหลดรูปสำเร็จ")}catch(i){g("อัปโหลดรูปไม่สำเร็จ: "+Ze(i))}}}async function ya(e){const t=new Set(r.matches[e].map(o=>o.match_code)),n=F[e].filter(o=>!t.has(o.code)).map((o,a)=>({level:e,match_code:o.code,round:o.round,order_no:a+1}));if(!n.length)return;const{error:i}=await h.from("azfutsal_matches").insert(n);if(i){g("สร้างตารางไม่สำเร็จ: "+i.message);return}await L(),g("สร้างตารางแข่งเริ่มต้นแล้ว")}async function va(e){const t=r.teams.filter(f=>f.level===e).map(f=>f.id),n=F[e].filter(f=>!f.refA&&!f.pool).map(f=>f.code),i=n.length*2,o=xn(e),a=i+(o?1:0);if(t.length<i){g(`ต้องมีทีมอย่างน้อย ${i} ทีมสำหรับรอบแรก`);return}if(t.length>a){g(`รอบแรกมี ${i} ช่อง รองรับทีมบายเพิ่มได้สูงสุด 1 ทีม`);return}const d=Nt(t),s=o?d.shift():null,c=n.map((f,x)=>({level:e,match_code:f,round:"รอบแรก",team_a_id:d[x*2],team_b_id:d[x*2+1]}));if(s){const f=`FIRST_ROUND_BYE_${e}`,{error:x}=await h.from("azfutsal_config").upsert({key:f,value:s});if(x){g("บันทึกทีมบายไม่สำเร็จ: "+x.message);return}const{error:b}=await h.from("azfutsal_matches").update({team_b_id:null}).eq("level",e).in("match_code",oe()?["M17","M19"]:["M12","M13"]);if(b){g("เตรียมช่องทีมบายไม่สำเร็จ: "+b.message);return}}const{error:l}=await h.from("azfutsal_matches").upsert(c,{onConflict:"level,match_code"});if(l){g("สุ่มจับคู่ไม่สำเร็จ: "+l.message);return}await L(),g(s?`ทีม ${U(s)} ได้บาย · สุ่มประกบคู่ 12 ทีมที่เหลือแล้ว`:"สุ่มจับคู่รอบแรกแล้ว")}async function ha(e,t,n){const i=F[e].find(x=>x.code===t),o=n==="a"?i==null?void 0:i.refA:i==null?void 0:i.refB;if(o!=="LOTTERY_1"&&o!=="LOTTERY_2")return;const a=gt(e,o);if(!a.length||!a.every(x=>G(e,x).loserId)){g("ต้องบันทึกผลการแข่งขันต้นทางให้ครบก่อนจับฉลาก");return}const d=Le(e,a);if(!d.length){g("ไม่พบทีมสำหรับจับฉลาก");return}const s=Nt(d)[0],c=n==="a"?"team_a_id":"team_b_id",{error:l}=await h.from("azfutsal_matches").update({[c]:s}).eq("level",e).eq("match_code",t);if(l){g("บันทึกผลจับฉลากไม่สำเร็จ: "+l.message);return}const f=ee(e,t);f&&(f[c]=s),$(),g(`จับฉลากได้ทีม ${U(s)}`)}async function wa(e,t){var l;if(!wt(e,t)){g("รอบก่อนหน้ายังแข่งไม่ครบ จับคู่รอบนี้ไม่ได้");return}const n=Re(e,((l=tt[e])==null?void 0:l[t])||[]),i=Ue(e).map(f=>f.id).filter(f=>n.includes(f));n.forEach(f=>{i.includes(f)||i.push(f)});const o=F[e].filter(f=>f.pool===t).map(f=>f.code),a=i.length,d=(F[e].find(f=>f.pool===t)||{}).round||"",s=o.map((f,x)=>({level:e,match_code:f,round:d,team_a_id:i[x],team_b_id:i[a-1-x]})),{error:c}=await h.from("azfutsal_matches").upsert(s,{onConflict:"level,match_code"});if(c){g("จัดคู่อัตโนมัติไม่สำเร็จ: "+c.message);return}await L(),g("จัดคู่ตามอันดับแล้ว (อันดับดี พบ อันดับรอง)")}async function _a(){const{level:e,pool:t}=r.manualPoolAssign,n=t==="SF",i=n?["M22","M23"]:F[e].filter(c=>c.pool===t).map(c=>c.code),o=n?"รองฯ":(F[e].find(c=>c.pool===t)||{}).round||"",a=[],d=new Set;for(const c of i){const l=R(`mp-${c}-a`).value||null,f=R(`mp-${c}-b`).value||null;if(!l||!f){g(`กรุณาเลือกทีมให้ครบทุกคู่ (ขาด ${c})`);return}if(l===f||d.has(l)||d.has(f)){g("มีทีมถูกเลือกซ้ำกันมากกว่า 1 คู่ กรุณาตรวจสอบ");return}d.add(l),d.add(f),a.push({level:e,match_code:c,round:o,team_a_id:l,team_b_id:f})}if(n){if(!nt(e)){g("เปลี่ยนคู่ไม่ได้ เพราะ M22 หรือ M23 เริ่มแข่งขันหรือมีข้อมูลรายงานตัวแล้ว");return}const c=Re(e,Ae),l=Le(e,Ae);if(!c.every(f=>d.has(f))||[...d].filter(f=>l.includes(f)).length!==1){g("ต้องเลือกผู้ชนะ M19–M21 ครบ 3 ทีม และผู้แพ้กลับเข้ารอบอีก 1 ทีม");return}}const{error:s}=await h.from("azfutsal_matches").upsert(a,{onConflict:"level,match_code"});if(s){g("บันทึกไม่สำเร็จ: "+s.message);return}r.manualPoolAssign=null,await L(),g("บันทึกการจับคู่แล้ว")}async function $a(e){var d;if(r.teamCreating)return;const t=R("new-team-name").value.trim(),n=R("new-team-level").value;if(!t){g("กรุณากรอกชื่อทีม");return}if(!e&&y(`REGISTRATION_OPEN_${n}`,"0")!=="1"){g(`ขณะนี้ปิดรับสมัครทีม${S[n].label}แล้ว`);return}let i;if(e){const s=r.capLookupResult;if(!s||typeof s!="object"){g("กรุณาค้นหาและเลือกหัวหน้าทีมก่อน");return}i=s.id}else i=r.identity.student.id;if(r.teamCreating=!0,$(),!e&&n==="HS"){const{count:s}=await h.from("azfutsal_teams").select("id",{count:"exact",head:!0}).eq("level","HS").eq("is_organizer",!1),c=Number(y("MAX_TEAMS_HS","14")||14);if((s||0)>=c){r.teamCreating=!1,g("ทีม ม.ปลาย เต็มโควตาแล้ว"),$();return}}const{data:o,error:a}=await h.from("azfutsal_teams").insert({name:t,level:n,captain_student_id:i}).select("id").single();if(r.teamCreating=!1,a){const s=a.code==="23505"?"นักเรียนคนนี้เป็นหัวหน้าทีมอยู่แล้ว สร้างทีมซ้ำไม่ได้":(d=a.message)!=null&&d.includes("HS_TEAM_QUOTA_FULL")?"ทีม ม.ปลาย เต็มโควตาแล้ว":"สร้างทีมไม่สำเร็จ: "+a.message;g(s),$();return}if(n==="HS"){const{count:s}=await h.from("azfutsal_teams").select("id",{count:"exact",head:!0}).eq("level","HS").eq("is_organizer",!1),c=Number(y("MAX_TEAMS_HS","14")||14);(s||0)>=c&&y("REGISTRATION_OPEN_HS","0")==="1"&&await h.from("azfutsal_config").upsert({key:"REGISTRATION_OPEN_HS",value:"0"})}r.newTeamName="",r.capLookupCode="",r.capLookupResult=null,e&&(r.adminCreatingTeam=!1,r.adminManageTeamId=o.id),await L(),g("สร้างทีมแล้ว เพิ่มรายชื่อนักกีฬาต่อได้เลย")}async function an(e){if(!e||e.trim().length<2)return[];const t=`%${e.trim()}%`,{data:n}=await h.from("students").select("id, full_name, student_code, image_url, photo_url").or(`full_name.ilike.${t},student_code.ilike.${t}`).limit(8);return n||[]}async function za(){const e=R("admin-login-username").value.trim(),t=R("admin-login-password").value;if(!e||!t){r.adminLoginError="กรอกยูสเซอร์เนมและรหัสผ่าน",$();return}let n=null;if(e===y("ADMIN_LOGIN_USERNAME","aaaaaa"))n=pn;else{const{data:o,error:a}=await h.rpc("resolve_sports_competition_login_email",{p_identifier:e});if(a){r.adminLoginError=a.message,$();return}n=o}if(!n){r.adminLoginError="ไม่พบบัญชีผู้รับผิดชอบที่พร้อมใช้งาน",$();return}const{error:i}=await h.auth.signInWithPassword({email:n,password:t});if(i){r.adminLoginError="ยูสเซอร์เนมหรือรหัสผ่านไม่ถูกต้อง",$();return}r.adminLoginOpen=!1,await L(),r.tab=r.identity.isAdmin?"admin":(r.identity.scopes||[]).length?"staff":"schedule",$(),g("เข้าสู่ระบบแล้ว")}async function rn(e,t,n){const i=n==="captain"?"captain_student_id":"vice_captain_student_id",{error:o}=await h.from("azfutsal_teams").update({[i]:t}).eq("id",e);if(o){g("บันทึกไม่สำเร็จ: "+o.message);return}await L(),g(n==="captain"?"ตั้งหัวหน้าทีมแล้ว":"ตั้งรองหัวหน้าทีมแล้ว")}async function ka(e){var o;const t=r.rosterLookupResult;if(!t||typeof t!="object")return;const n=(o=R("roster-jersey"))==null?void 0:o.value,{error:i}=await h.from("azfutsal_players").insert({team_id:e,student_id:t.id,jersey_number:n?Number(n):null});if(i){g("เพิ่มนักกีฬาไม่สำเร็จ: "+i.message);return}r.rosterLookupCode="",r.rosterLookupResult=null,r.rosterJersey="",await L(),g("เพิ่มนักกีฬาแล้ว")}async function Sa(e,t){var c,l;if(r.paymentUploading)return;const n=(l=(c=R("pay-slip-file"))==null?void 0:c.files)==null?void 0:l[0];if(!n){g("กรุณาเลือกไฟล์รูปภาพ");return}r.paymentUploading=!0,$();const i=`${e}/${t}_${Date.now()}_${n.name}`,{error:o}=await h.storage.from("azfutsal-payments").upload(i,n,{upsert:!0});if(o){g("อัปโหลดไม่สำเร็จ: "+o.message),r.paymentUploading=!1,$();return}const a=r.payments.find(f=>f.team_id===e),d={team_id:e,method:t,amount:Number(y("DEPOSIT_AMOUNT",500)),status:"pending",admin_note:null,slip_url:t==="transfer"?i:null,receipt_photo_url:t==="cash"?i:null,receipt_no:t==="cash"?(a==null?void 0:a.receipt_no)||`RCP-${Date.now()}`:null},{error:s}=await h.from("azfutsal_payments").upsert(d,{onConflict:"team_id"});if(r.paymentUploading=!1,s){g("บันทึกไม่สำเร็จ: "+s.message),$();return}r.confirmRegOpen=!1,r.confirmRegQR=null,await L(),g("ยืนยันการลงทะเบียนสำเร็จ ส่งหลักฐานแล้ว")}async function Ea(e){r.confirmRegTeamId=e,r.confirmRegOpen=!0,r.confirmRegQR=null,$();try{r.confirmRegQR=await Zn(y("PROMPTPAY_NUMBER","0825424340"),Number(y("DEPOSIT_AMOUNT",500)))}catch{r.confirmRegQR=null}$()}function Ma(e){const t=e==="MS"?"MS":"HS",n=Math.random().toString(36).slice(2,6).toUpperCase();return`${t}-${n}`}async function Ta(){const e=r.rejectPaymentId,t=r.rejectReasonText.trim();if(!e||!t)return;const{error:n}=await h.from("azfutsal_payments").update({status:"rejected",admin_note:t,reviewed_by:r.identity.profile.id,reviewed_at:new Date().toISOString()}).eq("id",e);if(n){g("บันทึกไม่สำเร็จ: "+n.message);return}r.rejectPaymentId=null,r.rejectReasonText="",await L(),g("ปฏิเสธการชำระเงินแล้ว")}async function Aa(e,t){const{error:n}=await h.from("azfutsal_payments").update({status:t,admin_note:null,reviewed_by:r.identity.profile.id,reviewed_at:new Date().toISOString()}).eq("id",e);if(n){g("บันทึกไม่สำเร็จ: "+n.message);return}if(t==="verified"){const i=r.payments.find(a=>a.id===e),o=i?r.teams.find(a=>a.id===i.team_id):null;if(o){const a={};o.team_code||(a.team_code=Ma(o.level));const d=Number(y(o.level==="MS"?"MAX_TEAMS_MS":"MAX_TEAMS_HS","")||0);if(d>0&&!o.is_organizer){const s=r.payments.filter(c=>{var l,f;return c.status==="verified"&&c.team_id!==o.id&&((l=r.teams.find(x=>x.id===c.team_id))==null?void 0:l.level)===o.level&&!((f=r.teams.find(x=>x.id===c.team_id))!=null&&f.is_organizer)}).length;a.is_reserve=s>=d}Object.keys(a).length&&await h.from("azfutsal_teams").update(a).eq("id",o.id)}}await L(),g("ยืนยันการชำระเงินแล้ว")}async function Ra(e,t={}){var c;const{data:n}=await h.from("azfutsal_refunds").select("id").eq("team_id",e).maybeSingle();if(n)return g("ทีมนี้ถูกยืนยันคืนเงินไปแล้ว (อาจมีคนอื่นยืนยันไปก่อนหน้านี้) กำลังรีเฟรชข้อมูล..."),await L(),"already";const i=r.teams.find(l=>l.id===e),o=r.payments.find(l=>l.team_id===e&&l.status==="verified");if(!i||!o)return g("ยืนยันไม่ได้: ไม่พบการชำระค่าประกันที่ผ่านการตรวจสอบ"),"error";const a={team_id:i.id,payment_id:o.id,...Oe(i),recipient_signature_url:t.recipientSignatureUrl||null,payment_method:t.paymentMethod||null,proof_url:t.proofUrl||null,confirmed_by:(c=r.identity.profile)==null?void 0:c.id,confirmed_at:new Date().toISOString()},{data:d,error:s}=await h.from("azfutsal_refunds").insert(a).select("id, team_id, receipt_no, deposit_amount, operation_fee, yellow_count, yellow_rate, yellow_deduction, red_count, red_rate, red_deduction, refund_amount, deduction_snapshot, logo_url, recipient_signature_url, payment_method, proof_url, confirmed_at, created_at").single();return s?s.code==="23505"||/duplicate key/i.test(s.message)?(g("ทีมนี้ถูกยืนยันคืนเงินไปแล้วโดยผู้อื่นพอดี กำลังรีเฟรชข้อมูล..."),await L(),"already"):(g("ยืนยันคืนเงินไม่สำเร็จ: "+s.message),"error"):(r.refunds=[d,...r.refunds.filter(l=>l.team_id!==e)],g(`ยืนยันคืนเงินทีม ${i.name} แล้ว`),L(),"success")}async function La(e){r.viewProofOpen=!0,r.viewProofUrl=null,$();const{data:t,error:n}=await h.storage.from("azfutsal-payments").createSignedUrl(e,300);if(n||!t){g("เปิดไฟล์ไม่สำเร็จ"),r.viewProofOpen=!1,$();return}r.viewProofUrl=t.signedUrl,$()}function Ia(){ie.addEventListener("click",async e=>{var i,o,a,d,s,c,l,f,x,b,m,w,_,T,E,M,v,z,N,I,j,O,D,Q,q,J;const t=e.target.closest("[data-act]");if(!t)return;const n=t.dataset.act;if(n==="toggleTheme"){r.theme=r.theme==="dark"?"light":"dark",localStorage.setItem("az_theme",r.theme),$();return}if(n==="tab"){r.tab=t.dataset.tab,$();return}if(n==="setScheduleMode"){r.scheduleMode=t.dataset.v==="bracket"?"bracket":"timeline",$();return}if(n==="setScheduleDay"){r.scheduleDay=t.dataset.v==="2"?2:1,$();return}if(n==="jumpToCurrentMatch"){if(!Ct()){g("ไม่มีคู่ที่กำลังแข่งขันอยู่ตอนนี้");return}(i=document.getElementById("az-current-match"))==null||i.scrollIntoView({behavior:"smooth",block:"start"});return}if(n==="setBracketLevel"){r.bracketLevel=t.dataset.v==="HS"?"HS":"MS",$();return}if(n==="jumpBracketRound"){const u=document.getElementById("az-bracket-scroll"),k=document.getElementById(`az-bracket-round-${t.dataset.v}`);u&&k&&u.scrollTo({left:k.offsetLeft-2,behavior:"smooth"});return}if(n==="setLevel"){r.filterLevel=t.dataset.v,$();return}if(n==="setStats"){r.statsLevel=t.dataset.v,$();return}if(n==="setTeamStatusLevel"){r.teamStatusLevel=t.dataset.v,$();return}if(n==="toggleTeamRoster"){r.teamStatusExpanded=r.teamStatusExpanded===t.dataset.id?null:t.dataset.id,$();return}if(n==="adminSec"){r.adminSection=t.dataset.v,$();return}if(n==="adminGroup"){const u=He.find(k=>k.id===t.dataset.v);u&&(r.adminSection=u.sections[0][0]),$();return}if(n==="myTeamTab"){r.myTeamTab=t.dataset.v,$();return}if(n==="adminTeamLevel"){r.adminTeamLevel=t.dataset.v,$();return}if(n==="adminAthleteLevel"){r.adminAthleteLevel=t.dataset.v,$();return}if(n==="showPlayerQR"){const u=r.players.find(k=>k.id===t.dataset.id);u&&Ki(u);return}if(n==="downloadAthletesExcel"){ja(t.dataset.level);return}if(n==="printAttendanceForm"){Kt();return}if(n==="downloadAttendanceForm"){Zt();return}if(n==="printAttendanceSystemNames"){Kt(!0);return}if(n==="downloadAttendanceSystemNames"){Zt(!0);return}if(n==="adminPaymentsLevel"){r.adminPaymentsLevel=t.dataset.v,$();return}if(n==="adminRefundLevel"){r.adminRefundLevel=t.dataset.v,$();return}if(n==="openRefundReceipt"){Xt(t.dataset.team);return}if(n==="openRefundReceiptPreview"){Ci(t.dataset.team);return}if(n==="confirmRefund"){const u=r.teams.find(k=>k.id===t.dataset.team);if(!u)return;r.refundConfirmSign={teamId:u.id},$();return}if(n==="refreshRefunds"){await L(),g("รีเฟรชข้อมูลแล้ว");return}if(n==="openRefundPayerSettings"){r.refundPayerSettingsOpen=!0,$();return}if(n==="closeRefundPayerSettings"){r.refundPayerSettingsOpen=!1,$();return}if(n==="clearRecipientSignature"){const u=R("refund-recipient-sigpad");u&&u.getContext("2d").clearRect(0,0,u.width,u.height);return}if(n==="cancelRefundSign"){r.refundConfirmSign=null,$();return}if(n==="confirmRefundWithSignature"){const u=t.dataset.team,k=R("refund-confirm-modal"),A=k==null?void 0:k.dataset.method;if(!A){g("กรุณาเลือกวิธีคืนเงิน (โอน/เงินสด)");return}let C=null;if(A==="transfer"){const V=(a=(o=R("refund-proof-file-transfer"))==null?void 0:o.files)==null?void 0:a[0];if(!V){g("กรุณาอัปโหลดสลิปการโอน");return}const X=await Pt(V,{maxWidth:1200,quality:.85}),Y=`refund-proof/${u}_${Date.now()}.jpg`,{error:te}=await h.storage.from("azfutsal-payments").upload(Y,X,{upsert:!0,contentType:"image/jpeg"});if(te){g("อัปโหลดสลิปไม่สำเร็จ: "+te.message);return}C=Y}const B=R("refund-recipient-sigpad");let H=null;if(B){const V=await new Promise(X=>B.toBlob(X,"image/png"));if(V){const X=`refund-recipient-signature_${u}_${Date.now()}.png`,{error:Y}=await h.storage.from("azfutsal-assets").upload(X,V,{upsert:!0,contentType:"image/png"});if(!Y){const{data:te}=h.storage.from("azfutsal-assets").getPublicUrl(X);H=te.publicUrl}}}const P=await Ra(u,{recipientSignatureUrl:H,paymentMethod:A,proofUrl:C});P==="success"?(r.refundConfirmSign=null,r.refundConfirmDone={teamId:u},$()):P==="already"&&(r.refundConfirmSign=null,$());return}if(n==="printRefundReceiptDone"){Xt(t.dataset.team);return}if(n==="closeRefundDone"){r.refundConfirmDone=null,$();return}if(n==="uploadCashRefundProof"||n==="uploadCashRefundProofInline"){const u=t.dataset.team,k=n==="uploadCashRefundProofInline"?`refund-cash-proof-file-${u}`:"refund-cash-proof-file",A=(s=(d=R(k))==null?void 0:d.files)==null?void 0:s[0];if(!A){g("กรุณาเลือกไฟล์รูปภาพ");return}const C=await Pt(A,{maxWidth:1200,quality:.85}),B=`refund-proof/${u}_${Date.now()}.jpg`,{error:H}=await h.storage.from("azfutsal-payments").upload(B,C,{upsert:!0,contentType:"image/jpeg"});if(H){g("อัปโหลดไม่สำเร็จ: "+H.message);return}const P=le(u);if(!P){g("ไม่พบข้อมูลคืนเงินของทีมนี้");return}const{error:V}=await h.from("azfutsal_refunds").update({proof_url:B}).eq("id",P.id);if(V){g("บันทึกไม่สำเร็จ: "+V.message);return}await L(),g("อัปโหลดรูปหลักฐานแล้ว");return}if(n==="closeModal"){r.editMatch=null,r.eventPicker=null,r.eventPickerFilter="",r.certModalOpen=!1,r.certFullscreenIndex=null,r.rejectPaymentId=null,r.rejectReasonText="",r.staffScopeEdit=null,r.manualPoolAssign=null,$();return}if(n==="confirmActionNo"){r.pendingConfirm=null,$();return}if(n==="confirmActionYes"){const u=r.pendingConfirm;r.pendingConfirm=null,$(),u!=null&&u.run&&await u.run();return}if(n==="account"){if(!r.identity.session){Jt();return}if(!r.identity.student){g("หน้านี้สำหรับนักเรียน (หัวหน้าทีม/ตัวแทนทีม) เท่านั้น");return}r.teamCodeInput||(r.teamCodeInput=localStorage.getItem("az_team_code")||""),r.tab="myteam",$();return}if(n==="admin-gear"){if(r.identity.isAdmin){r.tab="admin",$();return}if((r.identity.scopes||[]).length){r.tab="staff",$();return}r.adminLoginOpen=!0,r.adminLoginError="",r.adminLoginUsername="",$();return}if(n==="closeAdminLogin"){r.adminLoginOpen=!1,$();return}if(n==="goToPp5Login"){Jt("index.html");return}if(n==="submitAdminLogin"){await za();return}if(n==="adminSignOut"){await h.auth.signOut(),r.tab="schedule",await L(),g("ออกจากระบบแล้ว");return}if(n==="editMatch"){const u=ee(t.dataset.level,t.dataset.code);r.editMatch={level:t.dataset.level,code:t.dataset.code,penaltyMode:!!(u!=null&&u.is_penalty_shootout)},r.eventPicker=null,r.eventPickerFilter="",$();return}if(n==="togglePenaltyShootoutMode"){r.editMatch.penaltyMode=!r.editMatch.penaltyMode,$();return}if(n==="openEventPicker"){const u=t.closest("[data-match-editor-body]");r.editMatch&&(r.editMatch.scrollTop=(u==null?void 0:u.scrollTop)||0),r.eventPicker={team:t.dataset.team,type:t.dataset.type},r.eventPickerFilter="",$(),requestAnimationFrame(()=>{var k;return(k=document.getElementById("event-picker-filter"))==null?void 0:k.focus()});return}if(n==="closeEventPicker"){r.eventPicker=null,r.eventPickerFilter="",$(),requestAnimationFrame(()=>{var k;const u=ie==null?void 0:ie.querySelector("[data-match-editor-body]");u&&Number.isFinite((k=r.editMatch)==null?void 0:k.scrollTop)&&(u.scrollTop=r.editMatch.scrollTop)});return}if(n==="pickEventPlayer"){await ga(t.dataset.player);return}if(n==="removeMatchEvent"){await ma(t.dataset.id);return}if(n==="togglePlayerEventDetail"){r.expandedPlayerId=r.expandedPlayerId===t.dataset.id?null:t.dataset.id,$();return}if(n==="toggleEventPenalty"){const u=r.matchEvents.find(A=>A.id===t.dataset.id);if(!u)return;u.is_penalty=!u.is_penalty;let k=xe();if(String(u.id).startsWith("local_")){const A=k.find(C=>C.localEventId===u.id);A&&(A.payload.is_penalty=u.is_penalty)}else k.push({localId:Ie(),type:"togglePenalty",payload:{id:u.id,is_penalty:u.is_penalty}});he(k),$(),ge();return}if(n==="refreshMatchEditorData"){t.disabled=!0,t.textContent="กำลังรีเฟรช...",await L(),g("ดึงข้อมูลล่าสุดแล้ว");return}if(n==="saveMatch"){await xa(t.dataset.level,t.dataset.code);return}if(n==="saveMatchAndShift"){const u=t.dataset.level,k=t.dataset.code,A=R("mx-kickoff").value.trim();if(!/^\d{1,2}:\d{2}$/.test(A)){g("กรุณากรอกเวลาแข่งของนัดนี้ให้ถูกต้องก่อน (HH:MM)");return}const C=we(u,k),B=Me(C),H=B.findIndex(([ye,$e])=>ye===u&&$e===k);if(H===-1){g("ไม่พบนัดนี้ในลำดับตารางของวันนี้");return}const P=Number(y("MATCH_MIN",20))||20,V=Number(y("BREAK_MIN",5))||5,[X,Y]=A.split(":").map(Number);let te=new Date;te.setHours(X,Y,0,0);let ae=xe();for(let ye=H;ye<B.length;ye+=1){const[$e,st]=B[ye],Jn=te.toTimeString().slice(0,5),Xn=new Date(te.getTime()-10*6e4).toTimeString().slice(0,5),lt={level:$e,match_code:st,kickoff_time:Jn,ready_time:Xn,duration_min:P,break_min:V},Bt=ee($e,st);Bt?Object.assign(Bt,lt):r.matches[$e].push(lt),ae=ae.filter(ct=>!(ct.type==="saveMatch"&&ct.payload.level===$e&&ct.payload.match_code===st)),ae.push({localId:Ie(),type:"saveMatch",payload:lt}),te=new Date(te.getTime()+(P+V)*6e4)}he(ae),r.editMatch=null,$(),ge(),g(`ปรับเวลานัดนี้และเลื่อนอีก ${B.length-H-1} นัดที่เหลือของวันนี้แล้ว`);return}if(n==="seedMatches"){await ya(t.dataset.level);return}if(n==="randomDraw"){await va(t.dataset.level);return}if(n==="drawLotteryTeam"){await ha(t.dataset.level,t.dataset.code,t.dataset.side);return}if(n==="setMsFormat"){if(r.matches.MS.length){g("สร้างตารางแข่ง ม.ต้น ไปแล้ว เปลี่ยนรูปแบบไม่ได้");return}const{error:u}=await h.from("azfutsal_config").upsert({key:"MS_TEAM_FORMAT",value:t.dataset.v});if(u){g("บันทึกไม่สำเร็จ: "+u.message);return}await L(),g(`ตั้งรูปแบบสายการแข่ง ม.ต้น เป็น ${t.dataset.v} ทีมแล้ว`);return}if(n==="openCert"){r.certModalOpen=!0,r.certFullscreenIndex=null,r.knownStudentCode?(r.certInput=r.knownStudentCode,r.certResults=Ft(r.knownStudentCode)):(r.certResults=null,r.certInput=""),$();return}if(n==="certClose"){r.certModalOpen=!1,r.certFullscreenIndex=null,$();return}if(n==="certBack"){r.certFullscreenIndex=null,$();return}if(n==="certFull"){r.certFullscreenIndex=Number(t.dataset.idx),$();return}if(n==="certPrint"){const u=(r.certResults||[])[Number(t.dataset.idx)];if(!u)return;di({name:u.name,award:un(u.awardType),templateUrl:y("CERT_TEMPLATE_URL","")},g);return}if(n==="certSearch"){const u=R("az-certInput").value.trim();r.certInput=u,r.certResults=Ft(u),r.certFullscreenIndex=null,$();return}if(n==="createTeam"){await $a(t.dataset.admin==="1");return}if(n==="lookupTeamCode"){const u=(c=R("team-code-input"))==null?void 0:c.value.trim().toUpperCase();if(!u)return;const k=r.teams.find(A=>(A.team_code||"").toUpperCase()===u);r.teamCodeLookupResult=k||"notfound",k&&localStorage.setItem("az_team_code",u),$();return}if(n==="exitTeamCodeView"){r.teamCodeLookupResult=null,r.teamCodeInput="",$();return}if(n==="setCaptain"){await rn(t.dataset.team,Number(t.dataset.student),"captain");return}if(n==="setViceCaptain"){await rn(t.dataset.team,Number(t.dataset.student),"vice_captain");return}if(n==="startEditTeamName"){r.editingTeamName=!0,r.editTeamNameValue=t.dataset.name,$();return}if(n==="cancelEditTeamName"){r.editingTeamName=!1,r.editTeamNameValue="",$();return}if(n==="saveTeamName"){const u=(l=R("edit-team-name-input"))==null?void 0:l.value.trim();if(!u){g("กรุณากรอกชื่อทีม");return}const{error:k}=await h.from("azfutsal_teams").update({name:u}).eq("id",t.dataset.team);if(k){g("บันทึกไม่สำเร็จ: "+k.message);return}r.editingTeamName=!1,r.editTeamNameValue="",await L(),g("บันทึกชื่อทีมแล้ว");return}if(n==="startEditJersey"){r.editingJerseyId=t.dataset.id,r.editJerseyValue=t.dataset.v,$();return}if(n==="cancelEditJersey"){r.editingJerseyId=null,r.editJerseyValue="",$();return}if(n==="saveJersey"){const u=(f=R("edit-jersey-input"))==null?void 0:f.value,k=u===""||u===void 0?null:Number(u),{error:A}=await h.from("azfutsal_players").update({jersey_number:k}).eq("id",t.dataset.id);if(A){g("บันทึกไม่สำเร็จ: "+A.message);return}r.editingJerseyId=null,r.editJerseyValue="",await L(),g("บันทึกเบอร์เสื้อแล้ว");return}if(n==="adminNewTeam"){r.adminCreatingTeam=!0,r.adminManageTeamId=null,$();return}if(n==="adminBackToList"){r.adminCreatingTeam=!1,r.adminManageTeamId=null,$();return}if(n==="adminOpenTeam"){r.adminManageTeamId=t.dataset.id,$();return}if(n==="addRosterAthlete"){await ka(t.dataset.team);return}if(n==="uploadPayment"){await Sa(t.dataset.team,t.dataset.method);return}if(n==="openConfirmReg"){await Ea(t.dataset.team);return}if(n==="closeConfirmReg"){r.confirmRegOpen=!1,r.confirmRegQR=null,$();return}if(n==="reviewPayment"){await Aa(t.dataset.id,t.dataset.status);return}if(n==="openRejectModal"){r.rejectPaymentId=t.dataset.id,r.rejectReasonText="",$();return}if(n==="pickRejectTemplate"){r.rejectReasonText=t.dataset.text,$();return}if(n==="confirmReject"){await Ta();return}if(n==="viewProof"){await La(t.dataset.path);return}if(n==="closeViewProof"){r.viewProofOpen=!1,r.viewProofUrl=null,$();return}if(n==="toggleRequireEvents"){const u=y("REQUIRE_EVENTS_BEFORE_SCORE","0")==="1";await h.from("azfutsal_config").upsert({key:"REQUIRE_EVENTS_BEFORE_SCORE",value:u?"0":"1"}),await L();return}if(n==="toggleJointThirdHS"){const u=y("JOINT_THIRD_HS","0")==="1";await h.from("azfutsal_config").upsert({key:"JOINT_THIRD_HS",value:u?"0":"1"}),await L(),g(u?"ยกเลิกอันดับ 3 ร่วม ม.ปลายแล้ว — กลับไปใช้ผลนัดชิงที่ 3 (M24)":"เปิดอันดับ 3 ร่วม ม.ปลายแล้ว — ทีมแพ้รองฯ ทั้งสองคู่ได้อันดับ 3 ร่วมกัน");return}if(n==="toggleCert"){const u=y("CERT_ENABLED","1")==="1";await h.from("azfutsal_config").upsert({key:"CERT_ENABLED",value:u?"0":"1"}),await L();return}if(n==="saveCertTexts"){const u=[...document.querySelectorAll(".cert-text-input")].map(A=>({key:`CERT_TEXT_${A.dataset.type}`,value:A.value})),{error:k}=await h.from("azfutsal_config").upsert(u);if(k){g("บันทึกไม่สำเร็จ: "+k.message);return}await L(),g("บันทึกข้อความรางวัลแล้ว");return}if(n==="toggleRegistration"){const k=`REGISTRATION_OPEN_${t.dataset.level}`,A=y(k,"0")==="1";await h.from("azfutsal_config").upsert({key:k,value:A?"0":"1"}),await L();return}if(n==="uploadCertTemplate"){const u=(b=(x=R("cert-template-file"))==null?void 0:x.files)==null?void 0:b[0];if(!u){g("กรุณาเลือกรูปภาพ");return}const k=u.name.replace(/[^a-zA-Z0-9._-]/g,"_"),A=`cert-template_${Date.now()}_${k}`,{error:C}=await h.storage.from("azfutsal-assets").upload(A,u,{upsert:!0});if(C){g("อัปโหลดไม่สำเร็จ: "+C.message);return}const{data:B}=h.storage.from("azfutsal-assets").getPublicUrl(A);await h.from("azfutsal_config").upsert({key:"CERT_TEMPLATE_URL",value:B.publicUrl}),await L(),g("อัปโหลดพื้นหลังเกียรติบัตรแล้ว");return}if(n==="uploadRefundReceiptLogo"){const u=(w=(m=R("refund-receipt-logo-file"))==null?void 0:m.files)==null?void 0:w[0];if(!u){g("กรุณาเลือกรูปโลโก้โรงเรียน");return}if(!u.type.startsWith("image/")){g("กรุณาเลือกไฟล์รูปภาพ");return}if(u.size>5*1024*1024){g("ไฟล์โลโก้ต้องไม่เกิน 5 MB");return}const k=u.name.replace(/[^a-zA-Z0-9._-]/g,"_"),A=`refund-receipt/logo_${Date.now()}_${k}`,{error:C}=await h.storage.from("azfutsal-assets").upload(A,u,{upsert:!0});if(C){g("อัปโหลดไม่สำเร็จ: "+C.message);return}const{data:B}=h.storage.from("azfutsal-assets").getPublicUrl(A),{error:H}=await h.from("azfutsal_config").upsert({key:"REFUND_RECEIPT_LOGO_URL",value:B.publicUrl});if(H){g("บันทึกโลโก้ไม่สำเร็จ: "+H.message);return}await L(),g("อัปโหลดโลโก้สำหรับใบเสร็จแล้ว");return}if(n==="saveRefundPayerInfo"){const u=((T=(_=R("refund-payer-name"))==null?void 0:_.value)==null?void 0:T.trim())||"",k=((M=(E=R("refund-payer-title"))==null?void 0:E.value)==null?void 0:M.trim())||"",{error:A}=await h.from("azfutsal_config").upsert([{key:"REFUND_PAYER_NAME",value:u},{key:"REFUND_PAYER_TITLE",value:k}]);if(A){g("บันทึกไม่สำเร็จ: "+A.message);return}await L(),g("บันทึกข้อมูลผู้จ่ายเงินแล้ว");return}if(n==="clearSignaturePad"){const u=R("refund-payer-sigpad");u&&u.getContext("2d").clearRect(0,0,u.width,u.height);return}if(n==="saveDrawnSignature"){const u=R("refund-payer-sigpad");if(!u)return;const k=await new Promise(P=>u.toBlob(P,"image/png"));if(!k){g("ไม่มีลายเซ็นให้บันทึก");return}const A=`refund-payer-signature_${Date.now()}.png`,{error:C}=await h.storage.from("azfutsal-assets").upload(A,k,{upsert:!0,contentType:"image/png"});if(C){g("บันทึกลายเซ็นไม่สำเร็จ: "+C.message);return}const{data:B}=h.storage.from("azfutsal-assets").getPublicUrl(A),{error:H}=await h.from("azfutsal_config").upsert({key:"REFUND_PAYER_SIGNATURE_URL",value:B.publicUrl});if(H){g("บันทึกลายเซ็นไม่สำเร็จ: "+H.message);return}await L(),g("บันทึกลายเซ็นแล้ว");return}if(n==="uploadPayerSignature"){const u=(z=(v=R("refund-payer-sig-file"))==null?void 0:v.files)==null?void 0:z[0];if(!u){g("กรุณาเลือกไฟล์รูปลายเซ็น");return}if(!u.type.startsWith("image/")){g("กรุณาเลือกไฟล์รูปภาพ");return}if(u.size>5*1024*1024){g("ไฟล์ลายเซ็นต้องไม่เกิน 5 MB");return}const k=u.name.replace(/[^a-zA-Z0-9._-]/g,"_"),A=`refund-payer-signature_${Date.now()}_${k}`,{error:C}=await h.storage.from("azfutsal-assets").upload(A,u,{upsert:!0});if(C){g("อัปโหลดไม่สำเร็จ: "+C.message);return}const{data:B}=h.storage.from("azfutsal-assets").getPublicUrl(A),{error:H}=await h.from("azfutsal_config").upsert({key:"REFUND_PAYER_SIGNATURE_URL",value:B.publicUrl});if(H){g("บันทึกลายเซ็นไม่สำเร็จ: "+H.message);return}await L(),g("อัปโหลดลายเซ็นแล้ว");return}if(n==="uploadCertSong"){const u=(I=(N=R("cert-song-file"))==null?void 0:N.files)==null?void 0:I[0];if(!u){g("กรุณาเลือกไฟล์เพลง");return}const k=u.name.replace(/[^a-zA-Z0-9._-]/g,"_"),A=`cert-song_${Date.now()}_${k}`,{error:C}=await h.storage.from("azfutsal-assets").upload(A,u,{upsert:!0});if(C){g("อัปโหลดไม่สำเร็จ: "+C.message);return}const{data:B}=h.storage.from("azfutsal-assets").getPublicUrl(A);await h.from("azfutsal_config").upsert([{key:"CERT_SONG_URL",value:B.publicUrl},{key:"CERT_SONG_NAME",value:u.name}]),await L(),g("อัปโหลดเพลงแล้ว");return}if(n==="saveGeneral"){await h.from("azfutsal_config").upsert([{key:"EVENT_NAME",value:R("cfg-eventName").value},{key:"INFO_DATE",value:R("cfg-date").value},{key:"INFO_VENUE",value:R("cfg-venue").value},{key:"COLOR_MS",value:R("cfg-colorMs").value},{key:"COLOR_HS",value:R("cfg-colorHs").value}]),await L(),g("บันทึกแล้ว");return}if(n==="saveAdminAccount"){const u=R("admin-acct-username").value.trim(),k=R("admin-acct-password").value;if(!u){g("กรอกยูสเซอร์เนม");return}if(k&&k.length<6){g("รหัสผ่านต้องมีอย่างน้อย 6 ตัวอักษร");return}if(await h.from("azfutsal_config").upsert({key:"ADMIN_LOGIN_USERNAME",value:u}),k){const{error:A}=await h.auth.updateUser({password:k});if(A){g("เปลี่ยนรหัสผ่านไม่สำเร็จ: "+A.message);return}}await L(),g("บันทึกบัญชีแอดมินสำรองแล้ว");return}if(n==="saveRegSettings"){await h.from("azfutsal_config").upsert([{key:"DEPOSIT_AMOUNT",value:R("reg-deposit").value},{key:"MAX_ROSTER",value:R("reg-maxroster").value},{key:"PROMPTPAY_NUMBER",value:R("reg-promptpay").value.trim()},{key:"RATE_YELLOW",value:R("reg-ratey").value},{key:"RATE_RED",value:R("reg-rater").value},{key:"OPERATION_FEE",value:R("reg-opfee").value},{key:"MAX_TEAMS_MS",value:R("reg-quota-ms").value||""},{key:"MAX_TEAMS_HS",value:R("reg-quota-hs").value||""},{key:"REGISTER_EDIT_DEADLINE",value:R("reg-deadline").value||""}]),await L(),g("บันทึกการตั้งค่าแล้ว");return}if(n==="saveAutoTime"){const u=R("ops-start").value,k=R("ops-start-day2").value,A=Number(R("ops-matchmin").value||20),C=Number(R("ops-breakmin").value||5);if(!u||!k){g("กรุณาเลือกวันและเวลาเริ่มแข่งให้ครบทั้ง 2 วัน");return}if(new Date(k)<=new Date(u)){g("วันที่ 2 ต้องอยู่หลังวันที่ 1");return}await h.from("azfutsal_config").upsert([{key:"START_TIME",value:u},{key:"SECOND_DAY_START_TIME",value:k},{key:"MATCH_MIN",value:String(A)},{key:"BREAK_MIN",value:String(C)}]);const B=[{start:u,codes:Me(1)},{start:k,codes:Me(2)}].flatMap(P=>{let V=new Date(P.start);return P.codes.map(([X,Y])=>{const te=V.toTimeString().slice(0,5),ae=new Date(V.getTime()-10*6e4).toTimeString().slice(0,5);return V=new Date(V.getTime()+(A+C)*6e4),{level:X,match_code:Y,round:(F[X].find(ye=>ye.code===Y)||{}).round||"",kickoff_time:te,ready_time:ae,duration_min:A,break_min:C}})}),{error:H}=await h.from("azfutsal_matches").upsert(B,{onConflict:"level,match_code"});if(H){g("จัดเวลาไม่สำเร็จ: "+H.message);return}await L(),g("จัดตารางแข่งขัน 2 วันเรียบร้อยแล้ว");return}if(n==="saveHalfDuration"){const u=Number(R("ops-halfmin").value||20);if(u<=0){g("นาทีต่อครึ่งต้องมากกว่า 0");return}await h.from("azfutsal_config").upsert({key:"HALF_DURATION_MINUTES",value:String(u)}),await L(),g("บันทึกนาทีต่อครึ่งแล้ว");return}if(n==="resetAllMatchResults"){r.pendingConfirm={message:`ล้างผลการแข่งขันทั้งหมดจริงหรือไม่?
สกอร์ ผู้ทำประตู ใบเหลือง/ใบแดง และนาฬิกาของทุกนัดจะถูกล้างกลับเป็นค่าเริ่มต้น
การกระทำนี้ย้อนกลับไม่ได้`,danger:!0,confirmLabel:"ล้างผลทั้งหมด",run:async()=>{const u=[];["MS","HS"].forEach(C=>{F[C].forEach(B=>{u.push({level:C,match_code:B.code,score_a:null,score_b:null,is_penalty_shootout:!1,penalty_score_a:null,penalty_score_b:null,winner_team_id:null,loser_team_id:null,clock_status:"not_started",clock_half:null,clock_started_at:null,clock_elapsed_before:0,clock_half_started_elapsed:0})})});const{error:k}=await h.from("azfutsal_matches").upsert(u,{onConflict:"level,match_code"});if(k){g("ล้างผลไม่สำเร็จ: "+k.message);return}const{error:A}=await h.from("azfutsal_match_events").delete().in("level",["MS","HS"]);if(A){g("ลบผู้ทำประตู/การ์ดไม่สำเร็จ: "+A.message);return}await L(),g("ล้างผลการแข่งขันทั้งหมดแล้ว")}},$();return}if(n==="resetAllMatchSchedule"){r.pendingConfirm={message:`ล้างโปรแกรมประกบคู่และกำหนดการของทุกนัดจริงหรือไม่?
ทีมที่จับคู่ไว้และเวลาแข่ง/รายงานตัวของโปรแกรมจะถูกล้าง แต่จะไม่ลบทีม นักกีฬา การชำระเงิน หรือรายงานตัว`,danger:!0,confirmLabel:"ล้างโปรแกรมการแข่งขัน",run:async()=>{const{error:u}=await h.from("azfutsal_matches").update({team_a_id:null,team_b_id:null,ready_time:null,kickoff_time:null}).in("level",["MS","HS"]);if(u){g("ล้างโปรแกรมไม่สำเร็จ: "+u.message);return}await L(),g("ล้างโปรแกรมประกบคู่แล้ว — ผลการแข่งขันและข้อมูลทีมยังคงอยู่")}},$();return}if(n==="resetAllCheckins"){r.pendingConfirm={message:`ล้างข้อมูลรายงานตัวทั้งหมดจริงหรือไม่?
สถานะรายงานตัว (สแกน QR) ของทุกนัดทุกทีมจะถูกล้างกลับเป็นยังไม่รายงานตัว
การกระทำนี้ย้อนกลับไม่ได้`,danger:!0,confirmLabel:"ล้างข้อมูลรายงานตัว",run:async()=>{const{error:u}=await h.from("azfutsal_checkins").delete().in("level",["MS","HS"]);if(u){g("ล้างข้อมูลรายงานตัวไม่สำเร็จ: "+u.message);return}await L(),g("ล้างข้อมูลรายงานตัวทั้งหมดแล้ว")}},$();return}if(n==="resetAllEventCheckins"){r.pendingConfirm={message:`ล้างข้อมูลเช็คอินเข้างานทั้งหมดจริงหรือไม่?
สถานะเช็คอินเข้างาน (ทั้งสแกนเองและสตาฟสแกนให้) ของนักกีฬาทุกคนทั้ง 2 วันจะถูกล้างทั้งหมด
การกระทำนี้ย้อนกลับไม่ได้`,danger:!0,confirmLabel:"ล้างเช็คอินเข้างาน",run:async()=>{const{error:u}=await h.from("azfutsal_event_checkins").delete().in("day",[1,2]);if(u){g("ล้างข้อมูลไม่สำเร็จ: "+u.message);return}await L(),g("ล้างข้อมูลเช็คอินเข้างานทั้งหมดแล้ว")}},$();return}if(n==="startMatchClock"){je(t.dataset.level,t.dataset.code,{clock_status:"running",clock_half:1,clock_started_at:new Date().toISOString(),clock_elapsed_before:0,clock_half_started_elapsed:0}),$();return}if(n==="pauseMatchClock"){const u=t.dataset.level,k=t.dataset.code,A=ee(u,k),C=bt(A)||0;je(u,k,{clock_status:"paused",clock_elapsed_before:C,clock_started_at:null}),$();return}if(n==="resumeMatchClock"){je(t.dataset.level,t.dataset.code,{clock_status:"running",clock_started_at:new Date().toISOString()}),$();return}if(n==="endHalfClock"||n==="endMatchClock"){const u=t.dataset.level,k=t.dataset.code,A=ee(u,k),C=bt(A)||0;je(u,k,{clock_status:n==="endHalfClock"?"half_break":"ended",clock_elapsed_before:C,clock_started_at:null}),$();return}if(n==="startSecondHalfClock"){const u=t.dataset.level,k=t.dataset.code,A=ee(u,k);je(u,k,{clock_status:"running",clock_half:2,clock_started_at:new Date().toISOString(),clock_half_started_elapsed:(A==null?void 0:A.clock_elapsed_before)||0}),$();return}if(n==="adminNewTeamFromList"||n==="adminOpenTeamFromList"){r.tab="myteam",n==="adminNewTeamFromList"?(r.adminCreatingTeam=!0,r.adminManageTeamId=null):(r.adminManageTeamId=t.dataset.id,r.adminCreatingTeam=!1),$();return}if(n==="removeTeam"){r.pendingConfirm={message:`ลบทีมนี้?
ข้อมูลนักกีฬาและการชำระเงินของทีมจะถูกลบด้วย`,danger:!0,confirmLabel:"ลบทีม",run:async()=>{const{error:u}=await h.from("azfutsal_teams").delete().eq("id",t.dataset.id);if(u){g("ลบไม่สำเร็จ: "+u.message);return}await L(),g("ลบทีมแล้ว")}},$();return}if(n==="openLiveDraw"){r.liveDraw={level:t.dataset.level,pool:t.dataset.pool||null,started:!1,testMode:!0,orderStrategy:"bypair"},$();return}if(n==="autoSeedPool"){const u=t.dataset.level,k=t.dataset.pool;r.pendingConfirm={message:`จัดคู่รอบนี้อัตโนมัติตามอันดับผลงาน (ทีมอันดับดี พบ ทีมอันดับรอง)?
จะทับข้อมูลคู่แข่งเดิมของรอบนี้ถ้ามี`,danger:!1,confirmLabel:"จัดคู่เลย",run:async()=>{await wa(u,k)}},$();return}if(n==="openManualPoolAssign"){r.manualPoolAssign={level:t.dataset.level,pool:t.dataset.pool},$();return}if(n==="openSemifinalAssign"){r.manualPoolAssign={level:t.dataset.level,pool:"SF"},$();return}if(n==="saveManualPoolAssign"){await _a();return}if(n==="setLiveDrawMode"){r.liveDraw&&!r.liveDraw.started&&(r.liveDraw.testMode=t.dataset.v==="1",$());return}if(n==="setLiveDrawOrder"){r.liveDraw&&!r.liveDraw.started&&(r.liveDraw.orderStrategy=t.dataset.v,$());return}if(n==="closeLiveDraw"){We(),jt(),r.liveDraw=null,$();return}if(n==="startLiveDraw"){await ea();return}if(n==="shakePool"){await aa();return}if(n==="drawNext"){await ra();return}if(n==="useTopScorer"){const{error:u}=await h.from("azfutsal_awards").upsert({level:t.dataset.level,award_type:"top_scorer",student_id:t.dataset.student},{onConflict:"level,award_type"});if(u){g("บันทึกไม่สำเร็จ: "+u.message);return}await L(),g("ตั้งดาวซัลโวจากผู้นำอัตโนมัติแล้ว");return}if(n==="clearAward"){const{error:u}=await h.from("azfutsal_awards").upsert({level:t.dataset.level,award_type:t.dataset.type,student_id:null},{onConflict:"level,award_type"});if(u){g("บันทึกไม่สำเร็จ: "+u.message);return}await L(),g("ล้างรางวัลแล้ว");return}if(n==="printMatchForm"){Ui(t.dataset.level,t.dataset.code);return}if(n==="openCheckinScanner"){Gi(t.dataset.level,t.dataset.code);return}if(n==="openCheckinLiveDisplay"){Oi(t.dataset.level,t.dataset.code);return}if(n==="setEventCheckinDay"){r.eventCheckinDay=Number(t.dataset.v),$();return}if(n==="setEventCheckinIncompleteLevel"){r.eventCheckinIncompleteLevel=t.dataset.v,$();return}if(n==="openEventCheckinScanner"){Yi(Number(t.dataset.day));return}if(n==="openEventCheckinBigScreen"){Ji(Number(t.dataset.day));return}if(n==="openScheduleBigScreen"){bo();return}if(n==="openMatchBigScreen"){Nn(t.dataset.level,t.dataset.code);return}if(n==="openEventCheckinPendingReview"){Xi(Number(t.dataset.day));return}if(n==="openEventSelfCheckin"){Qi();return}if(n==="toggleEventCheckinBothDays"){const u=ce();await h.from("azfutsal_config").upsert({key:"EVENT_CHECKIN_REQUIRE_BOTH_DAYS",value:u?"0":"1"}),await L();return}if(n==="toggleEventCheckinRequirePermission"){const u=pe();await h.from("azfutsal_config").upsert({key:"EVENT_CHECKIN_REQUIRE_PARENT_PERMISSION",value:u?"0":"1"}),await L();return}if(n==="toggleEventCheckinRequireAttire"){const u=fe();await h.from("azfutsal_config").upsert({key:"EVENT_CHECKIN_REQUIRE_ATTIRE",value:u?"0":"1"}),await L();return}if(n==="saveEventCheckinWindow"){await h.from("azfutsal_config").upsert([{key:"EVENT_CHECKIN_OPEN_TIME",value:R("evci-open").value||""},{key:"EVENT_CHECKIN_CLOSE_TIME",value:R("evci-close").value||""}]),await L(),g("บันทึกเวลาเปิด-ปิดรับเช็คอินแล้ว");return}if(n==="useCurrentGPSForVenue"){g("กำลังอ่านพิกัด GPS...");const u=await Ln();if(u.error){g(u.error);return}const k=R("evci-venue-lat"),A=R("evci-venue-lng");k&&(k.value=u.lat.toFixed(6)),A&&(A.value=u.lng.toFixed(6)),g("อ่านพิกัดสำเร็จ — ตรวจสอบแล้วกดบันทึกพิกัดสถานที่");return}if(n==="viewVenueOnMap"){const u=parseFloat(R("evci-venue-lat").value.trim()),k=parseFloat(R("evci-venue-lng").value.trim()),A=parseFloat(R("evci-venue-radius").value.trim())||150;if(Number.isNaN(u)||Number.isNaN(k)){g('ยังไม่มีพิกัดให้ดู กรอกหรือกด "ใช้พิกัดปัจจุบัน" ก่อน');return}Zi(u,k,A);return}if(n==="saveEventVenueGeofence"){const u=R("evci-venue-lat").value.trim(),k=R("evci-venue-lng").value.trim(),A=R("evci-venue-radius").value.trim();if(u&&Number.isNaN(parseFloat(u))){g("ละติจูดไม่ถูกต้อง");return}if(k&&Number.isNaN(parseFloat(k))){g("ลองจิจูดไม่ถูกต้อง");return}await h.from("azfutsal_config").upsert([{key:"EVENT_VENUE_LAT",value:u},{key:"EVENT_VENUE_LNG",value:k},{key:"EVENT_VENUE_RADIUS",value:A||"150"}]),await L(),g("บันทึกพิกัดสถานที่แล้ว");return}if(n==="printCheckinForm"){const u=r.teams.find(k=>k.id===t.dataset.id);u&&Vi(u);return}if(n==="toggleOrganizer"){const{error:u}=await h.from("azfutsal_teams").update({is_organizer:t.dataset.v==="1"}).eq("id",t.dataset.id);if(u){g("บันทึกไม่สำเร็จ: "+u.message);return}await L();return}if(n==="removePlayer"){r.pendingConfirm={message:"ลบนักกีฬาคนนี้ออกจากทีม?",danger:!0,confirmLabel:"ลบ",run:async()=>{const{error:u}=await h.from("azfutsal_players").delete().eq("id",t.dataset.id);if(u){g("ลบไม่สำเร็จ: "+u.message);return}await L()}},$();return}if(n==="toggleStaffScope"){if(!r.staffScopeEdit)return;const u=t.dataset.key,k=r.staffScopeEdit.scopes||[];r.staffScopeEdit.scopes=t.checked?[...k,u]:k.filter(A=>A!==u),$();return}if(n==="cancelStaffScope"){r.staffScopeEdit=null,$();return}if(n==="saveStaffScope"){const u=r.staffScopeEdit;if(!u)return;if(!u.scopes||!u.scopes.length){g("เลือกสิทธิ์อย่างน้อย 1 อย่าง");return}if(u.mode==="add"){const{error:k}=await h.from("azfutsal_admins").insert({profile_id:u.profile_id,granted_by:r.identity.profile.id,scopes:u.scopes});if(k){g("มอบสิทธิ์ไม่สำเร็จ: "+k.message);return}g(`มอบสิทธิ์ให้ ${u.name} แล้ว`)}else{const k=(O=(j=r.staffList)==null?void 0:j.find(B=>B.id===u.id))==null?void 0:O.isSelf,A=(((Q=(D=r.staffList)==null?void 0:D.find(B=>B.id===u.id))==null?void 0:Q.scopes)||[]).includes("full"),{error:C}=await h.from("azfutsal_admins").update({scopes:u.scopes}).eq("id",u.id);if(C){g("บันทึกไม่สำเร็จ: "+C.message);return}if(g("บันทึกสิทธิ์แล้ว"),k&&A&&!u.scopes.includes("full")){r.staffScopeEdit=null,await L(),r.tab="schedule",$();return}}r.staffScopeEdit=null,await _t(),$();return}if(n==="editStaffScope"){r.staffScopeEdit={mode:"edit",id:t.dataset.id,name:t.dataset.name,scopes:t.dataset.scopes?t.dataset.scopes.split(","):[]},$();return}if(n==="removeStaff"){const u=(r.staffList||[]).filter(C=>(C.scopes||[]).includes("full")).length;if(((J=(q=(r.staffList||[]).find(C=>C.id===t.dataset.id))==null?void 0:q.scopes)==null?void 0:J.includes("full"))&&u<=1){g("ต้องมีแอดมินเต็มรูปแบบอย่างน้อย 1 คนเสมอ ลบคนสุดท้ายไม่ได้");return}const A=t.dataset.self==="1";r.pendingConfirm={message:A?`นี่คือบัญชีที่คุณกำลังใช้อยู่
ถ้าถอนสิทธิ์ตัวเองจะออกจากหน้าแอดมินทันที ยืนยันหรือไม่?`:"ถอนสิทธิ์คนนี้?",danger:!0,confirmLabel:"ถอนสิทธิ์",run:async()=>{const{error:C}=await h.from("azfutsal_admins").delete().eq("id",t.dataset.id);if(C){g("ถอนสิทธิ์ไม่สำเร็จ: "+C.message);return}if(A){await L(),r.tab="schedule",$();return}await _t()}},$();return}}),ie.addEventListener("change",async e=>{var n;const t=e.target;if(t.id==="new-team-level"){r.newTeamLevel=t.value;return}if(t.dataset.act==="uploadPlayerPhoto"&&((n=t.files)!=null&&n[0])){await ba(t.dataset.id,t.files[0]);return}}),ie.addEventListener("input",async e=>{var t;if(e.target.id==="az-filterTeam"&&(r.filterTeam=e.target.value,dn()),e.target.id==="az-filterTime"&&(r.filterTime=e.target.value,dn()),e.target.id==="new-team-name"&&(r.newTeamName=e.target.value),e.target.id==="team-code-input"&&(r.teamCodeInput=e.target.value),e.target.id==="roster-jersey"&&(r.rosterJersey=e.target.value),e.target.id==="event-picker-filter"){r.eventPickerFilter=e.target.value;const n=R("event-picker-list");n&&(n.innerHTML=Gn())}if(e.target.id==="athlete-search"){r.adminAthleteSearch=e.target.value;const n=R("athlete-list");n&&(n.innerHTML=Qn())}if(e.target.id==="reject-reason-text"){r.rejectReasonText=e.target.value;const n=document.querySelector('[data-act="confirmReject"]');if(n){const i=!!r.rejectReasonText.trim();n.disabled=!i,n.style.background=i?"#dc2626":"#f3b6b6",n.style.cursor=i?"pointer":"default"}}if(e.target.id==="staff-search"){const n=e.target.value,i=R("staff-search-results");if(!n||n.trim().length<2){i.style.display="none";return}const o=await ua(n);i.innerHTML=o.length?o.map(a=>`<div data-profile="${a.profile_id}" data-name="${p(a.name)}" style="padding:8px 10px;font-size:12.5px;cursor:pointer;border-bottom:1px solid #f3f4f6" class="az-staff-cand"><b>${p(a.name)}</b> <span style="color:#9ca3af">${a.sub}</span></div>`).join(""):'<div style="padding:8px 10px;font-size:12px;color:#9ca3af">ไม่พบ</div>',i.style.display="block",i.querySelectorAll(".az-staff-cand").forEach(a=>a.addEventListener("click",()=>{r.staffScopeEdit={mode:"add",profile_id:a.dataset.profile,name:a.dataset.name,scopes:[]},R("staff-search").value="",i.style.display="none",$()}))}if((t=e.target.classList)!=null&&t.contains("az-award-search")){const n=e.target.dataset.level,i=e.target.dataset.type,o=e.target.value.trim().toLowerCase(),a=R(`award-results-${n}-${i}`);if(!o){a.style.display="none";return}const s=r.players.filter(c=>{var l;return((l=r.teams.find(f=>f.id===c.team_id))==null?void 0:l.level)===n}).filter(c=>{var b,m;const l=(((b=c.students)==null?void 0:b.full_name)||"").toLowerCase(),f=String(((m=c.students)==null?void 0:m.student_code)||"").toLowerCase(),x=String(c.jersey_number??"");return l.includes(o)||f.includes(o)||x.includes(o)}).slice(0,20);a.innerHTML=s.length?s.map(c=>{var l,f;return`<div data-student="${c.student_id}" style="padding:8px 10px;font-size:12.5px;cursor:pointer;border-bottom:1px solid #f3f4f6" class="az-award-cand">${c.jersey_number!==null&&c.jersey_number!==void 0?`<b>#${p(c.jersey_number)}</b> `:""}<b>${p(((l=c.students)==null?void 0:l.full_name)||"")}</b> <span style="color:#9ca3af">${p(((f=c.students)==null?void 0:f.student_code)||"")} · ${p(U(c.team_id))}</span></div>`}).join(""):'<div style="padding:8px 10px;font-size:12px;color:#9ca3af">ไม่พบนักกีฬาที่ตรงกับคำค้น</div>',a.style.display="block",a.querySelectorAll(".az-award-cand").forEach(c=>c.addEventListener("click",async()=>{a.style.display="none";const{error:l}=await h.from("azfutsal_awards").upsert({level:n,award_type:i,student_id:c.dataset.student},{onConflict:"level,award_type"});if(l){g("บันทึกไม่สำเร็จ: "+l.message);return}await L(),g("บันทึกรางวัลแล้ว")}))}if(e.target.id==="cap-code"){const n=e.target.value;r.capLookupCode=n;const i=R("cap-search-results");if(!n||n.trim().length<2){i.style.display="none";return}const o=await an(n);i.innerHTML=o.length?o.map(a=>`<div data-id="${a.id}" style="padding:8px 10px;font-size:12.5px;cursor:pointer;border-bottom:1px solid #f3f4f6" class="az-cap-cand"><b>${p(a.full_name)}</b> <span style="color:#9ca3af">${p(a.student_code)}</span></div>`).join(""):'<div style="padding:8px 10px;font-size:12px;color:#9ca3af">ไม่พบ</div>',i.style.display="block",i.querySelectorAll(".az-cap-cand").forEach(a=>a.addEventListener("click",()=>{const d=o.find(s=>String(s.id)===a.dataset.id);r.capLookupResult=d,r.capLookupCode=d.full_name,i.style.display="none",$()}))}if(e.target.id==="roster-code"){const n=e.target.value;r.rosterLookupCode=n;const i=R("roster-search-results");if(!n||n.trim().length<2){i.style.display="none";return}const o=await an(n);i.innerHTML=o.length?o.map(a=>`<div data-id="${a.id}" style="padding:8px 10px;font-size:12.5px;cursor:pointer;border-bottom:1px solid #f3f4f6" class="az-roster-cand"><b>${p(a.full_name)}</b> <span style="color:#9ca3af">${p(a.student_code)}</span></div>`).join(""):'<div style="padding:8px 10px;font-size:12px;color:#9ca3af">ไม่พบ</div>',i.style.display="block",i.querySelectorAll(".az-roster-cand").forEach(a=>a.addEventListener("click",()=>{const d=o.find(c=>String(c.id)===a.dataset.id),s=r.players.find(c=>c.student_id===d.id);r.rosterLookupResult=s?"duplicate":d,r.rosterJersey="",r.rosterLookupCode=d.full_name,i.style.display="none",$()}))}})}function dn(){const e=It(),t=r.scheduleDay===2?2:1,n=R("az-schedule-count"),i=R("az-schedule-rows");n&&(n.textContent=`${e.filter(o=>o.day===t).length} นัด`),i&&(i.innerHTML=Bn(e))}function Ca(e){const t=r.payments.find(n=>n.team_id===e);return t?t.status==="verified"?`<span style="color:#16a34a;font-weight:600">● ยืนยันแล้ว</span> · ส่ง ${Ne(t.created_at)}${t.reviewed_at?" · ยืนยัน "+Ne(t.reviewed_at):""}`:t.status==="rejected"?`<span style="color:#ef4444;font-weight:600">● ถูกปฏิเสธ</span> · ส่ง ${Ne(t.created_at)}${t.reviewed_at?" · ปฏิเสธ "+Ne(t.reviewed_at):""}`:`<span style="color:#f59e0b;font-weight:600">● รอตรวจสอบ</span> · ส่งหลักฐาน ${Ne(t.created_at)}`:'<span style="color:#9ca3af;font-weight:600">● ยังไม่ส่งหลักฐานชำระเงิน</span>'}function Na(e){var t,n;return`
  <div style="border:1px solid #f3f4f6;border-radius:10px;padding:8px 10px">
    <div style="display:flex;align-items:center;justify-content:space-between">
      <div style="display:flex;align-items:center;gap:6px"><span style="font-size:13px;font-weight:700">${p(e.name)}</span>${e.is_reserve?Fe():""}${e.is_organizer?qe():""}</div>
      <div style="display:flex;gap:8px;align-items:center">
    ...
    <div style="font-size:10.5px;color:#6b7280;margin-top:3px">${Ca(e.id)}</div>
  ...
  </div>`}function sn(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&apos;")}function ja(e){if(!["MS","HS"].includes(e))return;const t=new Map(r.teams.map(m=>[m.id,m])),n=new Intl.Collator("th",{numeric:!0,sensitivity:"base"}),i=r.players.filter(m=>{var w;return((w=t.get(m.team_id))==null?void 0:w.level)===e}).sort((m,w)=>{var E,M,v,z;const _=n.compare(((E=t.get(m.team_id))==null?void 0:E.name)||"",((M=t.get(w.team_id))==null?void 0:M.name)||"");if(_)return _;const T=Number(m.jersey_number??999)-Number(w.jersey_number??999);return T||n.compare(((v=m.students)==null?void 0:v.full_name)||"",((z=w.students)==null?void 0:z.full_name)||"")});if(!i.length){g(`ยังไม่มีนักกีฬา${S[e].label}ให้ดาวน์โหลด`);return}const o=["ลำดับ","ระดับ","ชื่อทีม","รหัสทีม","สถานะทีม","เบอร์เสื้อ","รหัสนักเรียน","ชื่อ-สกุล","ชั้นเรียน","บทบาทในทีม","วันที่ลงทะเบียน"],a=i.map((m,w)=>{var M,v,z;const _=t.get(m.team_id),T=_!=null&&_.is_organizer?"ทีมผู้จัด":_!=null&&_.is_reserve?"ทีมสำรอง":"ทีมแข่งขัน",E=String(m.student_id)===String(_==null?void 0:_.captain_student_id)?"หัวหน้าทีม":String(m.student_id)===String(_==null?void 0:_.vice_captain_student_id)?"รองหัวหน้าทีม":"นักกีฬา";return[w+1,S[e].label,(_==null?void 0:_.name)||"",(_==null?void 0:_.team_code)||"",T,m.jersey_number??"",((M=m.students)==null?void 0:M.student_code)||"",((v=m.students)==null?void 0:v.full_name)||"",((z=m.students)==null?void 0:z.class_name)||"",E,m.registered_at?new Date(m.registered_at).toLocaleString("th-TH"):""]}),d=(m,w="Body")=>`<Cell ss:StyleID="${w}"><Data ss:Type="String">${sn(m)}</Data></Cell>`,s=[`<Row>${o.map(m=>d(m,"Header")).join("")}</Row>`,...a.map(m=>`<Row>${m.map(w=>d(w)).join("")}</Row>`)].join(""),c=`<?xml version="1.0" encoding="UTF-8"?>
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="${sn(S[e].label)}">
  <Table>
  ...
  <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel"><FreezePanes/><FrozenNoSplit/><SplitHorizontal>1</SplitHorizontal><TopRowBottomPane>1</TopRowBottomPane><ActivePane>2</ActivePane><ProtectObjects>False</ProtectObjects><ProtectScenarios>False</ProtectScenarios></WorksheetOptions>
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;padding:7px 0;border-bottom:1px solid #f3f4f6">
          <div style="min-width:0">
            ...
            <div style="font-size:11px;color:#6b7280">${p(((d=i.students)==null?void 0:d.student_code)||"")} · ${p(U(i.team_id))}${i.jersey_number!=null?` · เบอร์ ${p(String(i.jersey_number))}`:""}</div>
          </div>
        ...
        </div>`}).join(""):`<div style="font-size:12.5px;color:#9ca3af">${t?"ไม่พบนักกีฬาที่ค้นหา":"ยังไม่มีนักกีฬาลงทะเบียนในระดับนี้"}</div>`}function Ba(){const e=r.adminAthleteLevel||"MS",t=r.players.filter(n=>{var i;return((i=r.teams.find(o=>o.id===n.team_id))==null?void 0:i.level)===e}).length;return dt(`
    <div style="flex-shrink:0;margin-bottom:10px">
      <div style="display:flex;align-items:center;justify-content:space-between;gap:8px">
  ...
  `)}function Pa(){const e=r.adminPaymentsLevel||"MS",t=r.payments.filter(i=>{var o;return((o=r.teams.find(a=>a.id===i.team_id))==null?void 0:o.level)===e}),n=t.filter(i=>i.status==="pending").length;return dt(`
    <div style="flex-shrink:0;display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
      ...
      ${t.length?t.map(i=>{const o=r.teams.find(a=>a.id===i.team_id);return`
        <div style="border:1px solid #f3f4f6;border-radius:10px;padding:10px">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px">
            <div style="display:flex;align-items:center;gap:6px"><span style="font-size:13px;font-weight:700">${p((o==null?void 0:o.name)||"")}</span>${o!=null&&o.is_reserve?Fe():""}${o!=null&&o.is_organizer?qe():""}</div>
            ${Hn(i.status)}
          </div>
  ...
  `)}function Da(){const e=y("REFUND_PAYER_NAME",""),t=y("REFUND_PAYER_TITLE",""),n=y("REFUND_PAYER_SIGNATURE_URL","");return`
  <div style="position:fixed;inset:0;z-index:70;background:rgba(0,0,0,.5);display:flex;align-items:center;justify-content:center;padding:20px">
  ...
  </div>`}function Oa(){const e=r.adminRefundLevel||"MS",t=r.payments.filter(d=>{const s=r.teams.find(c=>c.id===d.team_id);return d.status==="verified"&&(s==null?void 0:s.level)===e}),n=t.filter(d=>le(d.team_id)).length,i=t.reduce((d,s)=>{const c=r.teams.find(x=>x.id===s.team_id),f=le(s.team_id)||Oe(c);return d+Number(f.refund_amount)},0),o=t.reduce((d,s)=>{const c=le(s.team_id);return d+(c?Number(c.refund_amount):0)},0),a=i-o;return dt(`
    <div style="flex-shrink:0;margin-bottom:10px">
      <div style="display:flex;align-items:center;justify-content:space-between;gap:8px">
    ...
    <div style="flex:1;min-height:0;display:flex;flex-direction:column;gap:9px;overflow-y:auto">
      ${t.length?t.map(d=>{const s=r.teams.find(f=>f.id===d.team_id),c=le(d.team_id),l=c||Oe(s);return`<div style="border:1px solid #e5e7eb;border-radius:11px;padding:11px">
  ...
  `)}function Ha(){const e=y("CERT_ENABLED","1")==="1",t=y("CERT_TEMPLATE_URL",""),n=y("CERT_SONG_NAME","");return ne(`
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
  ...
  `)+ne(`
    ...
    <div style="display:flex;flex-direction:column;gap:10px">
      ${Object.keys(Xe).map(i=>`
        <label style="font-size:11.5px;color:#6b7280">${p(ci[i])}
          <input class="cert-text-input" data-type="${i}" value="${p(y(`CERT_TEXT_${i}`,Xe[i]))}" style="display:block;width:100%;box-sizing:border-box;margin-top:4px;border:1px solid #e5e7eb;border-radius:9px;padding:8px 10px;font-size:12.5px"/>
        </label>`).join("")}
    </div>
  ...
  `)}function Ua(){const e=n=>{const i=Ue(n),o=Number(y("DEPOSIT_AMOUNT",500)),a=Number(y("RATE_YELLOW",30)),d=Number(y("RATE_RED",50)),s=Number(y("OPERATION_FEE",100));return r.teams.filter(c=>c.level===n).map(c=>{const l=i.find(x=>x.id===c.id)||{y:0,r:0},f=Math.max(o-s-l.y*a-l.r*d,0);return{team:c.name,refund:f}})},t=(n,i,o)=>{var f,x;const a=((f=r.awards.find(b=>b.level===n&&b.award_type===i))==null?void 0:f.student_id)||"",d=r.players.filter(b=>{var m;return((m=r.teams.find(w=>w.id===b.team_id))==null?void 0:m.level)===n}),s=a?d.find(b=>String(b.student_id)===String(a)):null,c=s&&((x=s.students)==null?void 0:x.full_name)||"";let l="";if(i==="top_scorer"){const b=Et(n);if(b.length){const m=b[0].goals,w=b.filter(_=>_.goals===m);if(w.length===1){const _=String(a)===String(w[0].studentId);l=`<div style="margin-top:4px;font-size:10.5px;color:#6b7280;display:flex;align-items:center;justify-content:space-between;gap:6px">
            <span>📊 ผู้นำ: ${p(w[0].name)} (${w[0].goals} ประตู)</span>
            ${_?'<span style="color:#16a34a;font-weight:700;flex-shrink:0">✓ เลือกแล้ว</span>':`<button data-act="useTopScorer" data-level="${n}" data-student="${w[0].studentId}" style="border:none;background:none;color:#db2777;font-weight:700;cursor:pointer;font-size:10.5px;flex-shrink:0">ใช้คนนี้</button>`}
    ...
    ${ne(`
      ...
      <div style="display:flex;flex-direction:column;gap:8px">
        ...
        <label style="font-size:11.5px;color:#6b7280">วันที่ 2 · รอบเข้ารอบจนถึงรอบชิง
          <input id="ops-start-day2" type="datetime-local" value="${p(ot(2))}" style="display:block;width:100%;box-sizing:border-box;margin-top:4px;border:1px solid #e5e7eb;border-radius:10px;padding:8px 10px;font-size:13px"/>
        </label>
        <div style="display:flex;gap:8px">
    ...
    `)}
  `}async function Fa(){await Ri(document.getElementById("azfutsal-root"),Kn)}Fa();
