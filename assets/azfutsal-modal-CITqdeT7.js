const u="10.22.817",c="10.22.817",i="azfutsal.html",f=o=>{const e=new URL(i,window.location.href);return e.searchParams.set("v",c),o&&e.searchParams.set("studentCode",o),e.href};function m(o){var r,n;(r=document.getElementById("azfutsal-modal"))==null||r.remove();const e=f(o),a=document.body.style.overflow;document.body.style.overflow="hidden";const t=document.createElement("div");t.id="azfutsal-modal",t.className="fixed inset-0 z-[320] bg-slate-950 flex flex-col",t.innerHTML=`
  ...
  `;const s=()=>{document.removeEventListener("keydown",l),document.body.style.overflow=a,t.remove()},l=d=>{d.key==="Escape"&&s()};document.addEventListener("keydown",l),document.body.appendChild(t),(n=t.querySelector("[data-azfutsal-close]"))==null||n.addEventListener("click",s)}export{u as A,c as a,m as o};
