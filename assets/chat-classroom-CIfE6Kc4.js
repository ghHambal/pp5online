import{isClassroomChatUnlocked as j,getOrCreateClassroomChatRoomId as q,getMyClassroomFreePick as J,pickClassroomChatFreeRoom as z,getClassStudents as F,getChatMessages as H,markChatRoomRead as E,deleteChatMessage as U,acknowledgeChatMessage as G,sendChatMessage as T,getTeacherNamesByProfileIds as K,getChatRoomReaders as Q,getChatMessageAcks as V,setChatMessageAck as W}from"./api-CnonnVVn.js";import{f as X}from"./student-api-CIXkHU-1.js";import{s as N}from"./supabase-BV-W2lsh.js";import{a as y,h as Y}from"./ui-CHdefT5i.js";import{_htmlEsc as x}from"./teacher-views-utils-B68DuafG.js";import{uploadChatImage as Z}from"./storage-CuUjCgvI.js";import"./impersonation-0xVfgYVY.js";import"./supabase-errors-BniCCodr.js";import"./version.js_v_10.22-mqYkeZoJ.js";function L(e){const t=document.getElementById("stu-content")||document.getElementById("main-content");t&&(t.innerHTML=e)}let _=null,$=null,C="",v=null;function k(){_&&(N.removeChannel(_),_=null),$&&(clearInterval($),$=null),v&&(clearTimeout(v),v=null),C=""}window._cleanupClassroomChat=k;const S=e=>new Date(e).toLocaleTimeString("th-TH",{hour:"2-digit",minute:"2-digit"}),B=e=>e.map(t=>`${t.id}:${t.deleted_at??""}:${t.requires_ack?1:0}`).join("|");async function fe(e,t,a){var u;(u=document.getElementById("classroom-chat-widget"))==null||u.remove(),k();const s=document.createElement("div");s.id="classroom-chat-widget",s.className="fixed inset-0 z-[200] flex items-center justify-center sm:p-4 bg-black/50",s.innerHTML=`
    ...
    </div>`}export{M as loadTeacherClassroomAccessInto,fe as openTeacherClassroomChat,be as renderStudentClassroomChat};
