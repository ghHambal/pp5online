...
import{a as g,h as P,_ as G}from"./ui-MMtcTwtt.js";import{checkDonorChatAccess as U,getDonorGroupRoomId as H,getAdminDmRoomsForAdmin as J,getMyBookmarkedMessages as W,toggleBookmark as q,getSystemConfig as F,getChatMessages as A,markChatRoomRead as E,deleteChatMessage as V,sendChatMessage as M,getMyAdminDmRoomId as K,getOrCreateAdminDmRoomId as Q,getMyClasses as X,getActiveChatAnnouncement as Y,unpinChatAnnouncement as Z,getTeacherNamesByProfileIds as ee,getChatTiersByProfileIds as te,getMyBookmarkedMessageIds as ae,getChatRoomReaders as ne,getChatAnnouncementHistory as se,createChatAnnouncement as oe}from"./api-CWYJTdOa.js";import{s as C}from"./supabase-BV-W2lsh.js";import{setActiveNav as re,setTitle as ie,setContent as ce,_htmlEsc as x}from"./teacher-views-utils-bZoYj54P.js";import{uploadChatImage as le}from"./storage-CuUjCgvI.js";import{a as de}from"./teacher-Cbd3fiuS.js";import"./impersonation-0xVfgYVY.js";import"./supabase-errors-BniCCodr.js";import"./skill-groups-BY1NTbf4.js";import"./promptpay-CIuxvxIA.js";import"./browser-JP79f-a9.js";import"./sync-CtuAgrx7.js";import"./theme-qDnPEUQn.js";import"./azfutsal-modal-CITqdeT7.js";import"./anti-pull-refresh-BGrI1pMY.js";import"./push-notify-CAl1Kmx3.js";import"./wen-sso-CcN06Rhh.js";import"./azizgames-modal-d_408eQI.js";import"./sports-portals.js_v_10.22-7yFaQki7.js";import"./sports-awards-admin-6oCPrlSb.js";import"./print-overlay-BVfxEd6n.js";import"./tutorial-D2C4vUJE.js";import"./terangganu-api-C1IjZK4l.js";import"./regrade-api-JnlABjxU.js";let k=null,_=null,L="";function h(){k&&(C.removeChannel(k),k=null),_&&(clearInterval(_),_=null),L=""}window._cleanupDonorChat=h;const j=t=>new Date(t).toLocaleTimeString("th-TH",{hour:"2-digit",minute:"2-digit"}),I=t=>t.map(e=>`${e.id}:${e.deleted_at??""}`).join("|");function $(){if(h(),typeof window._cleanupClassroomChat=="function")try{window._cleanupClassroomChat()}catch{}}const R=t=>new Date(t).toLocaleString("th-TH",{dateStyle:"medium",timeStyle:"short"});function We(t){if(!(t!=null&&t.id)||document.getElementById("donor-chat-fab"))return;const e=document.createElement("button");e.id="donor-chat-fab",e.title="แชทครูผู้สนับสนุน",e.className="fixed z-40 w-11 h-11 sm:w-14 sm:h-14 rounded-full text-white shadow-lg flex items-center justify-center overflow-hidden transition-transform hover:scale-105",e.style.cssText="position:fixed;right:max(0.75rem, env(safe-area-inset-right));left:auto;top:auto;bottom:calc(max(0.75rem, env(safe-area-inset-bottom)) + 68px + 64px);background:linear-gradient(135deg,#f59e0b,#b45309);font-size:1.3rem;",e.textContent="👑",document.body.appendChild(e),e.addEventListener("click",()=>me(t))}function S(){var t;$(),(t=document.getElementById("donor-chat-widget"))==null||t.remove()}async function me(t){var c,i;(c=document.getElementById("donor-chat-widget"))==null||c.remove(),$();const e=document.createElement("div");e.id="donor-chat-widget",e.className="fixed inset-0 z-[200] flex items-center justify-center sm:p-4 bg-black/50",e.innerHTML=`
    ...
    </div>`}export{We as injectDonorChatWidget,me as openDonorChatWidget,Fe as renderDonorChatAdmin};
