import{getClassStudents as H}from"./api-Cf_Y4s92.js";import{q as O,g as Q}from"./quiz-api-DaBneRGn.js";import{_htmlEsc as x}from"./teacher-views-utils-BWmONzsh.js";import"./supabase-BV-W2lsh.js";import"./ui-FQqAmrdo.js";import"./version.js_v_10.22-ffVTG8-v.js";const f=[{min:80,label:"80-100%",color:"#10b981"},{min:60,label:"60-79%",color:"#34d399"},{min:40,label:"40-59%",color:"#fbbf24"},{min:20,label:"20-39%",color:"#fb923c"},{min:0,label:"0-19%",color:"#ef4444"}];async function P(c){var k;(k=document.getElementById("quiz-analytics-modal"))==null||k.remove();const o=document.createElement("div");o.id="quiz-analytics-modal",o.className="fixed inset-0 z-[95] flex flex-col bg-gray-50",o.innerHTML=`
...
`),l=encodeURI("data:text/csv;charset=utf-8,"+e),a=document.createElement("a");a.href=l,a.download=`quiz_${c.title}_analytics.csv`,document.body.appendChild(a),a.click(),document.body.removeChild(a)}))}export{P as openQuizAnalytics};
