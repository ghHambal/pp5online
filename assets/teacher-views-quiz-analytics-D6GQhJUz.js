import{getClassStudents as H}from"./api-CWYJTdOa.js";import{q as O,c as Q}from"./quiz-api-BIDUVPR5.js";import{_htmlEsc as x}from"./teacher-views-utils-bZoYj54P.js";import"./supabase-BV-W2lsh.js";import"./impersonation-0xVfgYVY.js";import"./supabase-errors-BniCCodr.js";import"./skill-groups-BY1NTbf4.js";import"./ui-MMtcTwtt.js";const f=[{min:80,label:"80-100%",color:"#10b981"},{min:60,label:"60-79%",color:"#34d399"},{min:40,label:"40-59%",color:"#fbbf24"},{min:20,label:"20-39%",color:"#fb923c"},{min:0,label:"0-19%",color:"#ef4444"}];async function V(c){var k;(k=document.getElementById("quiz-analytics-modal"))==null||k.remove();const o=document.createElement("div");o.id="quiz-analytics-modal",o.className="fixed inset-0 z-[95] flex flex-col bg-gray-50",o.innerHTML=`
