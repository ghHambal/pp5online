const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/teacher-views-quiz-banks-B-LNACQS.js","assets/ui-DI1UEpN2.js","assets/version.js_v_10.22-DxLTis1W.js","assets/quiz-api-BIDUVPR5.js","assets/supabase-BV-W2lsh.js","assets/import-D0GLDW1_.js","assets/teacher-views-utils-Ceiaeijy.js","assets/katex-loader-DUJObfzT.js","assets/teacher-views-quiz-monitor-5lrNmmkc.js","assets/api-CnonnVVn.js","assets/impersonation-0xVfgYVY.js","assets/supabase-errors-BniCCodr.js","assets/teacher-views-quiz-analytics-Bbe5qdcq.js"])))=>i.map(i=>d[i]);
import{_ as A,h as I,a as v,n as D,b as Q,g as F}from"./ui-DI1UEpN2.js";import{getMyClasses as P,getSystemConfig as H,getScoreColumns as j}from"./api-CnonnVVn.js";import{t as N,c as R,v as z,s as V,n as W,w as U,x as G,y as K,p as X}from"./quiz-api-BIDUVPR5.js";import{setTitle as J,setContent as C,_htmlEsc as f,INPUT_CLS as $,SELECT_CLS as L}from"./teacher-views-utils-Ceiaeijy.js";import{l as Y,r as Z}from"./katex-loader-DUJObfzT.js";import"./version.js_v_10.22-DxLTis1W.js";import"./supabase-BV-W2lsh.js";import"./impersonation-0xVfgYVY.js";import"./supabase-errors-BniCCodr.js";const B={draft:{label:"ร่าง",cls:"bg-gray-100 text-gray-600"},announced:{label:"รอครูเริ่ม",cls:"bg-amber-100 text-amber-700"},started:{label:"กำลังสอบ",cls:"bg-emerald-100 text-emerald-700"},closed:{label:"ปิดสอบแล้ว",cls:"bg-gray-200 text-gray-500"}},O={first:"ครั้งแรก",last:"ครั้งล่าสุด",highest:"คะแนนสูงสุด"},ee={total_only:"เห็นคะแนนรวมเท่านั้น",per_question:"เห็นถูก/ผิดรายข้อ",full_review:"เห็นเฉลยเต็ม"},T={highest:{label:"เทียบเอาคะแนนสูงกว่า",hint:"ถ้าคอลัมน์นี้มีคะแนนอยู่แล้ว (กรอกมือ/กิจกรรมอื่น) จะเก็บค่าที่สูงกว่าไว้ (ค่าเริ่มต้น)"},overwrite:{label:"ทับคะแนนเก่า",hint:"เขียนทับคะแนนเดิมในคอลัมน์นี้เสมอ ไม่ว่าเดิมจะมีค่าเท่าไหร่"},add:{label:"บวกเพิ่มจากคะแนนเดิม",hint:"บวกคะแนนที่ได้จากควิซนี้เข้ากับคะแนนที่มีอยู่แล้วในคอลัมน์ เหมาะกับคอลัมน์สะสมคะแนนจากหลายควิซ"}};async function q(i,a,b=null){if(!a)return;J(`แบบทดสอบจากคลัง: ${a.name}`),C('<div class="flex justify-center py-12 text-gray-400">กำลังโหลดข้อมูล...</div>');const[n,e,r,o,h]=await Promise.all([N(a.id),P(i.id),R(a.id),H().catch(()=>({})),z(i.id).catch(()=>0)]),m=(window._pp5DonorTierIndex??0)>=2,g=parseInt(o.quizFreeStartLimit,10),u=Number.isFinite(g)?g:2,p=m||h<u,y=Object.fromEntries(e.map(t=>{var s;return[t.id,`${((s=t.master_subjects)==null?void 0:s.subject_name)??""} (${t.class_name??"—"})`]})),_=m?"":`
  ...
  `),document.getElementById("btn-back-questions").addEventListener("click",async()=>{const{_renderBankQuestions:t}=await A(async()=>{const{_renderBankQuestions:s}=await import("./teacher-views-quiz-banks-B-LNACQS.js");return{_renderBankQuestions:s}},__vite__mapDeps([0,1,2,3,4,5,6,7]));t(i,a)}),document.getElementById("btn-create-quiz").addEventListener("click",()=>M(i,a,e,r.length,null,b)),document.querySelectorAll(".btn-edit-quiz").forEach(t=>t.addEventListener("click",()=>M(i,a,e,r.length,n.find(s=>s.id===t.dataset.id)))),document.querySelectorAll(".btn-preview-quiz").forEach(t=>t.addEventListener("click",()=>se(n.find(s=>s.id===t.dataset.id),r))),document.querySelectorAll(".btn-start-quiz").forEach(t=>t.addEventListener("click",async()=>{if(!p){te(u);return}await I({title:"เริ่มสอบเลยหรือไม่?",message:"นักเรียนในห้องจะเริ่มเข้าทำแบบทดสอบได้ทันที",confirmText:"เริ่มสอบ"})&&(await V(t.dataset.id),v("เริ่มสอบแล้ว","success"),q(i,a))})),document.querySelectorAll(".btn-close-quiz").forEach(t=>t.addEventListener("click",async()=>{var k;const s=n.find(w=>w.id===t.dataset.id);if(!s)return;const d=(s.score_column_id?await j(s.class_id).catch(()=>[]):[]).find(w=>String(w.id)===String(s.score_column_id)),x=await D({quizTitle:s.title,hasScoreColumn:!!s.score_column_id,targetColumn:(d==null?void 0:d.assignment_name)??"",writeModeLabel:((k=T[s.score_write_mode])==null?void 0:k.label)??""});x&&(await W(t.dataset.id,{writeScores:x==="write_scores"}),v(x==="write_scores"?"ปิดสอบและส่งคะแนนแล้ว":"ปิดสอบแล้ว — สมุดคะแนนไม่ถูกเปลี่ยน","success"),q(i,a))})),document.querySelectorAll(".btn-apply-quiz-score").forEach(t=>t.addEventListener("click",async()=>{var S;const s=n.find(E=>E.id===t.dataset.id);if(!(s!=null&&s.score_column_id))return;const d=(await j(s.class_id).catch(()=>[])).find(E=>String(E.id)===String(s.score_column_id)),x=((S=T[s.score_write_mode])==null?void 0:S.label)??"ตามการตั้งค่า";if(!await I({title:"ส่งคะแนนข้อสอบย้อนหลัง?",message:`ระบบจะนำคะแนน “${s.title}” ไปยังคอลัมน์ “${(d==null?void 0:d.assignment_name)??"คอลัมน์ที่ผูกไว้"}”`,detail:`วิธีเขียน: ${x} · โหมดบวกเพิ่มจะเพิ่มเฉพาะส่วนต่าง จึงกดซ้ำแล้วไม่บวกคะแนนเดิมซ้ำ`,confirmText:"ส่งคะแนน"}))return;const w=await U(s.id);v(`ส่งคะแนนแล้ว ${w} คน`,"success")})),document.querySelectorAll(".btn-delete-quiz").forEach(t=>t.addEventListener("click",async()=>{await I({title:"ลบแบบทดสอบนี้?",message:"ประวัติการทำข้อสอบของนักเรียนในแบบทดสอบนี้จะถูกลบไปด้วย"})&&(await G(t.dataset.id),v("ลบแบบทดสอบแล้ว","success"),q(i,a))})),document.querySelectorAll(".btn-monitor-quiz").forEach(t=>t.addEventListener("click",async()=>{const{openQuizMonitor:s}=await A(async()=>{const{openQuizMonitor:l}=await import("./teacher-views-quiz-monitor-5lrNmmkc.js");return{openQuizMonitor:l}},__vite__mapDeps([8,9,4,10,11,3,1,2,6]));s(n.find(l=>l.id===t.dataset.id))})),document.querySelectorAll(".btn-analytics-quiz").forEach(t=>t.addEventListener("click",async()=>{const{openQuizAnalytics:s}=await A(async()=>{const{openQuizAnalytics:l}=await import("./teacher-views-quiz-analytics-Bbe5qdcq.js");return{openQuizAnalytics:l}},__vite__mapDeps([12,9,4,10,11,3,6,1,2]));s(n.find(l=>l.id===t.dataset.id))}))}async function M(i,a,b,n,e,r=null){const o=document.createElement("div");o.className="fixed inset-0 z-[90] bg-black/40 flex items-center justify-center p-4 overflow-y-auto",o.innerHTML=`
      ...
      <div class="space-y-3">
        ...
        <div>
          ...
          <select id="qz-review" class="${L}">
            ${Object.entries(ee).map(([l,d])=>`<option value="${l}" ${((e==null?void 0:e.review_policy)??"total_only")===l?"selected":""}>${d}</option>`).join("")}
          </select>
        </div>
        <div class="grid grid-cols-2 gap-3">
          <div>
  ...
  `,document.body.appendChild(o);const h=o.querySelector("#qz-class"),c=o.querySelector("#qz-score-col"),m=async()=>{const l=h.value;if(!l)return;const d=await j(l).catch(()=>[]);c.innerHTML='<option value="">— ไม่ผูกคะแนน —</option>'+d.map(x=>`<option value="${x.id}" ${(e==null?void 0:e.score_column_id)===x.id?"selected":""}>${f(x.assignment_name)}</option>`).join("")};h.addEventListener("change",m),h.value&&await m();const g=o.querySelector("#qz-write-mode-wrap"),u=o.querySelector("#qz-write-mode"),p=o.querySelector("#qz-write-mode-hint"),y=()=>{var l;g.classList.toggle("hidden",!c.value),p.textContent=((l=T[u.value])==null?void 0:l.hint)??""};c.addEventListener("change",y),u.addEventListener("change",y),y();const _=o.querySelector("#qz-lock-answer"),t=o.querySelector("#qz-instant-bonus"),s=()=>{t.checked?(_.checked=!0,_.disabled=!0):_.disabled=!1};t.addEventListener("change",s),s(),o.querySelector("#qz-cancel").addEventListener("click",()=>o.remove()),o.querySelector("#qz-save").addEventListener("click",async l=>{const d=o.querySelector("#qz-title").value.trim(),x=parseInt(o.querySelector("#qz-num").value,10);if(!d){v("กรุณาระบุชื่อแบบทดสอบ","warning");return}if(!x||x<1){v("กรุณาระบุจำนวนข้อที่ถูกต้อง","warning");return}if(x>n){v(`คลังมีแค่ ${n} ข้อ แต่ตั้งค่าให้สุ่ม ${x} ข้อ — เพิ่มคำถามในคลังก่อนบันทึก`,"warning");return}const k=o.querySelector("#qz-open").value,w=o.querySelector("#qz-close").value,S={bank_id:a.id,class_id:h.value,title:d,num_questions:x,shuffle_questions:o.querySelector("#qz-shuffle-q").checked,shuffle_choices:o.querySelector("#qz-shuffle-c").checked,lock_on_answer:o.querySelector("#qz-instant-bonus").checked||o.querySelector("#qz-lock-answer").checked,instant_feedback_bonus:o.querySelector("#qz-instant-bonus").checked,deterrent_notice_enabled:o.querySelector("#qz-deterrent").checked,max_attempts:parseInt(o.querySelector("#qz-attempts").value,10)||1,attempt_scoring_mode:o.querySelector("#qz-scoring").value,time_limit_minutes:parseInt(o.querySelector("#qz-time").value,10)||null,open_at:k?new Date(k).toISOString():null,close_at:w?new Date(w).toISOString():null,review_policy:o.querySelector("#qz-review").value,score_column_id:c.value||null,score_max:parseFloat(o.querySelector("#qz-score-max").value)||null,score_write_mode:u.value};Q(l.target,!0);try{e?await K(e.id,S):await X({...S,status:"announced"}),v("บันทึกแล้ว","success"),o.remove(),q(i,a)}catch(E){v("บันทึกไม่สำเร็จ: "+F(E),"error"),Q(l.target,!1,"บันทึก")}})}function te(i){const a=document.createElement("div");a.className="fixed inset-0 z-[95] bg-black/40 flex items-center justify-center p-4",a.innerHTML=`
  ...
  `,document.body.appendChild(a),a.querySelector("#paywall-cancel").addEventListener("click",()=>a.remove()),a.querySelector("#paywall-donate").addEventListener("click",()=>{var b;a.remove(),(b=document.getElementById("btn-donate-float"))==null||b.click()})}function se(i,a){if(!i)return;const b=a.slice(0,i.num_questions);if(!b.length){v("คลังนี้ยังไม่มีคำถาม","warning");return}let n=0;const e={},r=document.createElement("div");r.className="fixed inset-0 z-[95] bg-white flex flex-col",document.body.appendChild(r);const o=()=>{var g,u,p;const c=b[n],m=e[c.id];r.innerHTML=`
    ...
    `,Y().then(()=>Z(r)).catch(()=>{}),r.querySelector("#qp-close").addEventListener("click",()=>r.remove()),r.querySelectorAll(".qp-choice-input").forEach(y=>y.addEventListener("change",()=>{e[c.id]=parseInt(y.dataset.i,10),o()})),(g=r.querySelector("#qp-prev"))==null||g.addEventListener("click",()=>{n--,o()}),(u=r.querySelector("#qp-next"))==null||u.addEventListener("click",()=>{n++,o()}),(p=r.querySelector("#qp-finish"))==null||p.addEventListener("click",h)},h=()=>{const c=b.filter(g=>e[g.id]===g.correct_choice_index).length,m=b.length>0?c/b.length*100:0;r.innerHTML=`
      <div class="flex items-center gap-3 px-5 py-4 border-b border-gray-100 shadow-sm flex-shrink-0">
        <button id="qp-close" class="text-gray-400 hover:text-gray-700 text-2xl leading-none">←</button>
    ...
    `,r.querySelector("#qp-close").addEventListener("click",()=>r.remove()),r.querySelector("#qp-done").addEventListener("click",()=>r.remove())};o()}export{q as renderBankQuizzes};
