const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/teacher-views-quiz-banks-gbYPBFWO.js","assets/ui-FQqAmrdo.js","assets/version.js_v_10.22-ffVTG8-v.js","assets/quiz-api-DaBneRGn.js","assets/supabase-BV-W2lsh.js","assets/import-D0GLDW1_.js","assets/teacher-views-utils-BWmONzsh.js","assets/katex-loader-DUJObfzT.js","assets/teacher-views-quiz-monitor-DrZre72l.js","assets/api-Cf_Y4s92.js","assets/teacher-views-quiz-analytics-Bj3NqnvT.js"])))=>i.map(i=>d[i]);
import{_ as A,h as I,a as v,n as D,b as Q,g as F}from"./ui-FQqAmrdo.js";import{getMyClasses as P,getSystemConfig as H,getScoreColumns as j}from"./api-Cf_Y4s92.js";import{t as N,g as R,v as z,s as V,n as W,w as U,x as G,y as K,p as X}from"./quiz-api-DaBneRGn.js";import{setTitle as J,setContent as C,_htmlEsc as f,INPUT_CLS as $,SELECT_CLS as L}from"./teacher-views-utils-BWmONzsh.js";import{l as Y,r as Z}from"./katex-loader-DUJObfzT.js";import"./version.js_v_10.22-ffVTG8-v.js";import"./supabase-BV-W2lsh.js";const B={draft:{label:"ร่าง",cls:"bg-gray-100 text-gray-600"},announced:{label:"รอครูเริ่ม",cls:"bg-amber-100 text-amber-700"},started:{label:"กำลังสอบ",cls:"bg-emerald-100 text-emerald-700"},closed:{label:"ปิดสอบแล้ว",cls:"bg-gray-200 text-gray-500"}},O={first:"ครั้งแรก",last:"ครั้งล่าสุด",highest:"คะแนนสูงสุด"},ee={total_only:"เห็นคะแนนรวมเท่านั้น",per_question:"เห็นถูก/ผิดรายข้อ",full_review:"เห็นเฉลยเต็ม"},T={highest:{label:"เทียบเอาคะแนนสูงกว่า",hint:"ถ้าคอลัมน์นี้มีคะแนนอยู่แล้ว (กรอกมือ/กิจกรรมอื่น) จะเก็บค่าที่สูงกว่าไว้ (ค่าเริ่มต้น)"},overwrite:{label:"ทับคะแนนเก่า",hint:"เขียนทับคะแนนเดิมในคอลัมน์นี้เสมอ ไม่ว่าเดิมจะมีค่าเท่าไหร่"},add:{label:"บวกเพิ่มจากคะแนนเดิม",hint:"บวกคะแนนที่ได้จากควิซนี้เข้ากับคะแนนที่มีอยู่แล้วในคอลัมน์ เหมาะกับคอลัมน์สะสมคะแนนจากหลายควิซ"}};async function q(i,o,b=null){if(!o)return;J(`แบบทดสอบจากคลัง: ${o.name}`),C('<div class="flex justify-center py-12 text-gray-400">กำลังโหลดข้อมูล...</div>');const[n,e,r,a,h]=await Promise.all([N(o.id),P(i.id),R(o.id),H().catch(()=>({})),z(i.id).catch(()=>0)]),m=(window._pp5DonorTierIndex??0)>=2,g=parseInt(a.quizFreeStartLimit,10),u=Number.isFinite(g)?g:2,p=m||h<u,y=Object.fromEntries(e.map(t=>{var s;return[t.id,`${((s=t.master_subjects)==null?void 0:s.subject_name)??""} (${t.class_name??"—"})`]})),_=m?"":`
  ...
  `,document.body.appendChild(o),o.querySelector("#paywall-cancel").addEventListener("click",()=>o.remove()),o.querySelector("#paywall-donate").addEventListener("click",()=>{var b;o.remove(),(b=document.getElementById("btn-donate-float"))==null||b.click()})}function se(i,o){if(!i)return;const b=o.slice(0,i.num_questions);if(!b.length){v("คลังนี้ยังไม่มีคำถาม","warning");return}let n=0;const e={},r=document.createElement("div");r.className="fixed inset-0 z-[95] bg-white flex flex-col",document.body.appendChild(r);const a=()=>{var g,u,p;const c=b[n],m=e[c.id];r.innerHTML=`
