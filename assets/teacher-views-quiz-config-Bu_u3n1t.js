const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/teacher-views-quiz-banks-CQPj6WDR.js","assets/ui-MMtcTwtt.js","assets/quiz-api-BIDUVPR5.js","assets/supabase-BV-W2lsh.js","assets/import-DZhJ-DY2.js","assets/teacher-views-utils-bZoYj54P.js","assets/katex-loader-DUJObfzT.js","assets/teacher-views-quiz-monitor-BXd4d18R.js","assets/api-CWYJTdOa.js","assets/impersonation-0xVfgYVY.js","assets/supabase-errors-BniCCodr.js","assets/skill-groups-BY1NTbf4.js","assets/teacher-views-quiz-analytics-D6GQhJUz.js"])))=>i.map(i=>d[i]);
import{_ as A,h as I,a as v,n as D,b as Q,g as F}from"./ui-MMtcTwtt.js";import{getMyClasses as P,getSystemConfig as H,getScoreColumns as j}from"./api-CWYJTdOa.js";import{t as N,c as R,v as z,s as V,n as W,w as U,x as G,y as K,p as X}from"./quiz-api-BIDUVPR5.js";import{setTitle as J,setContent as C,_htmlEsc as f,INPUT_CLS as $,SELECT_CLS as L}from"./teacher-views-utils-bZoYj54P.js";import{l as Y,r as Z}from"./katex-loader-DUJObfzT.js";import"./supabase-BV-W2lsh.js";import"./impersonation-0xVfgYVY.js";import"./supabase-errors-BniCCodr.js";import"./skill-groups-BY1NTbf4.js";const B={draft:{label:"ร่าง",cls:"bg-gray-100 text-gray-600"},announced:{label:"รอครูเริ่ม",cls:"bg-amber-100 text-amber-700"},started:{label:"กำลังสอบ",cls:"bg-emerald-100 text-emerald-700"},closed:{label:"ปิดสอบแล้ว",cls:"bg-gray-200 text-gray-500"}},O={first:"ครั้งแรก",last:"ครั้งล่าสุด",highest:"คะแนนสูงสุด"},ee={total_only:"เห็นคะแนนรวมเท่านั้น",per_question:"เห็นถูก/ผิดรายข้อ",full_review:"เห็นเฉลยเต็ม"},T={highest:{label:"เทียบเอาคะแนนสูงกว่า",hint:"ถ้าคอลัมน์นี้มีคะแนนอยู่แล้ว (กรอกมือ/กิจกรรมอื่น) จะเก็บค่าที่สูงกว่าไว้ (ค่าเริ่มต้น)"},overwrite:{label:"ทับคะแนนเก่า",hint:"เขียนทับคะแนนเดิมในคอลัมน์นี้เสมอ ไม่ว่าเดิมจะมีค่าเท่าไหร่"},add:{label:"บวกเพิ่มจากคะแนนเดิม",hint:"บวกคะแนนที่ได้จากควิซนี้เข้ากับคะแนนที่มีอยู่แล้วในคอลัมน์ เหมาะกับคอลัมน์สะสมคะแนนจากหลายควิซ"}};async function q(i,a,b=null){if(!a)return;J(`แบบทดสอบจากคลัง: ${a.name}`),C('<div class="flex justify-center py-12 text-gray-400">กำลังโหลดข้อมูล...</div>');const[n,e,r,o,h]=await Promise.all([N(a.id),P(i.id),R(a.id),H().catch(()=>({})),z(i.id).catch(()=>0)]),m=(window._pp5DonorTierIndex??0)>=2,g=parseInt(o.quizFreeStartLimit,10),u=Number.isFinite(g)?g:2,p=m||h<u,y=Object.fromEntries(e.map(t=>{var s;return[t.id,`${((s=t.master_subjects)==null?void 0:s.subject_name)??""} (${t.class_name??"—"})`]})),_=m?"":`
