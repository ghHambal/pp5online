import{getClassStudents as S}from"./api-Cf_Y4s92.js";import{g as L,m as j,o as C}from"./quiz-api-DaBneRGn.js";import{s as k}from"./supabase-BV-W2lsh.js";import{a as w,g as M}from"./ui-FQqAmrdo.js";import{_htmlEsc as x}from"./teacher-views-utils-BWmONzsh.js";import"./version.js_v_10.22-ffVTG8-v.js";let b=null,u=null,_=0;const R=1e3,$={in_progress:{label:"กำลังทำ",cls:"bg-emerald-100 text-emerald-700"},submitted:{label:"ส่งแล้ว",cls:"bg-blue-100 text-blue-700"},terminated_violation:{label:"🔒 ถูกล็อก",cls:"bg-red-100 text-red-700"}};function T(e){const n=x(((e==null?void 0:e.full_name)??"?").charAt(0)),a="relative w-9 h-12 rounded-xl overflow-hidden flex-shrink-0 shadow-md ring-1 ring-black/5",d='<div class="absolute inset-0 rounded-xl pointer-events-none" style="box-shadow: inset 0 1px 2px rgba(255,255,255,0.55), inset 0 -10px 14px rgba(0,0,0,0.18)"></div>';return e!=null&&e.image_url?`<div class="${a}"><img src="${x(e.image_url)}" class="w-full h-full object-cover" />${d}</div>`:`<div class="${a} bg-gray-100 flex items-center justify-center text-sm font-bold text-gray-400">${n}${d}</div>`}async function B(e){var o;f(),(o=document.getElementById("quiz-monitor-modal"))==null||o.remove();const n=document.createElement("div");n.id="quiz-monitor-modal",n.className="fixed inset-0 z-[95] flex flex-col bg-gray-50",n.innerHTML=`
  ...
  `,document.body.appendChild(t),t.querySelector("#unlock-cancel").addEventListener("click",()=>t.remove());const o=async r=>{t.remove();try{await C(e,r),w(r==="resume"?"ปลดล็อก — ทำต่อจากจุดเดิมแล้ว":"ปลดล็อก — เริ่มชุดใหม่แล้ว","success"),await g(n,a,d)}catch(c){w("ปลดล็อกไม่สำเร็จ: "+M(c),"error")}};t.querySelector("#unlock-resume").addEventListener("click",()=>o("resume")),t.querySelector("#unlock-restart").addEventListener("click",()=>o("restart"))}export{B as openQuizMonitor};
