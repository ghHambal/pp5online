const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/teacher-views-quiz-banks-CQPj6WDR.js","assets/ui-MMtcTwtt.js","assets/quiz-api-BIDUVPR5.js","assets/supabase-BV-W2lsh.js","assets/import-DZhJ-DY2.js","assets/teacher-views-utils-bZoYj54P.js","assets/katex-loader-DUJObfzT.js","assets/chat-classroom-QsACduN9.js","assets/api-CWYJTdOa.js","assets/impersonation-0xVfgYVY.js","assets/supabase-errors-BniCCodr.js","assets/skill-groups-BY1NTbf4.js","assets/student-api-BkkkCebX.js","assets/score-display-CQ4dUIPx.js","assets/storage-CuUjCgvI.js"])))=>i.map(i=>d[i]);
import{a as b,g as M,n as Rs,_ as zt}from"./ui-MMtcTwtt.js";import{getSystemConfig as Zt,getMyClasses as $e,getMySchedule as Jt,getClassScheduleLinks as Kt,getPeriods as es,setSmartClassroomFreeClass as ts,getClassStudents as Qs,getActiveLeavePermissionsForClass as Us,getLeaveMaxActiveForClass as Ws,getLeaveMaxPerStudentWeekForClass as Gs,getScoreColumns as Vs,getStudentScores as Ys,getClassAttendanceAllFull as Xs,getClassLeaveHistory as Zs,getClassAssignmentsWithSubmissions as Js,getTeacherExamRequests as Ks,getClassAnnouncements as en,getAnnouncementTypeSuggestions as tn,getCourseSyllabus as sn,getLessonPlans as nn,getClassSessionDOWs as an,closeLeavePermission as Ht,createAnnouncement as rn,deleteAssignment as Pt,updateAssignment as on,createAssignment as ln,getMyDonationRequests as dn,saveStudentScore as cn,markAssignmentSubmissionReviewed as un,saveAssignmentFeedback as pn,rejectAssignmentSubmission as mn,saveAssignmentGrade as xn,deleteSyllabusItem as bn,updateSyllabusItem as gn,createSyllabusItem as fn,deleteLessonPlan as yn,updateLessonPlan as vn,createLessonPlan as hn}from"./api-CWYJTdOa.js";import{_ as He,a as ss,b as wn}from"./teacher-Cbd3fiuS.js";import{l as _n,m as Dt,s as kn,n as $n,o as Sn,f as En,k as Ln,c as qn,p as jn}from"./quiz-api-BIDUVPR5.js";import{openScoreScanner as In}from"./score-qr-scanner-CfDHgG4i.js";import{_openAttendanceModalForSession as Ft,_openLeaveQuotaModal as Cn,openAttendanceScanSetup as Mn,_openLeaveRequestModal as Tn,renderAttendanceGrid as An}from"./teacher-views-attendance-DkKZdoEb.js";import{p as Bn,a as zn}from"./teacher-views-grades-CXFdJBGK.js";import{openQuizMonitor as Nt}from"./teacher-views-quiz-monitor-BXd4d18R.js";import{openQuizAnalytics as Hn}from"./teacher-views-quiz-analytics-D6GQhJUz.js";import{openClassDashboard as Pn}from"./teacher-views-dashboard-B0a46sXh.js";import{e as ke,o as Dn,_ as Fn,j as Nn}from"./teacher-views-classes-DgW_t4uH.js";import{uploadAssignmentFile as Ot}from"./storage-CuUjCgvI.js";import{_htmlEsc as o,setActiveNav as Rt,setTitle as Qt,setContent as ze,_currentWeek as On,_generateSessions as Rn,_dateInputValue as Qn,ATT_STATUS as Ut,openFullScreenGridOverlay as Un}from"./teacher-views-utils-bZoYj54P.js";import{s as Wn}from"./supabase-BV-W2lsh.js";import{b as Gn,e as Wt}from"./score-display-CQ4dUIPx.js";import{openLessonPlanAIWorkspace as Gt,openLessonPlanDocument as Vn}from"./lesson-plan-ai-workspace-BgLV29Ng.js";import"./impersonation-0xVfgYVY.js";import"./supabase-errors-BniCCodr.js";import"./skill-groups-BY1NTbf4.js";import"./promptpay-CIuxvxIA.js";import"./browser-JP79f-a9.js";import"./sync-CtuAgrx7.js";import"./theme-qDnPEUQn.js";import"./azfutsal-modal-CITqdeT7.js";import"./anti-pull-refresh-BGrI1pMY.js";import"./push-notify-CAl1Kmx3.js";import"./wen-sso-CcN06Rhh.js";import"./azizgames-modal-d_408eQI.js";import"./sports-portals.js_v_10.22-7yFaQki7.js";import"./sports-awards-admin-6oCPrlSb.js";import"./print-overlay-BVfxEd6n.js";import"./tutorial-D2C4vUJE.js";import"./terangganu-api-C1IjZK4l.js";import"./regrade-api-JnlABjxU.js";import"./leave-time-CrS9gT63.js";import"./pp5-doc-WG5YzWe3.js";import"./confetti-loader-BAN5Lv-C.js";function Yn(m){var x;return((x=String((m==null?void 0:m.donationSpecialFeatures)??"").split(`
`).map(I=>{const A=I.split("|");return{text:A[1]??"",minTier:parseInt(A[2])||1}}).find(I=>I.text.includes("Smart Classroom")))==null?void 0:x.minTier)??4}async function ns(m){const x=await Zt().catch(()=>window._pp5SystemCfg??{}),I=Yn(x);let A=window._pp5DonorTierIndex??0,U=[];if(m!=null&&m.id)try{U=await dn(m.id);const B=U.filter($=>$.package_type==="donation"&&$.status==="approved").reduce(($,W)=>$+(W.amount??0),0),f=He(x.donationMinAmount,49),y=He(x.donationAmountStep,50),F=ss(x,f,y);A=wn(x,F,B)}catch{}return{cfg:x,minTier:I,unlocked:A>=I,donationRequests:U}}function Xn(m,x){var A;return He(m.donationMinAmount,49),He(m.donationAmountStep,50),((A=ss(m)[x-1])==null?void 0:A.amount)??null}function Zn(m,x,I){return m?!0:(x==null?void 0:x.smart_classroom_free_class_id)===I}async function as(m,x,{preselectClassId:I=null,onPicked:A}={}){var f;(f=document.getElementById("sc-pick-modal"))==null||f.remove();const U=await $e(m.id).catch(()=>[]),B=document.createElement("div");B.id="sc-pick-modal",B.className="fixed inset-0 z-[96] flex items-center justify-center bg-black/60 p-4",B.innerHTML=`
    <div class="bg-white rounded-3xl shadow-2xl w-full max-w-sm max-h-[85vh] flex flex-col overflow-hidden">
      ...
      <div class="overflow-y-auto flex-1 p-4 space-y-2">
        ${U.length?U.map(y=>`
          <label class="flex items-center gap-3 px-4 py-3 rounded-xl border cursor-pointer transition hover:border-amber-300 ${y.id===I?"border-amber-400 bg-amber-50":"border-gray-200"}">
            ...
            <span class="text-sm font-semibold text-gray-700">${o(y.class_name)}</span>
      ...
      <div class="p-4 flex-shrink-0 border-t border-gray-100">
        <button id="sc-pick-confirm" class="w-full py-3 rounded-2xl text-white font-bold text-sm shadow-lg hover:opacity-90 transition"
          style="background:linear-gradient(135deg,#a9781a,#e6c988)" ${U.length?"":"disabled"}>✅ ยืนยันใช้ห้องนี้</button>
        <button id="sc-pick-cancel" class="w-full py-2 mt-1.5 text-xs text-gray-400 hover:text-gray-600">ยกเลิก</button>
      </div>
    </div>`,document.body.appendChild(B),B.addEventListener("click",y=>{y.target===B&&B.remove()}),B.querySelector("#sc-pick-cancel").addEventListener("click",()=>B.remove()),B.querySelector("#sc-pick-confirm").addEventListener("click",async()=>{const y=B.querySelector('input[name="sc-pick-class"]:checked');if(!y){b("กรุณาเลือกห้องเรียน","warning");return}const F=parseInt(y.value),$=B.querySelector("#sc-pick-confirm");$.disabled=!0,$.textContent="กำลังบันทึก...";try{if(!await ts(m.id,F)){b("มีการเลือกห้องไปแล้วก่อนหน้านี้ กรุณาลองใหม่","error"),B.remove();return}m.smart_classroom_free_class_id=F,B.remove(),b("เลือกห้องฟรีสำเร็จ ✅","success"),A==null||A(F)}catch(W){b("บันทึกไม่สำเร็จ: "+M(W),"error"),$.disabled=!1,$.textContent="✅ ยืนยันใช้ห้องนี้"}})}function Vt(m){const x=Math.max(0,Math.floor((Date.now()-new Date(m).getTime())/6e4));return x<1?"<1 นาที":`${x} นาที`}const Yt="pp5_sc_skip_popup";async function Jn(m){var de,z,K,ve;const x=window._pp5SystemCfg??await Zt().catch(()=>({})),I=parseInt(x.academicYear??2568),A=parseInt(x.semester??1),[U,B,f,y]=await Promise.all([$e(m.id).catch(()=>[]),Jt(m.id,I,A).catch(()=>[]),Kt(m.id).catch(()=>[]),es().catch(()=>[])]);if(!U.length)return{classId:null,mode:"none"};const F=Object.fromEntries(y.map(T=>[T.period_no,T])),$=Object.fromEntries(B.map(T=>[T.id,T])),W=[];for(const T of f){const X=$[T.teacher_schedule_id];if(!X)continue;const ce=(X.period_no??1)+(X.span_periods??1)-1;W.push({classId:T.class_id,day_of_week:X.day_of_week,period:F[X.period_no],actualEndPeriod:F[ce]??F[X.period_no]})}const R=new Date,ie=R.getDay(),q=R.getHours()*3600+R.getMinutes()*60+R.getSeconds();for(const T of W){if(T.day_of_week!==ie||!((de=T.period)!=null&&de.start_time)||!((z=T.actualEndPeriod)!=null&&z.end_time))continue;const[X,ce]=T.period.start_time.split(":").map(Number),[ue,G]=T.actualEndPeriod.end_time.split(":").map(Number),Z=X*3600+ce*60,Se=ue*3600+G*60;if(q>=Z&&q<Se)return{classId:T.classId,mode:"live"}}let te=null;for(const T of W){if(!((K=T.period)!=null&&K.start_time))continue;const[X,ce]=T.period.start_time.split(":").map(Number),ue=X*3600+ce*60;let G=(T.day_of_week-ie+7)%7;G===0&&ue<=q&&(G=7);const Z=G*86400+ue-q;(te===null||Z<te.totalSecUntil)&&(te={totalSecUntil:Z,classId:T.classId})}return te?{classId:te.classId,mode:"upcoming"}:{classId:((ve=U[0])==null?void 0:ve.id)??null,mode:"none"}}async function za(m){var W,R,ie,q,te,de;const{cfg:x,minTier:I,unlocked:A}=await ns(m);if(A&&localStorage.getItem(Yt)==="1"){Xt(m);return}if(!A&&(m!=null&&m.smart_classroom_free_class_id)){xe(m,m.smart_classroom_free_class_id);return}(W=document.getElementById("sc-landing-modal"))==null||W.remove();const U=((R=x.smartClassroomLandingTitle)==null?void 0:R.trim())||"Smart Classroom — หน้าควบคุมขณะสอนสด",B=((ie=x.smartClassroomLandingDesc)==null?void 0:ie.trim())||"ทุกวินาทีระหว่างสอนสดมีค่า — ไม่ต้องเสียเวลาสลับหน้าจอไปมาระหว่างเช็คชื่อ คุมเวลา เปิดควิซ หรือสั่งงาน อีกต่อไป Smart Classroom รวมทุกเครื่องมือที่คุณใช้บ่อยที่สุดไว้จอเดียว ให้คุณโฟกัสกับการสอนได้เต็มที่ นักเรียนก็ได้รับข่าวสารถึงมือถือทันทีโดยไม่พลาด และแผนการสอน/บันทึกหลังสอนของคุณจะถูกเก็บเป็นระบบ พร้อมให้ตรวจสอบได้ทุกเมื่อโดยไม่ต้องมานั่งรวบรวมทีหลัง",f=[x.smartClassroomLandingImg1,x.smartClassroomLandingImg2,x.smartClassroomLandingImg3].filter(Boolean),y=[{emoji:"⏱️",text:"ไม่ต้องสลับหน้าจอนับสิบรอบระหว่างสอน ทุกเครื่องมือรวมไว้จอเดียว"},{emoji:"📲",text:"นักเรียนไม่พลาดประกาศ/งานอีกต่อไป แจ้งเตือนถึงมือถือทันทีที่กดส่ง"},{emoji:"📋",text:"แผนการสอน+บันทึกหลังสอนเป็นระบบ พร้อมตรวจสอบได้ทุกเมื่อ"}],F=["✅ เช็คชื่ออัตโนมัติ","🚪 Hall Pass สด","🎲 สุ่ม/จัดกลุ่ม","🧠 เปิดควิซสด","📚 สั่งงาน/ติดตามงาน","📘 กำหนดการสอน+แผนการสอน","🖊️ บันทึกหลังสอน+เซ็นชื่อ","📣 ประกาศแนบไฟล์+แจ้งเตือนมือถือ"],$=document.createElement("div");$.id="sc-landing-modal",$.className="fixed inset-0 z-[95] flex items-center justify-center bg-black/60 p-4",$.innerHTML=`
    <div class="bg-white rounded-3xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto animate-fade">
      <div class="relative px-6 py-8 text-center" style="background:linear-gradient(135deg,#a9781a,#e6c988)">
        ...
        <h2 class="text-white font-extrabold text-xl">${o(U)}</h2>
      </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-2">
          ${y.map(z=>`
            <div class="px-3 py-3 rounded-xl bg-amber-50 border border-amber-100 text-center">
              ...
              <p class="text-[11px] font-bold text-amber-800 leading-snug">${o(z.text)}</p>
            </div>`).join("")}
        </div>
        <p class="text-sm text-gray-600 leading-relaxed whitespace-pre-line">${o(B)}</p>
        ${f.length?`<div class="grid ${f.length>1?"grid-cols-2":"grid-cols-1"} gap-2">${f.map(z=>`<img src="${o(z)}" class="w-full rounded-xl border border-gray-100 object-cover" />`).join("")}</div>`:""}
        <div>
          ...
          <div class="grid grid-cols-2 gap-1.5 text-[11px] text-gray-500">
            ${F.map(z=>`<div class="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-gray-50">${z}</div>`).join("")}
          </div>
        </div>
        ${A?`
    ...
    <svg class="animate-spin h-6 w-6" viewBox="0 0 24 24" fill="none">
      ...
      <p class="text-sm text-gray-500 mt-2 leading-relaxed">คุณใช้สิทธิ์ฟรีกับห้อง <b>${o(t)}</b> ไปแล้ว<br>หากต้องการใช้ห้องนี้ด้วย กรุณาสนับสนุนระบบระดับ ${A}${n?` (${n} บาท)`:""} ขึ้นไปเพื่อใช้ได้ไม่จำกัดห้องครับ</p>
      ...
      <div class="relative w-9 h-9 mx-auto mb-1.5 mt-2 rounded-lg overflow-hidden bg-indigo-100 flex items-center justify-center text-indigo-700 font-bold text-xs">
        ${e.image_url?`<img src="${o(e.image_url)}" class="w-full h-full object-cover"/>`:o((e.full_name??"?").charAt(0))}
      ...
      <div class="text-[9px] text-gray-400 font-mono">${o(e.student_code??"")}</div>
      <div class="text-[11px] font-semibold text-gray-700 leading-tight truncate">${o(e.full_name??"")}</div>
      ${r?`<div class="mt-1 px-1.5 py-0.5 rounded-lg border text-[9px] font-bold truncate ${r.cls}">${r.icon} ${r.label}</div>`:a?`<div class="text-[10px] font-bold text-amber-600 mt-0.5">${o(a)}</div>`:""}
    </button>`}).join(""),cs=()=>F.length?F.map(e=>{const s=Ve[e.student_id];return`<div class="flex items-center gap-3 px-3 py-2.5 rounded-xl border border-amber-100 bg-amber-50 mb-2">
        <div class="w-8 h-8 rounded-lg overflow-hidden bg-indigo-100 flex items-center justify-center text-indigo-700 font-bold text-xs flex-shrink-0">
          ${s!=null&&s.image_url?`<img src="${o(s.image_url)}" class="w-full h-full object-cover"/>`:o(((s==null?void 0:s.full_name)??"?").charAt(0))}
        </div>
        <div class="flex-1 min-w-0">
          <p class="text-xs font-bold text-gray-800 truncate">${o((s==null?void 0:s.full_name)??"—")}</p>
          <p class="text-[10px] text-gray-500 truncate">${o(e.reason??"")}</p>
        </div>
      ...
      <div class="flex items-center gap-2 px-3 py-2 rounded-xl border border-gray-100 bg-gray-50">
        ...
        <div class="flex-1 min-w-0">
          <p class="text-xs font-bold text-gray-700 truncate">${o(e.title??"ควิซ")}</p>
        ...
        <div class="bg-white rounded-3xl p-6 w-full max-w-sm shadow-2xl my-8">
          ...
          <p class="text-xs text-gray-400 mb-4">${o(f.class_name??"")}</p>
          ...
          <div class="space-y-1.5 max-h-72 overflow-y-auto">
            ${d.map(l=>`
              <button class="sqq-bank-pick w-full text-left px-3.5 py-2.5 rounded-xl border border-gray-100 hover:border-indigo-300 hover:bg-indigo-50/50 transition" data-id="${l.id}">
                <span class="text-sm font-semibold text-gray-700">${o(l.name)}</span>
                ${l.description?`<p class="text-[11px] text-gray-400 truncate">${o(l.description)}</p>`:""}
              </button>`).join("")}
          </div>
          <button id="sqq-back" class="w-full mt-4 py-2 text-xs text-gray-400 hover:text-gray-600">← กลับ</button>
        </div>`,e.querySelector("#sqq-back").addEventListener("click",s),e.querySelectorAll(".sqq-bank-pick").forEach(l=>l.addEventListener("click",()=>n(d.find(p=>p.id===l.dataset.id))))},n=async d=>{e.innerHTML='<div class="bg-white rounded-3xl p-6 w-full max-w-sm shadow-2xl my-8 text-center text-sm text-gray-400 py-10">กำลังโหลด...</div>';const l=await qn(d.id).catch(()=>[]);if(!l.length){e.innerHTML=`
          <div class="bg-white rounded-3xl p-6 w-full max-w-sm shadow-2xl my-8 text-center">
            <p class="text-sm text-gray-500 mb-4">คลัง "${o(d.name)}" ยังไม่มีคำถามเลย เพิ่มคำถามก่อนถึงจะเปิดสอบได้</p>
            <button id="sqq-back" class="w-full py-2.5 rounded-xl border border-gray-200 text-gray-600 text-sm font-semibold">← กลับ</button>
        ...
        <div class="bg-white rounded-3xl p-6 w-full max-w-sm shadow-2xl my-8">
          <h3 class="font-bold text-gray-800 text-lg mb-1">🚀 เปิดสอบ: ${o(d.name)}</h3>
          <p class="text-xs text-gray-400 mb-4">คลังนี้มีคำถามทั้งหมด ${l.length} ข้อ · ${o(f.class_name??"")}</p>
          <div class="space-y-3">
            <div>
              <label class="text-xs font-semibold text-gray-500 mb-1 block">ชื่อการสอบครั้งนี้</label>
              <input id="sqq-title" class="input-field w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm" value="${o(d.name)} (${p})" />
            </div>
        ...
        </div>`,e.querySelector("#sqq-back").addEventListener("click",t),e.querySelector("#sqq-launch").addEventListener("click",async g=>{const i=e.querySelector("#sqq-title").value.trim(),c=parseInt(e.querySelector("#sqq-num").value,10);if(!i){b("กรุณาระบุชื่อการสอบ","warning");return}if(!c||c<1||c>l.length){b(`จำนวนข้อต้องอยู่ระหว่าง 1 – ${l.length}`,"warning");return}const u=g.target;u.disabled=!0,u.textContent="กำลังเปิด...";try{await jn({bank_id:d.id,class_id:x,title:i,num_questions:c,time_limit_minutes:parseInt(e.querySelector("#sqq-time").value,10)||null,status:"announced"}),b('สร้างควิซให้ห้องนี้แล้ว 🧠 กด "▶ เริ่ม" ในรายการเพื่อเปิดสอบสดได้เลย',"success"),e.remove(),D()}catch(S){b("เปิดควิซไม่สำเร็จ: "+M(S),"error"),u.disabled=!1,u.textContent="เปิดให้ห้องนี้"}})},a=()=>{e.innerHTML=`
        <div class="bg-white rounded-3xl p-6 w-full max-w-sm shadow-2xl my-8">
          <h3 class="font-bold text-gray-800 text-lg mb-1">✏️ สร้างคลังข้อสอบใหม่</h3>
          <p class="text-xs text-gray-400 mb-4">${o(f.class_name??"")} — ตั้งชื่อคลังก่อน แล้วไปเพิ่มคำถามได้ต่อ (พิมพ์เอง / ให้ AI ช่วยคิด / นำเข้า CSV)</p>
          <div>
        ...
        </div>`,e.querySelector("#sqq-back").addEventListener("click",s),e.querySelector("#sqq-c-save").addEventListener("click",async d=>{const l=e.querySelector("#sqq-c-title").value.trim();if(!l){b("กรุณาระบุชื่อคลังข้อสอบ","warning");return}const p=d.target;p.disabled=!0,p.textContent="กำลังสร้าง...";try{const g=await Ln({teacher_id:m.id,subject_id:ae,name:l}),{_renderBankQuestions:i}=await zt(async()=>{const{_renderBankQuestions:c}=await import("./teacher-views-quiz-banks-CQPj6WDR.js");return{_renderBankQuestions:c}},__vite__mapDeps([0,1,2,3,4,5,6]));e.remove(),b("สร้างคลังแล้ว — เพิ่มคำถามให้ครบก่อนไปสร้างแบบทดสอบนะครับ","success"),i(m,g,x)}catch(g){b("สร้างไม่สำเร็จ: "+M(g),"error"),p.disabled=!1,p.textContent="สร้างคลัง → เพิ่มคำถาม"}})};e.addEventListener("click",d=>{d.target===e&&e.remove()}),s()}const ms=()=>ue.length?`<div class="space-y-1.5 mb-3 max-h-40 overflow-y-auto">${ue.slice(0,10).map(e=>{var t;const s=[...Array.isArray(e.attachment_urls)?e.attachment_urls:[],...e.file_url?[{url:e.file_url,name:"ไฟล์แนบ"}]:[]];return`
      <div class="px-3 py-2 rounded-xl bg-gray-50 border border-gray-100 text-xs">
        <div class="flex items-center gap-1.5 flex-wrap">
          ${e.ann_type&&e.ann_type!=="general"?`<span class="text-[9px] font-bold px-1.5 py-0.5 rounded-full bg-amber-100 text-amber-700 flex-shrink-0">${o(e.ann_type)}</span>`:""}
          <p class="font-semibold text-gray-700 truncate flex-1 min-w-0">${o(e.title)}</p>
        </div>
        ${e.body?`<p class="text-gray-400 truncate">${o(e.body.slice(0,80))}</p>`:""}
        ${s.length?`<div class="flex flex-wrap gap-1 mt-1">${s.map(n=>`<a href="${o(n.url)}" target="_blank" rel="noopener" class="text-[10px] px-1.5 py-0.5 rounded-lg bg-white border border-gray-200 text-indigo-600 hover:bg-indigo-50">📎 ${o(n.name??"ไฟล์")}</a>`).join("")}</div>`:""}
        <p class="text-[10px] text-gray-300 mt-0.5">${new Date(e.created_at).toLocaleDateString("th-TH",{day:"numeric",month:"short",year:"2-digit"})}${(t=e.teachers)!=null&&t.full_name?" · "+o(e.teachers.full_name):""}</p>
      </div>`}).join("")}</div>`:'<p class="text-xs text-gray-400 mb-2">ยังไม่มีประกาศสำหรับห้องนี้</p>',xs=["อาทิตย์","จันทร์","อังคาร","พุธ","พฤหัสบดี","ศุกร์","เสาร์"],tt=e=>{if(!we.length)return'<p class="text-center py-6 text-xs text-gray-400">ยังไม่ได้ผูกตารางสอนให้ห้องนี้</p>';if(e==="daily"){const t=new Date().getDay(),n=we.filter(a=>a.day_of_week===t);return n.length?n.map(a=>{var r,d,l,p;return`
        <div class="flex items-center justify-between px-3 py-2.5 rounded-xl border border-gray-100 bg-gray-50 mb-1.5 text-xs">
          ...
          <span class="text-gray-500 font-mono">${((d=(r=a.period)==null?void 0:r.start_time)==null?void 0:d.slice(0,5))??"—"} - ${((p=(l=a.actualEndPeriod)==null?void 0:l.end_time)==null?void 0:p.slice(0,5))??"—"}</span>
      ...
      <div class="flex items-center gap-3 px-3 py-2.5 rounded-xl border border-gray-100 bg-gray-50 mb-1.5 text-xs">
        ...
        <div class="flex-1 min-w-0">
          <p class="font-semibold text-gray-700 truncate">${o(((t=e.students)==null?void 0:t.full_name)??"—")} — ${o(e.request_type??"")}</p>
      ...
      </div>`}).join(""):'<p class="text-center py-6 text-xs text-gray-400">ไม่มีคำร้องรอดำเนินการ</p>',Oe=e=>e?new Date(e).toLocaleString("th-TH",{day:"numeric",month:"short",year:"2-digit",hour:"2-digit",minute:"2-digit"}):"ไม่กำหนดส่ง",Re=e=>new Set((e.submissions??[]).map(s=>s.student_id)).size,nt=e=>{const s=Math.max(0,y.length-Re(e));if(!e.due_at||s===0)return{key:"normal",missingCount:s,urgent:!1,label:Oe(e.due_at)};const t=new Date(e.due_at).getTime()-Date.now(),n=Math.max(1,Math.ceil(Math.abs(t)/36e5));if(t<0){const a=n<24?`เกินกำหนด ${n} ชม.`:`เกินกำหนด ${Math.ceil(n/24)} วัน`;return{key:"overdue",missingCount:s,urgent:!0,label:a,diffMs:t}}return t<=864e5?{key:"today",missingCount:s,urgent:!0,label:`เหลือ ${n} ชม.`,diffMs:t}:t<=2592e5?{key:"soon",missingCount:s,urgent:!0,label:`เหลือ ${Math.ceil(n/24)} วัน`,diffMs:t}:{key:"normal",missingCount:s,urgent:!1,label:Oe(e.due_at),diffMs:t}},oe=K.map(e=>({assignment:e,state:nt(e)})).filter(e=>e.state.urgent).sort((e,s)=>{const t=e.state.key==="overdue",n=s.state.key==="overdue";if(t!==n)return t?-1:1;const a=new Date(e.assignment.due_at).getTime(),r=new Date(s.assignment.due_at).getTime();return t?r-a:a-r}),at=(e="mobile")=>{if(!oe.length)return"";const{assignment:s,state:t}=oe[0],n=Re(s);return`<div class="rounded-2xl border ${t.key==="overdue"?"border-red-200 bg-red-50 text-red-800":t.key==="today"?"border-orange-200 bg-orange-50 text-orange-800":"border-amber-200 bg-amber-50 text-amber-800"} shadow-sm p-4 ${e==="mobile"?"mb-4 lg:hidden":"mb-4 hidden lg:block"}">
      ...
      <p class="text-sm font-bold mt-2 truncate">${o(s.title)}</p>
      <p class="text-[11px] mt-1 opacity-80">${n}/${y.length} ส่งแล้ว · <b>${t.missingCount} คนยังไม่ส่ง</b></p>
      ${oe.length>1?`<p class="text-[10px] mt-1 opacity-70">และมีงานเร่งด่วนอีก ${oe.length-1} งาน</p>`:""}
      <div class="grid grid-cols-[1fr_auto] gap-2 mt-3">
        ...
        <div class="flex items-center gap-2 mt-1.5">
          ...
          ${r.missingCount?`<span class="text-[10px] font-bold ${r.urgent?l:"text-gray-400"} flex-shrink-0">${r.missingCount} ยังไม่ส่ง</span>`:""}
          ${a?`<span class="text-[10px] font-bold text-amber-600 flex-shrink-0">ช้า ${a}</span>`:""}
        </div>
      </button>`}).join(""):'<p class="text-center py-6 text-xs text-gray-400">ยังไม่มีงานที่มอบหมาย — กด "➕ สั่งงานใหม่" เพื่อเริ่ม</p>',re=On(I.semester_start),pe=G.find(e=>re>=e.week_start&&re<=e.week_end),fs=()=>G.length?`<div class="max-h-72 lg:max-h-[28rem] overflow-y-auto space-y-2 pr-1">${G.map(e=>`
      <button class="sc-syllabus-row w-full text-left flex items-center gap-2 px-3 py-2 rounded-xl border transition ${re>=e.week_start&&re<=e.week_end?"border-indigo-300 bg-indigo-50":"border-gray-100 bg-gray-50 hover:border-indigo-200"}" data-sylid="${e.id}">
        ...
        <span class="text-xs font-semibold text-gray-700 truncate flex-1">${o(e.topic)}</span>
      ...
      <div class="flex items-center gap-2 px-3 py-2 rounded-xl border border-gray-100 bg-gray-50">
        <button class="sc-plan-row flex-1 min-w-0 text-left" data-planid="${e.id}">
          <p class="text-xs font-bold text-gray-700 truncate">${o(e.title)}</p>
      ...
      <div class="my-3 px-3 py-2.5 rounded-xl ${pe?"bg-indigo-50 border border-indigo-100":"bg-gray-50 border border-gray-100"}">
        ...
        <p class="text-sm font-bold ${pe?"text-indigo-700":"text-gray-400"} mt-0.5">${pe?o(pe.topic):"ยังไม่ได้กำหนดหัวข้อสำหรับสัปดาห์นี้"}</p>
      </div>
    ...
    <div class="relative overflow-hidden bg-white border border-amber-200 rounded-2xl shadow-sm px-5 py-4 mb-4 flex items-center gap-4 flex-wrap">
      ...
      <div class="min-w-0">
        <h1 class="font-bold text-gray-800 text-base truncate">${o(Pe.subject_name??"")} · ${o(f.class_name??"")}</h1>
      ...
      <div class="min-w-0 border-l border-amber-100 pl-4">
        ...
        <p class="text-xs font-semibold ${pe?"text-gray-700":"text-gray-400"} truncate max-w-[240px]">${pe?o(pe.topic):"ยังไม่ได้กำหนดหัวข้อสำหรับสัปดาห์นี้"}</p>
      </div>
      ...
      <div id="sc-mobile-room-section" class="sc-mobile-app-section mobile-active">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 mb-4">
          ...
          ${ee?`<div class="flex items-center flex-wrap gap-2 mb-3 px-3 py-2 rounded-xl bg-red-50 border border-red-100 text-[11px] text-red-700">
            <span class="font-bold">🔴 กำลังสอบสด: ${o(ee.title)}</span>
    ...
    <div id="sc-reference-panel" class="sc-reference-panel bg-white rounded-2xl border border-gray-100 shadow-sm p-4 lg:p-5 mt-4">
      ...
      <div class="hidden lg:flex items-center justify-between gap-3 mb-4"><div><h2 class="text-base font-extrabold text-gray-800">พื้นที่จัดการรายวิชา</h2><p class="text-xs text-gray-400 mt-0.5">เลือกงานที่ต้องการ ระบบจะแยกข้อมูลและปุ่มสร้างให้ชัดเจน</p></div><span class="px-3 py-1.5 rounded-full bg-amber-50 border border-amber-100 text-[10px] font-bold text-amber-700">${o(Pe.subject_name??"")}</span></div>
      <div id="sc-reftabs-bar" class="sc-desktop-ref-tabs mb-5">
        ${ye.map(e=>`<button data-reftab="${e.key}" class="sc-reftab-btn ${e.key===ne?"active":""}"><span class="sc-ref-tab-icon">${e.icon}</span><span class="min-w-0 text-left"><b>${e.label}${e.key==="assignments"&&oe.length?` (${oe.length})`:""}</b><small>${e.desc}</small></span></button>`).join("")}
      </div>
      <div id="sc-reftab-body">${ot(ne)}</div>
    </div>
    ...
    <nav id="sc-mobile-ref-nav" class="sc-mobile-ref-nav" aria-label="เมนู Smart Classroom">
      ...
      <button class="sc-switch-btn w-full text-left px-3 py-2.5 rounded-xl border border-gray-100 hover:border-amber-300 hover:bg-amber-50 transition" data-cid="${a.id}">
        <p class="text-sm font-semibold text-gray-700 truncate">${o(a.class_name??"")}</p>
        <p class="text-xs text-gray-400 truncate">${o(((r=a.master_subjects)==null?void 0:r.subject_name)??"")}</p>
      </button>`}).join(""),t.querySelectorAll(".sc-switch-btn").forEach(a=>a.addEventListener("click",()=>{const r=parseInt(a.dataset.cid,10);e.remove(),xe(m,r)}))}async function hs(){var t,n;const e=document.getElementById("sc-open-attendance");e.disabled=!0;const s=e.textContent;e.textContent="⏳";try{const a=((t=f.master_subjects)==null?void 0:t.credit)??1,r=((n=f.master_subjects)==null?void 0:n.subject_group)==="ACDMVOC",d=r?await an(x).catch(()=>[]):[],l=Rn(f,a,d.length?d:null,r),p=Qn(new Date),g=l.filter(i=>i.ds===p);if(g.length===1)await Ft(m,f,g[0].n,{});else if(g.length>1)ut(l,g[0].n,"วันนี้มีหลายคาบ — เลือกคาบที่จะเช็คชื่อ");else{const i=new Date(p).getTime();let c=l[0],u=1/0;for(const S of l){const C=Math.abs(new Date(S.ds).getTime()-i);C<u&&(u=C,c=S)}ut(l,c==null?void 0:c.n,"วันนี้ไม่ตรงกับตารางสอนของห้องนี้ — เลือกคาบเอง (เลื่อนไปคาบใกล้วันนี้ที่สุดให้แล้ว)")}}catch(a){b("เปิดหน้าเช็คชื่อไม่สำเร็จ: "+M(a),"error")}finally{e.disabled=!1,e.textContent=s}}function ut(e,s,t){var r;(r=document.getElementById("sc-session-picker"))==null||r.remove();const n=document.createElement("div");n.id="sc-session-picker",n.className="fixed inset-0 z-[90] flex items-center justify-center bg-black/50 p-4",n.innerHTML=`
      <div class="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-5 space-y-3 animate-fade">
        <div class="flex items-center justify-between">
        ...
        <p class="text-xs text-gray-400">${o(t)}</p>
      ...
      <div class="p-3 flex-1 overflow-y-auto min-h-0">
        ...
        <div id="sc-sort-col-list" class="space-y-1">
          ${q.length?q.map(l=>`<button data-sortkey="col:${l.id}" data-sortlabel="${o(l.assignment_name??"")}" data-search="${o((l.assignment_name??"").toLowerCase())}" class="sc-sort-opt sc-sort-col-opt w-full text-left px-2.5 py-1.5 rounded-lg text-xs font-semibold transition ${P.key==="col:"+l.id?"bg-amber-100 text-amber-800":"text-gray-600 hover:bg-gray-50"}">${o(l.assignment_name??"")}</button>`).join(""):'<p class="text-xs text-gray-300 text-center py-3">ห้องนี้ยังไม่มีคอลัมน์คะแนน</p>'}
        </div>
        <div class="mt-3 pt-3 border-t border-gray-100">
          ...
          <div class="space-y-1">
            ${K.length?K.map(l=>`<button data-sortkey="assignment:${l.id}" data-sortlabel="งาน: ${o(l.title??"")}" class="sc-sort-opt w-full text-left px-2.5 py-2 rounded-lg text-xs font-semibold transition ${P.key==="assignment:"+l.id?"bg-amber-100 text-amber-800":"text-gray-600 hover:bg-gray-50"}">${o(l.title??"")}</button>`).join(""):'<p class="text-xs text-gray-300 text-center py-3">ห้องนี้ยังไม่มีงานที่มอบหมาย</p>'}
          </div>
        </div>
      </div>`,document.body.appendChild(t),t.querySelectorAll(".sc-sort-opt").forEach(l=>l.addEventListener("click",()=>{ws(l.dataset.sortkey,l.dataset.sortlabel),t.remove()}));const a=t.querySelector("#sc-sort-search");a==null||a.addEventListener("input",()=>{const l=a.value.trim().toLowerCase();t.querySelectorAll(".sc-sort-col-opt").forEach(p=>{p.style.display=!l||p.dataset.search.includes(l)?"":"none"})});const r=l=>{t.contains(l.target)||l.target===e||(t.remove(),document.removeEventListener("mousedown",r,!0))};setTimeout(()=>document.addEventListener("mousedown",r,!0),0)}const ks=[{key:"info",label:"👤 ข้อมูล"},{key:"score",label:"📝 คะแนน"},{key:"att",label:"✅ มาเรียน"},{key:"leave",label:"🚪 ออกห้อง"}];function $s(e){var n;const s=fe[e.id],t=ee?Ee[e.id]:null;return`
      <div class="space-y-2">
        ${ee?`
          <div class="px-3 py-2.5 rounded-xl bg-red-50 border border-red-100">
            <p class="text-xs text-red-700 font-bold mb-1">🔴 ${o(ee.title)}</p>
            ${t?`
        ...
        ${s?`
          <div class="flex items-center justify-between px-3 py-2.5 rounded-xl bg-amber-50 border border-amber-100">
            <div class="text-xs text-amber-800"><b>🚪 ออกนอกห้องอยู่</b><br>${o(s.reason??"")} · ${Vt(s.created_at)}</div>
          </div>
      ...
      <div class="space-y-4">
        ...
        ${n.length?`<div class="rounded-xl border border-indigo-100 bg-indigo-50/50 px-3 py-2.5"><p class="text-xs font-bold text-indigo-700 mb-1">🧮 คะแนนคำนวณ</p>${n.map(h=>`<div class="flex justify-between text-[11px] py-1"><span class="text-gray-600">${o(h.assignment_name??"")}</span><b class="text-indigo-700">${be(i(h))}/${be(parseFloat(h.max_score)||0)}</b></div>`).join("")}</div>`:""}
        <div class="bg-gradient-to-br from-amber-50 to-purple-50 rounded-2xl p-4 text-center border border-amber-100">
          ...
          <p class="text-3xl font-extrabold text-amber-700">${be(Q)}<span class="text-sm font-normal text-gray-400">/${be(H)}</span></p>
          <p class="text-[11px] text-gray-400 mt-0.5">คะแนนจริง ${be(N)} · ${O.toFixed(1)}%</p>
          <p class="text-xl font-bold text-purple-700 mt-1">เกรด ${Y>0?Y.toFixed(1):"0"} <span class="text-sm ${le.cls}">— ${le.label}</span></p>
        </div>
        <p class="text-[10px] text-gray-400 text-center">คำนวณด้วยกลุ่มกลางภาค/ปลายภาค สูตร และคะแนนโบนัสแบบเดียวกับหน้าคะแนนหลัก</p>
      </div>`}const qs={present:"#059669",absent:"#dc2626",late:"#f59e0b",excused:"#3b82f6",sick:"#f97316"};function js(e){const s=(he[e.id]??[]).slice().sort((c,u)=>(u.check_date??"").localeCompare(c.check_date??""));if(!s.length)return'<p class="text-center py-6 text-xs text-gray-400">ยังไม่มีข้อมูลเช็คชื่อ</p>';const t=["present","absent","late","excused","sick"],n={};for(const c of s)n[c.status]=(n[c.status]??0)+1;const a=s.length;let r=0;const d=t.filter(c=>n[c]).map(c=>{const u=n[c]/a*100,S=`${qs[c]} ${r}% ${r+u}%`;return r+=u,S}),l=d.length?`conic-gradient(${d.join(",")})`:"#e5e7eb",p=Math.round((n.present??0)/a*100),g=t.filter(c=>n[c]).map(c=>{const u=Ut[c];return`<span class="px-2 py-1 rounded-full text-[11px] font-bold ${(u==null?void 0:u.bg)??"bg-gray-50"} ${(u==null?void 0:u.color)??"text-gray-500"}">${(u==null?void 0:u.label)??c} ${n[c]}</span>`}).join(" "),i=s.slice(0,15).map(c=>{const u=Ut[c.status];return`<div class="flex items-center justify-between px-3 py-1.5 text-xs border-b border-gray-50">
        <span class="text-gray-500">${o(c.check_date??"")} · คาบ ${c.session_number}</span>
      ...
      <div class="max-h-48 overflow-y-auto border-t border-gray-100 pt-2">${i}</div>`}function Is(e){const s=Le[e.id]??[];return s.length?`<div class="max-h-64 overflow-y-auto space-y-1.5">${s.map(t=>{const n=t.status==="returned"?"กลับแล้ว":t.status==="overdue"?"เลยเวลา":"ยังไม่กลับ",a=t.status==="returned"?"text-emerald-600":t.status==="overdue"?"text-red-600":"text-amber-600";return`<div class="px-3 py-2 rounded-xl bg-gray-50 border border-gray-100 text-xs">
        <div class="flex items-center justify-between">
          <span class="font-semibold text-gray-700">${o(t.reason??"")}</span>
      ...
      </div>`}).join("")}</div>`:'<p class="text-center py-6 text-xs text-gray-400">ไม่เคยขอออกนอกห้องในวิชานี้</p>'}function Cs(e){var r;(r=document.getElementById("sc-student-modal"))==null||r.remove();let s="info",t=e;const n=document.createElement("div");n.id="sc-student-modal",n.className="fixed inset-0 z-[90] flex items-center justify-center bg-black/50 p-4",document.body.appendChild(n);const a=()=>{var p,g,i,c,u,S,C,V;fe[t.id];const d=y.findIndex(_=>_.id===t.id);n.innerHTML=`
          ...
          <div class="p-5 pb-3 flex-shrink-0">
            <div class="flex items-center gap-3">
              ...
              <div class="w-14 h-14 rounded-xl overflow-hidden bg-indigo-100 flex items-center justify-center text-indigo-700 font-bold text-xl flex-shrink-0">
                ${t.image_url?`<img src="${o(t.image_url)}" class="w-full h-full object-cover"/>`:o((t.full_name??"?").charAt(0))}
              </div>
              <div class="min-w-0 flex-1">
                <p class="font-bold text-gray-800 truncate">${o(t.full_name??"—")}</p>
                <p class="text-xs text-gray-400">${o(t.student_code??"")} · ${o(t.main_room??"")} · เลขที่ ${J.get(t.id)??"—"}</p>
              </div>
        ...
        </div>`,n.querySelector("#sc-sp-close").addEventListener("click",()=>n.remove()),(p=n.querySelector("#sc-sp-prev"))==null||p.addEventListener("click",()=>{d>0&&(t=y[d-1],s="info",a())}),(g=n.querySelector("#sc-sp-next"))==null||g.addEventListener("click",()=>{d<y.length-1&&(t=y[d+1],s="info",a())});const l=()=>{const _=n.querySelector("#sc-sp-jump"),w=parseInt(_.value,10),j=Ye.get(w);if(!j){b(`ไม่พบเลขที่ ${_.value}`,"warning"),_.value=J.get(t.id)??"";return}j.id!==t.id&&(t=j,s="info",a())};(i=n.querySelector("#sc-sp-jump"))==null||i.addEventListener("change",l),(c=n.querySelector("#sc-sp-jump"))==null||c.addEventListener("keydown",_=>{_.key==="Enter"&&(_.preventDefault(),l())}),n.querySelectorAll(".sc-sp-tab").forEach(_=>_.addEventListener("click",()=>{s=_.dataset.tab,a()})),n.querySelectorAll(".sc-score-input").forEach(_=>{_.addEventListener("change",async()=>{var H;const w=parseInt(_.dataset.col,10),j=_.value.trim();_.disabled=!0;try{await cn(x,t.id,w,j===""?null:j);const N=se[H=t.id]??(se[H]=[]),Q=N.find(Y=>Y.score_column_id===w),O=j===""?null:parseFloat(j);Q?Q.score=O:N.push({student_id:t.id,score_column_id:w,score:O}),b("บันทึกคะแนนแล้ว","success"),a()}catch(N){b("บันทึกไม่สำเร็จ: "+M(N),"error"),_.disabled=!1}})}),(u=n.querySelector("#sc-sp-return"))==null||u.addEventListener("click",async()=>{const _=fe[t.id];try{await Ht(_.id,"returned"),b("บันทึกกลับเข้าห้องแล้ว","success"),n.remove(),D()}catch(w){b("บันทึกไม่สำเร็จ: "+M(w),"error")}}),(S=n.querySelector("#sc-sp-leave"))==null||S.addEventListener("click",()=>{if(Object.keys(fe).length>=$){b(`ไม่อนุญาตให้ออกนอกห้องเพิ่ม เนื่องจากมีนักเรียนอยู่นอกห้องครบโควต้า ${$} คนแล้ว`,"warning");return}n.remove(),Tn(m,f,t.id,t.full_name,t.image_url,fe,$,()=>D())}),(C=n.querySelector("#sc-sp-quiz-monitor"))==null||C.addEventListener("click",()=>{ee&&Nt(ee)}),(V=n.querySelector("#sc-sp-unlock"))==null||V.addEventListener("click",_=>{const w=_.target.dataset.attempt;Ms(w,()=>{n.remove(),D()})})};n.addEventListener("click",d=>{d.target===n&&n.remove()}),a()}function Ms(e,s){const t=document.createElement("div");t.className="fixed inset-0 z-[97] bg-black/40 flex items-center justify-center p-4",t.innerHTML=`
      ...
      </div>`,document.body.appendChild(t),t.querySelector("#qu-cancel").addEventListener("click",()=>t.remove());const n=async a=>{t.remove();try{await Sn(e,a),b(a==="resume"?"ปลดล็อก — ทำต่อจากจุดเดิมแล้ว":"ปลดล็อก — เริ่มชุดใหม่แล้ว","success"),s==null||s()}catch(r){b("ปลดล็อกไม่สำเร็จ: "+M(r),"error")}};t.querySelector("#qu-resume").addEventListener("click",()=>n("resume")),t.querySelector("#qu-restart").addEventListener("click",()=>n("restart"))}document.getElementById("sc-pass-list").addEventListener("click",async e=>{const s=e.target.closest(".sc-return-btn");if(s)try{await Ht(s.dataset.lid,"returned"),b("บันทึกกลับเข้าห้องแล้ว","success"),D()}catch(t){b("บันทึกไม่สำเร็จ: "+M(t),"error")}}),document.getElementById("sc-leave-quota").addEventListener("click",()=>{Cn(f,$,W,()=>D())}),document.getElementById("sc-timer").addEventListener("click",()=>Dn(x,f,Ge)),document.getElementById("sc-random").addEventListener("click",()=>{const e=y.map((s,t)=>({...s,seat_no:t+1}));Fn(x,f,e,Ge)}),document.getElementById("sc-scan-att").addEventListener("click",()=>Mn(m)),document.getElementById("sc-scan-score").addEventListener("click",()=>In({classId:x,className:f.class_name})),document.getElementById("sc-dashboard").addEventListener("click",()=>Pn(x,f,window._pp5DonorTierIndex??0,I)),document.getElementById("sc-quiz-add").addEventListener("click",()=>ps()),document.getElementById("sc-quiz-list").addEventListener("click",async e=>{const s=e.target.closest(".sc-quiz-start"),t=e.target.closest(".sc-quiz-monitor"),n=e.target.closest(".sc-quiz-close"),a=e.target.closest(".sc-quiz-analytics");if(s)try{await kn(s.dataset.qid),b("เริ่มควิซให้ห้องนี้แล้ว 🧠","success"),D()}catch(r){b("เริ่มควิซไม่สำเร็จ: "+M(r),"error")}else if(t){const r=R.find(d=>d.id===t.dataset.qid);r&&Nt(r)}else if(n){const r=R.find(g=>g.id===n.dataset.qid);if(!r)return;const d=q.find(g=>String(g.id)===String(r.score_column_id)),l={highest:"เทียบเอาคะแนนสูงกว่า",overwrite:"ทับคะแนนเก่า",add:"บวกเพิ่มจากคะแนนเดิม"}[r.score_write_mode]??"ตามการตั้งค่าแบบทดสอบ",p=await Rs({quizTitle:r.title,hasScoreColumn:!!r.score_column_id,targetColumn:(d==null?void 0:d.assignment_name)??"",writeModeLabel:l});if(!p)return;try{await $n(r.id,{writeScores:p==="write_scores"}),b(p==="write_scores"?"ปิดสอบและส่งคะแนนแล้ว":"ปิดสอบแล้ว — สมุดคะแนนไม่ถูกเปลี่ยน","success"),D()}catch(g){b("ปิดสอบไม่สำเร็จ: "+M(g),"error")}}else if(a){const r=R.find(d=>d.id===a.dataset.qid);r&&Hn(r)}}),document.getElementById("sc-add-announcement").addEventListener("click",()=>Ts());function Ts(){var n;(n=document.getElementById("sc-ann-modal"))==null||n.remove();let e=null;const s=document.createElement("div");s.id="sc-ann-modal",s.className="fixed inset-0 z-[95] flex items-center justify-center bg-black/50 p-4",s.innerHTML=`
      <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto p-5 space-y-3 animate-fade">
        <div class="flex items-center justify-between">
          <h3 class="font-bold text-gray-800 text-sm">📣 สร้างประกาศ — ${o(f.class_name??"")}</h3>
        ...
        <div>
          ...
          <div id="ca-type-chips" class="flex flex-wrap gap-1.5 mb-2">
            ${De.map(a=>`<button type="button" data-emoji="${a.emoji}" data-label="${o(a.label)}" class="ca-type-chip px-2.5 py-1.5 rounded-full text-xs font-semibold border border-gray-200 text-gray-600 hover:border-amber-300 hover:bg-amber-50 transition">${a.emoji} ${a.label}</button>`).join("")}
          </div>
          ...
          <datalist id="ca-type-list">${Se.map(a=>`<option value="${o(a)}"></option>`).join("")}</datalist>
        </div>
        <div>
      ...
      </div>`,document.body.appendChild(s),s.addEventListener("click",a=>{a.target===s&&s.remove()}),s.querySelector("#ca-close").addEventListener("click",()=>s.remove());const t=s.querySelector("#ca-type-custom");s.querySelectorAll(".ca-type-chip").forEach(a=>a.addEventListener("click",()=>{e=`${a.dataset.emoji} ${a.dataset.label}`,t.value="",s.querySelectorAll(".ca-type-chip").forEach(r=>r.classList.remove("border-amber-400","bg-amber-100","text-amber-800")),a.classList.add("border-amber-400","bg-amber-100","text-amber-800")})),t.addEventListener("input",()=>{t.value.trim()&&(e=null,s.querySelectorAll(".ca-type-chip").forEach(a=>a.classList.remove("border-amber-400","bg-amber-100","text-amber-800")))}),s.querySelector("#ca-send").addEventListener("click",async()=>{const a=s.querySelector("#ca-text").value.trim();if(!a){b("พิมพ์ข้อความก่อนส่งนะ","warning");return}const r=t.value.trim()||e||`${De[0].emoji} ${De[0].label}`,d=s.querySelector("#ca-send");d.disabled=!0,d.textContent="กำลังส่ง...";try{const l=[...s.querySelector("#ca-files").files??[]],p=[];for(const g of l)p.push(await Ot(g,`class-${x}/announcements`));await rn({title:`📣 ${f.class_name}`,body:a,isActive:!0,teacherId:m.id,targetClassIds:[x],annType:r,attachmentUrls:p.length?p:null}),et(`${r} — ${f.class_name}`,a.slice(0,120),"sc-announcement"),b("ส่งประกาศถึงห้องนี้แล้ว 📣","success"),s.remove(),D()}catch(l){b("ส่งไม่สำเร็จ: "+M(l),"error"),d.disabled=!1,d.textContent="ส่งประกาศ"}})}let Me="daily";function As(){document.querySelectorAll(".sc-reftab-btn").forEach(t=>{t.classList.toggle("active",t.dataset.reftab===ne)});const e=ye.find(t=>t.key===ne),s=document.getElementById("sc-mobile-ref-title");s&&e&&(s.textContent=`${e.icon} ${e.label}`)}function pt(){var e,s,t,n,a,r,d,l;document.querySelectorAll(".sc-sched-tab").forEach(p=>{p.classList.toggle("active",p.dataset.sched===Me),p.addEventListener("click",()=>{Me=p.dataset.sched,document.querySelectorAll(".sc-sched-tab").forEach(g=>g.classList.toggle("active",g.dataset.sched===Me)),document.getElementById("sc-schedule-body").innerHTML=tt(Me)})}),(e=document.getElementById("sc-add-syllabus"))==null||e.addEventListener("click",()=>xt()),(s=document.getElementById("sc-ai-syllabus"))==null||s.addEventListener("click",()=>Gt({teacher:m,cls:f,courseId:ae,syllabusItems:G,lessonPlans:Z,currentWeek:re||1,initialMode:"schedule",onSaved:()=>D()})),(t=document.getElementById("sc-syllabus-list"))==null||t.addEventListener("click",p=>{const g=p.target.closest(".sc-syllabus-row");if(!g)return;const i=G.find(c=>c.id===parseInt(g.dataset.sylid,10));i&&xt(i)}),(n=document.getElementById("sc-add-plan"))==null||n.addEventListener("click",()=>bt()),(a=document.getElementById("sc-ai-plan"))==null||a.addEventListener("click",()=>Gt({teacher:m,cls:f,courseId:ae,syllabusItems:G,lessonPlans:Z,currentWeek:re||1,initialMode:"plan",onSaved:()=>D()})),(r=document.getElementById("sc-plan-list"))==null||r.addEventListener("click",p=>{const g=p.target.closest(".sc-plan-reflect"),i=p.target.closest(".sc-plan-row");if(g){const c=Z.find(u=>u.id===parseInt(g.dataset.planid,10));c&&Vn({plan:c,cls:f,teacher:m,classId:x,currentWeek:re||c.week_start})}else if(i){const c=Z.find(u=>u.id===parseInt(i.dataset.planid,10));c&&bt(c)}}),(d=document.getElementById("sc-add-assignment"))==null||d.addEventListener("click",()=>Ue()),(l=document.getElementById("sc-assignment-list"))==null||l.addEventListener("click",p=>{const g=p.target.closest(".sc-assignment-row");if(!g)return;const i=K.find(c=>c.id===parseInt(g.dataset.aid,10));i&&gt(i)})}pt();const Bs=()=>`
    ...
    <div id="sc-mobile-exam-preview">
      ...
      <div class="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-5 space-y-3 animate-fade">
        ...
        <div>
          ...
          <input id="sy-topic" type="text" value="${o(t.topic??"")}" placeholder="เช่น สมการเชิงเส้นตัวแปรเดียว" class="w-full text-sm border border-gray-200 rounded-xl px-3 py-2" />
        </div>
        <div>
          <label class="block text-xs font-semibold text-gray-500 mb-1">รายละเอียดเพิ่มเติม</label>
          <textarea id="sy-desc" rows="2" class="w-full text-sm border border-gray-200 rounded-xl px-3 py-2 resize-none">${o(t.description??"")}</textarea>
        </div>
        <button id="sy-save" class="sc-btn-dark w-full py-2.5 rounded-xl text-sm font-bold">บันทึก</button>
      </div>`,document.body.appendChild(n),n.addEventListener("click",d=>{d.target===n&&n.remove()}),n.querySelector("#sy-close").addEventListener("click",()=>n.remove()),(r=n.querySelector("#sy-delete"))==null||r.addEventListener("click",async()=>{if(confirm("ลบหัวข้อนี้?"))try{await bn(t.id),b("ลบแล้ว","success"),n.remove(),D()}catch(d){b("ลบไม่สำเร็จ: "+M(d),"error")}}),n.querySelector("#sy-save").addEventListener("click",async()=>{const d=parseInt(n.querySelector("#sy-week-start").value,10),l=parseInt(n.querySelector("#sy-week-end").value,10),p=n.querySelector("#sy-topic").value.trim();if(!d||!l||l<d){b("กำหนดช่วงสัปดาห์ให้ถูกต้อง","warning");return}if(!p){b("กรอกหัวข้อก่อนนะ","warning");return}const g=n.querySelector("#sy-save");g.disabled=!0,g.textContent="กำลังบันทึก...";const i={course_id:ae,week_start:d,week_end:l,topic:p,description:n.querySelector("#sy-desc").value.trim()||null};try{s?await gn(t.id,i):await fn(i),b("บันทึกแล้ว ✅","success"),n.remove(),D()}catch(c){b("บันทึกไม่สำเร็จ: "+M(c),"error"),g.disabled=!1,g.textContent="บันทึก"}})}function bt(e){var V,_,w,j;(V=document.getElementById("sc-plan-modal"))==null||V.remove();const s=!!e,t=e??{},n=(f==null?void 0:f.master_subjects)??{},a={MATH:"คณิตศาสตร์",THAI:"ภาษาไทย",SCI:"วิทยาศาสตร์และเทคโนโลยี",ENG:"ภาษาต่างประเทศ",SOC:"สังคมศึกษา ศาสนาและวัฒนธรรม",PE:"สุขศึกษาและพลศึกษา",ART:"ศิลปะ",CAREER:"การงานอาชีพ",ISLAM:"อิสลามศึกษา"},r=String(n.dept??n.subject_group??"").trim(),d=a[r.toUpperCase()]||r||"................................",l=String((f==null?void 0:f.class_name)??"").trim(),p=String(n.grade_level??"").replace(/ม\./g,"").trim(),g=/^ม\./.test(l)?l.replace(/^ม\./,""):[p,l].filter(Boolean).join(" "),i=f==null?void 0:f.students,c=(Array.isArray(i)?(_=i[0])==null?void 0:_.full_name:i==null?void 0:i.full_name)??"................................",u=document.createElement("div");u.id="sc-plan-modal",u.className="fixed inset-0 z-[95] bg-slate-100 flex flex-col",u.innerHTML=`
      <style>
      ...
      <header class="lp-toolbar">
        ...
        <input id="lp-title" value="${o(t.title??"")}" placeholder="ชื่อแผน *" class="lp-admin-input w-48 lp-hide-mobile">
        ...
        <details class="lp-extra"><summary class="h-10 px-3 rounded-xl border flex items-center justify-center text-xs font-bold text-gray-600 bg-white">⚙️ ข้อมูลเพิ่มเติม</summary><div class="lp-extra-content"><div class="grid grid-cols-2 gap-2 mb-2 sm:hidden"><label class="text-[10px] text-gray-500">ชื่อแผน<input id="lp-title-mobile" value="${o(t.title??"")}" class="lp-admin-input w-full mt-1"></label><label class="text-[10px] text-gray-500">สัปดาห์<input id="lp-week-mobile" value="${t.week_start??""}" class="lp-admin-input w-full mt-1"></label></div><label class="block text-[10px] font-bold text-gray-500">งาน/การบ้าน<textarea id="lp-homework" rows="3" class="mt-1">${o(t.homework??"")}</textarea></label><label class="block text-[10px] font-bold text-gray-500 mt-2">หมายเหตุครู<textarea id="lp-teacher_notes" rows="3" class="mt-1">${o(t.teacher_notes??"")}</textarea></label></div></details>
      ...
      <main class="lp-editor-scroll">
        <article class="lp-paper animate-fade">
          <section class="lp-head">
            ...
            <h2>กลุ่มสาระการเรียนรู้${o(d)}</h2>
            <p class="lp-subject-line">วิชา ${o(n.subject_name??"")} รหัสวิชา ${o(n.subject_code??"")} ชั้นมัธยมศึกษาปีที่ ${o(g||"................................")}</p>
            <div class="lp-unit-row">หน่วยการเรียนรู้ <input id="lp-unit-title" class="lp-doc-input" value="${o(t.unit_title??"")}" placeholder="หน่วยการเรียนรู้ที่ 1"> เรื่อง <input id="lp-key_concept" class="lp-doc-input" value="${o(t.key_concept??"")}" placeholder="เรื่องที่สอน"></div>
          </section>
          <section class="lp-meta">
            ...
            <label>วันที่ <input id="lp-lesson-date" type="date" class="lp-doc-input" value="${o(t.lesson_date??"")}"></label>
          </section>
          <section class="lp-columns">
            <div>
              <div class="lp-box"><div class="lp-box-title">1.มาตรฐาน/ตัวชี้วัด (ผลการเรียนรู้)</div><div class="lp-box-body"><textarea id="lp-standards" class="lp-doc-area" rows="5">${o(t.standards??"")}</textarea></div></div>
              <div class="lp-box"><div class="lp-box-title">2.จุดประสงค์การเรียนรู้</div><div class="lp-box-body"><textarea id="lp-objectives" class="lp-doc-area" rows="5">${o(t.objectives??"")}</textarea></div></div>
              <div class="lp-box"><div class="lp-box-title">3.กิจกรรมการเรียนรู้</div><div class="lp-box-body lp-activities"><b>ขั้นนำเข้าสู่บทเรียน</b><textarea id="lp-activities_intro" class="lp-doc-area" rows="3">${o(t.activities_intro??"")}</textarea><b>ขั้นสอน</b><textarea id="lp-activities_main" class="lp-doc-area main" rows="7">${o(t.activities_main??"")}</textarea><b>ขั้นสรุป</b><textarea id="lp-activities_wrap" class="lp-doc-area" rows="3">${o(t.activities_wrap??"")}</textarea></div></div>
              <div class="lp-box"><div class="lp-box-title">4.การวัดและประเมินผล</div><div class="lp-box-body"><textarea id="lp-assessment" class="lp-doc-area" rows="3">${o(t.assessment??"")}</textarea></div></div>
            </div>
            <div>
              <div class="lp-box lp-media"><div class="lp-box-title">5.สื่อการเรียนรู้</div><div class="lp-box-body"><textarea id="lp-media" class="lp-doc-area" rows="3">${o(t.media??"")}</textarea></div></div>
              <div class="lp-sign-pair">
                <div class="lp-sign"><div class="lp-sign-space"></div><div>ลงชื่อ</div><div class="lp-sign-line"></div><div>หัวหน้าห้อง</div><div>( ${o(c)} )</div><div>วันที่ ${t.lesson_date?o(t.lesson_date):"........................"}</div></div>
                <div class="lp-sign"><div class="lp-sign-space"></div><div>ลงชื่อ</div><div class="lp-sign-line"></div><div>ครูผู้สอน</div><div>( ${o((m==null?void 0:m.full_name)??"................................")} )</div><div>วันที่ ${t.lesson_date?o(t.lesson_date):"........................"}</div></div>
              </div>
      ...
      <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto p-5 space-y-3 animate-fade">
        ...
        <div>
          ...
          <input id="sa-title" type="text" value="${o(t.title??"")}" placeholder="เช่น ใบงานที่ 3 — สมการเชิงเส้น" class="w-full text-sm border border-gray-200 rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-300" />
        </div>
        <div>
          <label class="block text-xs font-semibold text-gray-500 mb-1">รายละเอียด</label>
          <textarea id="sa-desc" rows="2" class="w-full text-sm border border-gray-200 rounded-xl px-3 py-2 resize-none focus:outline-none focus:ring-2 focus:ring-indigo-300">${o(t.description??"")}</textarea>
        </div>
        <div>
        ...
        <div>
          ...
          <select id="sa-col" class="w-full text-sm border border-gray-200 rounded-xl px-3 py-2 bg-white">
            ...
            ${q.map(w=>`<option value="${w.id}" ${t.score_column_id===w.id?"selected":""}>${o(w.assignment_name)} (เต็ม ${w.max_score})</option>`).join("")}
          </select>
        </div>
        ...
        </span>`).join(""),r.querySelectorAll(".sa-remove-file").forEach(w=>w.addEventListener("click",()=>{n.splice(parseInt(w.dataset.i,10),1),d()}))};d();const l=a.querySelector("#sa-penalty-mode"),p=a.querySelector("#sa-penalty-value"),g=a.querySelector("#sa-penalty-hint");l.addEventListener("change",()=>{p.disabled=l.value==="none",p.disabled?(p.classList.add("bg-gray-50"),p.value=""):p.classList.remove("bg-gray-50"),g.textContent=l.value==="flat"?"หักคะแนนเท่านี้ทันทีถ้าส่งช้า ไม่ว่าจะช้ากี่วัน":l.value==="per_day"?"หักคะแนนเท่านี้ต่อวันที่ส่งช้า (คูณตามจำนวนวัน)":""});const i=a.querySelector("#sa-col"),c=a.querySelector("#sa-write-mode-wrap"),u=a.querySelector("#sa-write-mode"),S=a.querySelector("#sa-write-mode-hint"),C=()=>{var w;c.classList.toggle("hidden",!i.value),S.textContent=((w=Fe[u.value])==null?void 0:w.hint)??""};i.addEventListener("change",C),u.addEventListener("change",C),C(),a.querySelector("#sa-save").addEventListener("click",async()=>{const w=a.querySelector("#sa-title").value.trim();if(!w){b("กรอกชื่องานก่อนนะ","warning");return}const j=a.querySelector("#sa-save");j.disabled=!0,j.textContent="กำลังบันทึก...";try{const H=[...a.querySelector("#sa-files").files??[]],N=[];for(const le of H)N.push(await Ot(le,`class-${x}`));const Q=a.querySelector("#sa-due").value,O=a.querySelector("#sa-max-score").value.trim(),Y={score_column_id:i.value?parseInt(i.value,10):null,title:w,description:a.querySelector("#sa-desc").value.trim()||null,attachment_urls:[...n,...N],due_at:Q?new Date(Q).toISOString():null,late_penalty_mode:l.value,late_penalty_value:parseFloat(p.value)||0,score_write_mode:u.value,max_score:O===""?null:parseFloat(O)};s?(await on(t.id,Y),b("บันทึกการแก้ไขแล้ว ✅","success")):(await ln({...Y,class_id:x,teacher_id:m.id}),et(`📚 งานใหม่ — ${f.class_name}`,w,"sc-assignment"),b("สั่งงานสำเร็จ ✅","success")),a.remove(),D()}catch(H){b("บันทึกไม่สำเร็จ: "+M(H),"error"),j.disabled=!1,j.textContent=s?"บันทึกการแก้ไข":"บันทึกงาน"}})}function gt(e){var l,p,g;(l=document.getElementById("sc-track-modal"))==null||l.remove();const s=Object.fromEntries(e.submissions.map(i=>[i.student_id,i]));q.find(i=>i.id===e.score_column_id);const t=document.createElement("div");t.id="sc-track-modal",t.className="fixed inset-0 z-[95] flex items-center justify-center bg-black/50 p-4",t.innerHTML=`
      <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col animate-fade">
        <div class="p-5 pb-3 flex-shrink-0 border-b border-gray-100">
          <div class="flex items-start justify-between gap-3">
            <div class="min-w-0">
              <p class="font-bold text-gray-800 truncate">${o(e.title)}</p>
              <p class="text-xs text-gray-400 mt-0.5">${e.description?o(e.description)+" · ":""}กำหนดส่ง ${Oe(e.due_at)}</p>
              ${(p=e.attachment_urls)!=null&&p.length?`<div class="flex flex-wrap gap-1.5 mt-2">${e.attachment_urls.map(i=>`<a href="${o(i.url)}" target="_blank" rel="noopener" class="text-[11px] px-2 py-1 rounded-lg bg-indigo-50 text-indigo-600 hover:bg-indigo-100">📎 ${o(i.name)}</a>`).join("")}</div>`:""}
            </div>
        ...
        ${i.image_url?`<img src="${o(i.image_url)}" class="w-full h-full object-cover"/>`:o((i.full_name??"?").charAt(0))}
        ...
        <div class="flex items-center gap-2 min-w-0">
          ${c}
          ${u}
          <span class="font-semibold text-gray-600 truncate">${o(i.full_name??"")}</span>
        </div>
        <span class="text-gray-300 font-medium flex-shrink-0">ยังไม่ส่ง</span>
      </div>`;const C=Ie(e,S.submitted_at),V=Te(S);return`<div class="sc-track-row px-3 py-2.5 rounded-xl border ${C?"border-amber-200 bg-amber-50":"border-gray-100 bg-gray-50"} text-xs cursor-pointer hover:border-indigo-200" data-sid="${i.id}">
        <div class="flex items-center justify-between gap-2">
          <div class="flex items-center gap-2 min-w-0">
            ${c}
            ${u}
            <span class="font-semibold text-gray-700 truncate">${o(i.full_name??"")}</span>
          </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[92vh] flex flex-col animate-fade">
          <div class="p-5 pb-3 flex-shrink-0 border-b border-gray-100">
            <div class="flex items-center gap-3">
              ...
              <div class="min-w-0 flex-1">
                <p class="font-bold text-gray-800 truncate text-sm">${o(i.full_name??"—")}</p>
                <p class="text-[11px] text-gray-400">เลขที่ ${J.get(i.id)??"—"} · ${o(i.student_code??"")}</p>
              </div>
          ...
          <div class="p-5 pt-3 overflow-y-auto flex-1">
            ${c?`
              ...
              ${V}
              ${c.note?`<div class="bg-gray-50 border border-gray-100 rounded-xl p-3 mb-3"><p class="text-[10px] font-bold text-gray-400 mb-0.5">ข้อความจากนักเรียน</p><p class="text-xs text-gray-600">${o(c.note)}</p></div>`:""}
              ${n?`<div class="mb-3">
                <div class="flex items-center gap-2">
              ...
              <div>
                ...
                <textarea id="sgc-feedback" rows="2" placeholder="เช่น ทำได้ดีมาก แต่ข้อ 3 ทบทวนอีกครั้ง — หรือกดตัวอย่างด้านบนแล้วแก้ไขต่อได้" class="w-full text-xs border border-gray-200 rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-300 resize-none">${o(c.teacher_feedback??"")}</textarea>
                <div class="flex items-center gap-2 mt-1.5">
