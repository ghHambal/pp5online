const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/teacher-views-quiz-banks-DD2mjZcB.js","assets/ui-CHdefT5i.js","assets/version.js_v_10.22-mqYkeZoJ.js","assets/quiz-api-BIDUVPR5.js","assets/supabase-BV-W2lsh.js","assets/import-D0GLDW1_.js","assets/teacher-views-utils-B68DuafG.js","assets/katex-loader-DUJObfzT.js","assets/chat-classroom-CIfE6Kc4.js","assets/api-CnonnVVn.js","assets/impersonation-0xVfgYVY.js","assets/supabase-errors-BniCCodr.js","assets/student-api-CIXkHU-1.js","assets/storage-CuUjCgvI.js"])))=>i.map(i=>d[i]);
import{a as b,g as M,n as Rs,_ as zt}from"./ui-CHdefT5i.js";import{getSystemConfig as Zt,getMyClasses as $e,getMySchedule as Jt,getClassScheduleLinks as Kt,getPeriods as es,setSmartClassroomFreeClass as ts,getClassStudents as Qs,getActiveLeavePermissionsForClass as Us,getLeaveMaxActiveForClass as Ws,getLeaveMaxPerStudentWeekForClass as Gs,getScoreColumns as Vs,getStudentScores as Ys,getClassAttendanceAllFull as Xs,getClassLeaveHistory as Zs,getClassAssignmentsWithSubmissions as Js,getTeacherExamRequests as Ks,getClassAnnouncements as en,getAnnouncementTypeSuggestions as tn,getCourseSyllabus as sn,getLessonPlans as nn,getClassSessionDOWs as an,closeLeavePermission as Ht,createAnnouncement as rn,deleteAssignment as Pt,updateAssignment as on,createAssignment as ln,getMyDonationRequests as dn,saveStudentScore as cn,markAssignmentSubmissionReviewed as un,saveAssignmentFeedback as pn,rejectAssignmentSubmission as mn,saveAssignmentGrade as xn,deleteSyllabusItem as bn,updateSyllabusItem as gn,createSyllabusItem as fn,deleteLessonPlan as yn,updateLessonPlan as vn,createLessonPlan as hn}from"./api-CnonnVVn.js";import{_ as He,a as ss,b as wn}from"./teacher-BtysfaP8.js";import{l as _n,m as Dt,s as kn,n as $n,o as Sn,f as En,k as Ln,c as qn,p as jn}from"./quiz-api-BIDUVPR5.js";import{openScoreScanner as In}from"./score-qr-scanner-mLvI4Vrc.js";import{_openAttendanceModalForSession as Ft,_openLeaveQuotaModal as Cn,openAttendanceScanSetup as Mn,_openLeaveRequestModal as Tn,renderAttendanceGrid as An}from"./teacher-views-attendance-DgwBiTzi.js";import{p as Bn,a as zn}from"./teacher-views-grades-D80Yd6id.js";import{openQuizMonitor as Nt}from"./teacher-views-quiz-monitor--YRZrd5N.js";import{openQuizAnalytics as Hn}from"./teacher-views-quiz-analytics-Bbcaw0qR.js";import{openClassDashboard as Pn}from"./teacher-views-dashboard-DXzxtYZl.js";import{e as ke,o as Dn,_ as Fn,j as Nn}from"./teacher-views-classes-BlulhF1r.js";import{uploadAssignmentFile as Ot}from"./storage-CuUjCgvI.js";import{_htmlEsc as o,setActiveNav as Rt,setTitle as Qt,setContent as ze,_currentWeek as On,_generateSessions as Rn,_dateInputValue as Qn,ATT_STATUS as Ut,openFullScreenGridOverlay as Un}from"./teacher-views-utils-B68DuafG.js";import{s as Wn}from"./supabase-BV-W2lsh.js";import{a as Gn,e as Wt}from"./score-display-BIDpG83o.js";import{openLessonPlanAIWorkspace as Gt,openLessonPlanDocument as Vn}from"./lesson-plan-ai-workspace-CAqqn-cP.js";import"./version.js_v_10.22-mqYkeZoJ.js";import"./impersonation-0xVfgYVY.js";import"./supabase-errors-BniCCodr.js";import"./promptpay-CIuxvxIA.js";import"./browser-JP79f-a9.js";import"./sports-portals.js_v_10.22-CZLiBNBX.js";import"./sports-awards-admin-6oCPrlSb.js";import"./azizgames-modal-C0esVYMf.js";import"./print-overlay-BVfxEd6n.js";import"./theme-DIdoXkqD.js";import"./anti-pull-refresh-BGrI1pMY.js";import"./push-notify-CIUUKsmF.js";import"./wen-sso-CcN06Rhh.js";import"./azfutsal-modal-Lu4DEcmR.js";import"./tutorial-Dq1tcVvB.js";import"./terangganu-api-C1IjZK4l.js";import"./regrade-api-JnlABjxU.js";import"./leave-time-CrS9gT63.js";import"./pp5-doc-CLrzt9Hg.js";import"./confetti-loader-BAN5Lv-C.js";function Yn(m){var x;return((x=String((m==null?void 0:m.donationSpecialFeatures)??"").split(`
`).map(I=>{const A=I.split("|");return{text:A[1]??"",minTier:parseInt(A[2])||1}}).find(I=>I.text.includes("Smart Classroom")))==null?void 0:x.minTier)??4}async function ns(m){const x=await Zt().catch(()=>window._pp5SystemCfg??{}),I=Yn(x);let A=window._pp5DonorTierIndex??0,Q=[];if(m!=null&&m.id)try{Q=await dn(m.id);const B=Q.filter($=>$.package_type==="donation"&&$.status==="approved").reduce(($,U)=>$+(U.amount??0),0),f=He(x.donationMinAmount,49),y=He(x.donationAmountStep,50),N=ss(x,f,y);A=wn(x,N,B)}catch{}return{cfg:x,minTier:I,unlocked:A>=I,donationRequests:Q}}function Xn(m,x){var A;return He(m.donationMinAmount,49),He(m.donationAmountStep,50),((A=ss(m)[x-1])==null?void 0:A.amount)??null}function Zn(m,x,I){return m?!0:(x==null?void 0:x.smart_classroom_free_class_id)===I}async function as(m,x,{preselectClassId:I=null,onPicked:A}={}){var f;(f=document.getElementById("sc-pick-modal"))==null||f.remove();const Q=await $e(m.id).catch(()=>[]),B=document.createElement("div");B.id="sc-pick-modal",B.className="fixed inset-0 z-[96] flex items-center justify-center bg-black/60 p-4",B.innerHTML=`
    ...
    <div class="bg-white rounded-3xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto animate-fade">
      <div class="relative px-6 py-8 text-center" style="background:linear-gradient(135deg,#a9781a,#e6c988)">
        ...
        <h2 class="text-white font-extrabold text-xl">${o(Q)}</h2>
      </div>
    ...
    <svg class="animate-spin h-6 w-6" viewBox="0 0 24 24" fill="none">
      ...
      </button>`}).join(""):'<p class="text-center py-6 text-xs text-gray-400">ยังไม่มีงานที่มอบหมาย — กด "➕ สั่งงานใหม่" เพื่อเริ่ม</p>',re=On(I.semester_start),pe=W.find(e=>re>=e.week_start&&re<=e.week_end),fs=()=>W.length?`<div class="max-h-72 lg:max-h-[28rem] overflow-y-auto space-y-2 pr-1">${W.map(e=>`
