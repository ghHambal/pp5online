...
import { renderShirtSummary, renderSportsFundAdmin, renderSportsOverviewAdmin, renderSportsEvaluationWorkspace, renderSportsScoreSummary, renderShirtVoteSettings, renderShirtVoteDashboard } from './sports-portals.js?v=10.22.656'
...
async function handleTeacherFormSubmit(e) {
  ...
  const _ARRAY_ONLY_POSITIONS = ['religion_group_head', 'religion_subgroup_head', 'classroom_leaders_admin', 'regrade_executive', 'executive']
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const POS_GROUPS = [
    ...
    { label: '🎖️ ผู้บริหาร', options: [
      { value: 'executive', label: 'ผู้บริหาร (ภาพรวมทั้งระบบ — สภานักเรียน ฯลฯ)' },
    ] },
