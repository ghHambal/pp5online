...
export async function renderTeacherOverview(teacher, homeroomRooms = []) {
  ...
  const _parseTiers = () => {
    ...
    const defs = [
      ...
      [minA+step,  '🏅','ผู้สนับสนุนใจดี',      'ช่วยให้ระบบเติบโตต่อได้เรื่อยๆ','#c9a227'],
      [minA+step*2,'🐘','ผู้สนับสนุนพิเศษ',    'สนับสนุนการทำฟีเจอร์ใหม่ๆ',   '#7a9ab0'],
      [minA+step*3,'👑','ผู้สนับสนุนระดับตำนาน','เป็นแรงหนุนสำคัญของระบบนี้', '#d4a017'],
    ]
    const rows = raw
