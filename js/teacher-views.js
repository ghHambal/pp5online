...
export async function renderTeacherOverview(teacher, homeroomRooms = []) {
  ...
  window._openTeacherShirtModal = async () => {
    const { openTeacherShirtSizeModal } = await import('./sports-portals.js?v=10.22.683')
  ...
  const sidebarTileColors = {
    ...
    'sports-fund': ['#C8ECC9', '#67B96A'], 'sports-overview': ['#C6E6FA', '#4F9BD6'], 'sports-competition-manager': ['#D9E7F8', '#4C86C6'], 'sports-evaluation': ['#FBE1C6', '#D68A3F'], 'shirt-vote': ['#E2D3F5', '#9663D1'],
