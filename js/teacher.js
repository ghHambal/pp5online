...
const ROUTES = {
  ...
  'exam-docs':   () => import('./teacher-views-exam-docs.js?v=10.18.13').then(m => m.renderExamDocuments(_teacher)),
  ...
  'student-leave-scanner': () => {
    import('./teacher-views-leave-scanner.js?v=10.18.13').then(m => m.renderStudentLeaveScanner(_teacher))
  },
