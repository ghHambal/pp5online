...
import { renderAdvisorStudents, renderShirtSummary, renderSportsFundAdmin, openMyTeamWorkspace, renderShirtVoteSettings, renderShirtVoteDashboard } from './sports-portals.js?v=10.22.637'
...
function _showShirtSizeReminderPopup() {
  ...
  wrap.querySelector('#ssrp-go').addEventListener('click', () => {
    wrap.remove()
    import('./sports-portals.js?v=10.22.637').then(m => m.openTeacherShirtSizeModal?.(_teacher))
  })
