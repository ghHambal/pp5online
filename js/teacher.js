...
import { APP_VERSION } from './version.js?v=10.22.411'
...
import { renderAdvisorStudents, renderShirtSummary, renderSportsFundAdmin, openMyTeamWorkspace, renderShirtVoteSettings, renderShirtVoteDashboard } from './sports-portals.js?v=10.22.411'
import {
...
function _showShirtSizeReminderPopup() {
  ...
  wrap.querySelector('#ssrp-go').addEventListener('click', () => {
    wrap.remove()
    import('./sports-portals.js?v=10.22.411').then(m => m.openTeacherShirtSizeModal?.(_teacher))
  })
