...
import { APP_VERSION } from './version.js?v=10.18.19'
...
const ROUTES = {
  ...
  'exam-docs':   () => import('./teacher-views-exam-docs.js?v=10.18.19').then(m => m.renderExamDocuments(_teacher)),
  ...
  'student-leave-scanner': () => {
    import('./teacher-views-leave-scanner.js?v=10.18.19').then(m => m.renderStudentLeaveScanner(_teacher))
  },
