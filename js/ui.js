import { APP_VERSION } from './version.js?v=10.22.815'
...
const CHANGELOGS = {
  '10.22.815': [
    '🏅 ปรับรายชื่อผู้ได้รับเหรียญของรายการประเภททีมและทีมคู่ให้แสดงสมาชิกในทะเบียนครบทั้งทีม รวมตัวจริงและตัวสำรอง โดยไม่กระทบสถิติผู้ทำคะแนน',
  ],
  '10.22.814': [
  ...
  '10.22.805': [
    '📷 ปรับหน้ารับรายงานตัวให้อำนวยความสะดวกแก่ทีมงานทุกจุด โดยใช้รหัสกลาง azreg26 ได้ทันที ไม่ต้องมี Username/PIN แยกทุกคน และยังรองรับบัญชีเดิมตามปกติ',
  ],
  '10.22.804': [
  ...
  '10.22.795': [
    '🗂️ ปรับแท็บรายการแข่งขันให้แสดงรายการเดียวต่อประเภทกีฬา รวมจำนวนนัด เวลา จุดแข่งขัน และเปิดดูรายชื่อนักกีฬาเพื่อรับรายงานตัวแบบ Real-time ได้ชัดเจนขึ้น',
  ],
  '10.22.794': [
    '📷 เพิ่มแท็บรายการแข่งขันสำหรับครูรับรายงานตัว เปิดรายการแบบเต็มจอ แสดงสถานะนักกีฬารายคนแบบ Real-time และเพิ่มปุ่มรับรายงานตัวในเมนู ปพ.5',
  ],
  '10.22.793': [
    '🗓️ เพิ่มสรุปรายการแข่งขันตามวันที่เลือกในหน้ารับรายงานตัว เพื่อให้ครูเห็นประเภทกีฬา จำนวนคู่ เวลา และจุดแข่งขันก่อนรับรายงานตัว',
  ],
  '10.22.792': [
    '🔑 เชื่อม Username/Password ผู้รับผิดชอบเข้าบัญชีล็อกอินกีฬาสีหลักแบบแยกจาก ปพ.5 และให้บันทึกผลการแข่งขันผ่านระบบกีฬาสีหลักเท่านั้น',
  ],
  '10.22.791': [
    '👩‍🏫 เพิ่มบัญชี Username และรหัสผ่านให้ครูผู้รับผิดชอบทุกรายการที่มีอยู่ในฐานข้อมูล โดยครูคนเดียวใช้บัญชีเดียวและรวมรายการทั้งหมดไว้ในตาราง',
  ],
  '10.22.790': [
    '🔐 เพิ่ม CRUD ข้อมูล Username และรหัสผ่านผู้รับผิดชอบที่อนุมัติแล้ว ใช้เลขครู 4 หลักและรหัสเริ่มต้น azgames พร้อมค้นหาได้ทุกช่องในตาราง',
  ],
  '10.22.789': [
    '📋 ปรับตารางเป็นรายชื่อครูผู้รับผิดชอบที่แอดมินอนุมัติจริง แสดงยศ/ประเภท Username และรวมรายการที่รับผิดชอบไว้ในแถวเดียว',
  ],
  '10.22.788': [
    '✅ เพิ่มตารางรายการที่อนุมัติแล้วพร้อมครูและ Username สำหรับแอดมิน และเพิ่มปุ่มอนุมัติคำขอทั้งหมดในครั้งเดียว',
  ],
  '10.22.787': [
    '🖨️ เพิ่มปุ่มพิมพ์ใบรายชื่อนักกีฬาในหน้ารายการแข่งขันของฉัน แยกตามรายการย่อยและสี พร้อมรูปนักกีฬาและบันทึกเป็น PDF ได้',
  ],
  '10.22.786': [
    '📝 เปิดให้ครูส่งคำขอลงทะเบียนได้ทั้งรายการที่เป็นผู้รับผิดชอบในฐานข้อมูลอยู่แล้วและรายการที่ยังว่าง โดยไม่อนุญาตให้ขอรายการของครูท่านอื่น',
  ],
  '10.22.785': [
    '⚙️ เพิ่มแผงให้แอดมินตั้งค่าวันสิ้นสุดการแก้ไขโปรแกรมการแข่งขันได้จากหน้า “รายการแข่งขันของฉัน” โดยไม่ปิดการส่งคำขอลงทะเบียนผู้รับผิดชอบ',
  ],
  '10.22.784': [
    '📡 เพิ่ม Offline Queue หน้ารับรายงานตัวนักกีฬา: สแกนต่อได้เมื่อสัญญาณหลุด เก็บรายการไว้ในเครื่องและส่งอัตโนมัติเมื่อออนไลน์อีกครั้ง',
  ],
  '10.22.783': [
    '✨ เพิ่มเอฟเฟกต์ขอบ Popup เรืองแสงสีเขียวเมื่อสแกนรายงานตัวนักกีฬาสำเร็จ',
  ],
  '10.22.782': [
    '🔐 ปรับหน้ารับรายงานตัวนักกีฬาให้ใช้รหัสผ่านเดียวตามรูปแบบเดิม ทั้งการเปิดตรงจาก URL และการเปิดจากระบบกีฬาสีหลัก',
  ],
  '10.22.781': [
    '✅ ปรับหน้ารับรายงานตัวนักกีฬาเป็นหน้าต่างกล้องแบบ popup พร้อมแสดงผลสำเร็จชัดเจนบนมือถือและคอมพิวเตอร์',
  ],
  '10.22.780': [
    '🏃 เพิ่มแถบสลับชาย/หญิงในหน้ารับรายงานตัวนักกีฬา เพื่อค้นหารายชื่อได้รวดเร็วขึ้น',
  ],
  '10.22.779': [
    '📥 เพิ่มปุ่มดาวน์โหลด Excel สำหรับ GradeOnline ตามรูปแบบ 5 คอลัมน์: เลขที่, รหัสนักเรียน, ชื่อ-สกุล, คะแนนรวม, เกรด',
  ],
  '10.22.778': [
    '📤 แก้การส่งคะแนนเข้า GradeOnline: ไม่ส่งนักเรียนที่คะแนนยังไม่ครบเป็น 0/0 และหยุดกรอกเกรดเมื่อช่องคะแนนรวมปลายทางไม่สำเร็จ',
  ],
  '10.22.777': [
  ...
  '10.22.762': [
    '📝 เพิ่มการลงทะเบียนผู้รับผิดชอบรายการแข่งขันจากหน้า ปพ.5 โดยเลือกได้หลายรายการในคำขอเดียว และให้แอดมินอนุมัติก่อนเปิดสิทธิ์',
  ],
  '10.22.761': [
    '🧪 เพิ่มข้อความเตือนชัดเจนในหน้าบันทึกผลเมื่ออยู่ในโหมดทดลอง/ทดสอบ และกันผลจำลองไม่ให้เขียนเป็นข้อมูลทางการ',
    '🌟 แสดงตัวเลือกนักกีฬายอดเยี่ยม/ดีเด่นเฉพาะนัดชิงชนะเลิศ หรือหลังสรุปเหรียญเสร็จสิ้นเท่านั้น',
  ],
  '10.22.760': [
  ...
  '10.22.755': [
    '🏃 แยกรายการแข่งขันชาย/หญิง/รวม และกรองสีคู่แข่งขันให้ตรงกับเพศของรายการ พร้อมตรวจซ้ำที่ฐานข้อมูล',
  ],
  '10.22.754': [
    '🏟️ ให้บัญชีแอดมิน ปพ.5 เห็นและเข้าหน้ารายการแข่งขันของฉันได้ทันที เพื่อดูรายการและจัดการโปรแกรมการแข่งขันของทุกประเภท',
  ],
  '10.22.753': [
  ...
  '10.22.742': [
    '📐 ปรับเรียงคอลัมน์คะแนนให้สอดคล้องระหว่างหน้ากรอกคะแนนและเอกสาร PP5 พร้อมคงข้อมูลโปรแกรมประกบคู่เมื่อรีเซ็ทผลการแข่งขัน',
  ],
  '10.22.741': [
  ...
  '10.22.728': [
    '📄 ปรับช่อง ร และ มส ในสรุปหน้าปกให้แสดง - ตามรูปแบบสรุปเกรดตัวเลข',
  ],
  '10.22.727': [
    '📄 แก้สรุปหน้าปกให้นับเกรดอัปเกรด/บังคับครบ รวม ร และ มส พร้อมแสดง - เมื่อไม่มีผู้ได้เกรด',
  ],
  '10.22.726': [
    '👥 แก้รายชื่อครูที่ปรึกษาสามัญและศาสนาไม่ให้เลือกข้อมูลซ้ำ และกู้คืนรายการครูสามัญจากข้อมูลเดิมที่ถูกต้อง',
  ],
  '10.22.725': [
    '👥 ป้องกันการบันทึกครูที่ปรึกษาซ้ำในห้องเดียวกัน และเก็บรายการเดิมไว้ตรวจสอบย้อนหลัง',
  ],
  '10.22.724': [
  ...
  '10.22.721': [
    '📄 แก้เอกสาร ปพ.5 ให้แสดงเกรดบังคับจากหน้ากรอกคะแนนตรงกับค่าที่บันทึกในห้องเรียน',
  ],
  '10.22.720': [
  ...
  '10.22.713': [
    '🗑️ แก้ปุ่มลบใบสมัครสภานักเรียนให้เปิดหน้าต่างยืนยันและทำงานตามสิทธิ์แอดมินได้จริง',
  ],
  '10.22.713': [
    '✅ ยืนยันและปรับ query ใบสมัครสภานักเรียนให้กรองรายการที่ถูก soft-delete ตามฐานข้อมูล production',
  ],
  '10.22.713': [
    '🛠️ แก้การแสดงใบสมัครสภานักเรียนระหว่างรอติดตั้ง migration ฐานข้อมูล ให้ข้อมูลเดิมกลับมาแสดงได้',
  ],
  '10.22.713': [
  ...
  '10.22.707': [
    '📋 ปรับลำดับรายชื่อในใบรายชื่อนักเรียนให้เรียงตามรหัสนักเรียนก่อน เพื่อให้พิมพ์และตรวจสอบรายชื่อสอดคล้องกับลำดับจริงของห้องเรียน',
  ],
  '10.22.706': [
  ...
  '10.22.702': [
    '🏅 ศูนย์มอบเหรียญกีฬาสี: มอบหมายครูเข้าผ่าน ปพ.5 โดยไม่ใส่รหัส แยกคิวรอมอบและมอบแล้ว พร้อมโลโก้สี ประวัติการมอบ และรูปเชื่อมแกลเลอรี่หมวดพิธีมอบเหรียญ',
  ],
  '10.22.701': [
    '⚡ ปรับการเข้าสู่ระบบนักเรียนและการโหลดหน้าครู/ตารางคะแนน ลดการอ่านข้อมูลซ้ำและการลองซ้ำเมื่อระบบขัดข้อง',
    '📚 โหลดข้อมูล GPA นักเรียนแบบชุด รองรับข้อมูลจำนวนมาก โดยคงสูตรคะแนนและเกรดเดิม',
  ],
  '10.22.700': [
    '🔢 คะแนน: เพิ่มการบันทึกค่าปัดเลขร่วมสำหรับครู นักเรียน และ ปพ.5 โดยไม่เขียนทับคะแนนต้นฉบับ',
    '⭐ คะแนนพิเศษแสดงแยกในหน้านักเรียน ไม่บวกยอดรวมหรือเกรด และแก้การนับคอลัมน์ปรับคะแนนในเอกสาร',
  ],
  '10.22.699': [
  ...
  '10.22.696': [
    '🔐 ระบบกีฬาสี: การสมัครและอนุมัติกรรมการบันทึกผลเปลี่ยนเป็นบัญชี Username + PIN 6 หลักที่ตรวจในฐานข้อมูล เก็บ PIN แบบเข้ารหัส จำกัดสิทธิ์เฉพาะกีฬาที่ได้รับมอบหมาย และปิดช่องบันทึกผล/รายงานตัวโดยผู้ไม่ผ่านการอนุมัติ',
  ],
  '10.22.695': [
    '📝 หน้า "เอกสารช่วงสอบ" ทำใบปะหน้าซองภาษาอาหรับ/ยาวีใหม่ทั้งหมดให้ตรงกับใบจริงของฝ่ายศาสนา — โลโก้เดียวกลางหน้า+ชื่อโรงเรียน, หัวข้อ "ผู้คุมสอบ" แยกเป็นรายการเรียงเลข, ตารางสรุปวันที่/คาบ/กลุ่ม/เลขห้องท้ายซอง, ป้ายฝ่ายกิจการศาสนามุมล่างซ้าย และขยายระยะห่าง/ขนาดตัวอักษรให้เนื้อหาเต็มหน้า A4 แนวตั้ง',
  ],
  '10.22.694': [
    '👦👧 หน้า "เอกสารช่วงสอบ" ห้องไหนมีนักเรียนทั้งชายและหญิง จะมีตัวเลือก "ใช้ทั้งห้อง" หรือ "แยกเพศ" ขึ้นมาให้ — เลือกแยกเพศแล้วระบบนับจำนวนแต่ละเพศให้อัตโนมัติ พร้อมเลือกได้ว่าจะพิมพ์ทีละเพศ (เฉพาะที่กำลังดูอยู่) หรือพิมพ์ทีเดียวทั้งสองชุดต่อกัน (ชายก่อน แล้วต่อด้วยหญิง)',
  ],
  '10.22.693': [
    '📝 หน้า "เอกสารช่วงสอบ" ปรับโครงใบปะหน้าซองสำหรับภาษาอาหรับ/ยาวี ให้เป็นแนวตั้งแบบใบปะหน้าซองจริงของฝ่ายศาสนา (เดิมเป็นแนวนอนบรรทัดเดียวรวด) — รวมข้อมูลเป็นกลุ่มบรรทัด มีรายชื่อผู้คุมสอบเรียงเลข 1./2. และตารางสรุปวันที่/คาบสอบ/กลุ่ม/ห้องสอบท้ายซอง ส่วนภาษาไทยหน้าตายังเหมือนเดิมทุกประการ',
  ],
  '10.22.692': [
    '🐛 หน้า "เอกสารช่วงสอบ" แก้บั๊กเลือกชื่อครูคุมสอบแล้ว "ไม่มีอะไรเกิดขึ้น" — เดิมเลือกชื่อแล้วค่าถูกเก็บไว้จริง แต่ไม่เคยถูกพิมพ์ลงในเอกสารเลยสักที่ ตอนนี้ชื่อจะโชว์กำกับต่อท้ายเส้นลงชื่อผู้คุมสอบทั้ง 2 คนในเอกสารแล้ว (ยังพิมพ์เองแทนการเลือกจากรายชื่อได้อิสระเหมือนเดิม)',
  ],
  '10.22.691': [
    '📝 หน้า "เอกสารช่วงสอบ" เลือกภาษาเอกสารเป็นอาหรับ/ยาวี จะมีช่องแก้ไข "วันที่สอบ"/"เวลาสอบ" ที่จะพิมพ์ในเอกสารเพิ่มขึ้นมา (ไม่กรอก = แปลงจากวันที่/เวลาที่ตั้งไว้แบบไทยให้อัตโนมัติเหมือนเดิม) ส่วนภาษาไทยหน้าตายังเหมือนเดิมทุกประการ',
  ],
  '10.22.690': [
    '📝 หน้า "เอกสารช่วงสอบ" ช่อง "ประเภทสอบ" พิมพ์เองได้อิสระแล้ว (ยังเลือกจากตัวเลือกเดิมได้ด้วย) และเพิ่มช่อง "ชื่อวิชาที่แสดงในเอกสาร" ให้แก้ไขข้อความที่จะพิมพ์ได้ต่างหาก (เช่น แปลเป็นภาษาอาหรับ/ยาวี) โดยไม่กระทบชื่อวิชาจริงของห้องเรียนที่เลือกไว้ ใช้ได้แค่เอกสารชุดนั้นไม่บันทึกถาวร',
  ],
  '10.22.689': [
    '💬 หน้า "Feedback ถึงแอดมิน" เมื่อแอดมินตอบกลับ (ทั้งพิมพ์ตอบเองและปุ่มรีเซ็ทรหัสผ่านลัด) ระบบจะทำเครื่องหมายว่าอ่านแล้วอัตโนมัติ และส่ง push notification แจ้งผู้ส่งทันที ไม่ต้องรอให้เข้ามาเปิดหน้า Feedback เองถึงจะเห็นคำตอบ',
  ],
  '10.22.688': [
    '🔢 หน้าบันทึกคะแนน ปุ่ม "ปัดเลข" เปลี่ยนเป็นเปิดป๊อบอัพตั้งค่า เลือกได้อิสระทีละคอลัมน์ (รวมถึงช่องกรอกคะแนนเอง คอลัมน์คำนวณสูตร และผลรวมกลางภาค/ปลายภาค/รวมทั้งหมด) ว่าจะแสดงเป็นจำนวนเต็มหรือทศนิยม — ไม่กระทบคะแนนจริงที่บันทึกไว้ แค่ปรับการแสดงผล จำค่าที่เลือกไว้ต่อห้อง/ต่อครู',
  ],
  '10.22.687': [
    '🐛 แก้บั๊กคะแนนละหมาดโชว์ไม่ตรงกันข้ามวิชาศาสนา (ค่าที่บันทึกไว้กับค่าที่คำนวณสดไม่ตรงกัน) ต้นเหตุคือมีโค้ด 2 ชุดคำนวณคะแนนละหมาดแยกกัน — Postgres trigger (คำนวณสดถูกต้อง) กับฟังก์ชัน JS เดิมที่รันซ้ำทุกครั้งที่เปิดหน้าสมุดคะแนนวิชาศาสนา (ใช้สูตรจัดการข้อมูลซ้ำคนละแบบ) แย่งกันเขียนทับคอลัมน์เดียวกัน ตอนนี้ปล่อยให้ trigger เป็นเจ้าของคะแนนละหมาดแต่ผู้เดียว ฟังก์ชัน JS เหลือแค่สร้างคอลัมน์ให้มีไว้ก่อน',
  ],
  '10.22.686': [
    '🕌 แก้จุดแสดงห้องเรียนของนักเรียนศาสนาที่ยังโชว์ว่างเปล่า (ไม่มี fallback ไป religion_room) ในหน้าระบบแก้ค้างเก่าและตอนค้นหาชื่อออกใบเกียรติบัตร',
  ],
  '10.22.685': [
    '🕌 แก้บั๊กเชื่อมข้อมูลกับระบบดูแล (นำเข้า/ส่งออกเช็คชื่อ) ใช้ไม่ได้กับห้องเรียนศาสนา — เดิมจับคู่ห้องด้วย main_room เท่านั้น ทำให้วิชาศาสนาขึ้น "หาห้องเรียนไม่เจอ" ตลอด ตอนนี้แยกใช้ religion_room ให้วิชาศาสนาโดยอัตโนมัติ ทั้งฝั่ง pp5-online และบุ๊กมาร์กที่รันบนหน้าระบบดูแล',
  ],
  '10.22.684': [
    '🖥️ หน้าแอดมินใหม่ "ประวัติปรับกำลังเครื่อง" — ตารางแยกต่างหากจากหน้าประกาศทั่วไป แสดงประวัติทุกครั้งที่ระบบ auto-scale ปรับขนาด compute (Micro ↔ Medium) อัตโนมัติ',
  ],
  '10.22.683': [
    '🏛️ เพิ่มระบบเสนอชื่อตัวแทนสภานักเรียน (ม.3-ม.5) — ครูที่ปรึกษาสามัญเสนอชื่อนักเรียนได้ห้องละ 2 คนจากหน้า "นักเรียนที่ปรึกษา" แท็บใหม่ "เสนอชื่อสภา" ฝั่งแอดมินมีหน้าสรุปรายชื่อรวมทุกห้อง กรองระดับชั้น/เพศ/ค้นหา + พิมพ์ใบรายชื่อได้ (⚠️ ต้องรัน patch_council_rep_nominations.sql ก่อนใช้งานได้จริง — เป็นเครื่องมือเก็บรายชื่อแยกต่างหาก ไม่ผูกกับระบบสภานักเรียนจริง)',
  ],
  '10.22.682': [
  ...
  '10.22.680': [
    '🙋 ครูมอบหมายให้หัวหน้า/รองหัวหน้าห้อง (ตามที่แอดมินตั้งไว้) เช็คชื่อแทนได้ระหว่างคาบสอนจริง — เปิดใช้ในหน้ารายละเอียดห้องเรียน ฟรี 1 ห้อง / โดเนทระดับ 3 ขึ้นไปใช้ได้ไม่จำกัดห้อง ฝั่งนักเรียนที่เป็นหัวหน้า/รองหัวหน้าจะเห็นปุ่ม "เช็คชื่อแทนครู" ที่หน้าแรกเฉพาะช่วงเวลาที่กำลังเรียนวิชานั้นจริง (⚠️ ต้องรัน patch_attendance_delegation.sql ก่อนใช้งานได้จริง — migration นี้ยังปิดช่องโหว่ RLS เก่าของตาราง classes ที่เปิดกว้างเกินไปด้วย)',
  ],
  '10.22.679': [
    '🔀 ป๊อบอัพ "จัดการกลุ่มรายวิชา" (นักเรียน) เพิ่มแท็บสลับสามัญ/ศาสนา เหมือนหน้าหลัก — ปุ่มขอย้ายกลุ่มโชว์เฉพาะแท็บศาสนาเท่านั้น (กรณีจริงคือวิชาสามัญถูกจัดเข้ากลุ่มศาสนาเพราะครูผู้สอนอยู่หมวดศาสนา ไม่ใช่ตัววิชาเอง)',
  ],
  '10.22.678': [
    '🔀 นักเรียนขอย้ายวิชาข้ามกลุ่มสามัญ/ศาสนาเองได้แล้ว (หน้า "รายวิชาของฉัน" → "จัดการกลุ่มรายวิชา") สำหรับวิชาที่ฝ่ายทะเบียนจัดรหัสผิดกลุ่มตามหลักสูตร — คำขอไม่มีผลทันที ต้องผ่านแอดมินตรวจสอบ/อนุมัติก่อน (หน้าใหม่ "คำขอย้ายกลุ่มวิชา" ในแดชบอร์ดแอดมิน) โดยแอดมินเลือกได้เองว่าจะให้มีผลกับห้องไหนบ้างในระดับชั้นเดียวกัน',
  ],
  '10.22.677': [
    '🐛 แก้บั๊กเกรดเฉลี่ย (GPA) หน้านักเรียน — วิชาที่ครูยังกรอกคะแนนไม่ครบทุกช่อง เดิมนับช่องที่ว่างเป็น 0 ทำให้ GPA ต่ำผิดปกติ/ดูเหมือนสอบตกทั้งที่ครูยังตรวจไม่เสร็จ ตอนนี้ไม่นับวิชานั้นเข้า GPA จนกว่าจะให้คะแนนครบ (โชว์ "⏳ x/y" แทน) — เพิ่มแท็บสลับสามัญ/ศาสนา ในหน้า "รายวิชาของฉัน" และเพิ่มมุมมองการ์ด/ตาราง ในหน้าเกรดเฉลี่ยด้วย',
  ],
  '10.22.676': [
  ...
  '10.22.674': [
    '🐛 แก้บั๊กป๊อบอัพเต็มหน้าจอ (เช็คชื่อ/คะแนน) — ป๊อบอัพย่อยที่เปิดจากข้างใน เช่น "เช็คทั้งหมด" ก่อนหน้านี้เด้งไปโผล่ด้านหลังป๊อบอัพเต็มจอ ดูเหมือนกดแล้วไม่มีอะไรเกิดขึ้น ต้องปิดหน้าถึงจะเห็น แก้แล้ว',
  ],
  '10.22.673': [
    '✅ หน้าเช็คชื่อ เพิ่มปุ่ม "เช็คทั้งหมด" — เลือกช่วงวันที่ + สถานะ แล้วเติมเช็คชื่อให้ทีเดียวทั้งห้อง เฉพาะช่องที่ยังว่างอยู่เท่านั้น (ไม่ทับช่องที่เช็คไว้แล้ว) ใช้ได้ทั้งหน้าเช็คชื่อปกติและใน Smart Classroom',
  ],
  '10.22.672': [
    '🗂️ แท็บ "คะแนน"/"เช็คชื่อ" ทั้งห้อง เปลี่ยนจากขยายฝังในหน้าเดิม เป็นเปิดป๊อบอัพเต็มหน้าจอลอยทับแทน (ทั้งในหน้ารายละเอียดห้องเรียน และใน Smart Classroom) ใช้งานตารางกว้างๆ ได้สะดวกขึ้น มีปุ่ม ✕ ปิดชัดเจน',
  ],
  '10.22.671': [
    '🔄 เปลี่ยนชื่อคอลัมน์ "ปรับคะแนนกลางภาค" เป็น "คอลัมน์ปรับคะแนน" — เชื่อมกับคอลัมน์หลักหมวดไหนก็ได้แล้ว (ระหว่างเรียน/กลางภาค/ปลายภาค) ไม่จำกัดแค่กลางภาคเหมือนเดิม ปรับทั้งหน้าจัดการคอลัมน์เต็มหน้าและป๊อบอัพจัดการคอลัมน์ด่วนในหน้าบันทึกคะแนน',
  ],
  '10.22.670': [
    '➕ คอลัมน์ "ปรับคะแนนกลางภาค" เพิ่มโหมด "บวกเพิ่มจากคะแนนตั้งต้น" นอกเหนือจากโหมดเดิม "ใช้คะแนนที่มากกว่า" — เลือกได้ตอนสร้าง/แก้คอลัมน์ โหมดบวกเพิ่มจะจำคะแนนตั้งต้นไว้ครั้งแรกที่ปรับ ไม่บวกซ้ำสะสมถ้าแก้ค่าคอลัมน์ปรับซ้ำภายหลัง (⚠️ ต้องรัน patch_score_override_add_mode.sql ก่อนใช้งานได้จริง)',
  ],
  '10.22.669': [
  ...
  '10.22.667': [
    '🥉 ระบบฟุตซอล เพิ่มสวิตช์ "ตัดนัดชิงที่ 3 ม.ปลาย (ให้อันดับ 3 ร่วม)" ในหน้าตั้งค่าแอดมิน — เปิดใช้แล้วสำหรับ AZFUTSALCUP2026 เพราะไม่ได้แข่งนัดชิงที่ 3 จริง ทำให้ทีมที่แพ้รอบรองฯ ทั้งสองคู่ได้อันดับ 3 ร่วมกัน (มีผลกับหน้าสรุปผล/เกียรติบัตรทันที)',
  ],
  '10.22.666': [
    '⚠️ หน้ารับชำระค่าเสื้อกีฬาสี ปุ่ม "ยกเลิกรายการ" เปลี่ยนจากป๊อบอัพเบราว์เซอร์ธรรมดาเป็นป๊อบอัพแดงเด่นชัด อธิบายผลก่อนกดยืนยัน กันครูที่ปรึกษากดพลาด',
  ],
  '10.22.665': [
    '💰 หน้ารับชำระค่าเสื้อกีฬาสี (ครูที่ปรึกษาศาสนา) เพิ่มแท็บ "ยกเลิก" เก็บประวัติรายการที่ยกเลิกไว้ (ใครยกเลิก เมื่อไหร่) แทนการลบทิ้งถาวร ป้องกันกรณีบันทึกผิดแล้วอยากตรวจสอบย้อนหลัง',
  ],
  '10.22.664': [
    '🐛 แก้บั๊กร้ายแรง: หน้าเช็คชื่อ/บันทึกคะแนนของบางห้องเรียน (ที่มีประวัติสะสมเยอะ) โหลดไม่สำเร็จเพราะฐานข้อมูลประมวลผลช้าเกินเวลา (แก้ที่ระบบตรวจสิทธิ์เบื้องหลัง ไม่กระทบการใช้งานที่เห็นหน้าจอ)',
  ],
  '10.22.663': [
    '🐛 หน้าบันทึกคะแนน แก้บั๊ก "บังคับเกรด" ไม่เคยบันทึกจริง (เดิมรีเฟรชหน้าแล้วหายทุกครั้ง) ตอนนี้บันทึกลงฐานข้อมูลจริงและโหลดกลับมาถูกต้องแล้ว',
  ],
  '10.22.662': [
    '📤 หน้าบันทึกคะแนน เพิ่มปุ่ม "ส่งสรุปเกรดเข้าระบบแก้ค้างเก่า" (โชว์เฉพาะตั้งแต่วันที่แอดมินกำหนดไว้ในหน้าตั้งค่าแก้ค้างเก่า) — คำนวณนักเรียนที่ติด 0/ถูกบังคับเกรดแล้วส่งเข้าระบบแก้ค้างเก่าอัตโนมัติ กดซ้ำได้ปลอดภัยไม่ทับรายการเดิม',
  ],
  '10.22.661': [
    '🔄 หน้าตั้งค่าระบบ เพิ่มปุ่ม "ขึ้นภาคเรียนใหม่" (แอดมิน) — สร้างห้องเรียนใหม่เปล่าให้ทุกวิชาของเทอมปัจจุบันในคลิกเดียว ลงทะเบียนนักเรียนอัตโนมัติ ห้องเทอมเก่ายังแก้ไขย้อนหลังได้แต่ซ่อนจากหน้า "ห้องเรียนของฉัน" ตามค่าเริ่มต้น (มีปุ่มดูย้อนหลัง)',
  ],
  '10.22.660': [
    '📅 เพิ่มปี/เทอมให้ห้องเรียนทุกห้อง (เตรียมรองรับขึ้นภาคเรียนที่ 2) — ห้องเรียนเก่าจากเทอมก่อนจะไม่ถูกนับว่า "ใช้ชื่อห้องนี้แล้ว" ตอนทำสำเนาห้องเรียนสำหรับเทอมใหม่อีกต่อไป และแก้ระบบซิงก์นักเรียนรายสัปดาห์ไม่ให้ลงทะเบียนซ้ำเข้าห้องเก่าข้ามเทอม',
  ],
  '10.22.659': [
  ...
  '10.22.657': [
    '🧑‍⚖️ หน้า "ภาพรวมกีฬาสี" (แอดมิน) เพิ่มแท็บ "การประเมิน" — ดูความครบถ้วนของแต่ละเกณฑ์ (กี่สีจากทั้งหมดมีคะแนนแล้ว) + รายชื่อผู้ประเมินทุกคน (ทั้งครู ปพ.5 และกรรมการ AZIZGAMES เดิม) พร้อมสถานะส่งคะแนนแล้ว/ยังไม่ส่ง',
  ],
  '10.22.656': [
    '🏅 เพิ่มหน้า "สรุปคะแนนทุกสี" ในตัวปพ.5 — เทียบคะแนนทุกสีในหน้าเดียว (พาเหรด/หน้าเว็บ/วันเข้าสี-กีฬาสีจริง + วิชาการ + กีฬา + เหรียญรางวัล) ข้อมูลสดชุดเดียวกับ ColorScoreBoard ของ AZIZGAMES ไม่ต้องสลับไปเปิดอีกระบบ',
  ],
  '10.22.655': [
    '📅 หน้าประเมินกีฬาสี เพิ่มดรอปดาวน์เลือกรอบ/วันที่จะประเมิน (เช่นเข้าสีครั้งที่ 1/2/วันซ้อมใหญ่/วันจริง) แสดงแค่ 3 หัวข้อของรอบที่เลือกทีละรอบ แทนที่จะเห็นทั้ง 10 หัวข้อยาวพร้อมกันทุกสี',
  ],
  '10.22.654': [
    '🐛 หน้าประเมินกีฬาสี แก้การ์ดสีอ้างอิงชื่อ/สีตามตำแหน่งจริง (เพศ+ลำดับ) แทนชื่อที่แก้ได้ผ่านคำขอเปลี่ยนอัตลักษณ์ กันโลโก้เสีย/ชื่อเพี้ยนแบบที่เจอจริง และเพิ่มเกณฑ์ย่อย 3 หัวข้อ (การซ้อมกีฬา/การซ้อมพาเหรด/การจัดการของสตาฟ หัวข้อละ 10) ให้ครบทั้งเข้าสีครั้งที่1 ครั้งที่2 และวันซ้อมใหญ่ ตามแบบประเมินจริง',
  ],
  '10.22.653': [
    '🎨 หน้า "ประเมินกีฬาสี" ปรับใหม่ให้เข้าใจง่ายขึ้น — เปลี่ยนจากตารางยาวเป็นการ์ดแยกทีละสี พร้อมโลโก้และสีปกติของแต่ละสี (ไม่ใช่สีอัตลักษณ์ที่ปรับแต่งได้) เพิ่มแท็บสลับหมวดเมื่อได้รับมอบหมายมากกว่า 1 หมวด',
  ],
  '10.22.652': [
    '🧑‍⚖️ เพิ่มระบบ "ประเมินกีฬาสี" ในตัวปพ.5 — แอดมินมอบหมายครูจริงในระบบให้เป็นผู้ประเมิน (ขบวนพาเหรด/ความร่วมมือสี, วันเข้าสี-วันกีฬาสีจริง, หน้าเว็บเพจ) ครูที่ได้รับมอบหมายเห็นเมนู "ประเมินกีฬาสี" เอง ให้คะแนนได้หลายคนต่อหัวข้อแล้วระบบเฉลี่ยอัตโนมัติ พร้อมแผงตั้งค่าหัวข้อ/คะแนนเต็มในตัว ไม่ต้องแยกไปล็อกอิน AZIZGAMES อีกระบบ',
  ],
  '10.22.651': [
    '🗂️ แก้ค้างเก่า: หัวหน้ากลุ่มสาระมอบหมายวิชาที่ยังไม่มีครูแบบแบ่งกลุ่มนักเรียนได้แล้ว ("☑️ เลือกเฉพาะบางคน") ไม่ต้องยกทั้งวิชาให้ครูคนเดียวเหมือนเดิม',
  ],
  '10.22.650': [
    '🐛 หน้าตั้งค่าระบบ: ปุ่ม "บันทึก" ตอนบันทึกไม่สำเร็จ (เช่น ติด RLS policy) ตอนนี้แสดงสาเหตุจริงในข้อความแจ้งเตือนแทนข้อความทั่วไป',
  ],
  '10.22.649': [
    '🐛 หน้า "ภาพรวมกีฬาสี" แท็บเช็คชื่อรายวัน แก้ตารางแสดงวันเยอะเกินจริง (เคยดึงวันเช็คชื่อทดสอบ/ย้อนหลังนอกปฏิทินมาด้วย) ตอนนี้แสดงเฉพาะวันที่ตั้งไว้ในปฏิทินปฏิบัติงานจริงเท่านั้น พร้อมป้ายชื่อวันใต้วันที่',
  ],
  '10.22.648': [
    '🏛️ สภานักเรียน: ฟอร์มสร้างกิจกรรมเลือกเพศ (สภาชาย/หญิง/ทั้งหมด) ได้อิสระเสมอ แม้เป็นสมาชิกที่ได้รับมอบหมายสร้างเอง ไม่ล็อกไว้ที่ฝั่งตัวเองอีกต่อไป',
  ],
  '10.22.647': [
    '🏛️ สภานักเรียน: ประธาน/สมาชิกที่ได้รับมอบหมายสร้างกิจกรรม-เช็คชื่อได้เอง + ตั้งเกณฑ์ % เช็คชื่อขั้นต่ำสำหรับประเมิน + หน้า "สรุปของฉัน" ดูกิจกรรม/ผลเช็คชื่อ/ผลประเมินของตัวเอง',
  ],
  '10.22.646': [
    '🔗 แก้จุดเข้าไม่ถึงหน้าฝั่งกีฬาสี — เพิ่มเมนู "ภาพรวมกีฬาสี"/"บัญชีเงินกีฬาสี"/"สรุปยอดเสื้อกีฬาสี" ในไซด์บาร์หน้า Admin Dashboard (เดิมมีแค่ในเมนูครู) และเพิ่มปุ่ม "📊 ภาพรวมกีฬาสี" ในหน้าตั้งค่าสรุปยอดเสื้อ (สรุปยอดเสื้อ→⚙️ การเปิดใช้งาน) ให้เข้าได้อีกทาง',
  ],
  '10.22.645': [
    '📊 เพิ่มหน้า "ภาพรวมกีฬาสี" สำหรับแอดมิน สรุปเช็คชื่อรายวัน/ค่าบำรุง/บัญชี เทียบทุกสีพร้อมกันในหน้าเดียว (เมนูไซด์บาร์/หน้าภาพรวมของครู) ไม่ต้องไล่เปิดทีละสีเหมือนเดิม',
  ],
  '10.22.644': [
    '📋 หน้าเช็คชื่อเข้าสีและหน้าค่าบำรุงสี เพิ่มรายชื่อแบบแท็บสลับ "เช็คชื่อ/จ่ายแล้ว" กับ "ยังไม่เช็คชื่อ/ยังไม่จ่าย" อัปเดตสดตามการสแกน พร้อมช่องค้นหา',
  ],
  '10.22.643': [
    '🔲 หน้าสมาชิกในสี เพิ่มปุ่มเปิด QR Code ประจำตัวนักเรียนต่อคน กดสแกนเช็คชื่อ/เก็บค่าบำรุงได้เลยไม่ต้องพก QR',
  ],
  '10.22.642': [
  ...
  '10.22.638': [
    '🏃 หน้าจัดการสีแยกนักกีฬาไม่ซ้ำ รายการสมัคร จำนวนประเภทและเปอร์เซ็นต์ พร้อมดูรายการที่ลงแล้วหรือยังขาด',
    '🔎 เพิ่มค้นหาชื่อ รหัส ห้อง กีฬา เบอร์เสื้อ และกรองตามประเภทการแข่งขันในหน้านักกีฬา',
    '🔳 เพิ่มปุ่มเปิด QR Code นักกีฬาแต่ละคนสำหรับช่วยรายงานตัวเมื่อไม่ได้พก QR ประจำตัว',
    '⏱️ เพิ่มช่วงเวลาปิดรับสมัครและช่วงแก้ไขข้อมูลเดิมของฝ่ายสี พร้อมบังคับสิทธิ์และบันทึกประวัติที่ Supabase',
    '📊 เพิ่มความคืบหน้าการลงทะเบียนรายสีในภาพรวม AZIZGAMES และกดขยายดูประเภทที่ขาดได้',
  ],
  '10.22.637': [
    '🚪 ปรับการอนุญาตออกนอกพื้นที่สีเป็นปุ่มเดียว เปิดป๊อปอัพสแกน QR หรือกรอกรหัส พร้อมรูปนักเรียน สถานะสี และสถานะเช็คชื่อก่อนอนุญาต',
    '⏱️ เลือกเหตุผลและเวลากลับด้วยปุ่มแบบระบบออกนอกห้องเรียน พร้อมคงการติดตาม กลับแล้ว และไม่กลับ–ยกเลิกเช็คชื่อไว้ครบ',
    '📱 แก้เมนูด้านล่างมือถือและกล่องคำขออัตลักษณ์ไม่ให้บังเนื้อหา พร้อมเปลี่ยนคำขอโลโก้สีเป็นอัปโหลดไฟล์จริง',
    '🖼️ แก้โลโก้และไอคอนในหน้าตั้งค่า AZIZGAMES ให้บันทึกลง Storage และโหลดค่าถาวรกลับมาหลังรีเฟรช',
  ],
  '10.22.636': [
    '🚪 เพิ่มระบบอนุญาตนักเรียนออกจากพื้นที่สี ระบุเหตุผลและเวลาที่ควรกลับ พร้อมแจ้งจำนวนผู้ที่อยู่นอกพื้นที่และผู้ที่เกินเวลา',
    '✅ นักเรียนสต๊าฟและครูประจำสีที่มีสิทธิ์เช็คชื่อกดกลับแล้ว หรือระบุว่าไม่กลับเพื่อยกเลิกเช็คชื่อของวันนั้นได้ โดยเก็บเหตุผลและผู้ดำเนินการไว้ตรวจสอบย้อนหลัง',
  ],
  '10.22.635': [
    '📸 แอดมินเพิ่ม แก้ไข เปิดใช้ หรือปิดใช้ประเภทภาพกิจกรรมกีฬาสีได้เอง พร้อมกำหนดวันที่แบบ DD/MM/YY โดยไม่ต้องแก้โค้ด',
    '🗂️ นักเรียนสต๊าฟและครูประจำสีเห็นประเภทใหม่ในช่องเลือกตอนอัปโหลดทันที และเมื่อแก้ชื่อหรือวันที่ อัลบั้มรูปเดิมจะแสดงข้อมูลใหม่ตามโดยไม่ทำให้รูปหาย',
  ],
  '10.22.634': [
    '📄 ปรับหน้าสร้างและแก้ไขแผนการสอนเป็นพื้นที่ทำงานเต็มหน้าจอ พร้อมกระดาษ A4 ที่จัดหัวกระดาษ กล่องเนื้อหา 1–5 ลายเซ็น และบันทึกหลังสอนตามไฟล์ต้นแบบหน้าเดียว',
    '🖨️ ปรับเอกสารพิมพ์ให้ใช้โครงเดียวกับหน้าจอและไฟล์ต้นแบบ ทั้งตำแหน่งข้อมูล สี เส้นบันทึก และลายเซ็นครบ 3 ฝ่าย',
    '📅 ผู้ช่วย AI กำหนดการสอนเพิ่มจำนวนสัปดาห์สอนจริงโดยไม่รวมสัปดาห์สอบ และกำชับให้ AI ส่ง JSON ทั้งหมดในกล่องโค้ด json เพียงกล่องเดียว',
  ],
  '10.22.633': [
    '📚 ปรับหน้าคอร์สวิชาของฉันเป็นการ์ดรายคอร์ส จัดกลุ่มตามกลุ่มสาระ และแสดงจำนวนห้องที่เปิดแล้วอย่างชัดเจน',
    '🎓 เพิ่มข้อมูลหน่วยกิต คาบต่อสัปดาห์ และคาบต่อภาคเรียนบนทุกการ์ด โดยคำนวณตามโครงสร้างหลักสูตร 1 หน่วยกิต = 2 คาบต่อสัปดาห์ = 40 คาบต่อภาคเรียน',
    '📱 จัดปุ่มงานหลักให้อยู่ด้านหน้าการ์ด และรวมเครื่องมือ/เอกสารรองไว้ในส่วนขยาย ช่วยลดความแน่นและใช้งานบนมือถือได้สะดวกขึ้น',
  ],
  '10.22.632': [
    '🧭 ปรับขอบเขตหน้าคอร์สให้ชัดเจน เหลือเฉพาะการออกแบบกำหนดการสอนและแผนการสอนหน้าเดียวที่ใช้ร่วมกันทุกห้อง พร้อมตัดส่วนแชทและทางเข้า Smart Classroom ออกจากคอร์ส',
    '💬 Smart Classroom เพิ่มปุ่มแชทห้องเรียนโดยตรง ใช้ห้องที่กำลังสอนอยู่และคงระบบสิทธิ์แชทเดิมทั้งหมด',
    '✨ Smart Classroom เพิ่ม AI เตรียมการสอนรายห้อง ทั้งแถบด้านบนบนคอมพิวเตอร์และเมนูเพิ่มเติมบนมือถือ โดยใช้ Prompt AI สิทธิ์และโควตาชุดเดิม',
  ],
  '10.22.631': [
    '📚 คอร์สวิชาของฉันเพิ่มศูนย์จัดการคอร์ส รวมกำหนดการสอน แผนหน้าเดียว ห้องเรียน และทางเข้า Smart Classroom ไว้ในหน้าต่างเดียวที่รองรับทั้งจอใหญ่และมือถือ',
    '💬 เพิ่มทางเข้าแชทห้องเรียนจากระดับคอร์ส โดยยังแยกข้อความตามห้องอย่างชัดเจน ไม่ปะปนข้อมูลนักเรียนต่างห้อง',
    '🤖 นำผู้ช่วย AI สำหรับผู้มีสิทธิ์ Smart Classroom มาใช้ในระดับคอร์สตามการตั้งค่าผู้สนับสนุนเดิม พร้อมเลือกห้องเป็นบริบท และแยกบันทึกหลังสอน/ลายเซ็นเป็นรายห้อง',
  ],
  '10.22.630': [
    '📚 ผู้ช่วย AI กำหนดการสอนเพิ่มรายการหน่วยการเรียนรู้ได้หลายหน่วย แต่ละหน่วยมีชื่อและคำอธิบายพอสังเขป ระบบนำข้อมูลทั้งหมดไปรวมใน Prompt ควบคู่กับเอกสารที่ครูแนบ',
    '⏱️ ผู้ช่วย AI แผนหน้าเดียวเปลี่ยนจากกรอกเวลารวมเป็นจำนวนคาบและนาทีต่อคาบ พร้อมคำนวณเวลารวมอัตโนมัติและกำชับ AI ให้ออกแบบกิจกรรมพอดีกับเวลา',
    '🖥️ ย้ายปุ่มสร้าง/คัดลอก Prompt และตรวจ/สร้างจาก JSON ขึ้นไปรวมด้านขวาของหัวข้อแต่ละส่วน ลดการเลื่อนหน้าต่างบนจอใหญ่',
  ],
  '10.22.629': [
    '📘 Smart Classroom แยก “กำหนดการสอน” และ “แผนการสอนหน้าเดียว” เป็นคนละพื้นที่ชัดเจน แต่ละแท็บมีปุ่มสร้างด้วย AI และสร้างเองของตัวเอง ไม่ต้องเปิดหน้าต่างเดียวแล้วสลับประเภทเอกสารอีกต่อไป',
    '🖥️ ปรับ UI จอใหญ่ของพื้นที่จัดการรายวิชาใหม่: เมนูแบบการ์ด 5 กลุ่มพร้อมคำอธิบาย ปุ่มงานหลักขนาดใหญ่ สรุปจำนวนข้อมูล และพื้นที่รายการที่แสดงได้มากขึ้น',
  ],
  '10.22.628': [
    '✏️ แก้ค้างเก่า: รายการที่ครูตอบรับแล้วแสดงปุ่มเปิดไฟล์งาน (เมื่อมีไฟล์), ใบสั้น และปุ่มแก้ไขอย่างเป็นขั้นตอน — กดแก้ไขจึงแสดงตัวเลือกนัดสอบปรับ/ให้งานแก้',
    '🐛 แก้บั๊กจริง: ในหน้า “มอบหมายงาน” กดนัดสอบปรับหรือให้งานแก้แล้วสองปุ่มหายและฟอร์มไม่แสดงจนต้องรีเฟรช — ตอนนี้ฟอร์มแก้ไขแสดงต่อในการ์ดเดิมและปิดกลับได้ตามปกติ',
  ],
  '10.22.627': [
    '🤖 Smart Classroom เพิ่มผู้ช่วยจัดทำกำหนดการสอนและแผนหน้าเดียวด้วย AI ส่วนตัว: ระบบสร้าง Prompt เฉพาะรายวิชา/สัปดาห์/ครั้งสอน รองรับเลือกหนังสือเรียน หลักสูตร และไฟล์ต้นแบบ แล้วรับ JSON กลับมาตรวจและสร้างข้อมูลในระบบอัตโนมัติ',
    '📝 แผนหน้าเดียวรองรับครั้งสอน วันที่ ระยะเวลา หน่วยการเรียนรู้ มาตรฐาน/ตัวชี้วัด การตรวจความสอดคล้องกับกำหนดการ และหน้าพิมพ์ A4 ตามแบบฟอร์มโรงเรียน',
    '✍️ เอกสารแผนรองรับลายเซ็นหัวหน้าห้อง ครูผู้สอน และหัวหน้ากลุ่มสาระ ทั้งวาดด้วยนิ้ว/เมาส์และอัปโหลดภาพ พร้อมเก็บไฟล์ลายเซ็นใน Storage แบบ private',
  ],
  '10.22.626': [
    '📱 Smart Classroom บนมือถือปรับเป็นอินเทอร์เฟซแบบแอป แถบล่างจัดเครื่องมือเป็น 5 กลุ่ม: ห้อง/สอนสด/งาน/แผน/เพิ่มเติม เปิดแต่ละส่วนได้ทันที พร้อม badge และสรุปงานใกล้ครบกำหนดหรือเกินกำหนดที่แสดงจำนวนส่งแล้ว/ยังไม่ส่ง; บนคอมพิวเตอร์แสดงสรุปงานเร่งด่วนในคอลัมน์ขวา',
    '📚 เมนูเรียงรายชื่อนักเรียนรองรับการเลือกงานที่มอบหมายแล้ว โดยจัดกลุ่มผู้ที่ส่งแล้วรอตรวจ → ยังไม่ส่ง → ตรวจแล้ว และแสดงสัญลักษณ์สถานะบนการ์ดนักเรียนทุกคน',
    '📝 แท็บคะแนนรายบุคคลใน Smart Classroom ปรับให้เหมือนหน้าคะแนนหลัก: แยกกลางภาค/ปลายภาค แสดงคะแนนเต็ม เปอร์เซ็นต์ ผลรวม คะแนนคำนวณ เกรด และผลผ่าน/ไม่ผ่าน พร้อมแก้คะแนนได้จากหน้าเดิม',
  ],
  '10.22.625': [
    '👑 หน้าภาพรวมครูเพิ่มปุ่ม Smart Classroom แบบถาวรในแถวสรุปด้านบนแล้ว มองเห็นและเข้าใช้งานได้ทันทีทั้งคอมพิวเตอร์และมือถือ ไม่ถูกซ่อนไปพร้อมชุดไอคอน “ระบบอื่น ๆ” บนจอใหญ่',
  ],
  '10.22.624': [
  ...
  '10.22.622': [
    '🔔 แก้ค้างเก่า: เปิดแจ้งเตือนจริงทั้งสองฝั่ง — ครูได้รับ push เมื่อนักเรียนแจ้งความจำนง นักเรียนได้รับ push เมื่อครูตอบรับ/แก้ไข/ยกเลิก พร้อม badge จำนวนรายการบนเมนูและไอคอนหน้าหลักสำหรับผู้ที่ไม่ได้เปิด push',
  ],
  '10.22.621': [
    '📎 แก้ค้างเก่า: ครูอัปโหลดไฟล์ชี้แจงจากเครื่องได้โดยตรง และเมื่อตอบรับนักเรียนคนถัดไปในวิชา/ภาคเรียน/หมวดเดียวกัน ระบบจะถามกลางหน้าจอว่าจะใช้ไฟล์เดิม อัปโหลดใหม่ หรือไม่แนบไฟล์ โดยไฟล์เดิมถูกเก็บเพียงครั้งเดียวแล้วใช้ร่วมกัน',
  ],
  '10.22.620': [
    '✏️ แก้ค้างเก่า: ครูแก้ไข/เปลี่ยนวิธีตอบรับเดิมหรือยกเลิกให้กลับไปรอตอบรับใหม่ได้ ใบสั้นใช้ข้อมูลล่าสุดอัตโนมัติ และเปลี่ยนวันที่นัดสอบ/กำหนดส่งเป็นตัวเลือกปฏิทินพร้อมตัวเลือกเวลา',
  ],
  '10.22.619': [
    '📄 แก้ค้างเก่า: แยกเทมเพลตใบสั้นเป็น 2 แบบ สามัญ/ศาสนา เลือก+ออกแบบแยกกันได้อิสระในแท็บ "เอกสาร" (พิมพ์ใบสั้นจะเลือกเทมเพลตตามหมวดของนักเรียนอัตโนมัติ)',
  ],
  '10.22.618': [
  ...
  '10.22.615': [
    '🐛 แก้บั๊กจริง: หน้าติดตามไซซ์เสื้อครู/บุคลากร โหมด "☑️ เลือกเพื่อพิมพ์" ติ๊กเลือกรายชื่อแล้วไม่ติดค้าง (บุคลากรทุกคนไปชนคีย์เดียวกันหมด ครูเทียบเลขรหัสผิดชนิดข้อมูล) แก้ให้ติ๊กเลือกได้ถูกต้องทีละคนแล้ว',
    '🚻 เพิ่มตัวกรอง "❔ ไม่ระบุเพศ" ในหน้าเดียวกัน ใช้ร่วมกับตัวกรองสถานะ (เช่น ดูเฉพาะคนที่ "แจ้งแล้ว" + "ไม่ระบุเพศ" พร้อมกันได้)',
  ],
  '10.22.614': [
    '📊 หน้าติดตามไซซ์เสื้อครู/บุคลากร (สำหรับฝ่ายที่รับผิดชอบ): ตารางสรุปจำนวนไซซ์เสื้อแยกแถวชาย/หญิงให้เห็นพร้อมกันเลย ไม่ต้องกดสลับปุ่มเพศด้านบนอีกต่อไป — กดตัวเลขในแต่ละแถวกรองรายชื่อด้านล่างได้ทันที',
    '🔧 แก้ข้อมูล: ย้ายไซซ์เสื้อของคุณครู 3 ท่านที่ไปแจ้งผิดหน้า (แจ้งที่หน้าบุคลากรแทนหน้าครู) กลับเข้าตารางครูให้ถูกต้อง',
  ],
  '10.22.613': [
    '📱 หน้าภาพรวม (ครู/ผู้บริหาร): ซ่อนกริดไอคอน "ระบบอื่น ๆ" อัตโนมัติเมื่อเปิดบนจอใหญ่ (แล็ปท็อป/คอมพิวเตอร์) เพราะซ้ำกับเมนูด้านซ้ายที่เปิดค้างอยู่แล้ว — มือถือยังเห็นกริดไอคอนตามปกติ',
  ],
  '10.22.612': [
    '🐛 แก้บั๊กจริงเพิ่มเติมทั่วระบบ: หน้าต่างพิมพ์/พรีวิวเอกสารทุกจุดในระบบ (ใบเสร็จคืนเงินฟุตซอล/เอกสารช่วงสอบ/ใบขออนุมัติโครงการสภา/เกียรติบัตรกิจกรรมสภา/ปพ.5/ติดตามความคืบหน้าแก้ค้างเก่า/รายชื่อกีฬาสี/ใบรายชื่อ+ใบเสร็จ TERANGGANU/ใบรายชื่อนักเรียนพิมพ์คะแนน-เช็คชื่อ) เปลี่ยนจากเปิดหน้าต่างแยก (window.open) มาแสดงในหน้าเดิมทั้งหมด แก้ปัญหาเดียวกับเกียรติบัตร (v10.22.611) ที่กด "ปิด" บนแอป PWA แล้วเด้งกลับหน้าภาพรวมผิดที่ — ตอนนี้ปิดจากระบบไหนก็กลับไประบบนั้นถูกต้องทุกจุด',
  ],
  '10.22.611': [
    '🐛 แก้บั๊กจริง: ดูตัวอย่าง/พิมพ์เกียรติบัตร (และใบสั้นแก้ค้างเก่า) บนแอปที่ติดตั้งลงหน้าจอ (PWA) กด "ปิด" แล้วเด้งกลับหน้าภาพรวมเฉยๆ แทนที่จะปิด — ต้นเหตุคือ window.open เปิดหน้าต่างใหม่ไม่ได้จริงบน PWA เขียนทับหน้าแอปเดิมแทน เปลี่ยนมาแสดงในหน้าเดิมด้วย overlay ไม่ต้องพึ่ง window.open อีกต่อไป ใช้ได้ทุกอุปกรณ์เหมือนกัน',
  ],
  '10.22.610': [
    '⬅️ เพิ่มปุ่ม "ปิดหน้าต่างนี้" ในหน้าต่างพิมพ์/พรีวิวเอกสารที่เปิดแบบป๊อปอัพทุกจุดที่ยังไม่มี (เกียรติบัตร/ใบสั้นแก้ค้างเก่า/ใบเสร็จคืนเงินฟุตซอล/เอกสารช่วงสอบ/ใบขออนุมัติโครงการสภา/ใบรายชื่อ TERANGGANU/ใบเสร็จ TERANGGANU/ปพ.5/รายชื่อกีฬาสี/ติดตามความคืบหน้าแก้ค้างเก่า) — เดิมปิดได้ทางเดียวคือปิดแท็บเบราว์เซอร์เอง',
  ],
  '10.22.609': [
    '🏠 เพิ่มปุ่มลอย "หน้าภาพรวม" มุมซ้ายล่างของจอ โผล่เฉพาะตอนอยู่หน้าอื่นที่ไม่ใช่ภาพรวม กดกลับหน้าภาพรวมได้ทันทีไม่ต้องเปิดเมนูซ้าย',
  ],
  '10.22.608': [
  ...
  '10.22.606': [
    '⬅️ เพิ่มปุ่ม "กลับ" ที่หน้าจอมอนิเตอร์อีก 4 หน้าที่ยังไม่มี (ศูนย์ติดตามรวม/แดชบอร์ดแนวโน้มละหมาด/จอมอนิเตอร์ละหมาดเรียลไทม์/จอติดตามการออกนอกห้องเรียน) — ครบทุกหน้าจอมอนิเตอร์ในระบบแล้ว',
  ],
  '10.22.605': [
    '⬅️ เพิ่มปุ่ม "กลับ" ที่หน้ามอนิเตอร์กีฬาสีทั้ง 4 หน้า (บัญชีเงิน/ไซซ์เสื้อ/ค่าบำรุง/เช็คชื่อ) ที่ยังไม่มีปุ่มย้อนกลับมาก่อน',
  ],
  '10.22.604': [
    '🛡️ หน้าภาพรวมผู้บริหาร: เพิ่มไอคอนลัด "ระบบเวร" ในกลุ่ม "ระบบอื่นๆ" ด้วย (นอกจากในกลุ่มจอมอนิเตอร์)',
    '📋 ระบบสภานักเรียน: หน้าหลักของแอดมิน/ผู้บริหารแสดงสถิติ "การสมัครสภานักเรียน" ทันทีโดยไม่ต้องกดเข้าแท็บ "ระบบ" > "ภาพรวม" ก่อน',
  ],
  '10.22.603': [
    '🛡️ หน้าภาพรวมผู้บริหาร: เพิ่มปุ่มลัด "ระบบเวร" ในกลุ่มจอมอนิเตอร์ เชื่อมไปหน้า TV Monitor ของระบบติดตามการปฏิบัติเวร (โปรเจกต์แยก) ที่เปิดดูได้เลยไม่ต้องล็อกอิน',
  ],
  '10.22.602': [
    '🐛 แก้ตัวเลขผิดในหน้าภาพรวมผู้บริหาร: (1) "จำนวนคุณครู" ขึ้น 0 เพราะกรองด้วย teachers.is_active ที่ยังไม่เคยถูกตั้งค่าใช้งานจริงในระบบ เปลี่ยนเป็นนับครูทั้งหมดให้ตรงกับหน้าภาพรวมแอดมิน (2) "จำนวนคอร์ส"/"จำนวนรายวิชา" ตกหล่นเพราะติด limit 1,000 แถวของ Supabase (ห้องเรียนจริงมี 1,450 ห้อง แต่ดึงมาได้แค่ 1,000) แก้ด้วยการไล่ดึงทีละหน้าจนครบ',
  ],
  '10.22.601': [
    '👔 หน้าภาพรวมผู้บริหาร: เพิ่มการ์ดสถิติ 4 อัน (จำนวนครู active/นักเรียน active/คอร์ส/รายวิชาที่เปิดสอน) กดขยายดูรายละเอียดได้ — คอร์ส/รายวิชาแยกหมวดชัดเจน (สามัญมัธยม ม.ต้น/ม.ปลาย, สามัญปวช, ศาสนามัธยม, ศาสนาปวช), เพิ่มไอคอนลัดเข้าประกาศ/ปฏิทินปฏิบัติงาน/สภานักเรียน/TERANGGANU/แก้ค้างเก่า (ตามสิทธิ์จริง) และปุ่มลัดจอมอนิเตอร์ 8 ระบบทั้งหมด ไม่ต้องเปิดเมนูซ้ายอีกต่อไป, ลบข้อความอธิบายในการ์ด "ทีมผู้บริหาร"',
    '🏛️ หน้าภาพรวมผู้บริหาร (council.html แท็บ "ภาพรวม"): สลับลำดับให้ส่วน "การสมัครสภานักเรียน" ขึ้นก่อนส่วน "สภานักเรียนวาระปัจจุบัน"',
  ],
  '10.22.600': [
    '🖼️ แก้สัดส่วนรูปโปรไฟล์ครูในการ์ดหน้าภาพรวมที่แคบเกินไปหลังปรับให้สูงขึ้น (96×112px แทน 64×112px)',
  ],
  '10.22.599': [
  ...
  '10.22.597': [
    '🎨 ไอคอนกริด "ระบบอื่นๆ" (หน้าภาพรวมครู/นักเรียน) ปรับดีไซน์ใหม่เป็นโทนพาสเทล มุมโค้งน้อยลง อิโมจิใหญ่ขึ้น พร้อมเพิ่มการตั้งค่า "รูปแบบไอคอน" ในหน้าตั้งค่า > ทั่วไป > เบ็ดเตล็ด ให้แอดมินสลับได้ 3 แบบ (เงาสีเข้ม/เงามันแบบ 3D/กระจกฝ้า) มีผลทั้งฝั่งครูและนักเรียนพร้อมกัน',
  ],
  '10.22.596': [
    '🖨️ แก้ค้างเก่า: ใบพิมพ์รายชื่อห้อง (บอร์ดผู้บริหาร) คอลัมน์เลขประจำตัวจัดกึ่งกลางแล้ว',
  ],
  '10.22.595': [
