...
revoke all on function public.start_admin_impersonation(uuid) from anon;
revoke all on function public.validate_admin_impersonation(uuid) from anon;
revoke all on function public.end_admin_impersonation(uuid) from anon;
